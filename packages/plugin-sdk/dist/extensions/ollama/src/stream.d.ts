...
import type { EnclawedConfig, ProviderWrapStreamFnContext } from "@enclawed/plugin-sdk/plugin-entry";
...
export declare function resolveConfiguredOllamaProviderConfig(params: {
    ...
    providerId?: string;
}): import("@enclawed/plugin-sdk/provider-model-shared").ModelProviderConfig | undefined;
