...
export type ChannelConfigAdapter<ResolvedAccount> = {
    ...
    isConfigured?: BivariantCallback<(account: ResolvedAccount, cfg: EnclawedConfig) => boolean | Promise<boolean>>;
    unconfiguredReason?: BivariantCallback<(account: ResolvedAccount, cfg: EnclawedConfig) => string>;
    describeAccount?: BivariantCallback<(account: ResolvedAccount, cfg: EnclawedConfig) => ChannelAccountSnapshot>;
