...
export declare function discoverConfigSecretTargets(config: EnclawedConfig): DiscoveredConfigSecretTarget[];
export declare function discoverConfigSecretTargetsByIds(config: EnclawedConfig, targetIds?: Iterable<string>): DiscoveredConfigSecretTarget[];
