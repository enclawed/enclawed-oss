...
export declare function resolveMemoryDreamingPluginId(cfg: EnclawedConfig | Record<string, unknown> | undefined): string;
export declare function resolveMemoryDreamingPluginConfig(cfg: EnclawedConfig | Record<string, unknown> | undefined): Record<string, unknown> | undefined;
...
export declare function resolveMemoryDreamingWorkspaces(cfg: EnclawedConfig): MemoryDreamingWorkspace[];
