...
export declare function createSetupWizardAdapter(params: SetupWizardAdapterParams): import("../plugin-sdk/setup.ts").ChannelSetupWizardAdapter;
export declare function createPluginSetupWizardAdapter(plugin: SetupWizardTestPlugin): import("../plugin-sdk/setup.ts").ChannelSetupWizardAdapter;
