...
export declare function resolveBootstrapMaxChars(cfg?: EnclawedConfig): number;
export declare function resolveBootstrapTotalMaxChars(cfg?: EnclawedConfig): number;
export declare function resolveBootstrapPromptTruncationWarningMode(cfg?: EnclawedConfig): "off" | "once" | "always";
