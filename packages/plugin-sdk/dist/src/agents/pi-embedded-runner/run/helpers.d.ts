...
export declare function resolveOverloadFailoverBackoffMs(cfg?: EnclawedConfig): number;
export declare function resolveOverloadProfileRotationLimit(cfg?: EnclawedConfig): number;
export declare function resolveRateLimitProfileRotationLimit(cfg?: EnclawedConfig): number;
