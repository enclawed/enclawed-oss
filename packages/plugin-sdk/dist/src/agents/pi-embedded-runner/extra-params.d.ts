...
export declare function applyExtraParamsToAgent(agent: {
    streamFn?: StreamFn;
}, cfg: EnclawedConfig | undefined, provider: string, modelId: string, extraParamsOverride?: Record<string, unknown>, thinkingLevel?: ThinkLevel, agentId?: string, workspaceDir?: string, model?: ProviderRuntimeModel, agentDir?: string): {
