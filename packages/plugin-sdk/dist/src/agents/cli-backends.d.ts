...
export declare function resolveCliBackendIds(cfg?: EnclawedConfig): Set<string>;
export declare function resolveCliBackendLiveTest(provider: string): ResolvedCliBackendLiveTest | null;
export declare function resolveCliBackendConfig(provider: string, cfg?: EnclawedConfig): ResolvedCliBackend | null;
