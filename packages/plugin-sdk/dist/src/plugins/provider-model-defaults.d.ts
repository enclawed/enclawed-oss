...
export declare function applyGoogleGeminiModelDefault(cfg: EnclawedConfig): {
    next: EnclawedConfig;
    changed: boolean;
};
export declare function applyOpenAIProviderConfig(cfg: EnclawedConfig): EnclawedConfig;
export declare function applyOpenAIConfig(cfg: EnclawedConfig): EnclawedConfig;
export declare function applyOpencodeGoModelDefault(cfg: EnclawedConfig): {
    next: EnclawedConfig;
    changed: boolean;
};
