 ...
 */
export declare const PLUGIN_MANIFEST_FILENAME = "enclawed.plugin.json";
/** Legacy filename still readable for backward compatibility. */
export declare const LEGACY_PLUGIN_MANIFEST_FILENAME = "openclaw.plugin.json";
/**
 ...
 */
export declare const PLUGIN_MANIFEST_FILENAMES: readonly ["enclawed.plugin.json", "openclaw.plugin.json"];
...
export declare function getPackageManifestMetadata(manifest: PackageManifest | undefined): EnclawedPackageManifest | undefined;
