...
export declare function loadEnclawedPlugins(options?: PluginLoadOptions): PluginRegistry;
export declare function loadEnclawedPluginCliRegistry(options?: PluginLoadOptions): Promise<PluginRegistry>;
export {};
