...
import type { DiagnosticEventInput, DiagnosticEventPayload } from "../infra/diagnostic-events.js";
...
import type { ProviderDefaultThinkingPolicyContext, ProviderThinkingPolicyContext, ProviderThinkingProfile } from "./provider-thinking.types.js";
import type { PluginRuntime } from "./runtime/types.js";
import type { EnclawedPluginHookOptions, EnclawedPluginToolFactory, EnclawedPluginToolOptions } from "./tool-types.js";
...
export type { EnclawedPluginHookOptions, EnclawedPluginToolContext, EnclawedPluginToolFactory, EnclawedPluginToolOptions, } from "./tool-types.js";
...
export type { CliBackendNormalizeConfigContext, CliBackendPlugin, CliBundleMcpMode, PluginTextReplacement, PluginTextTransforms, } from "./cli-backend.types.js";
...
export type ProviderAuthMethod = {
    ...
    runNonInteractive?: (ctx: ProviderAuthMethodNonInteractiveContext) => Promise<EnclawedConfig | null>;
};
...
export type { ProviderDefaultThinkingPolicyContext, ProviderThinkingLevel, ProviderThinkingLevelId, ProviderThinkingPolicyContext, ProviderThinkingProfile, } from "./provider-thinking.types.js";
/**
...
export type ProviderPlugin = {
     ...
     */
    resolveThinkingProfile?: (ctx: ProviderThinkingPolicyContext) => ProviderThinkingProfile | null | undefined;
    /**
...
export type SpeechProviderPlugin = {
     ...
     */
    prepareSynthesis?: (ctx: SpeechProviderPrepareSynthesisContext) => SpeechProviderPreparedSynthesis | Promise<SpeechProviderPreparedSynthesis | undefined> | undefined;
...
export type EnclawedPluginHttpRouteHandler = (req: IncomingMessage, res: ServerResponse) => Promise<boolean | void> | boolean | void;
...
export type EnclawedPluginSecurityAuditCollector = (ctx: EnclawedPluginSecurityAuditContext) => SecurityAuditFinding[] | Promise<SecurityAuditFinding[]>;
/**
...
export type EnclawedGatewayDiscoveryService = {
    id: string;
    advertise: (ctx: EnclawedGatewayDiscoveryAdvertiseContext) => void | Promise<void | {
...
export type EnclawedPluginNodeInvokeApprovalDecision = "allow-once" | "allow-always" | "deny";
...
export type EnclawedPluginNodeInvokePolicy = {
    commands: string[];
    handle: (ctx: EnclawedPluginNodeInvokePolicyContext) => Promise<EnclawedPluginNodeInvokePolicyResult> | EnclawedPluginNodeInvokePolicyResult;
};
...
export type EnclawedPluginApi = {
    ...
    logger: PluginLogger;
    registerTool: (tool: AnyAgentTool | EnclawedPluginToolFactory, opts?: EnclawedPluginToolOptions) => void;
    registerHook: (events: string | string[], handler: InternalHookHandler, opts?: EnclawedPluginHookOptions) => void;
    ...
    registerCli: (registrar: EnclawedPluginCliRegistrar, opts?: {
     ...
     */
    registerAgentToolResultMiddleware: (handler: import("./agent-tool-result-middleware-types.js").AgentToolResultMiddleware, opts?: import("./agent-tool-result-middleware-types.js").AgentToolResultMiddlewareOptions) => void;
