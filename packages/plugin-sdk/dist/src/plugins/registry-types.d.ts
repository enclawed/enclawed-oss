...
import type { CliBackendPlugin, ImageGenerationProviderPlugin, MediaUnderstandingProviderPlugin, MusicGenerationProviderPlugin, EnclawedPluginChannelRegistration, EnclawedPluginCliCommandDescriptor, EnclawedPluginCliRegistrar, EnclawedPluginCommandDefinition, EnclawedGatewayDiscoveryService, EnclawedPluginGatewayRuntimeScopeSurface, EnclawedPluginNodeInvokePolicy, MigrationProviderPlugin, EnclawedPluginHttpRouteAuth, EnclawedPluginHttpRouteHandler, EnclawedPluginHttpRouteMatch, EnclawedPluginReloadRegistration, EnclawedPluginSecurityAuditCollector, EnclawedPluginService, EnclawedPluginToolFactory, PluginConversationBindingResolvedEvent, PluginHookRegistration as TypedPluginHookRegistration, PluginLogger, PluginOrigin, PluginTextTransformRegistration, ProviderPlugin, RealtimeTranscriptionProviderPlugin, RealtimeVoiceProviderPlugin, SpeechProviderPlugin, VideoGenerationProviderPlugin, WebFetchProviderPlugin, WebSearchProviderPlugin } from "./types.js";
...
export type PluginAgentToolResultMiddlewareRegistration = {
    ...
    runtimes: ReadonlyArray<import("./agent-tool-result-middleware-types.js").AgentToolResultMiddlewareRuntime>;
    source: string;
    rootDir?: string;
};
