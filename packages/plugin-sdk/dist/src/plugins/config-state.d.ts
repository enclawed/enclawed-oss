...
export declare const normalizePluginsConfig: (config?: EnclawedConfig["plugins"]) => NormalizedPluginsConfig;
export declare function createPluginActivationSource(params: {
    config?: EnclawedConfig;
    plugins?: NormalizedPluginsConfig;
}): PluginActivationConfigSource;
export declare const hasExplicitPluginConfig: (plugins?: EnclawedConfig["plugins"]) => boolean;
export declare function applyTestPluginDefaults(cfg: EnclawedConfig, env?: NodeJS.ProcessEnv): EnclawedConfig;
export declare function isTestDefaultMemorySlotDisabled(cfg: EnclawedConfig, env?: NodeJS.ProcessEnv): boolean;
