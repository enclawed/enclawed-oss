...
export declare const ENCLAWED_MODEL_ID = "enclawed";
export declare const ENCLAWED_DEFAULT_MODEL_ID = "enclawed/default";
...
export declare function resolveHttpBrowserOriginPolicy(req: IncomingMessage, cfg?: import("../config/types.enclawed.ts").EnclawedConfig): NonNullable<Parameters<typeof authorizeHttpGatewayConnect>[0]["browserOriginPolicy"]>;
...
export declare function resolveAgentIdFromModel(model: string | undefined, cfg?: import("../config/types.enclawed.ts").EnclawedConfig): string | undefined;
