...
export declare function hasAmbiguousGatewayAuthModeConfig(cfg: EnclawedConfig): boolean;
export declare function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: EnclawedConfig): void;
