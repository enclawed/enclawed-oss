...
export declare const GatewayClientIdSchema: import("@sinclair/typebox").TUnion<import("@sinclair/typebox").TLiteral<"cli" | "webchat-ui" | "enclawed-control-ui" | "enclawed-tui" | "webchat" | "gateway-client" | "enclawed-macos" | "enclawed-ios" | "enclawed-android" | "node-host" | "test" | "fingerprint" | "enclawed-probe">[]>;
