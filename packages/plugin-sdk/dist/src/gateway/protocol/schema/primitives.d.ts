...
export declare const GatewayClientIdSchema: import("@sinclair/typebox").TUnion<import("@sinclair/typebox").TLiteral<"webchat" | "cli" | "webchat-ui" | "enclawed-control-ui" | "enclawed-tui" | "gateway-client" | "enclawed-macos" | "enclawed-ios" | "enclawed-android" | "node-host" | "test" | "fingerprint" | "enclawed-probe">[]>;
export declare const GatewayClientModeSchema: import("@sinclair/typebox").TUnion<import("@sinclair/typebox").TLiteral<"webchat" | "cli" | "test" | "ui" | "backend" | "node" | "probe">[]>;
