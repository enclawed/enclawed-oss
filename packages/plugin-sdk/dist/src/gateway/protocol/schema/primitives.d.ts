...
export declare const GatewayClientIdSchema: import("@sinclair/typebox").TUnion<import("@sinclair/typebox").TLiteral<"cli" | "webchat" | "webchat-ui" | "enclawed-control-ui" | "enclawed-tui" | "gateway-client" | "enclawed-macos" | "enclawed-ios" | "enclawed-android" | "node-host" | "test" | "fingerprint" | "enclawed-probe">[]>;
export declare const GatewayClientModeSchema: import("@sinclair/typebox").TUnion<import("@sinclair/typebox").TLiteral<"probe" | "cli" | "ui" | "webchat" | "test" | "backend" | "node">[]>;
