...
export declare const validateCommandsListParams: AjvPkg.ValidateFunction<{
    ...
    scope?: "native" | "text" | "both" | undefined;
...
export declare const validateConnectParams: AjvPkg.ValidateFunction<{
    ...
    client: {
        ...
        id: "cli" | "webchat" | "webchat-ui" | "enclawed-control-ui" | "enclawed-tui" | "gateway-client" | "enclawed-macos" | "enclawed-ios" | "enclawed-android" | "node-host" | "test" | "fingerprint" | "enclawed-probe";
        version: string;
        platform: string;
    };
}>;
