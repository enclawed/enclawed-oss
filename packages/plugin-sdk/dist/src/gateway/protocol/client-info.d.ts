export declare const GATEWAY_CLIENT_IDS: {
    ...
    readonly CONTROL_UI: "enclawed-control-ui";
    readonly TUI: "enclawed-tui";
    readonly WEBCHAT: "webchat";
    readonly CLI: "cli";
    readonly GATEWAY_CLIENT: "gateway-client";
    readonly MACOS_APP: "enclawed-macos";
    readonly IOS_APP: "enclawed-ios";
    readonly ANDROID_APP: "enclawed-android";
    readonly NODE_HOST: "node-host";
    readonly TEST: "test";
    readonly FINGERPRINT: "fingerprint";
    readonly PROBE: "enclawed-probe";
};
