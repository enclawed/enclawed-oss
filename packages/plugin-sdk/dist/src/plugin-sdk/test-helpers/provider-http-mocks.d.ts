import type { resolveProviderHttpRequestConfig } from "../provider-http.js";
...
export declare function getProviderHttpMocks(): {
    ...
    sanitizeConfiguredModelProviderRequestMock: import("vitest").Mock<(request: SanitizeConfiguredModelProviderRequestParams) => unknown>;
