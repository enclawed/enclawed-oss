...
export declare function openAiPluginPersonalityConfig(personality: "friendly" | "off"): EnclawedConfig;
export declare function sharedGpt5PersonalityConfig(personality: "friendly" | "off"): EnclawedConfig;
