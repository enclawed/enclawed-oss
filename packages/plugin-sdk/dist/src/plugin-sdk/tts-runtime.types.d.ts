...
export type TtsTestFacade = {
    ...
    getResolvedSpeechProviderConfig: (config: ResolvedTtsConfig, providerId: string, cfg?: EnclawedConfig) => SpeechProviderConfig;
...
export type TtsRuntimeFacade = {
    ...
    isTtsProviderConfigured: (config: ResolvedTtsConfig, provider: TtsProvider, cfg?: EnclawedConfig) => boolean;
