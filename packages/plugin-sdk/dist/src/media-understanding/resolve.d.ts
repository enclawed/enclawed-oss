...
export declare function resolveCapabilityConfig(cfg: EnclawedConfig, capability: MediaUnderstandingCapability): MediaUnderstandingConfig | undefined;
...
export declare function resolveConcurrency(cfg: EnclawedConfig): number;
