...
export declare function resolveTextChunkLimit(cfg: EnclawedConfig | undefined, provider?: TextChunkProvider, accountId?: string | null, opts?: {
    fallbackLimit?: number;
}): number;
export declare function resolveChunkMode(cfg: EnclawedConfig | undefined, provider?: TextChunkProvider, accountId?: string | null): ChunkMode;
/**
