...
export declare function hasControlCommand(text?: string, cfg?: EnclawedConfig, options?: CommandNormalizeOptions): boolean;
export declare function isControlCommandMessage(text?: string, cfg?: EnclawedConfig, options?: CommandNormalizeOptions): boolean;
/**
...
export declare function shouldComputeCommandAuthorized(text?: string, cfg?: EnclawedConfig, options?: CommandNormalizeOptions): boolean;
