...
export declare function resolveQueuedReplyRuntimeConfig(config: EnclawedConfig): EnclawedConfig;
export declare function resolveQueuedReplyExecutionConfig(config: EnclawedConfig, params?: {
...
export declare function buildEmbeddedRunBaseParams(params: {
    ...
    execOverrides: Pick<import("../../agents/bash-tools.exec-types.ts").ExecToolDefaults, "ask" | "security" | "host" | "node"> | undefined;
    bashElevated: {
        enabled: boolean;
        allowed: boolean;
