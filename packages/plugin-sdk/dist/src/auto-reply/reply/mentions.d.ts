...
export declare function buildMentionRegexes(cfg: EnclawedConfig | undefined, agentId?: string): RegExp[];
...
export declare function stripMentions(text: string, ctx: MsgContext, cfg: EnclawedConfig | undefined, agentId?: string): string;
