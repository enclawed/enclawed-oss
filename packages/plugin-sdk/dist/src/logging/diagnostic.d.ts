...
export declare function resolveStuckSessionWarnMs(config?: EnclawedConfig): number;
...
export declare function startDiagnosticHeartbeat(config?: EnclawedConfig, opts?: {
