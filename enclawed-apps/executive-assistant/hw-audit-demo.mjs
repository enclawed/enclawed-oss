...
// the executive assistant experiences it: bootstrapEnclawed() binds the device; every accredited SkillGate
// action records the hardware root in the audit; and if the enclaweder is removed, actions HALT.
//   node enclawed-apps/executive-assistant/hw-audit-demo.mjs
...
const op = () =>
  gate.dispatch({
    skillId: "executive-assistant-skill",
