...
// (ENCLAWED_EXECUTIVE_ASSISTANT_HITL_CHANNEL, ENCLAWED_EXECUTIVE_ASSISTANT_HITL_EMAIL_TIMEOUT_MIN)
...
const { values } = parseArgs({
  ...
  strict: true,
  options: {
    flavor: { type: "string", default: env.ENCLAWED_FLAVOR ?? "enclaved" },
    hitl: { type: "string", default: "bicriterion" },
    "hitl-channel": {
      type: "string",
      default: env.ENCLAWED_EXECUTIVE_ASSISTANT_HITL_CHANNEL ?? "auto",
    },
    "hitl-email-timeout-min": {
      type: "string",
      default: env.ENCLAWED_EXECUTIVE_ASSISTANT_HITL_EMAIL_TIMEOUT_MIN ?? "30",
    },
    "eod-summary-at": { type: "string", default: "23:55" },
    "eod-trash-at": { type: "string", default: "23:59" },
    "inbox-poll-ms": {
      type: "string",
      default: env.ENCLAWED_EXECUTIVE_ASSISTANT_INBOX_POLL_MS ?? "5000",
    },
...
process.exit(
  await runApp({
    ...
    // ENCLAWED_EXECUTIVE_ASSISTANT_PRINCIPAL_EMAIL (post-rename: the human
    ...
    ...(env.ENCLAWED_EXECUTIVE_ASSISTANT_PRINCIPAL_EMAIL
      ? { principalEmailFromEnv: env.ENCLAWED_EXECUTIVE_ASSISTANT_PRINCIPAL_EMAIL }
      : {}),
