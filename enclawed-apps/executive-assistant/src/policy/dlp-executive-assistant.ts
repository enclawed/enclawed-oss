// Executive Assistant-specific DLP layer on top of the framework's dlp-scanner.
//
...
//
// For the executive assistant scenario we layer on three extra concerns:
//
 ...
 * framework scanner plus executive assistant-specific heuristics. The body is NEVER
...
function hostIsAllowed(host: string, allowed: ReadonlySet<string>): boolean {
  ...
  // host appears in the allowlist (which the executive assistant's policy does — gmail,
