...
import { f as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-tXlWPaMC.js";
import "./pi-embedded-helpers-B73c6wEg.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-Cy4poLEJ.js";
//#region src/agents/cli-runner.ts
async function runCliAgent(params) {
	const { prepareCliRunContext } = await import("./prepare.runtime-Bj_UHcOk.js");
	return runPreparedCliAgent(await prepareCliRunContext(params));
}
async function runPreparedCliAgent(context) {
	const { executePreparedCliRun } = await import("./execute.runtime-CDsfFDsx.js");
