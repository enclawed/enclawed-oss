...
import { n as assertNoPathAliasEscape } from "./path-alias-guards-CWtn4o3G.js";
import { t as isWindowsDrivePath } from "./archive-path-xknm3LhT.js";
import { a as safeFileURLToPath, r as hasEncodedFileUrlSeparator, t as assertNoWindowsNetworkPath } from "./local-file-access-DcHUOMtl.js";
...
async function resolveAllowedTmpMediaPath(params) {
	...
	if (!isPathInside(enclawedTmpDir, resolved)) return;
	await assertNoTmpAliasEscape({
		filePath: resolved,
		tmpRoot: enclawedTmpDir
	});
	return resolved;
}
