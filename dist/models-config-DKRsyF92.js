...
import { i as createConfigRuntimeEnv } from "./state-dir-dotenv-C2cfNhIh.js";
import { d as resolveSecretInputRef } from "./types.secrets-C7GHgMrh.js";
import { t as MODEL_APIS } from "./types.models-HMPkk8k9.js";
import "./public-surface-runtime-DvmOdLvy.js";
import "./bundled-plugin-metadata-CwKLNsbJ.js";
import { a as loadConfig, s as projectConfigOntoRuntimeSourceSnapshot } from "./io-Dzvn-wpi.js";
import { n as findNormalizedProviderValue } from "./provider-id-CxDLTf9A.js";
...
import { h as resolveOwningPluginIdsForProvider } from "./plugin-auto-enable-BE3SC6M5.js";
import { O as resolveProviderConfigApiKeyWithPlugin, h as normalizeProviderConfigWithPlugin, r as applyProviderNativeStreamingUsageCompatWithPlugin } from "./provider-runtime-DB4wLsLH.js";
import { t as resolveEnclawedAgentDir } from "./agent-paths-Pa0y6OT5.js";
import { h as resolveNonEnvSecretRefHeaderValueMarker, m as resolveNonEnvSecretRefApiKeyMarker, p as resolveEnvSecretRefHeaderValueMarker, u as isNonSecretApiKeyMarker } from "./model-auth-markers-CZACM95M.js";
import { i as runProviderCatalog, n as normalizePluginDiscoveryResult, r as resolvePluginDiscoveryProviders, t as groupPluginDiscoveryProvidersByOrder } from "./provider-discovery-BhoK6h11.js";
import { a as normalizeHeaderValues, c as resolveMissingProviderApiKey, i as normalizeConfiguredProviderApiKey, n as createProviderAuthResolver, o as normalizeResolvedEnvApiKey, s as resolveApiKeyFromProfiles, t as createProviderApiKeyResolver } from "./models-config.providers.secrets-vSGlqxAE.js";
...
function resolveLiveProviderCatalogTimeoutMs(env) {
	if (!(env.ENCLAWED_LIVE_TEST === "1" || env.ENCLAWED_LIVE_GATEWAY === "1" || env.LIVE === "1")) return null;
...
function resolveProviderDiscoveryFilter(params) {
	...
	if (!(env.ENCLAWED_LIVE_TEST === "1" || env.ENCLAWED_LIVE_GATEWAY === "1" || env.LIVE === "1")) return;
	const rawValues = [env.ENCLAWED_LIVE_PROVIDERS?.trim(), env.ENCLAWED_LIVE_GATEWAY_PROVIDERS?.trim()].filter((value) => Boolean(value && value !== "all"));
...
async function planEnclawedModelsJsonWithDeps(params, deps) {
	const { cfg, agentDir, env } = params;
...
async function planEnclawedModelsJson(params) {
...
async function ensureEnclawedModelsJson(config, agentDirOverride) {
...
//#endregion
export { ensureEnclawedModelsJson as t };
