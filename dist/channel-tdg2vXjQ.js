...
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-CXTFhYLQ.js";
import "./channel-api-DTdD-Sip.js";
import { n as looksLikeDiscordTargetId, o as parseDiscordTarget, r as normalizeDiscordMessagingTarget } from "./normalize-BAQCPs3C.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-CaOJezlJ.js";
import { t as getDiscordRuntime } from "./runtime-DzLsGSxf.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-m9ArkXt3.js";
import { t as getDiscordApprovalCapability } from "./approval-native-B494M4fS.js";
import { t as discordMessageActions$1 } from "./channel-actions-UDJstnvd.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-2X6VFMAM.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-BLsTahL4.js";
import { n as discordOutbound } from "./outbound-adapter-BATaDlIa.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-Dy4q_lG5.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-eWX6y9nN.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-BY9mDxWk.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-NpbcfC6c.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-BwJfjvfj.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-BDYzk2vn.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime-DBRpdGHS.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-DnvZ6zbZ.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-CMOEGHE4.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-DCwUIA1P.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-CxKyX1na.js");
