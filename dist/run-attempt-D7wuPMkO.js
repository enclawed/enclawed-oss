...
import { a as normalizeUsage } from "./usage-CwW0G6C9.js";
import { d as isMessagingToolSendAction, i as extractToolResultMediaArtifact, o as filterToolResultMediaUrls, t as buildEmbeddedAttemptToolRunContext, u as isMessagingTool } from "./attempt.tool-run-context-SXAp9gZ1.js";
import { c as resolveModelAuthMode } from "./model-auth-CEwjo3Cm.js";
import { c as supportsModelTools, r as resolveAttemptSpawnWorkspaceDir } from "./attempt.thread-helpers-B8zkwd__.js";
import { t as log } from "./logger-UWzJtLV8.js";
import { f as formatToolAggregate } from "./attempt.prompt-helpers-CpBc4FVv.js";
import { i as emitAgentEvent } from "./agent-events-m_o42nBy.js";
import { t as callGatewayTool } from "./gateway-B2xBY4c_.js";
import { a as isToolWrappedWithBeforeToolCallHook, i as isToolCallBlockedError, s as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-C52866db.js";
import { l as setActiveEmbeddedRun, n as clearActiveEmbeddedRun } from "./runs-DYuSrnq1.js";
import { o as resolveSandboxContext } from "./sandbox-f-aJNLxY.js";
import "./agent-harness-Cj52ApWI.js";
import { C as resolveAgentHarnessBeforePromptBuildResult, D as normalizeAgentRuntimeTools, M as runAgentCleanupStep, N as formatApprovalDisplayPath, S as createCodexAppServerToolResultExtensionRunner, T as runAgentHarnessBeforeCompactionHook, _ as buildHarnessContextEngineRuntimeContextFromUsage, b as runHarnessContextEngineMaintenance, c as runAgentHarnessAgentEndHook, d as runAgentHarnessLlmOutputHook, f as runAgentHarnessAfterToolCallHook, g as buildHarnessContextEngineRuntimeContext, h as bootstrapHarnessContextEngine, i as inferToolMetaFromArgs, k as normalizeHeartbeatToolResponse, m as assembleHarnessContextEngine, n as classifyAgentHarnessTerminalOutcome, p as runAgentHarnessBeforeMessageWriteHook, r as formatToolProgressOutput, s as registerNativeHookRelay, t as TOOL_PROGRESS_OUTPUT_MAX_CHARS, u as runAgentHarnessLlmInputHook, v as finalizeHarnessContextEngineTurn, w as runAgentHarnessAfterCompactionHook, x as createAgentToolResultMiddlewareRunner, y as isActiveHarnessContextEngine } from "./agent-harness-runtime-D9p7fWjh.js";
import { i as resolveCodexAppServerRuntimeOptions, n as codexSandboxPolicyForTurn, r as readCodexPluginConfig } from "./config-CZygc85A.js";
import { i as readCodexDynamicToolCallParams, n as assertCodexThreadStartResponse, r as assertCodexTurnStartResponse, s as readCodexTurn, t as assertCodexThreadResumeResponse } from "./protocol-validators-jl4aCFxv.js";
import { t as isJsonObject } from "./protocol-3Yi01-fE.js";
import { n as renderCodexPromptOverlay } from "./prompt-overlay-BaoaWHz6.js";
import { r as isModernCodexModel } from "./provider-CztP7uZn.js";
import { c as isCodexAppServerApprovalRequest, o as refreshCodexAppServerAuthTokens, t as clearSharedCodexAppServerClient } from "./shared-client-DQRq0P-Y.js";
import { i as writeCodexAppServerBinding, n as readCodexAppServerBinding, t as clearCodexAppServerBinding } from "./session-binding-BeHjfjGU.js";
import { n as defaultCodexAppServerClientFactory, t as createCodexAppServerClientFactoryTestHooks } from "./client-factory-BLXu1jX0.js";
import { t as ensureCodexComputerUse } from "./computer-use-DN1ecjGj.js";
	...
	return {
		...
		handleToolCall: async (call, options) => {
			...
			if (!tool) return {
				contentItems: [{
					type: "inputText",
					text: `Unknown Enclawed tool: ${call.tool}`
				}],
				success: false
			};
			...
			try {
				...
				const blocked = isToolCallBlockedError(error);
				collectToolTelemetry({
					toolName: tool.name,
					args,
					result: void 0,
...
async function handleDynamicToolCallWithTimeout(params) {
	if (params.signal.aborted) return failedDynamicToolResponse("Enclawed dynamic tool call aborted before execution.");
	...
	try {
		...
		resolveAbort = void 0;
		if (!timedOut && !controller.signal.aborted) controller.abort(/* @__PURE__ */ new Error("Enclawed dynamic tool call finished."));
	}
}
...
async function buildDynamicTools(input) {
	...
	const agentDir = params.agentDir ?? resolveEnclawedAgentDir();
	const { createEnclawedCodingTools } = await import("./plugin-sdk/agent-harness.js");
	const visionFilteredTools = filterToolsForVisionInputs(applyCodexDynamicToolProfile(createEnclawedCodingTools({
...
function readMirroredSessionHistoryMessages(sessionFile, sessionManager) {
	try {
		...
		log.warn("failed to read mirrored session history for codex harness hooks", {
			error,
			sessionFile
		});
		return;
