...
import { r as buildChannelConfigSchema } from "./config-schema-Dl-YbJo-.js";
...
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-n1cctuu6.js";
import { d as readNumberParam, h as readStringParam, i as createActionGate, n as ToolAuthorizationError } from "./common-BMEsSwt3.js";
import { t as adaptScopedAccountAccessor, u as createScopedDmSecurityResolver } from "./channel-config-helpers-bOV5DWOp.js";
import { C as projectAccountConfigWarningCollector, g as createAllowlistProviderOpenWarningCollector } from "./channel-policy-C02m4wT2.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-CCHy2XBt.js";
import { i as createResolvedDirectoryEntriesLister } from "./directory-config-helpers-EqIULxuE.js";
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-W6w9c0NC.js";
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-BSDzfHgF.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-CHriktlm.js";
import "./routing-Cs1E5kjm.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-C9jGJ-IK.js";
import "./approval-delivery-runtime-5YZGPjMJ.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-CdRxDZz6.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-CN1Mvdh8.js";
import { n as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-DS_rF55O.js";
import "./approval-native-runtime-Dxwwp1fR.js";
import "./outbound-runtime-CRBGdkio.js";
import "./conversation-runtime-DjOH5oQ8.js";
import { t as chunkTextForOutbound } from "./text-chunking-gfmBwUee.js";
import { n as describeAccountSnapshot } from "./account-helpers-CYo5OeYU.js";
import "./channel-config-primitives-CyMeF3dm.js";
import "./channel-actions-BGxn5OtH.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-C1k6YTNy.js";
import "./channel-core-BvQCVlU0.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-zOJ_Klee.js";
import "./session-store-runtime-CFNw3j01.js";
import "./string-coerce-runtime-DHP37Oa1.js";
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-Z5fKx70K.js";
import "./channel-status-lBa-A1_e.js";
import { t as extractToolSend } from "./tool-send-JWnxNzIU.js";
import { X as Optional, g as String$1 } from "./build-BqpZINkL.js";
import { a as resolveMatrixAccountConfig } from "./account-config-YLbSRkmf.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-BDgpsXHq.js";
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-B9wpCe5i.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-Ce60beaa.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-BVN2WxrR.js";
import { n as normalizeMatrixUserId } from "./allowlist-C3OZSzls.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-Cdfi1yS6.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-htGhMMZY.js";
import { t as formatMatrixErrorMessage } from "./errors-CjeEs-FE.js";
import { n as matrixConfigAdapter, t as MatrixConfigSchema } from "./config-schema-BRcQSpQm.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-BKj5mBiW.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-Q8ACzobt.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-C6n42P2d.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-DmxA9D40.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-Dvt0YfhF.js";
import { i as autoPrepareLegacyMatrixCrypto, o as autoMigrateLegacyMatrixState, r as resolveMatrixMigrationStatus } from "./matrix-migration.runtime-D1S2-ZvU.js";
import { t as maybeCreateMatrixMigrationSnapshot } from "./migration-snapshot-backup-Bk7N1yku.js";
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-BzxfpzbE.js";
...
const matrixMessageActions = {
	...
	handleAction: async (ctx) => {
		const { handleMatrixAction } = await import("./tool-actions.runtime-Bns2Midd.js");
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-DW3JH3yk.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixChannelRuntime$1 = createLazyRuntimeNamedExport(() => import("./resolver.runtime-DAlTqB4F.js"), "matrixResolverRuntime");
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-B1UbNpF6.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-BikX7llJ.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixDoctor = {
	...
	runConfigSequence: async ({ cfg, env, shouldRepair }) => await (await import("./doctor-Btz1IMMi.js")).runMatrixDoctorSequence({
		cfg,
		env,
		shouldRepair
	}),
	cleanStaleConfig: async ({ cfg }) => await (await import("./doctor-Btz1IMMi.js")).cleanStaleMatrixPluginConfig(cfg)
};
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-CfvJ4xvF.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
