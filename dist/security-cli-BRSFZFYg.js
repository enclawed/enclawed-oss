...
import { a as createIcaclsResetCommand, o as formatIcaclsResetCommand } from "./audit-fs-CTqQIWT8.js";
import { a as loadConfig, r as createConfigIO } from "./io-BPigC1a6.js";
...
import { o as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-BhK2K9pt.js";
import { t as formatHelpExamples } from "./help-format-02fn-Ugc.js";
import { t as runSecurityAudit } from "./audit-iDOvsGrW.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-C5BYJ49J.js");
...
function registerSecurityCli(program) {
	program.command("security").description("Audit local config and state for common security foot-guns").addHelpText("after", () => `\n${theme.heading("Examples:")}\n${formatHelpExamples([
		...
		["enclawed security audit --deep --password <password>", "Use explicit password for deep probe."],
