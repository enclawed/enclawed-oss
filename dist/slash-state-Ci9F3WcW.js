...
import { l as isTrustedProxyAddress, p as resolveClientIp } from "./net-DkWIq6k8.js";
...
import { i as deliverTextOrMediaReply, m as resolveSendableOutboundReplyParts, u as isReasoningReplyPayload } from "./reply-payload-ULobvdLo.js";
...
import { a as isRequestBodyLimitError, s as readRequestBodyWithLimit } from "./http-body-CrYxTOA6.js";
...
import { i as normalizeMattermostAllowList, t as authorizeMattermostCommandInvocation } from "./monitor-auth-wjAnvm6E.js";
...
async function registerSlashCommands(params) {
	...
	for (const spec of commands) {
		...
		if (ownedCommands.length === 0 && foreignCommands.length > 0) {
			log?.(`mattermost: trigger /${spec.trigger} already used by non-Enclawed command(s); skipping to avoid mutating external integrations`);
			continue;
		}
...
function getProviderModels(data, provider) {
	return [...data.byProvider.get(normalizeProviderId(provider)) ?? /* @__PURE__ */ new Set()].toSorted((a, b) => a < b ? -1 : a > b ? 1 : 0);
}
