...
import { n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers--RJu1ACo.js";
...
import { r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-BYMdDJ4Z.js";
import { i as isDiscordExecApprovalClientEnabled, n as getDiscordExecApprovalApprovers, r as isDiscordExecApprovalApprover, t as shouldHandleDiscordApprovalRequest } from "./approval-shared-DIRJ9rAw.js";
...
function createDiscordApprovalCapability(configOverride) {
	return createApproverRestrictedNativeApprovalCapability({
		...
		nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
			...
			load: async () => (await import("./approval-handler.runtime-D9dHZ5PG.js")).discordApprovalNativeRuntime
		})
	});
}
