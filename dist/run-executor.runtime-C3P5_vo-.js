...
import { u as resolveEffectiveModelFallbacks } from "./agent-scope-n27Qvudk.js";
...
import { o as resolveSessionTranscriptPath } from "./paths-Lozvxyih.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-Dcs_bNw0.js";
import { u as registerAgentRunContext } from "./agent-events-BfuQdc-z.js";
import { i as LiveSessionModelSwitchError, r as runWithModelFallback } from "./model-fallback-DOn2mqGh.js";
import { i as resolveCronPayloadOutcome } from "./helpers-CWyIwpV2.js";
import { n as isLikelyInterimCronMessage } from "./subagent-followup-hints-CmU9WFsU.js";
import { i as syncCronSessionLiveSelection } from "./run-session-state-Dx6qkqdk.js";
...
async function loadCronExecutionCliRuntime() {
	cronExecutionCliRuntimePromise ??= import("./run-execution-cli.runtime-CBY_FDHp.js");
...
async function loadCronEmbeddedRuntime() {
	cronEmbeddedRuntimePromise ??= import("./run-embedded.runtime-C_G6CZOp.js");
	return await cronEmbeddedRuntimePromise;
}
async function loadCronSubagentRegistryRuntime() {
	cronSubagentRegistryRuntimePromise ??= import("./run-subagent-registry.runtime-DyfnM2SX.js");
