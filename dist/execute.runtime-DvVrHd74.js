...
import { o as sanitizeHostExecEnv } from "./host-env-security-9zf-JImt.js";
import { a as shouldLogVerbose } from "./globals-D8R_YQwt.js";
import { p as scopedHeartbeatWakeOptions } from "./session-key-D8SZau-8.js";
import { t as applyPluginTextReplacements } from "./plugin-text-transforms-BXYqyRTr.js";
import { a as prependBootstrapPromptWarning } from "./bootstrap-budget-BpYVYL-p.js";
import { t as classifyFailoverReason } from "./errors-mPsA10gc.js";
import "./pi-embedded-helpers-g589tXhs.js";
import { s as resolveFailoverStatus, t as FailoverError } from "./failover-error-B4l-iODK.js";
...
async function prepareClaudeCliSkillsPlugin(params) {
	...
	const tempDir = await fs.mkdtemp(path.join(resolvePreferredEnclawedTmpDir(), "enclawed-claude-skills-"));
	...
	try {
		return await enqueueCliRun(queueKey, async () => {
			...
			try {
				...
				const logOutputText = isTruthyEnvValue(process.env["ENCLAWED_CLI_BACKEND_LOG_OUTPUT"]) || isTruthyEnvValue(process.env["ENCLAWED_CLAUDE_CLI_LOG_OUTPUT"]);
				const env = (() => {
