...
import { n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-C9jGJ-IK.js";
...
import { r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-BZ31aFkW.js";
import { i as isDiscordExecApprovalClientEnabled, n as getDiscordExecApprovalApprovers, r as isDiscordExecApprovalApprover, t as shouldHandleDiscordApprovalRequest } from "./approval-shared-0z0K9KWE.js";
...
function createDiscordApprovalCapability(configOverride) {
	return createApproverRestrictedNativeApprovalCapability({
		...
		nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
			...
			load: async () => (await import("./approval-handler.runtime-Bs14A6BN.js")).discordApprovalNativeRuntime
		})
	});
}
