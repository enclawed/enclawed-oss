...
import { d as readNumberParam, h as readStringParam } from "./common-BLKrO58o.js";
...
import { t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-pVL77e8h.js";
import "./text-runtime-BRbvmj_h.js";
import { n as buildOutboundBaseSessionKey } from "./thread-id-LoCtkgfE.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute } from "./core-Csabf6e9.js";
import "./routing-Dqh5aJRb.js";
import { t as resolveApprovalApprovers } from "./approval-approvers-Dcr5RgkK.js";
import { t as createResolvedApproverActionAuthAdapter } from "./approval-auth-helpers-X8kI_IvG.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers--RJu1ACo.js";
...
import { n as createChannelNativeOriginTargetResolver, t as createChannelApproverDmTargetResolver } from "./approval-native-helpers-Iw9i_LqT.js";
import "./approval-native-runtime-uCDVsI10.js";
import { o as resolveConfiguredFromRequiredCredentialStatuses, r as projectCredentialSnapshotFields } from "./account-snapshot-fields-BUrPgrA9.js";
import "./reply-reference-DBvu-KL7.js";
import { o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter, s as createFlatAllowlistOverrideResolver } from "./allowlist-config-edit-CpBdD2M1.js";
...
import "./param-readers-D1wDsaZJ.js";
import { d as createDefaultChannelRuntimeState, u as createComputedAccountStatusAdapter } from "./status-helpers-D2DtBiBO.js";
import { h as stringifyRouteThreadId, o as channelRouteTargetsMatchExact } from "./channel-route-DXbpdGsz.js";
import { a as resolveSlackAccount, i as resolveDefaultSlackAccountId, l as resolveSlackReplyToMode, n as listSlackAccountIds, o as resolveSlackAccountAllowFrom } from "./accounts-DVJOe-QR.js";
import { i as resolveSlackChannelId, n as normalizeSlackMessagingTarget, r as parseSlackTarget, t as looksLikeSlackTargetId } from "./target-parsing-dz7plcH-.js";
import { a as normalizeSlackApproverId, c as shouldSuppressLocalSlackExecApprovalPrompt, i as isSlackExecApprovalClientEnabled, o as resolveSlackExecApprovalTarget, r as isSlackExecApprovalAuthorizedSender, s as shouldHandleSlackExecApprovalRequest, t as getSlackExecApprovalApprovers } from "./exec-approvals-DkoYPL3Q.js";
import { n as buildSlackPresentationBlocks, r as resolveSlackInteractiveBlockOffsets, t as buildSlackInteractiveBlocks } from "./blocks-render-BYnR566k.js";
import { t as SLACK_TEXT_LIMIT } from "./limits-DF-WZ7gY.js";
import { n as extractSlackToolSend, t as describeSlackMessageTool } from "./message-tool-api-COP-PRED.js";
import { n as isSlackInteractiveRepliesEnabled, t as compileSlackInteractiveReplies } from "./interactive-replies-B8Xs6mRL.js";
import "./channel-api-uTiepbZY.js";
import { r as createSlackWebClient } from "./client-B_Ewl7Jg.js";
import { r as normalizeAllowListLower } from "./allow-list-CKC8mwfb.js";
import { n as resolveSlackGroupToolPolicy, t as resolveSlackGroupRequireMention } from "./group-policy-BFzm7I4L.js";
import { t as resolveSlackReplyBlocks } from "./reply-blocks-CAGQZVvG.js";
import { t as getOptionalSlackRuntime } from "./runtime-BVDTi1jM.js";
import { i as slackSecurityAdapter, n as isSlackPluginAccountConfigured, r as slackConfigAdapter, t as createSlackPluginBase } from "./shared-ByyZOCjj.js";
import { i as SLACK_CHANNEL, n as createSlackSetupWizardProxy, r as slackSetupAdapter } from "./setup-core-D731Qt7o.js";
import { n as resolveSlackThreadTsValue, t as normalizeSlackThreadTsCandidate } from "./thread-ts-c1och-U9.js";
...
const slackApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-8OrjK4u8.js")).slackApprovalNativeRuntime
	})
});
...
async function loadSlackActionRuntime$1() {
	slackActionRuntimePromise$1 ??= import("./action-runtime.runtime-Bv1XXlSE.js");
...
const loadSlackSetupSurfaceModule = createLazyRuntimeModule(() => import("./setup-surface-Cgf1-03u.js"));
const loadSlackScopesModule = createLazyRuntimeModule(() => import("./scopes-BjEzJaSa.js"));
const loadSlackOutboundAdapterModule = createLazyRuntimeModule(() => import("./outbound-adapter-CiNyjcic.js"));
...
const loadSlackDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-gboVwoTz.js"));
const loadSlackResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-CPwIpBWH.js"));
const loadSlackResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-DxVHBghF.js"));
async function loadSlackActionRuntime() {
	slackActionRuntimePromise ??= import("./action-runtime.runtime-Bv1XXlSE.js");
	return await slackActionRuntimePromise;
}
async function loadSlackSendRuntime() {
	slackSendRuntimePromise ??= import("./send.runtime-pwQ3-5Jv.js");
	return await slackSendRuntimePromise;
}
async function loadSlackProbeModule() {
	slackProbeModulePromise ??= import("./probe-BHrCel1M.js");
	return await slackProbeModulePromise;
}
async function loadSlackMonitorModule() {
	slackMonitorModulePromise ??= import("./monitor-D_K1xcPX.js");
	return await slackMonitorModulePromise;
}
async function loadSlackDirectoryLiveModule() {
	slackDirectoryLiveModulePromise ??= import("./directory-live-CFjn0TAN.js");
