import { a as createMigrationConfigPatchItem, c as hasMigrationConfigPatchConflict, i as applyMigrationManualItem, r as applyMigrationConfigPatchItem, s as createMigrationManualItem } from "./migration-DOSnICX3.js";
import { a as isRecord, c as readString, l as readStringArray, n as childRecord } from "./helpers-CdKiqbVQ.js";
...
function buildConfigItems(params) {
	...
	if (memoryProvider === "honcho") {
		...
		items.push(createMigrationManualItem({
			...
			message: "Hermes used Honcho memory. Enclawed keeps built-in memory selected until the matching plugin is installed and reviewed.",
