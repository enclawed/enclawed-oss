...
import { f as resolveConfigDir, g as resolveUserPath } from "./utils-BcQ7uNrT.js";
...
import { a as resolvePackageExtensionEntries, i as loadPluginManifest, r as getPackageManifestMetadata, t as DEFAULT_PLUGIN_ENTRY_CANDIDATES } from "./manifest-Cdg6fKQA.js";
import { c as detectBundleManifestFormat, i as safeStatSync, l as loadBundleManifest, n as isPathInside, r as safeRealpathSync, t as formatPosixMode } from "./path-safety-DBwpKwNC.js";
...
function resolvePluginSourceRoots(params) {
	...
	return {
		...
		workspace: workspaceRoot ? path.join(workspaceRoot, ".enclawed", "extensions") : void 0
	};
}
...
function shouldUseDiscoveryCache(env) {
	if (env.ENCLAWED_DISABLE_PLUGIN_DISCOVERY_CACHE?.trim()) return false;
...
function discoverEnclawedPlugins(params) {
	const env = params.env ?? process.env;
...
//#endregion
export { resolvePluginSourceRoots as i, discoverEnclawedPlugins as n, resolvePluginCacheInputs as r, clearPluginDiscoveryCache as t };
