...
import { i as getRuntimeConfig, p as readSourceConfigSnapshotForWrite, r as createConfigIO } from "./io-b4s6ivfp.js";
...
import { o as shouldEnableShellEnvFallback, t as getShellEnvAppliedKeys } from "./shell-env-BtVb9cHO.js";
...
import { _ as resolveDefaultAgentWorkspaceDir } from "./workspace-Dg5fnKWT.js";
import { S as resolveDefaultAgentId, b as resolveAgentDir, i as resolveAgentExplicitModelPrimary, s as resolveAgentModelFallbacksOverride, x as resolveAgentWorkspaceDir } from "./agent-scope-D-lQQ64_.js";
...
import { a as loadAuthProfileStoreForRuntime, n as ensureAuthProfileStore } from "./store-CFRep4YQ.js";
...
import { f as modelKey, m as parseModelRef, t as isCliProvider } from "./model-selection-cli-CsqB1sDP.js";
import { t as modelKey$1 } from "./model-ref-shared-BVYR9WKg.js";
import { d as resolveConfiguredModelRef, f as resolveDefaultModelForAgent, i as buildModelAliasIndex, m as resolveModelRefFromString } from "./model-selection-DYKhuAoE.js";
...
import { a as setAuthProfileOrder, n as listProfilesForProvider, o as upsertAuthProfile } from "./profiles-BxmkyPvG.js";
import { d as resolveProfileUnusableUntilForDisplay, i as clearAuthProfileCooldown } from "./order-CXBjWUf1.js";
import { i as getCustomProviderApiKey, l as resolveUsableCustomProviderApiKey, o as hasUsableCustomProviderApiKey, s as resolveApiKeyForProvider } from "./model-auth-m8tj01Sr.js";
...
import { n as shouldSuppressBuiltInModel } from "./model-suppression-Bs27wA8K.js";
import { r as resolveModelWithRegistry } from "./model-BvO5W3LU.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-CmXZqYYH.js";
...
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-DUx4tYSW.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-CF4Zvu9n.js");
				await openUrl(url);
			},
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore, ensureEnclawedModelsJson } = await import("./list.runtime-CduUF1CU.js");
...
function loadProviderUsageRuntime() {
	providerUsageRuntimePromise ??= import("./provider-usage-u9h0Qy3J.js");
...
async function modelsStatusCommand(opts, runtime) {
	...
	let probeSummary;
	if (opts.probe) {
		const [{ withProgressTotals }, { runAuthProbes }] = await Promise.all([import("./progress-BePQsLk4.js"), import("./list.probe-DfP4jGG4.js")]);
	...
	if (missingProvidersInUse.length > 0) {
		const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-COuanku8.js");
		runtime.log("");
	...
	if (probeSummary) {
		const [{ getTerminalTableWidth, renderTable }, { describeProbeSummary, formatProbeLatency, sortProbeResults }] = await Promise.all([import("./table-C4DIkmLG.js"), import("./list.probe-DfP4jGG4.js")]);
		runtime.log("");
