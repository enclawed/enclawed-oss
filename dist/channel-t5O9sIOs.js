...
import { n as normalizeAtHashSlug } from "./string-normalization-QLwZvaSN.js";
...
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-CH69C8W1.js";
...
import { n as resolveTargetsWithOptionalToken } from "./target-resolvers-CS_HTISS.js";
...
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-BZ31aFkW.js";
import "./channel-api-CzAg6Jlb.js";
import { n as looksLikeDiscordTargetId, o as parseDiscordTarget, r as normalizeDiscordMessagingTarget } from "./normalize-DjrkFQys.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-71coXkof.js";
import { t as getDiscordRuntime } from "./runtime-DnKeGkMS.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-0z0K9KWE.js";
import { t as getDiscordApprovalCapability } from "./approval-native-BVc_l1a2.js";
import { t as discordMessageActions$1 } from "./channel-actions-CFPudVly.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-DRKL4Jw_.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-DqYQQuba.js";
import { n as discordOutbound } from "./outbound-adapter-B5c-_Wgd.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-D0Y7huyO.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-BhkjPdcA.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-0PDuFsh8.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-_6PAZY1b.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-DkJtUm1f.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-CyfAsXVn.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime-Ckw8tjmM.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-BPR-bw53.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-CzFwX2O4.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-B-Gf7dvQ.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-DWefgQB-.js");
