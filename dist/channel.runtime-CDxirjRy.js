...
import { d as resolveThreadSessionKeys$1 } from "./session-key-BOC5unB4.js";
...
import { u as isReasoningReplyPayload } from "./reply-payload-Dibp0yeY.js";
import "./error-runtime-8fPZWhDX.js";
import { i as formatInboundFromLabel$1 } from "./envelope-WLCyTRUC.js";
...
import { f as ssrfPolicyFromPrivateNetworkOptIn, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-CRYhPVuv.js";
import "./ssrf-runtime-9LvoQ5Lf.js";
import { t as resolveChannelMediaMaxBytes } from "./media-limits-DFl8pwFc.js";
import { t as registerPluginHttpRoute } from "./http-registry-Bw0Zbsil.js";
import "./security-runtime-CbsrjaQi.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-4_pcqRqm.js";
import { t as buildModelsProviderData } from "./commands-models-LSQ52g3k.js";
import "./extension-shared-RN-LIaob.js";
...
async function registerMattermostMonitorSlashCommands(params) {
	...
	try {
		...
		const slashCallbackUrl = resolveCallbackUrl({
			config: slashConfig,
			gatewayPort: parseStrictPositiveInteger(process.env.ENCLAWED_GATEWAY_PORT?.trim()) ?? params.cfg.gateway?.port ?? 18789,
