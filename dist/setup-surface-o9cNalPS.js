...
import { a as createSetupInputPresenceValidator, i as createPatchedAccountSetupAdapter, n as applySetupAccountConfigPatch, s as migrateBaseNameToDefaultAccount } from "./setup-helpers-BXCkKBqj.js";
import { Q as splitSetupEntries, d as createPromptParsedAllowFromForAccount, f as createStandardChannelSetupStatus, t as addWildcardAllowFrom, v as mergeAllowFromEntries } from "./setup-wizard-helpers-DFTrn_L5.js";
...
function parseServiceAccount(value) {
	...
	if (typeof value === "string") {
		...
		return safeParseJsonWithSchema(JsonRecordSchema, trimmed) ?? null;
	}
	return safeParseWithSchema(JsonRecordSchema, value) ?? null;
}
