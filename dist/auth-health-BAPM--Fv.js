...
import { b as evaluateStoredCredentialEligibility, x as resolveTokenExpiryState } from "./store-DxE5HEh1.js";
import { t as resolveAuthProfileDisplayLabel } from "./auth-profiles-bSqTLkPQ.js";
import { i as resolveEffectiveOAuthCredential } from "./oauth-CaK2Slhi.js";
...
function buildProfileHealth(params) {
	...
	const { status: rawStatus, remainingMs } = resolveOAuthStatus(effectiveCredential.expires, now, warnAfterMs);
	return {
		profileId,
		provider,
		type: "oauth",
