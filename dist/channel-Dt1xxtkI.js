...
import { r as buildChannelConfigSchema } from "./config-schema-Er7gsmfD.js";
...
import { d as readNumberParam, h as readStringParam, i as createActionGate, n as ToolAuthorizationError } from "./common-DthjNV6P.js";
import { t as adaptScopedAccountAccessor, u as createScopedDmSecurityResolver } from "./channel-config-helpers-bOV5DWOp.js";
import { C as projectAccountConfigWarningCollector, g as createAllowlistProviderOpenWarningCollector } from "./channel-policy-CdRqk-3-.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-BnUutJQf.js";
...
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-DBv8LeUb.js";
import "./routing-CpgMqq54.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-B0J8p_YE.js";
import "./approval-delivery-runtime-LuZFtWKl.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-Dv0QkH7k.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-BxSBidBq.js";
import { n as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-is03TAKZ.js";
...
import { i as createPairingPrefixStripper } from "./channel-pairing-DA3C8ymT.js";
...
import { a as resolveMatrixAccountConfig } from "./account-config-B2Jz28an.js";
...
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-Dawvfr57.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-C6m5gAHv.js";
...
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-ColaCJBB.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-7l6wBn-6.js";
import { i as autoPrepareLegacyMatrixCrypto, o as autoMigrateLegacyMatrixState, r as resolveMatrixMigrationStatus } from "./matrix-migration.runtime-CbgfTLDf.js";
...
const matrixMessageActions = {
	...
	handleAction: async (ctx) => {
		const { handleMatrixAction } = await import("./tool-actions.runtime-G_xYuYDm.js");
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-BFlBLG1l.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixChannelRuntime$1 = createLazyRuntimeNamedExport(() => import("./resolver.runtime-vmvX3pmG.js"), "matrixResolverRuntime");
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-DE3xXBdL.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-Dcf8xGsG.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixDoctor = {
	...
	runConfigSequence: async ({ cfg, env, shouldRepair }) => await (await import("./doctor-BZfEmbVo.js")).runMatrixDoctorSequence({
		cfg,
		env,
		shouldRepair
	}),
	cleanStaleConfig: async ({ cfg }) => await (await import("./doctor-BZfEmbVo.js")).cleanStaleMatrixPluginConfig(cfg)
};
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-CRKRlp40.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
