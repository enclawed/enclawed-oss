...
import { n as normalizeAtHashSlug } from "./string-normalization-BWhNVcLY.js";
...
import { i as resolveToolsBySender } from "./group-policy--05mfb-H.js";
...
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-B6HiUXj_.js";
...
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-CgccMlcy.js";
import "./channel-api-TM-UgVSV.js";
import { n as looksLikeDiscordTargetId, o as parseDiscordTarget, r as normalizeDiscordMessagingTarget } from "./normalize-CL-TAjzv.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-L2SCS6QS.js";
import { t as getDiscordRuntime } from "./runtime-B7xMwi_Y.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-Bwy_zTMs.js";
import { t as getDiscordApprovalCapability } from "./approval-native-Dl5mO3MG.js";
import { t as discordMessageActions$1 } from "./channel-actions-8pyYV6_9.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-LZsZ2Fsz.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-AIlFmLzS.js";
import { n as discordOutbound } from "./outbound-adapter-BMwOe1BX.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-xwrJ4TR2.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-DrJ_oRPH.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-DQ9_EgWL.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-Cjsg58uU.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-Dccz8ItX.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-BgH7xM07.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime-OlZohHqp.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime--zzYQ3e9.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-CtNkIwLk.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-DBaSPPRs.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-Dw2PR6v7.js");
...
const discordPlugin = createChatChannelPlugin({
	base: {
		...
		agentPrompt: { messageToolHints: () => ["- Discord components: set `components` when sending messages to include buttons, selects, or v2 containers.", "- Forms: add `components.modal` (title, fields). Enclawed adds a trigger button and routes submissions as new messages."] },
		messaging: {
