...
import { D as isAnthropicModelRef, k as applyAnthropicEphemeralCacheControlMarkers, y as stripNullHeaderValues } from "./provider-stream-shared-emBXIITC.js";
import { o as patchCodexNativeWebSearchPayload, s as resolveCodexNativeSearchActivation } from "./codex-native-web-search-DzcGXGbw.js";
...
import { l as resolveProviderRequestPolicyConfig } from "./provider-request-config-CDH3_uwq.js";
import { t as log } from "./logger-BR1_JIwf.js";
import { l as isProxyReasoningUnsupportedModelHint } from "./provider-model-shared-Cw7Df4po.js";
	...
	return (model, context, options) => {
		...
		return underlying(model, context, {
			...
			headers: resolveProviderRequestPolicyConfig({
				...
				capability: "llm",
				transport: "stream",
				callerHeaders: stripNullHeaderValues(options?.headers),
