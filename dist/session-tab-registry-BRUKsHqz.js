...
import { n as getBridgeAuthForPort } from "./bridge-auth-registry-B2lCMxjD.js";
import { h as resolveBrowserRateLimitMessage } from "./cdp.helpers-o2dWzlsd.js";
import { n as resolveBrowserControlAuth } from "./control-auth-EjiHiuJO.js";
...
async function fetchBrowserJson(url, init) {
	...
	try {
		...
		const { dispatchBrowserControlRequest } = await import("./local-dispatch.runtime-CCoNaJLF.js");
