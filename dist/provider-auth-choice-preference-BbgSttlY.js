import { n as resolveManifestProviderAuthChoice } from "./provider-auth-choices-DpeIpo19.js";
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-C0GxJLiC.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-B0BvHBw5.js");
