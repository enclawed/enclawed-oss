...
import { a as loadConfig, l as readConfigFileSnapshot } from "./io-CXz21W7w.js";
...
import { r as replaceConfigFile, t as ConfigMutationConflictError } from "./config-D3uukyZR.js";
...
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-CIFb_WXb.js";
...
import { r as resolveProviderPluginChoice } from "./provider-wizard-CDzK2kAZ.js";
import { t as applyPrimaryModel } from "./provider-model-primary-D0mJPHgl.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DQSwUaZR.js";
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-DQ5qqC_T.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-CM9IpTNM.js";
import { n as applyAuthChoice } from "./auth-choice-C5dlgjaT.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-C9YNtGZl.js";
import { i as setupChannels } from "./onboard-channels-bF1eALU9.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-0ve3wnlk.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CjiQmx-K.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-BAnDL1Zr.js";
import { t as promptCustomApiConfig } from "./onboard-custom-C2aXt57i.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-CI4B6A4z.js";
import { n as formatHealthCheckFailure } from "./health-format-NDiK0Ura.js";
import { n as healthCommand } from "./health-C5BzPd1P.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-BQMTR7eI.js";
import { t as setupSkills } from "./onboard-skills-pAnE6O8a.js";
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-Br-qQNfq.js");
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-XLTmFH9P.js");
	...
	try {
		...
		if (opts.sections) {
			...
			if (selected.includes("plugins")) {
				const { configurePluginConfig } = await import("./setup.plugin-config-DKgCwRK8.js");
