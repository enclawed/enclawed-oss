...
import { M as formatMemoryDreamingDay } from "./dreaming-D6fRJtHx.js";
...
function isContaminatedDreamingSnippet(raw) {
	...
	if (/<!--\s*enclawed-memory-promotion:/i.test(snippet) || DREAMING_TRANSCRIPT_PROMPT_LINE_RE.test(snippet)) return true;
