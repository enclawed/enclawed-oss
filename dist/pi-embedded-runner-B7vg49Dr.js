...
import { g as resolveUserPath } from "./utils-BcQ7uNrT.js";
import { t as sanitizeForLog } from "./ansi-haTfqSzd.js";
import { t as createSubsystemLogger } from "./subsystem-WGqvYWrS.js";
import { t as isTruthyEnvValue } from "./env-DMXNDA06.js";
import { _ as resolveStateDir } from "./paths-Z7drr_SN.js";
import { n as resolveOwnerDisplaySetting } from "./owner-display-BavYQbOP.js";
import { q as normalizeGoogleApiBaseUrl } from "./io-Dzvn-wpi.js";
import { r as normalizeProviderId } from "./provider-id-CxDLTf9A.js";
import { a as isSubagentSessionKey, i as isCronSessionKey, n as isAcpSessionKey } from "./session-key-utils-qXY7QK1H.js";
import { c as normalizeAgentId } from "./session-key-D8SZau-8.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER, t as DEFAULT_CONTEXT_TOKENS } from "./defaults-Dzck2uJH.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-BhAkATy2.js";
import { p as isWorkspaceBootstrapPending, r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-dcdTJd2I.js";
import { g as listAgentEntries, m as resolveSessionAgentIds, r as resolveAgentExecutionContract, t as hasConfiguredModelFallbacks, x as resolveAgentWorkspaceDir } from "./agent-scope-5o1jve-2.js";
import { i as isMarkdownCapableMessageChannel, u as normalizeMessageChannel } from "./message-channel-BZ78qqgM.js";
import { n as ensureAuthProfileStore } from "./store-J7Io5AUg.js";
import { r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-BXYqyRTr.js";
import { i as resolveContextEngine, u as listRegisteredAgentHarnesses } from "./registry-nxcy40tP.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-mFbFyRwr.js";
import { F as resolveProviderSystemPromptContribution, I as resolveProviderTextTransforms, K as transformProviderSystemPrompt, x as prepareProviderRuntimeAuth } from "./provider-runtime-DB4wLsLH.js";
...
import "./facade-loader-C3J-_dvo.js";
import { t as ensureContextEnginesInitialized } from "./init-BhFxz2v-.js";
import { t as ensureRuntimePluginsLoaded } from "./runtime-plugins-BYrWLiaN.js";
import { a as resolveToolCallArgumentsEncoding } from "./provider-model-compat-BTKr4bsR.js";
import { i as resolveSessionLockMaxHoldFromTimeout, t as acquireSessionWriteLock } from "./session-write-lock-CtXlB9QZ.js";
import { n as sleepWithAbort } from "./backoff-D8FAZIeO.js";
import { a as normalizeUsage, i as makeZeroUsageSnapshot, r as hasNonzeroUsage, t as derivePromptTokens } from "./usage-CwW0G6C9.js";
import { n as extractAssistantTextForPhase, o as parseAssistantTextSignature, s as resolveAssistantMessagePhase } from "./chat-message-content-CcFUU_mI.js";
import { t as parseInlineDirectives } from "./directive-tags-B8g3zt37.js";
import { $ as releaseWsSession, B as guardSessionManager, C as validateReplayTurns, D as buildEmbeddedExtensionFactories, E as limitHistoryTurns, F as applyFinalEffectiveToolPolicy, G as truncateOversizedToolResultsInSessionManager, H as resolveLiveToolResultMaxChars, J as repairSessionFileIfNeeded, K as installContextEngineLoopHook, L as resolveCompactionTimeoutMs, O as SAFETY_MARGIN, Q as createBundleLspToolRuntime, R as isCacheTtlEligibleProvider, S as sanitizeSessionHistory, T as getDmHistoryLimitFromSessionKey, U as sessionLikelyHasOversizedToolResults, V as estimateToolResultReductionPotential, W as truncateOversizedToolResultsInSession, X as assessLastAssistantMessage, Y as createPreparedEmbeddedPiSettingsManager, Z as dropThinkingBlocks, _ as resolveEmbeddedAgentBaseStreamFn, b as prewarmSessionFile, c as flushPendingToolResultsAfterIdle, d as collectAllowedToolNames, dt as resolveSessionCompactionCheckpointReason, et as buildStreamErrorAssistantMessage, f as applySystemPromptOverrideToSession, g as resolveEmbeddedAgentApiKey, h as describeEmbeddedAgentStreamStrategy, k as estimateMessagesTokens, l as mapThinkingLevel, m as createSystemPromptOverride, n as asCompactionHookRunner, nt as resolveChannelCapabilities, ot as captureCompactionCheckpointSnapshot, p as buildEmbeddedSystemPrompt, q as installToolResultContextGuard, rt as filterHeartbeatPairs, s as runPostCompactionSideEffects, st as cleanupCompactionCheckpointSnapshot, t as readPiModelContextTokens, u as splitSdkTools, ut as persistSessionCompactionCheckpoint, v as resolveEmbeddedAgentStreamFn, w as buildEmbeddedMessageActionDiscoveryInput, x as trackSessionManagerAccess, y as resolveEmbeddedRunSkillEntries, z as readLastCacheTtlTimestamp } from "./model-context-tokens-aFQvKZ1m.js";
import { i as enqueueCommandInLane } from "./command-queue-DQC1ydD8.js";
import { a as formatContextWindowWarningMessage, i as formatContextWindowBlockMessage, n as CONTEXT_WINDOW_WARN_BELOW_TOKENS, o as resolveContextWindowInfo, r as evaluateContextWindowGuard, t as CONTEXT_WINDOW_HARD_MIN_TOKENS } from "./context-window-guard-CWD4TqPC.js";
import { a as extractToolResultText, c as isToolResultTimedOut, d as isMessagingToolSendAction, f as normalizeEmbeddedAgentRuntime, i as extractToolResultMediaArtifact, l as sanitizeToolResult, m as resolveEmbeddedAgentRuntime, n as extractMessagingToolSend, o as filterToolResultMediaUrls, p as resolveEmbeddedAgentHarnessFallback, r as extractToolErrorMessage, s as isToolResultError, t as buildEmbeddedAttemptToolRunContext, u as isMessagingTool } from "./attempt.tool-run-context-SXAp9gZ1.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, o as startsWithSilentToken, r as isSilentReplyPayloadText, s as stripLeadingSilentToken } from "./tokens-pnu38gX0.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-lantmEA9.js";
import { t as getMachineDisplayName } from "./machine-name-F6tJyR7x.js";
import { f as MAX_IMAGE_BYTES } from "./mime-Bs8vyLeZ.js";
import { l as normalizeToolName } from "./tool-policy-D994AhXf.js";
import { a as listChannelSupportedActions, c as resolveChannelReactionGuidance, o as resolveChannelMessageToolCapabilities, s as resolveChannelMessageToolHints, u as getPluginToolMeta } from "./channel-tools-DJBTw8u5.js";
import { n as buildTtsSystemPromptHint } from "./tts-runtime-DWqtv1Yz.js";
import "./tts-DA5Tz0Sd.js";
import { t as isReasoningTagProvider } from "./provider-utils--Wo4gBHl.js";
import { t as parseBooleanValue } from "./boolean-A42uycBE.js";
import { n as estimateBase64DecodedBytes } from "./base64-DC5dVoRM.js";
import { a as prependBootstrapPromptWarning, i as buildBootstrapTruncationReportMeta, n as buildBootstrapInjectionStats, r as buildBootstrapPromptWarning, t as analyzeBootstrapBudget } from "./bootstrap-budget-BpYVYL-p.js";
import { a as resolveContextInjectionMode, i as resolveBootstrapContextForRun, n as hasCompletedBootstrapTurn, r as makeBootstrapWarn, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-D0nEsD2-.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-h7kutsRA.js";
import { a as resolveBootstrapPromptTruncationWarningMode, i as resolveBootstrapMaxChars, o as resolveBootstrapTotalMaxChars } from "./google-BrzdI_S_.js";
import { n as formatRawAssistantErrorForUi } from "./assistant-error-format-BGQs2PwF.js";
import { d as stableStringify$1, l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE, v as parseExecApprovalResultText } from "./sanitize-user-facing-text-B5AP2eg1.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-4BY4qquV.js";
import { c as isTimeoutErrorMessage } from "./failover-matches-GPB2UP4c.js";
import { _ as parseImageDimensionError, a as formatAssistantErrorText, c as isCloudCodeAssistFormatError, d as isFailoverAssistantError, f as isFailoverErrorMessage, i as extractObservedOverflowTokenCount, l as isCompactionFailureError, m as isRateLimitAssistantError, o as isAuthAssistantError, p as isLikelyContextOverflowError, s as isBillingAssistantError, t as classifyFailoverReason, v as parseImageSizeError } from "./errors-mPsA10gc.js";
import { a as isMessagingToolDuplicateNormalized, c as extractToolCallsFromAssistant, d as downgradeOpenAIFunctionCallReasoningPairs, n as validateGeminiTurns, o as normalizeTextForComparison, r as pickFallbackThinkingLevel, t as validateAnthropicTurns, u as sanitizeToolCallIdsForCloudCodeAssist } from "./pi-embedded-helpers-g589tXhs.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-BfMc3nWK.js";
import { t as resolveEnclawedDocsPath } from "./docs-path-THs-mnFI.js";
import { a as isTimeoutError, n as coerceToFailoverError, r as describeFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-B4l-iODK.js";
import { t as buildModelAliasLines } from "./model-alias-lines-C_VJ2Gh_.js";
import "./auth-profiles-CWIWzE4_.js";
import { r as markAuthProfileGood } from "./profiles-FX5Xo3iA.js";
import { t as redactIdentifier } from "./redact-identifier-opkVaevO.js";
import { t as sanitizeForConsole } from "./console-sanitize-CJ-7TFT6.js";
import { f as resolveProfilesUnavailableReason, l as markAuthProfileFailure, n as resolveAuthProfileOrder, s as isProfileInCooldown, t as resolveAuthProfileEligibility, u as markAuthProfileUsed } from "./order-B81rwr6N.js";
import { c as resolveModelAuthMode, n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride, u as shouldPreferExplicitConfigApiKeyAuth } from "./model-auth-CEwjo3Cm.js";
import { a as shouldUseOpenAIWebSocketTransport, c as supportsModelTools, i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, o as logProviderToolSchemaDiagnostics, r as resolveAttemptSpawnWorkspaceDir, s as normalizeProviderToolSchemas, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-B8zkwd__.js";
import { f as sanitizeTransportPayloadText, m as buildGuardedModelFetch, u as mergeTransportHeaders } from "./openai-transport-stream-BAYkDZaP.js";
import { r as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-C4bGrLwd.js";
import { o as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-CP0ypOLf.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-fpsgXwVt.js";
import { f as sanitizeRuntimeProviderRequestOverrides, s as resolveProviderRequestConfig } from "./provider-request-config-DpuK1s8u.js";
import { t as log$3 } from "./logger-UWzJtLV8.js";
import { t as registerProviderStreamForModel } from "./provider-stream-BnLz9_gq.js";
import { t as parseGeminiAuth } from "./gemini-auth-BbYajsCG.js";
import { i as getOrCreateSessionMcpRuntime, n as materializeBundleMcpToolsForRun, r as disposeSessionMcpRuntime } from "./pi-bundle-mcp-tools-B8kFOn8E.js";
import { n as setReplyPayloadMetadata } from "./reply-payload-DLP99vUx.js";
import { r as parseFenceSpans } from "./fences-Di4P629F.js";
import { r as splitMediaFromOutput } from "./parse-DYhBZI0m.js";
import { u as parseReplyDirectives } from "./deliver-CNl357yl.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-ULobvdLo.js";
import { a as resolveAttemptFsWorkspaceOnly, c as resolvePromptModeForSession, d as runContextEngineMaintenance, f as formatToolAggregate, i as prependSystemPromptAddition, l as shouldInjectHeartbeatPrompt, n as buildAfterTurnRuntimeContextFromUsage, o as resolveAttemptPrependSystemContext, r as mergeOrphanedTrailingUserPrompt, s as resolvePromptBuildHookResult, t as buildAfterTurnRuntimeContext, u as shouldWarnOnOrphanedUserRepair } from "./attempt.prompt-helpers-CpBc4FVv.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent, s as emitAgentPlanEvent } from "./agent-events-m_o42nBy.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-C8QsklKv.js";
import { a as shouldAllowCooldownProbeForReason, i as LiveSessionModelSwitchError, o as buildApiErrorObservationFields, s as buildTextObservationFields } from "./model-fallback-C9WX3Pud.js";
import { h as isStrictAgenticSupportedProviderModel, m as isStrictAgenticExecutionContractActive } from "./enclawed-tools-BOX1dGI0.js";
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-zn7FdQP3.js";
import { a as stripDowngradedToolCallText } from "./assistant-visible-text-BKlRMt-f.js";
...
import { a as MIN_PROMPT_BUDGET_TOKENS, i as MIN_PROMPT_BUDGET_RATIO, n as applyPiAutoCompactionGuard } from "./pi-settings-x7_TWium.js";
import { i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./pi-tool-definition-adapter-CjI9dM19.js";
import { n as resolveToolLoopDetectionConfig, t as createEnclawedCodingTools } from "./pi-tools-CfRDfe6E.js";
import { n as ensureGlobalUndiciEnvProxyDispatcher, r as ensureGlobalUndiciStreamTimeouts } from "./undici-global-dispatcher-CEjuidQ3.js";
import { i as generateSecureToken } from "./secure-random-BPngSinf.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-DniDWYPx.js";
import { l as setActiveEmbeddedRun, n as clearActiveEmbeddedRun, u as updateActiveEmbeddedRunSnapshot } from "./runs-DYuSrnq1.js";
import { t as resolveAgentTimeoutMs } from "./timeout-CZTBoioj.js";
import { s as resolveSkillsPromptForRun } from "./workspace-BrWC5DeP.js";
import { t as detectRuntimeShell } from "./shell-utils-Cn5GYmJh.js";
...
import { o as resolveSandboxContext } from "./sandbox-f-aJNLxY.js";
import { a as sanitizeToolUseResultPairing, t as isRedactedSessionsSpawnAttachment } from "./session-transcript-repair-DRtM1jJg.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-PntP1DWt.js";
import { t as buildSystemPromptParams } from "./system-prompt-params-zwUJQzJu.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-DZT8o5fo.js";
import "./tool-loop-detection-CuZIcG8m.js";
import { i as shouldAllowProviderOwnedThinkingReplay, n as resolveEmbeddedCompactionTarget, r as resolveTranscriptPolicy, t as buildEmbeddedCompactionRuntimeContext } from "./compaction-runtime-context-BQb8cE6I.js";
import { a as isGooglePromptCacheEligible, n as resolveAgentTransportOverride, o as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-Cw1yZTVu.js";
import { n as buildAgentUserPromptPrefix } from "./system-prompt-CFBu1-WE.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-BtHKtFOp.js";
import { t as resolveBootstrapMode } from "./bootstrap-mode-DqV0On8C.js";
import { t as detectAndLoadPromptImages } from "./images-CYJy1nqo.js";
import { n as resolveModelAsync } from "./model-CuUEmEan.js";
import { a as resolveStoredSessionKeyForSessionId, i as resolveSessionKeyForRequest, n as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-Dg37eaoZ.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-DFqWvoUN.js";
...
function resolveCacheTraceConfig(params) {
	...
	const enabled = parseBooleanValue(env.ENCLAWED_CACHE_TRACE) ?? config?.enabled ?? false;
	...
	const includeMessages = parseBooleanValue(env.ENCLAWED_CACHE_TRACE_MESSAGES) ?? config?.includeMessages;
...
function resolveRawStreamPath() {
	return process.env.ENCLAWED_RAW_STREAM_PATH?.trim() || path.join(resolveStateDir(), "logs", "raw-stream.jsonl");
}
...
function isTranscriptOnlyEnclawedAssistantMessage(message) {
...
function handleMessageStart(ctx, evt) {
	...
	if (msg?.role !== "assistant" || isTranscriptOnlyEnclawedAssistantMessage(msg)) return;
...
async function reconcileSessionStoreCompactionCountAfterSuccess(params) {
	const { reconcileSessionStoreCompactionCountAfterSuccess: reconcile } = await import("./pi-embedded-subscribe.handlers.compaction.runtime-CbTNmYfU.js");
...
function loadExecApprovalReply() {
	execApprovalReplyModulePromise ??= import("./exec-approval-reply-2dUnmj9C.js");
	return execApprovalReplyModulePromise;
}
function loadHookRunnerGlobal() {
	hookRunnerGlobalModulePromise ??= import("./hook-runner-global-BdXusIF8.js");
	return hookRunnerGlobalModulePromise;
}
function loadMediaParse() {
	mediaParseModulePromise ??= import("./parse-DCjuShdj.js");
	return mediaParseModulePromise;
}
function loadBeforeToolCall() {
	beforeToolCallModulePromise ??= import("./pi-tools.before-tool-call-BdmNZx0F.js");
...
const SESSIONS_YIELD_ABORT_SETTLE_TIMEOUT_MS = process.env.ENCLAWED_TEST_FAST === "1" ? 250 : 2e3;
...
function resolveAgentHarnessPolicy(params) {
	...
	return {
		runtime: env.ENCLAWED_AGENT_RUNTIME?.trim() ? resolveEmbeddedAgentRuntime(env) : normalizeEmbeddedAgentRuntime(agentPolicy?.runtime ?? defaultsPolicy?.runtime),
