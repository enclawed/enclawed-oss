...
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-CGXI-iwe.js";
...
import { t as resolveConfiguredTtsMode } from "./tts-config-BjpH7yNw.js";
import { r as prefixSystemMessage } from "./system-message-D2Q3YloJ.js";
import { i as toAcpRuntimeError } from "./errors-CNt98fXd.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-DNmJYOr-.js";
import { r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-7iVsWZaN.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-YpPshIfQ.js";
import { a as resolveAcpDispatchPolicyError, i as resolveAcpAgentPolicyError } from "./policy-Br1bwECH.js";
import { a as resolveAcpThreadSessionDetailLines } from "./session-identifiers-CcgaGhHx.js";
import { r as createBlockReplyPipeline } from "./block-reply-pipeline-CW0nO2Th.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-iG2PT6XX.js";
...
function loadDispatchAcpMediaRuntime() {
	dispatchAcpMediaRuntimePromise ??= import("./dispatch-acp-media.runtime-DiJ-m_uI.js");
...
function loadDispatchAcpTtsRuntime$1() {
	dispatchAcpTtsRuntimePromise$1 ??= import("./dispatch-acp-tts.runtime-DBLO5Tp4.js");
	return dispatchAcpTtsRuntimePromise$1;
}
function loadChannelPluginRuntime() {
	channelPluginRuntimePromise ??= import("./plugins-B-qX5vSJ.js");
	return channelPluginRuntimePromise;
}
function loadMessageActionRuntime() {
	messageActionRuntimePromise ??= import("./message-action-runner-DB9yYdnk.js");
...
function loadDispatchAcpManagerRuntime() {
	dispatchAcpManagerRuntimePromise ??= import("./dispatch-acp-manager.runtime-DHip4-eI.js");
	return dispatchAcpManagerRuntimePromise;
}
function loadDispatchAcpSessionRuntime() {
	dispatchAcpSessionRuntimePromise ??= import("./dispatch-acp-session.runtime-Bu6yTzTp.js");
	return dispatchAcpSessionRuntimePromise;
}
function loadDispatchAcpTtsRuntime() {
	dispatchAcpTtsRuntimePromise ??= import("./dispatch-acp-tts.runtime-DBLO5Tp4.js");
