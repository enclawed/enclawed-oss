...
import { n as retryAsync, t as resolveRetryConfig } from "./retry-hubNFPI9.js";
import "./text-runtime-CAI4yT_W.js";
import { t as createReplyToFanout } from "./outbound-runtime-CRBGdkio.js";
...
import { a as chunkDiscordTextWithMode, i as normalizeDiscordOutboundTarget } from "./normalize-DjrkFQys.js";
...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-De7tuNM0.js").then((module) => module.sendDiscordComponentMessage);
	return await (await discordComponentSendPromise)(...args);
}
function loadDiscordSharedInteractive() {
	discordSharedInteractivePromise ??= import("./shared-interactive-VUDdogCN.js");
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-DJamik8K.js");
