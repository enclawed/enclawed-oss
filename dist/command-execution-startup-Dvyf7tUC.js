...
import { n as isGatewayConfigBypassCommandPath } from "./explicit-connection-policy-cFvoRQyh.js";
import { n as resolvePluginRegistryScopeForCommandPath, t as ensureCliPluginRegistryLoaded } from "./plugin-registry-loader-Bn6xXCqJ.js";
//#region src/cli/command-bootstrap.ts
let configGuardModulePromise;
function loadConfigGuardModule() {
	configGuardModulePromise ??= import("./config-guard-DeKuelRg.js");
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-BZDdR3LL.js");
	if (params.argv) {
