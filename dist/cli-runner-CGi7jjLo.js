...
import { f as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-mPsA10gc.js";
import "./pi-embedded-helpers-g589tXhs.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-B4l-iODK.js";
//#region src/agents/cli-runner.ts
async function runCliAgent(params) {
	const { prepareCliRunContext } = await import("./prepare.runtime-BEqmL8hH.js");
	return runPreparedCliAgent(await prepareCliRunContext(params));
}
async function runPreparedCliAgent(context) {
	const { executePreparedCliRun } = await import("./execute.runtime-DvVrHd74.js");
