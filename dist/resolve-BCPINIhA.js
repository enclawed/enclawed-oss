...
import { a as normalizeStringifiedOptionalString, c as getPlatformAdapter, d as registerPlatformAdapterFactory, l as hasPlatformAdapter, o as readStringField, r as normalizeOptionalLowercaseString, t as asOptionalObjectRecord, u as registerPlatformAdapter } from "./string-normalize-DWA3ypgp.js";
...
function createBuiltinAdapter() {
	return {
		...
		async downloadFile(url, destDir, filename) {
			const { fetchRemoteMedia } = await import("./plugin-sdk/media-runtime.js");
		...
		async resolveApproval(approvalId, decision) {
			try {
				const { getRuntimeConfig } = await import("./plugin-sdk/runtime-config-snapshot.js");
				const { resolveApprovalOverGateway } = await import("./plugin-sdk/approval-gateway-runtime.js");
