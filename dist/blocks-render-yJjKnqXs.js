...
import { l as presentationToInteractiveReply } from "./payload-CN10T53l.js";
import "./text-runtime-BSsrP5ac.js";
import { t as reduceInteractiveReply } from "./interactive-yPRRoy_B.js";
import { n as truncateSlackText } from "./limits-DF-WZ7gY.js";
//#region extensions/slack/src/reply-action-ids.ts
const SLACK_REPLY_BUTTON_ACTION_ID = "enclawed:reply_button";
const SLACK_REPLY_SELECT_ACTION_ID = "enclawed:reply_select";
//#endregion
...
function readSlackEnclawedBlockIndex(blockId, prefix) {
...
function resolveSlackInteractiveBlockOffsets(blocks) {
	...
	for (const block of blocks ?? []) {
		...
		if (!blockId) continue;
		buttonIndexOffset = Math.max(buttonIndexOffset, readSlackEnclawedBlockIndex(blockId, "enclawed_reply_buttons_") ?? 0);
		selectIndexOffset = Math.max(selectIndexOffset, readSlackEnclawedBlockIndex(blockId, "enclawed_reply_select_") ?? 0);
	}
	return {
		buttonIndexOffset,
		selectIndexOffset
