...
import { d as waitProviderOperationPollInterval, n as createProviderOperationDeadline, u as resolveProviderOperationTimeoutMs } from "./shared-6piY2B-y.js";
...
import { a as GOOGLE_VIDEO_ALLOWED_DURATION_SECONDS, l as createGoogleVideoGenerationProviderMetadata, o as GOOGLE_VIDEO_MAX_DURATION_SECONDS, s as GOOGLE_VIDEO_MIN_DURATION_SECONDS } from "./generation-provider-metadata-478pGrL8.js";
import { o as resolveGoogleGenerativeAiApiOrigin } from "./provider-policy-CrtnO9TN.js";
import { t as parseGeminiAuth } from "./gemini-auth-fhjfy5GY.js";
import "./api-CQKuUaW_.js";
import { t as createGoogleGenAI } from "./google-genai-runtime-CGm8Eqo7.js";
...
async function downloadGeneratedVideo(params) {
	const tempDir = await mkdtemp(path.join(resolvePreferredEnclawedTmpDir(), "enclawed-google-video-"));
