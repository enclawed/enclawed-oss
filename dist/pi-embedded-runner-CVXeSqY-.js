...
import { t as isTruthyEnvValue } from "./env-DkSj_7zL.js";
import { _ as resolveStateDir } from "./paths-CDjhyzOH.js";
import { n as resolveOwnerDisplaySetting } from "./owner-display-BywHw0QM.js";
import { q as normalizeGoogleApiBaseUrl } from "./io-gK4mTn0s.js";
import { r as normalizeProviderId } from "./provider-id-JqYiEozY.js";
import { a as isSubagentSessionKey, i as isCronSessionKey, n as isAcpSessionKey } from "./session-key-utils-Ce7cepnN.js";
...
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-CSlLJnzJ.js";
import { p as isWorkspaceBootstrapPending, r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-k9VV8iuP.js";
import { g as listAgentEntries, m as resolveSessionAgentIds, r as resolveAgentExecutionContract, t as hasConfiguredModelFallbacks, x as resolveAgentWorkspaceDir } from "./agent-scope-n27Qvudk.js";
import { i as isMarkdownCapableMessageChannel, u as normalizeMessageChannel } from "./message-channel-eZXacO7t.js";
...
import { i as resolveContextEngine, u as listRegisteredAgentHarnesses } from "./registry-aeOT3dMj.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-D5tYPLdd.js";
import { F as resolveProviderSystemPromptContribution, I as resolveProviderTextTransforms, K as transformProviderSystemPrompt, x as prepareProviderRuntimeAuth } from "./provider-runtime-CChIRNbc.js";
...
import "./facade-loader-DS0Agzvt.js";
import { t as ensureContextEnginesInitialized } from "./init-Bnm7PgjO.js";
import { t as ensureRuntimePluginsLoaded } from "./runtime-plugins-Di6r5RK2.js";
import { a as resolveToolCallArgumentsEncoding } from "./provider-model-compat-CALTrfp5.js";
...
import { a as normalizeUsage, i as makeZeroUsageSnapshot, r as hasNonzeroUsage, t as derivePromptTokens } from "./usage-BAoTEYmL.js";
import { n as extractAssistantTextForPhase, o as parseAssistantTextSignature, s as resolveAssistantMessagePhase } from "./chat-message-content-C5zS33r4.js";
import { t as parseInlineDirectives } from "./directive-tags-CuUhPrjG.js";
...
import { i as enqueueCommandInLane } from "./command-queue-CCZ99txj.js";
import { a as formatContextWindowWarningMessage, i as formatContextWindowBlockMessage, n as CONTEXT_WINDOW_WARN_BELOW_TOKENS, o as resolveContextWindowInfo, r as evaluateContextWindowGuard, t as CONTEXT_WINDOW_HARD_MIN_TOKENS } from "./context-window-guard-r1MxOqwW.js";
import { a as extractToolResultText, c as isToolResultTimedOut, d as isMessagingToolSendAction, f as normalizeEmbeddedAgentRuntime, i as extractToolResultMediaArtifact, l as sanitizeToolResult, m as resolveEmbeddedAgentRuntime, n as extractMessagingToolSend, o as filterToolResultMediaUrls, p as resolveEmbeddedAgentHarnessFallback, r as extractToolErrorMessage, s as isToolResultError, t as buildEmbeddedAttemptToolRunContext, u as isMessagingTool } from "./attempt.tool-run-context-BdlCnv8U.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, o as startsWithSilentToken, r as isSilentReplyPayloadText, s as stripLeadingSilentToken } from "./tokens-DEyoRqN5.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-CNoAzxT9.js";
import { t as getMachineDisplayName } from "./machine-name-DQk9-5U8.js";
import { f as MAX_IMAGE_BYTES } from "./mime-CwPaZfyo.js";
import { l as normalizeToolName } from "./tool-policy-Bkov0fJO.js";
import { a as listChannelSupportedActions, c as resolveChannelReactionGuidance, o as resolveChannelMessageToolCapabilities, s as resolveChannelMessageToolHints, u as getPluginToolMeta } from "./channel-tools-CUMxi4EB.js";
import { n as buildTtsSystemPromptHint } from "./tts-runtime-Co7RCIN3.js";
import "./tts-CV2S6AJZ.js";
import { t as isReasoningTagProvider } from "./provider-utils-CR8GEiww.js";
import { t as parseBooleanValue } from "./boolean-i-pNV0Da.js";
import { n as estimateBase64DecodedBytes } from "./base64-Ck-PZtY7.js";
import { a as prependBootstrapPromptWarning, i as buildBootstrapTruncationReportMeta, n as buildBootstrapInjectionStats, r as buildBootstrapPromptWarning, t as analyzeBootstrapBudget } from "./bootstrap-budget-Dcs_bNw0.js";
import { a as resolveContextInjectionMode, i as resolveBootstrapContextForRun, n as hasCompletedBootstrapTurn, r as makeBootstrapWarn, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-Dj2tWTtj.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-C7u3T4xG.js";
import { a as resolveBootstrapPromptTruncationWarningMode, i as resolveBootstrapMaxChars, o as resolveBootstrapTotalMaxChars } from "./google-DD7XqDyr.js";
import { n as formatRawAssistantErrorForUi } from "./assistant-error-format-CC5yyFEh.js";
import { d as stableStringify$1, l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE, v as parseExecApprovalResultText } from "./sanitize-user-facing-text-DC3SMoyx.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-TXQsrF2r.js";
import { c as isTimeoutErrorMessage } from "./failover-matches-DSKxz_I-.js";
import { _ as parseImageDimensionError, a as formatAssistantErrorText, c as isCloudCodeAssistFormatError, d as isFailoverAssistantError, f as isFailoverErrorMessage, i as extractObservedOverflowTokenCount, l as isCompactionFailureError, m as isRateLimitAssistantError, o as isAuthAssistantError, p as isLikelyContextOverflowError, s as isBillingAssistantError, t as classifyFailoverReason, v as parseImageSizeError } from "./errors-tXlWPaMC.js";
...
import { i as resolveImageSanitizationLimits } from "./tool-images-in97HBKp.js";
import { t as resolveEnclawedDocsPath } from "./docs-path-akUb02QY.js";
import { a as isTimeoutError, n as coerceToFailoverError, r as describeFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-Cy4poLEJ.js";
import { t as buildModelAliasLines } from "./model-alias-lines-CY53u-r0.js";
import "./auth-profiles-bSqTLkPQ.js";
import { r as markAuthProfileGood } from "./profiles-BHvv2Pe4.js";
import { t as redactIdentifier } from "./redact-identifier-9TQb6GYG.js";
import { t as sanitizeForConsole } from "./console-sanitize-XONLHCwM.js";
import { f as resolveProfilesUnavailableReason, l as markAuthProfileFailure, n as resolveAuthProfileOrder, s as isProfileInCooldown, t as resolveAuthProfileEligibility, u as markAuthProfileUsed } from "./order-CI8OVemT.js";
import { c as resolveModelAuthMode, n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride, u as shouldPreferExplicitConfigApiKeyAuth } from "./model-auth-BXCDAk3Y.js";
import { a as shouldUseOpenAIWebSocketTransport, c as supportsModelTools, i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, o as logProviderToolSchemaDiagnostics, r as resolveAttemptSpawnWorkspaceDir, s as normalizeProviderToolSchemas, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-BOH5Px3v.js";
import { f as sanitizeTransportPayloadText, m as buildGuardedModelFetch, u as mergeTransportHeaders } from "./openai-transport-stream-CxpYV6p1.js";
import { r as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-BEDMtsHT.js";
import { o as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-emBXIITC.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-ChD2IjV1.js";
import { f as sanitizeRuntimeProviderRequestOverrides, s as resolveProviderRequestConfig } from "./provider-request-config-CDH3_uwq.js";
import { t as log$3 } from "./logger-BR1_JIwf.js";
import { t as registerProviderStreamForModel } from "./provider-stream-DTDglTib.js";
import { t as parseGeminiAuth } from "./gemini-auth-BlLIRce6.js";
import { i as getOrCreateSessionMcpRuntime, n as materializeBundleMcpToolsForRun, r as disposeSessionMcpRuntime } from "./pi-bundle-mcp-tools-Dx_gxBVI.js";
import { n as setReplyPayloadMetadata } from "./reply-payload-BoHBuWWM.js";
import { r as parseFenceSpans } from "./fences-CDRUybLx.js";
import { r as splitMediaFromOutput } from "./parse-pWNXot2C.js";
import { u as parseReplyDirectives } from "./deliver-DqeU4N-T.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-Dibp0yeY.js";
...
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent, s as emitAgentPlanEvent } from "./agent-events-BfuQdc-z.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-CQDlqDha.js";
import { a as shouldAllowCooldownProbeForReason, i as LiveSessionModelSwitchError, o as buildApiErrorObservationFields, s as buildTextObservationFields } from "./model-fallback-Du-0Oeji.js";
import { h as isStrictAgenticSupportedProviderModel, m as isStrictAgenticExecutionContractActive } from "./enclawed-tools-CjwQbk40.js";
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-BpZUcgZ_.js";
import { a as stripDowngradedToolCallText } from "./assistant-visible-text-DorKrU1h.js";
...
import { a as MIN_PROMPT_BUDGET_TOKENS, i as MIN_PROMPT_BUDGET_RATIO, n as applyPiAutoCompactionGuard } from "./pi-settings-wQsDlBDF.js";
import { i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./pi-tool-definition-adapter-BgYhk_FO.js";
import { n as resolveToolLoopDetectionConfig, t as createEnclawedCodingTools } from "./pi-tools-DQXk0kOv.js";
import { n as ensureGlobalUndiciEnvProxyDispatcher, r as ensureGlobalUndiciStreamTimeouts } from "./undici-global-dispatcher-j3TK6-oA.js";
import { i as generateSecureToken } from "./secure-random-CoURpmDF.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-C8D3Qf2R.js";
import { l as setActiveEmbeddedRun, n as clearActiveEmbeddedRun, u as updateActiveEmbeddedRunSnapshot } from "./runs-BnrT3CiH.js";
import { t as resolveAgentTimeoutMs } from "./timeout-D3KpBffA.js";
import { s as resolveSkillsPromptForRun } from "./workspace-z29yLNhU.js";
import { t as detectRuntimeShell } from "./shell-utils-nNPgdWW8.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-CfTYJi9T.js";
import "./skills-B916F3M2.js";
import { o as resolveSandboxContext } from "./sandbox-BRj4dwYO.js";
import { a as sanitizeToolUseResultPairing, t as isRedactedSessionsSpawnAttachment } from "./session-transcript-repair-B1hknRjj.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-CZ9M4cO5.js";
import { t as buildSystemPromptParams } from "./system-prompt-params-DInphR3l.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-B7Ma7EC7.js";
import "./tool-loop-detection-C_KxyKjx.js";
import { i as shouldAllowProviderOwnedThinkingReplay, n as resolveEmbeddedCompactionTarget, r as resolveTranscriptPolicy, t as buildEmbeddedCompactionRuntimeContext } from "./compaction-runtime-context-Dz3gewka.js";
import { a as isGooglePromptCacheEligible, n as resolveAgentTransportOverride, o as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-CmdjxAoD.js";
import { n as buildAgentUserPromptPrefix } from "./system-prompt-CNk7rfky.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-tu6H5qT_.js";
import { t as resolveBootstrapMode } from "./bootstrap-mode-RdQhc_xt.js";
import { t as detectAndLoadPromptImages } from "./images-C-Rfr1Qd.js";
import { n as resolveModelAsync } from "./model-CvpDBVgK.js";
import { a as resolveStoredSessionKeyForSessionId, i as resolveSessionKeyForRequest, n as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-BKw0FTvt.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-B1m1srKI.js";
...
async function reconcileSessionStoreCompactionCountAfterSuccess(params) {
	const { reconcileSessionStoreCompactionCountAfterSuccess: reconcile } = await import("./pi-embedded-subscribe.handlers.compaction.runtime-D6vsToo6.js");
...
function loadExecApprovalReply() {
	execApprovalReplyModulePromise ??= import("./exec-approval-reply-Brnh6Z_9.js");
	return execApprovalReplyModulePromise;
}
function loadHookRunnerGlobal() {
	hookRunnerGlobalModulePromise ??= import("./hook-runner-global-BeSPJnbU.js");
	return hookRunnerGlobalModulePromise;
}
function loadMediaParse() {
	mediaParseModulePromise ??= import("./parse-Dqz2sObL.js");
	return mediaParseModulePromise;
}
function loadBeforeToolCall() {
	beforeToolCallModulePromise ??= import("./pi-tools.before-tool-call-C7eire7A.js");
