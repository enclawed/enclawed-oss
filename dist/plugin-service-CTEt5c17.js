...
import { c as jsonResult, h as readStringParam, s as imageResultFromFile } from "./common-DthjNV6P.js";
import { t as callGatewayTool } from "./gateway-DxzpW_Fw.js";
import { a as selectDefaultNodeFromList, i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-BQDNDJzx.js";
import { i as wrapExternalContent } from "./external-content-BG0h4WfB.js";
import "./text-runtime-BSsrP5ac.js";
import { t as startLazyPluginServiceModule } from "./lazy-service-module-CZUE1J5L.js";
import { n as respondUnavailableOnNodeInvokeError } from "./nodes.helpers-CXE247_P.js";
import { i as resolveNodeCommandAllowlist, n as isNodeCommandAllowed } from "./node-command-policy-CZnYCqwa.js";
import { t as BrowserToolSchema } from "./browser-tool.schema-CG7Ds0dR.js";
import { t as withTimeout } from "./sdk-node-runtime-BxXA39zP.js";
import "./sdk-security-runtime-DsBIPRO8.js";
import { D as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./cdp.helpers-D-cV1SL9.js";
import "./control-auth-sGa336au.js";
import { c as resolveExistingPathsWithinRoot, i as resolveProfile, n as resolveBrowserConfig, s as DEFAULT_UPLOAD_DIR } from "./config-BGK7hjIz.js";
import "./sdk-setup-tools-D4vSxGXm.js";
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-C0gAkm1O.js";
import { c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as isPersistentBrowserProfileMutation, l as browserAct, n as persistBrowserProxyFiles, o as resolveRequestedBrowserProfile, p as browserScreenshotAction, s as browserConsoleMessages, t as applyBrowserProxyPaths, u as browserArmDialog } from "./browser-runtime-DdY5poHl.js";
import { r as getBrowserProfileCapabilities } from "./target-id-LTiSI4FQ.js";
import { r as createBrowserRouteDispatcher, t as startBrowserControlServiceFromConfig } from "./control-service-BJYjC5_D.js";
import { n as createBrowserControlContext } from "./plugin-enabled-C9KhSO_2.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-CwHrAKv2.js"),
