...
const ENCLAWED_DEBUG_PROXY_ENABLED = "ENCLAWED_DEBUG_PROXY_ENABLED";
const ENCLAWED_DEBUG_PROXY_URL = "ENCLAWED_DEBUG_PROXY_URL";
const ENCLAWED_DEBUG_PROXY_DB_PATH = "ENCLAWED_DEBUG_PROXY_DB_PATH";
const ENCLAWED_DEBUG_PROXY_BLOB_DIR = "ENCLAWED_DEBUG_PROXY_BLOB_DIR";
const ENCLAWED_DEBUG_PROXY_CERT_DIR = "ENCLAWED_DEBUG_PROXY_CERT_DIR";
const ENCLAWED_DEBUG_PROXY_SESSION_ID = "ENCLAWED_DEBUG_PROXY_SESSION_ID";
const ENCLAWED_DEBUG_PROXY_REQUIRE = "ENCLAWED_DEBUG_PROXY_REQUIRE";
...
function resolveDebugProxySettings(env = process$1.env) {
	...
	const sessionId = (env["ENCLAWED_DEBUG_PROXY_SESSION_ID"]?.trim() || void 0) ?? (cachedImplicitSessionId ??= randomUUID());
	return {
		enabled,
		required: isTruthy(env[ENCLAWED_DEBUG_PROXY_REQUIRE]),
		proxyUrl: env["ENCLAWED_DEBUG_PROXY_URL"]?.trim() || void 0,
