...
import { n as CHAT_CHANNEL_ORDER } from "./ids-DIOx3XOb.js";
...
import { t as getLoadedChannelPluginById } from "./registry-loaded-nwjstTdo.js";
import { i as normalizeChannelId, r as listChannelPlugins, t as getChannelPlugin } from "./registry-DAV2wQ3B.js";
...
import { b as resolveAgentDir, g as listAgentEntries, l as resolveAgentSkillsFilter, p as resolveSessionAgentId, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-n27Qvudk.js";
import "./config-zbBVmEjy.js";
import { d as resolveGatewayMessageChannel, r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-eZXacO7t.js";
import "./message-channel-core-BmmOta3N.js";
import { i as isInterSessionInputProvenance } from "./input-provenance-DwdRnS02.js";
import { d as resetRegisteredAgentHarnessSessions } from "./registry-aeOT3dMj.js";
...
import { m as resolveModelRefFromString } from "./model-selection-CRPDotcW.js";
import { S as resolveGroupSessionKey, f as resolveMaintenanceConfigFromInput, h as resolveSessionStoreEntry, o as updateSessionStore, v as deriveSessionMetaPatch } from "./store-CnDX3BCC.js";
...
import { c as resolveSessionResetPolicy, i as resolveThreadFlag, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-B4fA0aij.js";
import { n as resolveSessionKey } from "./session-key-CyNU4ghU.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-BwL2bjyO.js";
import { t as loadSessionStore } from "./store-load-BbG7SOzr.js";
import { a as resolveAndPersistSessionFile } from "./transcript-1JzP1v-A.js";
import { t as parseSessionThreadInfo } from "./thread-info-BqPEFEYg.js";
import "./delivery-context-BfPF5_QR.js";
import { o as getQueueSize, r as clearCommandLane } from "./command-queue-CCZ99txj.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-DEyoRqN5.js";
...
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-CxbOxRFP.js";
...
import { r as disposeSessionMcpRuntime } from "./pi-bundle-mcp-tools-Dx_gxBVI.js";
import { t as collectTextContentBlocks } from "./content-blocks-CTobxsLi.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-BSOw8eN4.js";
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, p as fireAndForgetHook, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-BH-POpUk.js";
...
import { t as resolveQueueSettings } from "./queue-CzE8g6JB.js";
...
import { r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-zPTWDIGf.js";
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-tu6H5qT_.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-CgwxYhVz.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-2TUINDDf.js";
...
import { t as resolveRunTypingPolicy } from "./typing-policy-C-7leU88.js";
...
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-BHXc0Fjl.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-DpBvFXjq.js";
import { t as resolveChannelModelOverride } from "./model-overrides-3wk76zZh.js";
import { t as normalizeGroupActivation } from "./group-activation-CbofnQzN.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-EHfKU6fs.js";
import { t as resolveFastModeState } from "./fast-mode-Da7kARRD.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-CXVMCt8o.js";
import { t as resolveCommandAuthorization } from "./command-auth-GMnNsUuz.js";
import { t as buildCommandContext } from "./commands-context-P2b2qyta.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-MqqWWpGx.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-CAuXl9nQ.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-BqGvZhoo.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-Cpb5Znkb.js";
import { t as resolveStoredModelOverride } from "./stored-model-override-BQVfa9bJ.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-B89DQKhB.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-BEDUqE0s.js";
...
import { n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-B9CBKLI1.js";
...
import { t as drainFormattedSystemEvents } from "./session-system-events-BSarjK5G.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-o9PE7hRn.js";
import { n as buildSessionStartHookPayload, t as buildSessionEndHookPayload } from "./session-hooks-D_ZHnEyx.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-Cbw9zlzL.js");
...
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-IjfGYBr_.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-BuM9G05r.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-8a-YIZeJ.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-DNqlZKwP.js");
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-DpgVoci6.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-B4O5gWom.js");
...
async function handleInlineActions(params) {
	...
	const skillCommands = shouldLoadSkillCommands && params.skillCommands ? params.skillCommands : shouldLoadSkillCommands ? (await import("./skill-commands.runtime-B4O5gWom.js")).listSkillCommandsForWorkspace({
		workspaceDir,
		cfg,
		agentId,
		skillFilter
	...
	if (skillInvocation) {
		...
		if (dispatch?.kind === "tool") {
			...
			const { createEnclawedTools } = await import("./enclawed-tools.runtime--PXZM99G.js");
	...
	if (!isStopLikeInbound && targetSessionEntry) {
		...
		if (cutoff) await (await import("./abort-cutoff.runtime-bB4zMrZq.js")).clearAbortCutoffInSessionRuntime({
			sessionEntry: targetSessionEntry,
			sessionStore,
			sessionKey,
			storePath
	...
	if (handleInlineStatus) {
		const { buildStatusReply } = await import("./commands.runtime-HGOYtZh3.js");
	...
	const runCommands = async (commandInput) => {
		const { handleCommands } = await import("./commands.runtime-HGOYtZh3.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-CiyxhPbT.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-aOp30aFY.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-h6Thdv4c.js");
	return agentRunnerRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-CDU0wpTu.js");
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-BNbBYWJx.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-LvwcMucB.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-Zi09FYqn.js");
...
function loadHookRunnerGlobal() {
	hookRunnerGlobalPromise ??= import("./hook-runner-global-BeSPJnbU.js");
...
async function applyMediaUnderstandingIfNeeded(params) {
	...
	const { applyMediaUnderstanding } = await import("./apply.runtime-2nlhHPrh.js");
	await applyMediaUnderstanding(params);
	return true;
}
async function applyLinkUnderstandingIfNeeded(params) {
	if (!hasLinkCandidate(params.ctx)) return false;
	const { applyLinkUnderstanding } = await import("./apply.runtime-lufh4uYC.js");
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	const maybeEmitMissingResetHooks = async () => {
		...
		const { emitResetCommandHooks } = await import("./commands-core.runtime-B3kU303G.js");
