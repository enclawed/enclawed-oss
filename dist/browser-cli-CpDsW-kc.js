...
import { t as addGatewayClientOptions } from "./gateway-rpc-CiMkSrD5.js";
import { t as formatHelpExamples } from "./help-format-Cc7aGPm0.js";
import { i as registerCommandGroups } from "./register-command-groups-D0ccfeO7.js";
import { t as shouldEagerRegisterSubcommands } from "./command-registration-policy-BsIUk0l1.js";
...
const browserCommandGroupDefinitions = [
	{
		...
		register: async (args) => {
			(await import("./browser-cli-manage-BtCphvc8.js")).registerBrowserManageCommands(args.browser, args.parentOpts);
		}
	},
	{
		...
		register: async (args) => {
			(await import("./browser-cli-inspect-CUtbjKTE.js")).registerBrowserInspectCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-input-TmGrOpwL.js")).registerBrowserActionInputCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-observe-CdGCoQar.js")).registerBrowserActionObserveCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-debug-B9GPQ_18.js")).registerBrowserDebugCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-state--AExc26f.js")).registerBrowserStateCommands(args.browser, args.parentOpts);
		}
	}
];
