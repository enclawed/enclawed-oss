...
import { n as migrateElevenLabsLegacyTalkConfig } from "./config-compat-CiPO8olF.js";
...
const legacyConfigRules = [{
	path: ["talk"],
	message: "talk.voiceId/talk.voiceAliases/talk.modelId/talk.outputFormat/talk.apiKey are legacy; use talk.providers.<provider> and run enclawed doctor --fix.",
