...
import { n as listConfiguredWebSearchProviders } from "./runtime-bOZgZCgd.js";
...
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-CUDWs-9-.js";
import { i as formatControlUiSshHint, m as waitForGatewayReachable, u as probeGatewayReachable } from "./onboard-helpers-DQ5qqC_T.js";
...
import { t as runTui } from "./tui-AP6bj8OL.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DFAkYYBQ.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-Br-qQNfq.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-Br-qQNfq.js");
