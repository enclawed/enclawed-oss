...
import { C as withTelegramApiErrorLogging, k as isRecoverableTelegramNetworkError } from "./send-DJZn2aUp.js";
import { n as readTelegramUpdateOffset, r as writeTelegramUpdateOffset } from "./update-offset-store-CvecDRxu.js";
import { n as TELEGRAM_GET_UPDATES_REQUEST_TIMEOUT_MS, t as createTelegramBot } from "./bot-Crd6SuFP.js";
...
var TelegramPollingSession = class {
	...
	async #runPollingCycle(bot) {
		...
		try {
			...
			const conflictHint = isConflict ? " Another Enclawed gateway, script, or Telegram poller may be using this bot token; stop the duplicate poller or switch this account to webhook mode." : "";
