...
import { u as registerUnhandledRejectionHandler } from "./unhandled-rejections-C09iJ5eo.js";
import { a as getLogger, i as getChildLogger, o as getResolvedLoggerSettings } from "./logger-wuQoU2z2.js";
import { t as resolveEnclawedPackageRoot } from "./enclawed-root-CTcOq9RL.js";
import { i as isPlainObject } from "./workspace-dir-CwLpjIOc.js";
import { S as truncateUtf16Safe, b as sleep, g as resolveUserPath, s as ensureDir } from "./utils-BcQ7uNrT.js";
import { n as defaultRuntime } from "./runtime-DVd7lkz0.js";
import { t as sanitizeForLog } from "./ansi-haTfqSzd.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-WGqvYWrS.js";
import { n as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-DMXNDA06.js";
...
import { _ as resolveStateDir, i as isNixMode, r as STATE_DIR } from "./paths-Z7drr_SN.js";
import { n as VERSION, s as resolveRuntimeServiceVersion } from "./version-CqzZ9FH6.js";
import { o as isSecretRef } from "./types.secrets-C7GHgMrh.js";
import { a as logWarn, t as logDebug } from "./logger-B8mPHfvt.js";
import { i as runExec, r as runCommandWithTimeout } from "./exec-LGLh3vyF.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-fQzMWAOJ.js";
import { t as safeEqualSecret } from "./secret-equal-BFOmFk2p.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-fKbnCPqE.js";
import { _ as resolveRequestClientIp, a as isLoopbackHost, g as resolveHostName, h as resolveGatewayListenHosts, i as isLoopbackAddress, l as isTrustedProxyAddress, m as resolveGatewayBindHost, n as isContainerEnvironment, o as isPrivateOrLoopbackAddress, p as resolveClientIp, r as isLocalishHost, s as isPrivateOrLoopbackHost, t as defaultGatewayBindMode, u as isValidIPv4 } from "./net-DkWIq6k8.js";
import { a as createAuthRateLimiter, i as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, n as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, o as normalizeRateLimitClientIp, r as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH } from "./auth-rate-limit-De26OCMe.js";
import { a as resolveEffectiveSharedGatewayAuth, i as isLocalDirectRequest, n as authorizeHttpGatewayConnect, o as resolveGatewayAuth, r as authorizeWsControlUiGatewayConnect, s as checkBrowserOrigin, t as assertGatewayAuthConfigured } from "./auth-BO-EkmdB.js";
import { t as sameFileIdentity } from "./file-identity-BKWJrd2H.js";
import { r as openBoundaryFile } from "./boundary-file-read-g48ivAAk.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-D1NW64Um.js";
import { D as applyConfigOverrides, S as validateConfigObjectWithPlugins, a as loadConfig, g as writeConfigFile, h as resolveConfigSnapshotHash, i as getRuntimeConfig, l as readConfigFileSnapshot, m as registerConfigWriteListener, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshotForWrite } from "./io-Dzvn-wpi.js";
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-CMKPGWB_.js";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-T6Kfp_L4.js";
import { r as normalizeProviderId } from "./provider-id-CxDLTf9A.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey, o as parseAgentSessionKey, r as isCronRunSessionKey } from "./session-key-utils-qXY7QK1H.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-6Mvnxe99.js";
import { c as normalizeAgentId, h as toAgentStoreSessionKey, l as normalizeMainKey, m as toAgentRequestSessionKey, o as classifySessionKeyShape, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-D8SZau-8.js";
import { i as normalizeChannelId, n as getLoadedChannelPlugin, r as listChannelPlugins, t as getChannelPlugin } from "./registry-BZZmrGdc.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-Dzck2uJH.js";
import { n as resolveSubagentMaxConcurrent, t as resolveAgentMaxConcurrent } from "./agent-limits-B79N4tsY.js";
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-B8CWnI5T.js";
import { t as applyMergePatch } from "./merge-patch-BGy6BHu_.js";
import { n as resolveAgentModelPrimaryValue } from "./model-input-fnfl6j7e.js";
import { a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_SOUL_FILENAME, d as ensureAgentWorkspace, i as DEFAULT_HEARTBEAT_FILENAME, l as DEFAULT_TOOLS_FILENAME, m as isWorkspaceSetupCompleted, o as DEFAULT_MEMORY_ALT_FILENAME, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_MEMORY_FILENAME, t as DEFAULT_AGENTS_FILENAME, u as DEFAULT_USER_FILENAME } from "./workspace-dcdTJd2I.js";
import { S as resolveDefaultAgentId, _ as listAgentIds, b as resolveAgentDir, g as listAgentEntries, p as resolveSessionAgentId, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-5o1jve-2.js";
import { t as matchesSkillFilter } from "./filter-CCBUPTet.js";
import { a as normalizePluginsConfig } from "./config-state-DbwRF0HU.js";
import { r as parseByteSize } from "./zod-schema-DMQIXdwE.js";
import { t as parseDurationMs } from "./parse-duration-HsxmkmJ-.js";
import { n as isRestartEnabled } from "./commands.flags-B_GAO4QP.js";
import "./config-DOKACpaG.js";
import { n as normalizeDeviceAuthScopes } from "./device-auth-DlVQ7NKi.js";
import { a as getPreauthHandshakeTimeoutMsFromEnv, c as buildDeviceAuthPayloadV3, i as resolveDeviceAuthConnectErrorDetailCode, n as ConnectErrorDetailCodes, r as resolveAuthConnectErrorDetailCode, s as buildDeviceAuthPayload } from "./client-ATvMQY9h.js";
import { i as publicKeyRawBase64UrlFromPem, n as loadOrCreateDeviceIdentity, o as verifyDeviceSignature, r as normalizeDevicePublicKeyBase64Url, t as deriveDeviceIdFromPublicKey } from "./device-identity-CEc1YLN9.js";
import { t as rawDataToString } from "./ws-DGbhWWgu.js";
import { _ as hasGatewayClientCap, a as isOperatorUiClient, c as isGatewayMessageChannel, h as GATEWAY_CLIENT_MODES, m as GATEWAY_CLIENT_IDS, n as isGatewayCliClient, o as isWebchatClient, p as GATEWAY_CLIENT_CAPS, s as isDeliverableMessageChannel, t as isBrowserOperatorUiClient, u as normalizeMessageChannel } from "./message-channel-BZ78qqgM.js";
import "./message-channel-core-DiqXDzpD.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-D8mTHWkH.js";
import { $ as validateNodeInvokeParams, $t as validateWizardNextParams, A as validateCronRunParams, At as validateSessionsMessagesUnsubscribeParams, Bt as validateSkillsSearchParams, C as validateConfigSchemaLookupResult, Ct as validateSessionsCompactionGetParams, D as validateCronAddParams, Dt as validateSessionsDeleteParams, E as validateConnectParams, Et as validateSessionsCreateParams, F as validateDevicePairListParams, Ft as validateSessionsSendParams, G as validateExecApprovalsNodeGetParams, Gt as validateTalkSpeakParams, H as validateExecApprovalRequestParams, Ht as validateSkillsUpdateParams, I as validateDevicePairRejectParams, It as validateSessionsUsageParams, J as validateLogsTailParams, Jt as validateUpdateRunParams, K as validateExecApprovalsNodeSetParams, Kt as validateToolsCatalogParams, L as validateDevicePairRemoveParams, Lt as validateSkillsBinsParams, M as validateCronStatusParams, Mt as validateSessionsPreviewParams, N as validateCronUpdateParams, Nt as validateSessionsResetParams, O as validateCronListParams, Ot as validateSessionsListParams, P as validateDevicePairApproveParams, Pt as validateSessionsResolveParams, Q as validateNodeEventParams, Qt as validateWizardCancelParams, R as validateDeviceTokenRevokeParams, Rt as validateSkillsDetailParams, S as validateConfigSchemaLookupParams, St as validateSessionsCompactionBranchParams, T as validateConfigSetParams, Tt as validateSessionsCompactionRestoreParams, U as validateExecApprovalResolveParams, Ut as validateTalkConfigParams, V as validateExecApprovalGetParams, Vt as validateSkillsStatusParams, W as validateExecApprovalsGetParams, Wt as validateTalkModeParams, X as validateModelsListParams, Xt as validateWebLoginStartParams, Y as validateMessageActionParams, Yt as validateWakeParams, Z as validateNodeDescribeParams, Zt as validateWebLoginWaitParams, _t as validateSecretsResolveParams, a as validateAgentsCreateParams, an as parseSessionLabel, at as validateNodePairRequestParams, b as validateConfigGetParams, bt as validateSessionsAbortParams, c as validateAgentsFilesListParams, ct as validateNodePendingDrainParams, d as validateAgentsUpdateParams, dt as validatePluginApprovalRequestParams, en as validateWizardStartParams, et as validateNodeInvokeResultParams, f as validateChannelsLogoutParams, ft as validatePluginApprovalResolveParams, ht as validateRequestFrame, i as validateAgentWaitParams, in as COMMAND_DESCRIPTION_MAX_LENGTH, it as validateNodePairRejectParams, j as validateCronRunsParams, jt as validateSessionsPatchParams, k as validateCronRemoveParams, kt as validateSessionsMessagesSubscribeParams, l as validateAgentsFilesSetParams, lt as validateNodePendingEnqueueParams, mt as validatePushTestParams, n as validateAgentIdentityParams, nn as ErrorCodes, nt as validateNodePairApproveParams, o as validateAgentsDeleteParams, ot as validateNodePairVerifyParams, p as validateChannelsStatusParams, pt as validatePollParams, q as validateExecApprovalsSetParams, qt as validateToolsEffectiveParams, r as validateAgentParams, rn as errorShape, rt as validateNodePairListParams, s as validateAgentsFilesGetParams, st as validateNodePendingAckParams, t as formatValidationErrors, tn as validateWizardStatusParams, tt as validateNodeListParams, u as validateAgentsListParams, ut as validateNodeRenameParams, v as validateCommandsListParams, vt as validateSecretsResolveResult, w as validateConfigSchemaParams, wt as validateSessionsCompactionListParams, x as validateConfigPatchParams, xt as validateSessionsCompactParams, y as validateConfigApplyParams, yt as validateSendParams, z as validateDeviceTokenRotateParams, zt as validateSkillsInstallParams } from "./protocol-G22L7yBL.js";
import { a as normalizeInputProvenance } from "./input-provenance-BiaaGm3T.js";
import { a as approvalDecisionLabel, n as MAX_PLUGIN_APPROVAL_TIMEOUT_MS, o as buildPluginApprovalExpiredMessage, s as buildPluginApprovalRequestMessage, t as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-BN3__poV.js";
import { c as PAIRING_SCOPE, d as WRITE_SCOPE, i as isNodeRoleMethod, l as READ_SCOPE, n as authorizeOperatorScopesForMethod, o as ADMIN_SCOPE$1, s as APPROVALS_SCOPE$1, t as CLI_DEFAULT_OPERATOR_SCOPES, u as TALK_SECRETS_SCOPE } from "./method-scopes-BYgvEi9d.js";
import { n as formatConfigIssueLines } from "./issue-format-DdkTqXUL.js";
import { n as pickBestEffortPrimaryLanIPv4 } from "./network-discovery-display-CzEQnnaW.js";
import { i as resolveAssistantAvatarUrl, r as normalizeControlUiBasePath } from "./control-ui-shared-CRN-pz9n.js";
import { t as hasAnyAuthProfileStoreSource } from "./source-check-WHC0RF1m.js";
import { n as ensureAuthProfileStore } from "./store-J7Io5AUg.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-BE3SC6M5.js";
import { l as disposeRegisteredAgentHarnesses } from "./registry-nxcy40tP.js";
import { B as resolveMemoryLightDreamingConfig, F as resolveMemoryDeepDreamingConfig, I as resolveMemoryDreamingConfig, L as resolveMemoryDreamingPluginConfig, N as isSameMemoryDreamingDay, V as resolveMemoryRemDreamingConfig, z as resolveMemoryDreamingWorkspaces } from "./dreaming-CUK7e7lT.js";
import { r as loadEnclawedPlugins } from "./loader-oqr3fQSf.js";
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-BRuVcg7S.js";
import { s as getPluginCommandSpecs } from "./command-registration-DVi1CVoR.js";
import { o as runGlobalGatewayStopSafely, t as getGlobalHookRunner } from "./hook-runner-global-mFbFyRwr.js";
import { f as registerInternalHook, h as unregisterInternalHook, i as hasInternalHookListeners, m as triggerInternalHook, n as createInternalHookEvent, p as setInternalHooksEnabled } from "./internal-hooks-DSYfb2-U.js";
import { i as canonicalizePathVariant, n as PROTECTED_PLUGIN_ROUTE_PREFIXES, r as canonicalizePathForSecurity } from "./http-route-overlap-MS3DxJFz.js";
import { t as createEmptyPluginRegistry } from "./registry-empty-Br8mkWPG.js";
import { n as withPluginRuntimeGatewayRequestScope, t as getPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-BXA8cvv1.js";
import { f as releasePinnedPluginChannelRegistry, l as pinActivePluginChannelRegistry, p as releasePinnedPluginHttpRouteRegistry, r as getActivePluginRegistry, u as pinActivePluginHttpRouteRegistry, v as resolveActivePluginHttpRouteRegistry, y as setActivePluginRegistry } from "./runtime-CO-f4q2v.js";
import "./logging-DotYzX7j.js";
import { r as createPluginRuntimeLoaderLogger } from "./load-context-BaqRro7n.js";
import { t as resolveEnclawedAgentDir } from "./agent-paths-Pa0y6OT5.js";
import { t as ensureEnclawedModelsJson } from "./models-config-DKRsyF92.js";
import { a as getModelRefStatus, c as resolveConfiguredModelRef, l as resolveHooksGmailModel, m as parseModelRef, o as normalizeModelSelection, p as normalizeModelRef, s as resolveAllowedModelRef, t as isCliProvider } from "./model-selection-cli-DrzfE0gz.js";
import { a as normalizeElevatedLevel, c as normalizeThinkLevel, d as normalizeVerboseLevel, n as formatXHighModelHint, o as normalizeFastMode, s as normalizeReasoningLevel, u as normalizeUsageDisplay } from "./thinking.shared-BxNIEx-D.js";
import { a as getModelRefStatus$1, d as resolveConfiguredModelRef$1, f as resolveDefaultModelForAgent, l as resolveAllowedModelRef$1, p as resolveHooksGmailModel$1, t as buildAllowedModelSet, x as resolveThinkingDefault, y as resolveSubagentConfiguredModelSelection } from "./model-selection-3QcDboLc.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-USTwUAvA.js";
import { r as loadModelCatalog } from "./model-catalog-DQh8b8if.js";
import { n as resolveAgentIdentity } from "./identity-IAiNDSmy.js";
import { o as updateSessionStore, s as updateSessionStoreEntry, t as archiveRemovedSessionTranscripts } from "./store-eo7yB1I1.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-DWqaDaEZ.js";
import { n as resolveMainSessionKeyFromConfig, t as extractDeliveryInfo } from "./sessions-Dq3XJ_x5.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-CADYkZ1j.js";
import { l as setSessionRuntimeModel, n as mergeSessionEntry } from "./types-BBvDQ1eb.js";
import { n as cleanStaleLockFiles } from "./session-write-lock-CtXlB9QZ.js";
import { n as readJsonFile, r as writeJsonAtomic, t as createAsyncLock } from "./json-files-zRqqRJ8X.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-B7S7hCmE.js";
import { t as loadSessionStore } from "./store-load-C5fhLNaT.js";
import { n as onSessionTranscriptUpdate } from "./transcript-events-lxMn1Y_m.js";
import { t as parseSessionThreadInfo } from "./thread-info-C6jU7FZH.js";
import { i as resolveAgentSessionDirs } from "./targets-BtW2-P1D.js";
import { n as sleepWithAbort, t as computeBackoff } from "./backoff-D8FAZIeO.js";
import { n as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-BXSXNQtf.js";
import { o as startGatewayModelPricingRefresh } from "./usage-format-DW7In3eD.js";
...
import { n as deriveSessionTotalTokens, r as hasNonzeroUsage } from "./usage-CwW0G6C9.js";
import { a as readSessionPreviewItemsFromTranscript, i as readSessionMessages, t as attachEnclawedTranscriptMeta } from "./session-utils.fs-Bz4LmaEr.js";
import { r as stripInlineDirectiveTagsForDisplay } from "./directive-tags-B8g3zt37.js";
import { a as resolveSessionTranscriptCandidates, i as cleanupArchivedSessionTranscripts, t as archiveFileOnDisk } from "./session-transcript-files.fs-DDMQcD4D.js";
import { ct as getSessionCompactionCheckpoint, lt as listSessionCompactionCheckpoints } from "./model-context-tokens-aFQvKZ1m.js";
import { n as isDiagnosticsEnabled } from "./diagnostic-events-BlvVbYid.js";
import { t as CommandLane } from "./lanes-B3mvqfEh.js";
import { i as enqueueCommandInLane, s as getTotalQueueSize, u as setCommandLaneConcurrency } from "./command-queue-DQC1ydD8.js";
import { m as resolveEmbeddedAgentRuntime } from "./attempt.tool-run-context-SXAp9gZ1.js";
import { n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripLeadingSilentToken } from "./tokens-pnu38gX0.js";
import { s as stripHeartbeatToken } from "./heartbeat-BcjtLIIQ.js";
import { n as resolveNormalizedAccountEntry, t as resolveAccountEntry } from "./account-lookup-DHfCLcGa.js";
import { t as getMachineDisplayName } from "./machine-name-F6tJyR7x.js";
import { t as detectMime } from "./mime-Bs8vyLeZ.js";
import { d as PROFILE_OPTIONS, m as resolveCoreToolProfiles, p as listCoreToolSections } from "./tool-policy-D994AhXf.js";
import { d as resolvePluginTools, u as getPluginToolMeta } from "./channel-tools-DJBTw8u5.js";
import { C as synthesizeSpeech, S as setTtsProvider, b as setTtsEnabled, c as isTtsEnabled, f as resolveExplicitTtsOverrides, g as resolveTtsProviderOrder, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, p as resolveTtsAutoMode, w as textToSpeech } from "./tts-runtime-DWqtv1Yz.js";
import "./tts-DA5Tz0Sd.js";
import { n as compactEmbeddedPiSession, r as selectAgentHarness } from "./pi-embedded-runner-B7vg49Dr.js";
import { i as supportsXHighThinking, t as formatThinkingLevels } from "./thinking-DWHN3uH-.js";
import { o as resolveFailoverReasonFromError } from "./failover-error-B4l-iODK.js";
import "./auth-profiles-CWIWzE4_.js";
import { t as SsrFBlockedError } from "./ssrf-DjpVlwtu.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-CgHO6oDe.js";
import { n as createOutboundPayloadPlan, s as projectOutboundPayloadPlanForMirror, t as deliverOutboundPayloads } from "./deliver-CNl357yl.js";
import { c as getAgentRunContext, f as sweepStaleRunContexts, l as onAgentEvent, t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-m_o42nBy.js";
import { i as normalizeCronJobPatch, n as normalizeCronJobCreate, r as normalizeCronJobInput } from "./enclawed-tools-BOX1dGI0.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-yg1TShgQ.js";
import { g as writeFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-C3irXap3.js";
import { T as resolveExecApprovalRequestAllowedDecisions, _ as normalizeExecTarget, d as mergeExecApprovalsSocketDefaults, j as saveExecApprovals, o as ensureExecApprovals, p as normalizeExecApprovals, r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, w as resolveExecApprovalAllowedDecisions, y as readExecApprovalsSnapshot } from "./exec-approvals-CSCQWe00.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-Bbe-15LK.js";
import { i as parseAbsoluteTimeMs } from "./stagger-DPAlfj2L.js";
import { n as assertSafeCronSessionTargetId, r as isInvalidCronSessionTargetIdError, t as normalizeHttpWebhookUrl } from "./webhook-url-B-DlEGEO.js";
import { a as summarizeRestartSentinel, n as formatDoctorNonInteractiveHint, r as formatRestartSentinelMessage, s as writeRestartSentinel, t as consumeRestartSentinel } from "./restart-sentinel-kYCIe5kw.js";
import { c as setPreRestartDeferralCheck, n as deferGatewayRestartUntilIdle, o as scheduleGatewaySigusr1Restart, r as emitGatewayRestart, s as setGatewaySigusr1RestartPolicy } from "./restart-kOaImqWJ.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-19YzSsn6.js";
import { r as cleanOldMedia } from "./store-C1zvYuUA.js";
import { a as CANVAS_HOST_PATH, c as injectCanvasLiveReload, l as normalizeUrlPath, s as handleA2uiHttpRequest, u as resolveFileWithinRoot } from "./web-media-CyP1yxk5.js";
import { i as isKnownSecretTargetId } from "./target-registry-se_Ryd0R.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-secret-gateway-DhBMjDV3.js";
import { i as evaluateGatewayAuthSurfaceStates, r as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-web-tools-Cfb6-fuP.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-D9fHzFoO.js";
import { n as normalizePollInput } from "./polls-D5ZMaO90.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-B5NVxhPw.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-B6nCGxOo.js";
import { r as resetDirectoryCache } from "./target-resolver-DykdzpnS.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-CUyoVHRH.js";
import { l as failDelivery, o as ackDelivery, s as enqueueDelivery } from "./delivery-queue-CKk6bp9Y.js";
import { i as resolveReplyToMode } from "./reply-threading-DgnXLXTC.js";
import { t as buildOutboundSessionContext } from "./session-context-B6CfcyZI.js";
import { r as resolveOutboundTarget } from "./targets-CWuXRKwP.js";
import { t as extractToolPayload } from "./tool-payload-Cynf6crz.js";
import { i as setHeartbeatsEnabled, n as requestHeartbeatNow } from "./heartbeat-wake-C3o6lVAm.js";
import { i as enqueueSystemEvent, o as isSystemEventContextChanged } from "./system-events-BDxISYT2.js";
import { a as createRunningTaskRun, o as failTaskRunByRunId, r as completeTaskRunByRunId } from "./task-executor-DF7aWa4R.js";
import { m as cleanupBrowserSessionsForLifecycleEnd, o as initSubagentRegistry, p as scheduleSubagentOrphanRecovery } from "./subagent-registry-BAXhdRAB.js";
import { a as clearSessionQueues } from "./queue-K1Qq4xfA.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-DQe9wJ77.js";
import { a as isEmbeddedPiRunActive, f as waitForEmbeddedPiRunEnd, r as getActiveEmbeddedRunCount, t as abortEmbeddedPiRun } from "./runs-DYuSrnq1.js";
import { h as stopDiagnosticHeartbeat, m as startDiagnosticHeartbeat } from "./diagnostic-CMxDD9Ft.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DAldxFPt.js";
import { n as movePathToTrash } from "./browser-maintenance-DUVK41sg.js";
import { n as onSessionLifecycleEvent } from "./session-lifecycle-events-C8ICyLSb.js";
import { t as resolveAgentTimeoutMs } from "./timeout-CZTBoioj.js";
import { n as normalizeSpawnedRunMetadata, r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-BqCA2bpH.js";
import { c as resolveHookExternalContentSource, o as isExternalHookSession, s as mapHookExternalContentSource } from "./external-content-DVMYTLPU.js";
import { r as registerSkillsChangeListener, t as bumpSkillsSnapshotVersion } from "./refresh-state-CSG5kcZY.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-BrWC5DeP.js";
import { n as hasBinary } from "./config-eval-Bgc6u9oB.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-CzIeCJkJ.js";
import { c as roleScopesAllow, o as resolveMissingRequestedScope } from "./pairing-token-D8xpMZ4w.js";
import { a as refreshRemoteBinsForConnectedNodes, c as setSkillsRemoteRegistry, d as listNodePairing, f as rejectNodePairing, g as verifyNodeToken, h as updatePairedNodeMetadata, i as recordRemoteNodeInfo, l as approveNodePairing, m as requestNodePairing, n as primeRemoteSkillsCache, o as refreshRemoteNodeBins, p as renamePairedNode, s as removeRemoteNodeInfo, t as getRemoteSkillEligibility, u as getPairedNode } from "./skills-remote-BAfNk7T2.js";
import { t as canExecRequestNode } from "./exec-defaults-BKM0zsgV.js";
import "./skills-B8WQ6YkU.js";
import { n as resolveCronStyleNow } from "./current-time-PG-6Aoei.js";
import { n as getActiveMemorySearchManager, r as resolveActiveMemoryBackendConfig } from "./memory-runtime-q_NLbz7c.js";
import { t as resolveMemorySearchConfig } from "./memory-search-O4rqS4eA.js";
import { t as resolveModel } from "./model-CuUEmEan.js";
import { o as resolvePreferredSessionKeyForSessionIdMatches } from "./live-model-switch-Dg37eaoZ.js";
import "./pi-embedded-CWRkQ2Oz.js";
import { r as listPluginCommands } from "./commands-apUpszqv.js";
import { n as createPluginRuntime, r as setGatewaySubagentRuntime } from "./runtime-eqjo_yzY.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-2keVg1rG.js";
import "./commands-registry-kc2RkbyN.js";
import { o as getTotalPendingReplies } from "./dispatch-D2lB3lT5.js";
import { n as resolveSendPolicy, t as normalizeSendPolicy } from "./send-policy-DyvnrMuc.js";
import { n as sanitizeInboundSystemTags } from "./inbound-text-BbAL1S_Q.js";
import { t as getChannelActivity } from "./channel-activity-BGbOMrtA.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-DqfDTaRv.js";
import { n as getAcpSessionManager } from "./manager-PnokQ4wk.js";
import { t as primeConfiguredBindingRegistry } from "./binding-registry-DIar6pSU.js";
import { t as WizardCancelledError } from "./prompts-CfYXJ8rO.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-Dj5cphUo.js";
import { c as formatExecApprovalExpiresIn, f as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-reply-DXBP45LV.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "./approval-handler-adapter-runtime-BP4xZui2.js";
import { n as sanitizeExecApprovalDisplayText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-C3ipBx8k.js";
import { n as createChannelApprovalHandlerFromCapability } from "./approval-handler-runtime-CER6IxCO.js";
import { i as watchChannelRuntimeContexts, n as getChannelRuntimeContext, t as createTaskScopedChannelRuntime } from "./channel-runtime-context-DVijF7Px.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-C5tqT8P3.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-nw80NvNs.js";
import { t as normalizeGroupActivation } from "./group-activation-BSdDNYPx.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-DOcOJPYa.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-CyJtyQAU.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context--RWEDccN.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-COfdzFBC.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-DEu9My5k.js";
import { n as resolveAgentOutboundIdentity } from "./identity-CRPkIVc3.js";
import { i as parseVerboseOverride, n as applyVerboseOverride, r as parseTraceOverride, t as applyTraceOverride } from "./level-overrides-DZAfmP1D.js";
import { r as agentCommandFromIngress } from "./agent-command-D3bmt4I1.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-dVq8gEOF.js";
import { a as ensureGatewayStartupAuth, i as safeParseJson, n as respondUnavailableOnNodeInvokeError, o as mergeGatewayAuthConfig, r as respondUnavailableOnThrow, s as mergeGatewayTailscaleConfig, t as respondInvalidParams } from "./nodes.helpers-BM2xTE9o.js";
import { i as resolveNodeCommandAllowlist, n as isNodeCommandAllowed, r as normalizeDeclaredNodeCommands } from "./node-command-policy-cRTZg7hq.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs, t as formatForLog } from "./ws-log-CbpCZ_44.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-DvQK3A5B.js";
import { r as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-grlY3I25.js";
import { _ as verifyDeviceToken, a as getPairedDevice, c as listDevicePairing, d as removePairedDevice, f as requestDevicePairing, g as updatePairedDeviceMetadata, h as summarizeDeviceTokens, i as formatDevicePairingForbiddenMessage, l as listEffectivePairedDeviceRoles, m as rotateDeviceToken, n as approveDevicePairing, o as hasEffectivePairedDeviceRole, p as revokeDeviceToken, r as ensureDeviceToken, s as listApprovedPairedDeviceRoles, t as approveBootstrapDevicePairing, u as rejectDevicePairing } from "./device-pairing-BEZ8lwll.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-f7gc-apG.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-C3iK1WIK.js";
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-DloYl-yt.js";
import "./agent-2JWvODEK.js";
import { n as shouldIncludeHook } from "./config-BYmE45cb.js";
import "./session-identifiers-qSSSoR0s.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, i as buildSystemRunApprovalEnvBinding, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-LMrUq756.js";
import { n as resolveSystemRunApprovalRequestContext, r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-RxuRvvJE.js";
import { t as closeMcpLoopbackServer } from "./mcp-http-CNrdMNsP.js";
import { A as isSessionKeyAllowedByPrefix, B as resolveHookTargetAgentId, D as getHookChannelError, E as getHookAgentPolicyError, F as readJsonBody, H as applyHookMappings, I as resolveHookChannel, L as resolveHookDeliver, M as normalizeHookDispatchSessionKey, N as normalizeHookHeaders, O as getHookSessionKeyPrefixError, P as normalizeWakePayload, R as resolveHookIdempotencyKey, T as extractHookToken, U as resolveFunctionModuleExport, V as resolveHooksConfig, _ as sendGatewayAuthFailure, a as getHeader, h as loadGatewayModelCatalog, i as getBearerToken, j as normalizeAgentPayload, k as isHookAgentAllowed, l as resolveHttpBrowserOriginPolicy, m as __resetModelCatalogCacheForTest, p as resolveTrustedHttpOperatorScopes, r as authorizeGatewayHttpRequestOrReply, x as setDefaultSecurityHeaders, z as resolveHookSessionKey } from "./http-utils-B-NU8is7.js";
import { t as createOutboundSendDeps$1 } from "./outbound-send-deps-D3_3wqaj.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-CCNcKH4x.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DzqerXvt.js";
import { t as loadProviderUsageSummary } from "./provider-usage-Byr73rWo.js";
import "./refresh-EmGrNx0_.js";
import { o as fetchClawHubSkillDetail } from "./clawhub-DNe3XZ3z.js";
import { a as loadSessionUsageTimeSeries, n as loadCostUsageSummary, o as resolveExistingUsageSessionFile, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-CPxTQW1l.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-DkCz9DT0.js";
import { a as performGatewaySessionReset } from "./session-reset-service-Ccx3tzzL.js";
import { t as buildChannelUiCatalog } from "./catalog-PZoA7w5F.js";
import { t as ensureEnclawedCliOnPath } from "./path-env-eo6X4A_D.js";
import { a as removeBackfillDiaryEntries, c as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeGroundedShortTermCandidates, r as previewGroundedRemMarkdown, s as repairDreamingArtifacts } from "./memory-core-bundled-runtime-Dltc_Hx6.js";
import { a as resolveGatewayStartupPluginIds, r as resolveConfiguredDeferredChannelPluginIds } from "./channel-plugin-ids-DOXIaXPk.js";
import { a as redactConfigSnapshot, i as redactConfigObject, o as restoreRedactedValues, r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-D03KS_XC.js";
import { a as writeWideAreaGatewayZone, i as resolveWideAreaDiscoveryDomain } from "./widearea-dns-DK_cWIPL.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DiGXQLRG.js";
import { t as GatewayLockError } from "./gateway-lock-CpZgMYHD.js";
import { t as loadWorkspaceHookEntries } from "./workspace-DJOQBoe9.js";
import { t as readConfiguredLogTail } from "./log-tail-CIdR7ku5.js";
import { o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-CTgCEL37.js";
import { t as getHealthSnapshot } from "./health-DUkkyEAc.js";
import { t as installSkill } from "./skills-install-D7etQ3H4.js";
import { n as normalizeCronJobIdentityFields, r as runGatewayUpdate, t as runChannelPluginStartupMaintenance } from "./lifecycle-startup-DGBTUzBO.js";
import { m as normalizeUpdateChannel, n as compareSemverStrings, o as resolveNpmChannelTag, t as checkUpdateStatus } from "./update-check-BaOFfy0o.js";
import { i as migrateOrphanedSessionKeys } from "./state-migrations-q2ucIIkZ.js";
import { t as runSetupWizard } from "./setup-CRKt6yIf.js";
import "./status-Cvq_8XzQ.js";
import { t as getStatusSummary } from "./status.summary-DqQvh9Mb.js";
import { d as startTaskRegistryMaintenance, f as stopTaskRegistryMaintenance, g as markCronJobActive, h as clearCronJobActive, n as getInspectableTaskRegistrySummary } from "./task-registry.maintenance-muGtbKwY.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-Bw_To64F.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeLogArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-AosgPGft.js";
import { t as buildChannelAccountSnapshot } from "./status-JN0OgAxw.js";
import { _ as resolveDeliveryTarget, a as computeJobPreviousRunAtMs, c as findJobOrThrow, d as isJobEnabled, f as nextWakeAtMs, g as resolveJobPayloadTextForMain, h as recordScheduleComputeError, i as computeJobNextRunAtMs, l as hasScheduledNextRunAtMs, m as recomputeNextRunsForMaintenance, n as applyJobPatch, o as createJob, p as recomputeNextRuns, r as assertSupportedJobSpec, s as errorBackoffMs, t as DEFAULT_ERROR_BACKOFF_SCHEDULE_MS, u as isJobDue } from "./jobs-BwPMOAgT.js";
import { a as resolveHeartbeatAckMaxChars$1, i as resolveCronPayloadOutcome, t as isHeartbeatOnlyResponse } from "./helpers-lIvNpLKi.js";
import { n as markCronSessionPreRun, r as persistCronSkillsSnapshotIfChanged, t as createPersistCronSessionEntry } from "./run-session-state-C3WStrsR.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-CDzubBe8.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-DX7cjuuJ.js";
import { n as MediaOffloadError, r as parseMessageWithAttachments, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-B9Gr-pVl.js";
import { a as resolveCronSession, n as runHeartbeatOnce, r as startHeartbeatRunner } from "./heartbeat-runner-DNiBFgYQ.js";
import { _ as injectTimestamp, a as DEDUPE_TTL_MS, c as MAX_PAYLOAD_BYTES, d as isSuppressedControlReplyLeadFragment, f as isSuppressedControlReplyText, g as waitForTerminalGatewayDedupe, h as setGatewayDedupeEntry, i as DEDUPE_MAX, l as MAX_PREAUTH_PAYLOAD_BYTES, m as readTerminalSnapshotFromGatewayDedupe, n as chatHandlers, o as HEALTH_REFRESH_INTERVAL_MS, p as abortChatRunById, s as MAX_BUFFERED_BYTES, u as TICK_INTERVAL_MS, v as timestampOptsFromConfig } from "./chat-D0lr9SoL.js";
...
function loadExecApprovalForwarderRuntime() {
	execApprovalForwarderRuntimePromise ??= import("./exec-approval-forwarder.runtime-BSMhLK5Q.js");
...
function spawnGogServe(cfg) {
	...
	child.on("exit", (code, signal) => {
		...
		if (addressInUse) {
			log$6.warn("gog serve failed to bind (address already in use); stopping restarts. Another watcher is likely running. Set ENCLAWED_SKIP_GMAIL_WATCHER=1 or stop the other process.");
			watcherProcess = null;
			return;
		}
...
async function loadSkillsSnapshotRuntime() {
	skillsSnapshotRuntimePromise ??= import("./skills-snapshot.runtime-BOzSojmD.js");
...
async function loadCliRunnerRuntime() {
	return await import("./cli-runner.runtime-CYUHzqWQ.js");
}
async function loadUsageFormatRuntime() {
	return await import("./usage-format-B3pF5J3f.js");
}
...
async function loadSessionSubagentReactivationRuntime() {
	return import("./session-subagent-reactivation.runtime-DBGpV12w.js");
}
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-B5XGgz58.js");
...
const sessionsHandlers = {
	...
	"sessions.reset": async ({ params, respond, context }) => {
		...
		const { performGatewaySessionReset } = await import("./sessions.runtime-6SXRtZAW.js");
		const result = await performGatewaySessionReset({
			key,
			reason,
	...
	"sessions.delete": async ({ params, respond, client, isWebchatConnect, context }) => {
		...
		const { archiveSessionTranscriptsForSessionDetailed, cleanupSessionBeforeMutation, emitGatewaySessionEndPluginHook, emitSessionUnboundLifecycleEvent } = await import("./sessions.runtime-6SXRtZAW.js");
...
const updateHandlers = { "update.run": async ({ params, respond, client, context }) => {
	...
	try {
		...
		result = await runGatewayUpdate({
			timeoutMs,
			cwd: await resolveEnclawedPackageRoot({
				moduleUrl: import.meta.url,
				argv1: process.argv[1],
				cwd: process.cwd()
			}) ?? process.cwd(),
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-DYeeL2Zy.js");
...
const FALLBACK_GATEWAY_CONTEXT_STATE_KEY = Symbol.for("enclawed.fallbackGatewayContextState");
...
const PLUGIN_SUBAGENT_POLICY_STATE_KEY = Symbol.for("enclawed.pluginSubagentOverridePolicyState");
...
function authorizeFallbackModelOverride(params) {
	...
	if (!policy?.allowModelOverride) return {
		allowed: false,
		reason: `plugin "${pluginId}" is not trusted for fallback provider/model override requests. See https://docs.enclawed.ai/tools/plugin#runtime-helpers and search for: plugins.entries.<id>.subagent.allowModelOverride`
	};
...
function recoverPendingOutboundDeliveries(params) {
	(async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-DuInBbwH.js");
		const { deliverOutboundPayloads } = await import("./deliver-BmSoqm9l.js");
...
function isCanvasPath(pathname) {
	return pathname === "/__enclawed__/a2ui" || pathname.startsWith(`/__enclawed__/a2ui/`) || pathname === "/__enclawed__/canvas" || pathname.startsWith(`/__enclawed__/canvas/`) || pathname === "/__enclawed__/ws";
}
...
function resolvePluginRouteRuntimeOperatorScopes(req, requestAuth, surface = "write-default") {
	...
	if (getHeader(req, "x-enclawed-scopes") === void 0) return [WRITE_SCOPE];
	return resolveTrustedHttpOperatorScopes(req, requestAuth);
}
//#endregion
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-DRTyBuEp.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-DNPxPM4z.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-CDWMoXy5.js");
	return embeddingsHttpModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-B-Cgtxs6.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-DPKihOTO.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-fCN-L8lx.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-CVZhQaTR.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-D97IP8IF.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-H5c84GV-.js");
...
function isA2uiPath(pathname) {
	return pathname === "/__enclawed__/a2ui" || pathname.startsWith(`/__enclawed__/a2ui/`);
}
...
function createHooksRequestHandler(opts) {
	...
	return async (req, res) => {
		...
		if (url.searchParams.has("token")) {
			res.statusCode = 400;
			res.setHeader("Content-Type", "text/plain; charset=utf-8");
			res.end("Hook token must be provided via Authorization: Bearer <token> or X-Enclawed-Token header (query parameters are not allowed).");
			return true;
		}
		if (req.method !== "POST") {
			res.statusCode = 405;
...
function attachGatewayUpgradeHandler(opts) {
	...
	httpServer.on("upgrade", (req, socket, head) => {
		(async () => {
			...
			const resolvedAuth = getResolvedAuth();
			if (canvasHost) {
				if (new URL(req.url ?? "/", "http://localhost").pathname === "/__enclawed__/ws") {
					const ok = await authorizeCanvasRequest({
						req,
						auth: resolvedAuth,
						trustedProxies,
...
Too many unauthenticated sockets`);
			...
			try {
				wss.handleUpgrade(req, socket, head, (ws) => {
					ws.__enclawedPreauthBudgetKey = preauthBudgetKey;
					wss.emit("connection", ws, req);
					if (Boolean(ws.__enclawedPreauthBudgetClaimed)) {
						budgetTransferred = true;
	...
	const applyHotReload = async (plan, nextConfig) => {
		...
		if (plan.restartGmailWatcher) {
			...
			await startGmailWatcherWithLogs({
				cfg: nextConfig,
				log: params.logHooks,
				onSkipped: () => params.logHooks.info("skipping gmail watcher restart (ENCLAWED_SKIP_GMAIL_WATCHER=1)")
			});
		}
		if (plan.restartChannels.size > 0) if (isTruthyEnvValue(process.env.ENCLAWED_SKIP_CHANNELS) || isTruthyEnvValue(process.env.ENCLAWED_SKIP_PROVIDERS)) params.logChannels.info("skipping channel reload (ENCLAWED_SKIP_CHANNELS=1 or ENCLAWED_SKIP_PROVIDERS=1)");
		else {
...
async function resolveGatewayRuntimeConfig(params) {
	...
	const canvasHostEnabled = process.env.ENCLAWED_SKIP_CANVAS_HOST !== "1" && params.cfg.canvasHost?.enabled !== false;
	...
	if (tailscaleMode === "funnel" && authMode !== "password") throw new Error("tailscale funnel requires gateway auth mode=password (set gateway.auth.password or ENCLAWED_GATEWAY_PASSWORD)");
	...
	if (!isLoopbackHost(bindHost) && !hasSharedSecret && authMode !== "trusted-proxy") throw new Error(`refusing to bind gateway to ${bindHost}:${params.port} without auth (set gateway.auth.token/password, or set ENCLAWED_GATEWAY_TOKEN/ENCLAWED_GATEWAY_PASSWORD)`);
...
function isDisabledByEnv$1() {
	if (isTruthyEnvValue(process.env.ENCLAWED_SKIP_CANVAS_HOST)) return true;
	if (isTruthyEnvValue(process.env.ENCLAWED_SKIP_CANVAS_HOST)) return true;
	if (process.env.VITEST) return true;
	return false;
}
function normalizeBasePath(rawPath) {
	const normalized = normalizeUrlPath((rawPath ?? "/__enclawed__/canvas").trim() || "/__enclawed__/canvas");
	if (normalized === "/") return "/";
...
async function createCanvasHostHandler(opts) {
	...
	const handleUpgrade = (req, socket, head) => {
		if (!wss) return false;
		if (new URL(req.url ?? "/", "http://localhost").pathname !== "/__enclawed__/ws") return false;
		wss.handleUpgrade(req, socket, head, (ws) => {
			wss.emit("connection", ws, req);
		});
		return true;
	...
	const handleHttpRequest = async (req, res) => {
		...
		try {
			...
			if (url.pathname === "/__enclawed__/ws") {
			...
			if (!opened) {
				if (urlPath === "/" || urlPath.endsWith("/")) {
					...
					res.end(`<!doctype html><meta charset="utf-8" /><title>Enclawed Canvas</title><pre>Missing file.\nCreate ${rootDir}/index.html</pre>`);
					return true;
				}
				res.statusCode = 404;
				res.setHeader("Content-Type", "text/plain; charset=utf-8");
...
function getMaxPreauthConnectionsPerIpFromEnv(env = process.env) {
	const configured = env.ENCLAWED_MAX_PREAUTH_CONNECTIONS_PER_IP || env.VITEST && env.ENCLAWED_TEST_MAX_PREAUTH_CONNECTIONS_PER_IP;
...
function pruneSkippedStartupSecretSurfaces(config) {
	if (!(isTruthyEnvValue(process.env.ENCLAWED_SKIP_CHANNELS) || isTruthyEnvValue(process.env.ENCLAWED_SKIP_PROVIDERS)) || !config.channels) return config;
	return {
		...config,
		channels: void 0
	};
...
function isDisabledByEnv() {
	if (isTruthyEnvValue(process.env.ENCLAWED_DISABLE_BONJOUR)) return true;
	if (process.env.VITEST) return true;
	return false;
}
...
async function startGatewayBonjourAdvertiser(opts) {
	...
	try {
		const hostname = (process.env.ENCLAWED_MDNS_HOSTNAME?.trim() || "enclawed").replace(/\.local$/i, "").split(".")[0].trim() || "enclawed";
		const instanceName = typeof opts.instanceName === "string" && opts.instanceName.trim() ? opts.instanceName.trim() : `${hostname} (Enclawed)`;
...
function formatBonjourInstanceName(displayName) {
	const trimmed = displayName.trim();
	if (!trimmed) return "Enclawed";
	if (/enclawed/i.test(trimmed)) return trimmed;
	return `${trimmed} (Enclawed)`;
}
function resolveBonjourCliPath(opts = {}) {
	const envPath = (opts.env ?? process.env).ENCLAWED_CLI_PATH?.trim();
...
async function resolveTailnetDnsHint(opts) {
	const envRaw = (opts?.env ?? process.env).ENCLAWED_TAILNET_DNS?.trim();
...
async function startGatewayDiscovery(params) {
	...
	const bonjourEnabled = mdnsMode !== "off" && process.env.ENCLAWED_DISABLE_BONJOUR !== "1" && !process.env.VITEST;
	...
	const sshPortEnv = mdnsMinimal ? void 0 : process.env.ENCLAWED_SSH_PORT?.trim();
...
async function runAutoUpdateCommand(params) {
	...
	if (argv.length === 0) argv.push("enclawed", ...baseArgs);
	try {
		const res = await runCommandWithTimeout(argv, {
			timeoutMs: params.timeoutMs,
			env: { ENCLAWED_AUTO_UPDATE: "1" }
		});
		return {
			ok: res.code === 0,
			code: res.code,
...
async function runGatewayUpdateCheck(params) {
	...
	if (cmp != null && cmp < 0) {
		...
		if (shouldRunUpdateHints && shouldNotify) {
			params.log.info(`update available (${tag}): v${resolved.version} (current v${VERSION}). Run: ${formatCliCommand("enclawed update")}`);
...
*/
const IMMUTABLE_SOURCES = new Set(["enclawed-bundled"]);
...
const loadedHookRegistrations = resolveGlobalSingleton(Symbol.for("enclawed.loadedInternalHookRegistrations"), () => []);
...
function maybeWarnTrustedHookSource(source) {
	...
	if (source === "enclawed-managed") log$3.warn("Loading managed hook code into the gateway process. Managed hooks are trusted local code.");
}
...
async function loadInternalHooks(cfg, workspaceDir, opts) {
	...
	for (const handlerConfig of handlers) try {
		...
		const mod = await import(buildImportUrl(safeModulePath, "enclawed-workspace"));
...
function logGatewayStartup(params) {
	...
	if (enabledDangerousFlags.length > 0) {
		const warning = `security warning: dangerous config flags enabled: ${enabledDangerousFlags.join(", ")}. Run \`enclawed security audit\`.`;
...
async function startGatewaySidecars(params) {
	...
	if (!(isTruthyEnvValue(process.env.ENCLAWED_SKIP_CHANNELS) || isTruthyEnvValue(process.env.ENCLAWED_SKIP_PROVIDERS))) try {
	...
	else params.logChannels.info("skipping channel start (ENCLAWED_SKIP_CHANNELS=1 or ENCLAWED_SKIP_PROVIDERS=1)");
...
function attachGatewayWsConnectionHandler(params) {
	...
	wss.on("connection", (socket, upgradeReq) => {
		...
		const preauthBudgetKey = socket.__enclawedPreauthBudgetKey;
		socket.__enclawedPreauthBudgetClaimed = true;
...
async function startGatewayServer(port = 18789, opts = {}) {
	const minimalTestGateway = process.env.VITEST === "1" && process.env.ENCLAWED_TEST_MINIMAL_GATEWAY === "1";
	...
	else log.warn("Gateway auth token was missing. Generated a runtime token for this startup without changing config; restart will generate a different token. Persist one with `enclawed config set gateway.auth.mode token` and `enclawed config set gateway.auth.token <token>`.");
