...
import { l as listDeliverableMessageChannels } from "./message-channel-eZXacO7t.js";
import { n as resolveChannelApprovalCapability } from "./plugins-DlBOVsJe.js";
import { t as buildMemoryPromptSection } from "./memory-state-CFyyWZvk.js";
import { n as normalizeStructuredPromptSection, t as normalizePromptCapabilityIds } from "./prompt-cache-stability-DxPXwJEf.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-DEyoRqN5.js";
import { t as SYSTEM_PROMPT_CACHE_BOUNDARY } from "./system-prompt-cache-boundary-ChD2IjV1.js";
import { n as buildLimitedBootstrapPromptLines, t as buildFullBootstrapPromptLines } from "./bootstrap-prompt-DCWdkEhz.js";
...
function buildAgentSystemPrompt(params) {
	...
	const coreToolSummaries = {
		...
		agents_list: acpSpawnRuntimeEnabled ? "List Enclawed agent ids allowed for sessions_spawn when runtime=\"subagent\" (not ACP harness ids)" : "List Enclawed agent ids allowed for sessions_spawn",
	...
	if (promptMode === "none") return "You are a personal assistant running inside Enclawed.";
	const lines = [
