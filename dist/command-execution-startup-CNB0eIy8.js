...
import { n as resolvePluginRegistryScopeForCommandPath, t as ensureCliPluginRegistryLoaded } from "./plugin-registry-loader-CI2C6goF.js";
//#region src/cli/command-bootstrap.ts
let configGuardModulePromise;
function loadConfigGuardModule() {
	configGuardModulePromise ??= import("./config-guard-BW7nLJtW.js");
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-CxpwgKR_.js");
	if (params.argv) {
