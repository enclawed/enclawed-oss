...
import { t as danger } from "./globals-D8R_YQwt.js";
...
import { t as isChannelVisibleInConfiguredLists } from "./exposure-DuKl8SgJ.js";
...
import { i as loadAuthProfileStore } from "./store-J7Io5AUg.js";
import "./plugins-BRuVcg7S.js";
import "./logging-DotYzX7j.js";
import { c as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-koEgVT7h.js";
import "./auth-profiles-CWIWzE4_.js";
import { r as callGateway } from "./call-D6zBw8Jl.js";
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-D-Xq2bfy.js";
...
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-DqfDTaRv.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-Dsxp4-4J.js";
import { n as withProgress } from "./progress-DZ7JU7SC.js";
import { t as createClackPrompter } from "./clack-prompter-TewPG3xu.js";
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-BYK6RaDL.js";
import { n as formatUsageReportLines, t as loadProviderUsageSummary } from "./provider-usage-Byr73rWo.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-D26pXIXY.js";
import { n as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-w5w02Gf_.js";
import { t as parseLogLine } from "./parse-log-line-Dsg9sngy.js";
import { r as describeBinding, t as applyAgentBindings } from "./agents.bindings-BoxiLUgQ.js";
import { n as requireValidConfigSnapshot, t as requireValidConfigFileSnapshot } from "./config-validation-BcdnHxmA.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-BwMp7fxR.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-JN0OgAxw.js";
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	const { listChannelPluginCatalogEntries } = await import("./catalog-Bc_zQErE.js");
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-Dr2Nkuz5.js"), import("./onboard-channels-BVqCpHME.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-B49yyZnw.js");
	...
	if (!channel && catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-CUBgckop.js");
		if (!isCatalogChannelInstalled({
			cfg: nextConfig,
			entry: catalogEntry,
			workspaceDir
		})) {
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-B49yyZnw.js");
			const prompter = createClackPrompter();
	...
	if (afterAccountConfigWritten) {
		const { runCollectedChannelOnboardingPostWriteHooks } = await import("./onboard-channels-BVqCpHME.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = !useWizard && rawChannel && (!channel || !getChannelPlugin(channel)) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-DTF86fwA.js");
