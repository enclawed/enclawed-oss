...
import { a as projectOutboundPayloadPlanForDelivery, n as createOutboundPayloadPlan, s as projectOutboundPayloadPlanForMirror, t as deliverOutboundPayloads } from "./deliver-Cm9sSV1G.js";
...
function loadMessageConfigRuntime() {
	messageConfigRuntimePromise ??= import("./message.config.runtime-D-WjlTMi.js");
	return messageConfigRuntimePromise;
}
function loadMessageGatewayRuntime() {
	messageGatewayRuntimePromise ??= import("./message.gateway.runtime-DSE_jKde.js");
