...
import "./accounts-3jNSKvle.js";
import "./runtime-api-Dh6sAUDq.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-FtzTmL8q.js";
import { t as sendMessageZalo } from "./send-DYimlBeD.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-DlWluSV1.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-DoRD5AQK.js");
