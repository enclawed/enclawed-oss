...
import { n as buildGatewayInstallPlan, t as resolveGatewayInstallToken } from "./gateway-install-token-DTAmUu-4.js";
...
import { h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode } from "./shared-BZtv1d1b.js";
	...
	if (loaded) {
		if (!opts.force) if (await gatewayServiceNeedsAutoNodeExtraCaCertsRefresh({
			...
			if (!json) {
				...
				defaultRuntime.log(`Reinstall with: ${formatCliCommand("enclawed gateway install --force")}`);
			}
			return;
		}
	}
