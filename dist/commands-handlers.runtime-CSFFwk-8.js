...
import { i as normalizeChannelId$1, t as getChannelPlugin } from "./registry-CI36HBCI.js";
import { b as resolveAgentDir, p as resolveSessionAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-D-lQQ64_.js";
...
import { n as resolveChannelApprovalCapability } from "./plugins-lmHd1cqM.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-DME9Vvkn.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-Bf8EdmFA.js";
...
import { i as formatUsd, r as formatTokenCount } from "./usage-format-BzIB3P-3.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-B-t4NsiU.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-BiDOsKsH.js";
import { S as setTtsProvider, _ as setLastTtsAttempt, a as getTtsMaxLength, b as setTtsEnabled, c as isTtsEnabled, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, r as getLastTtsAttempt, s as isSummarizationEnabled, v as setSummarizationEnabled, w as textToSpeech, x as setTtsMaxLength } from "./tts-runtime-C0wxbtbl.js";
...
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-Aykyg1nc.js";
...
import { i as unsetConfiguredMcpServer, r as setConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-CfPKdROG.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-CQDlqDha.js";
import { r as callGateway } from "./call-BbWFdSoI.js";
import { l as triggerEnclawedRestart, o as scheduleGatewaySigusr1Restart } from "./restart-BunH6e-H.js";
...
import { h as replyRunRegistry, i as getActiveEmbeddedRunSnapshot } from "./runs-BK6SAvHE.js";
import "./diagnostic-L0RPMr_9.js";
import { t as formatDurationCompact } from "./format-duration-DtQBjCYd.js";
import { O as getFinishedSession, k as getSession } from "./bash-tools.exec-runtime-B0EBcxpK.js";
import "./sandbox-B3AYL5AZ.js";
import { o as stripToolResultDetails } from "./session-transcript-repair-sxj88xbt.js";
...
import { r as resolveModelWithRegistry } from "./model-BvO5W3LU.js";
...
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-BnnE3n-g.js";
...
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-LZO5lxHI.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-CKg7NJ45.js";
import { l as resolveArchiveKind } from "./archive-Cy1y6Ja0.js";
...
import { t as resolveFastModeState } from "./fast-mode-CYXqc2rG.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-CvElY4rb.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-DekDXmhq.js";
...
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-u_hgjHdU.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-2Hrx28_T.js";
import { t as extractBtwQuestion } from "./btw-command-CSYUNVrR.js";
...
import { t as handleAcpCommand } from "./commands-acp-3SITKNpN.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-grR85B5e.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-EV6r9w8i.js";
import { r as handleModelsCommand } from "./commands-models-6puivz43.js";
import { n as setPluginEnabledInConfig } from "./enable--x_8awhI.js";
import { n as createExecTool } from "./bash-tools-s6HRdk90.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./status-text-CLS4d_ml.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-CX-fk1vK.js";
import { f as resolveSubagentsAction, h as resolveCommandSurfaceChannel, l as resolveHandledPrefix, m as resolveChannelAccountId, p as stopWithText, u as resolveRequesterSessionKey } from "./shared-QNM6vGOp.js";
import { n as buildToolsMessage } from "./status-DQyuFjez.js";
import { t as parseConfigValue } from "./config-value-CRn4eDNL.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-zO62IGdG.js";
import { t as buildStatusReply } from "./commands-status-Dwybrrnv.js";
import { i as buildNpmInstallRecordFields, n as persistPluginInstall } from "./plugins-install-persist-BlFdohXW.js";
import { m as parseClawHubPluginSpec } from "./clawhub-CHEjoiE_.js";
import { r as installPluginFromClawHub } from "./clawhub-JWQqldyY.js";
import { a as buildPluginInspectReport, i as buildPluginDiagnosticsReport, o as buildPluginSnapshotReport, s as formatPluginCompatibilityNotice, t as buildAllPluginInspectReports } from "./status-CpeGx82G.js";
import { a as decidePreferredClawHubFallback, i as createPluginInstallLogger, n as buildPreferredClawHubSpec, u as resolveFileNpmSpecToLocalPath } from "./plugins-command-helpers-C_MONROl.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-CNEAe4gq.js";
...
const handleCompactCommand = async (params) => {
	...
	const runtime = await import("./commands-compact.runtime-x4gujSEW.js");
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-31hXyra6.js");
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-B3-dyZ1w.js");
...
function loadAgentsAction() {
	actionAgentsPromise ??= import("./action-agents-DhpmTUOa.js");
	return actionAgentsPromise;
}
function loadFocusAction() {
	actionFocusPromise ??= import("./action-focus-DsDLR8FC.js");
	return actionFocusPromise;
}
function loadHelpAction() {
	actionHelpPromise ??= import("./action-help-fGrXvKmP.js");
	return actionHelpPromise;
}
function loadInfoAction() {
	actionInfoPromise ??= import("./action-info-BqXrlNln.js");
	return actionInfoPromise;
}
function loadKillAction() {
	actionKillPromise ??= import("./action-kill-smRdB3Re.js");
	return actionKillPromise;
}
function loadListAction() {
	actionListPromise ??= import("./action-list-Cah89mpF.js");
	return actionListPromise;
}
function loadLogAction() {
	actionLogPromise ??= import("./action-log-hIqMDrE0.js");
	return actionLogPromise;
}
function loadSendAction() {
	actionSendPromise ??= import("./action-send-CcVzkVfG.js");
	return actionSendPromise;
}
function loadSpawnAction() {
	actionSpawnPromise ??= import("./action-spawn-BiMJQ4Cd.js");
	return actionSpawnPromise;
}
function loadUnfocusAction() {
	actionUnfocusPromise ??= import("./action-unfocus-DuGwnssN.js");
	return actionUnfocusPromise;
}
function loadControlRuntime() {
	controlRuntimePromise ??= import("./commands-subagents-control.runtime-DiqgCFge.js");
