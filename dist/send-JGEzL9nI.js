...
import "./logging-core-DtsGqJmm.js";
import "./markdown-table-runtime-D7oc8Vo8.js";
import { r as resolveDefaultWhatsAppAccountId } from "./account-ids-BhlkFg8j.js";
import { a as resolveWhatsAppAccount, s as resolveWhatsAppMediaMaxBytes } from "./accounts-D17EoX3g.js";
import { t as getRegisteredWhatsAppConnectionController } from "./connection-controller-registry-DVDvJQm9.js";
import { i as markdownToWhatsApp, o as toWhatsappJid } from "./text-runtime-Dg2kf9IN.js";
import { a as resolveWhatsAppOutboundMediaUrls, i as prepareWhatsAppOutboundMedia, n as normalizeWhatsAppPayloadText } from "./outbound-media-contract-Dc34xX9x.js";
...
function requireOutboundActiveWebListener(params) {
	...
	if (!listener) throw new Error(`No active WhatsApp Web listener (account: ${resolvedAccountId}). Start the gateway, then link WhatsApp with: ${formatCliCommand(`enclawed channels login --channel whatsapp --account ${resolvedAccountId}`)}.`);
	return {
