...
import { d as resolveSecretInputRef } from "./types.secrets-B-g1z55T.js";
import { t as createGatewayCredentialPlan } from "./credential-planner-7-s3g1Jp.js";
import { u as secretRefKey } from "./ref-contract-B_vjonjo.js";
import "./shared-6rc7ZNul.js";
import { o as resolveSecretRefValues } from "./resolve-jcnf_t2z.js";
import { n as getBootstrapChannelSecrets } from "./bootstrap-registry-B1qQzh3i.js";
import { S as resolveDefaultAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-Bv7XD6OT.js";
import { a as normalizePluginsConfig, c as resolveEnableState } from "./config-state-DPvzxDpF.js";
import { o as collectPluginConfigContractMatches, s as resolvePluginConfigContractsById } from "./plugin-auto-enable-DfzfHwyb.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-DY9_wUGH.js";
import { a as createLazyRuntimeSurface, i as createLazyRuntimeNamedExport } from "./lazy-runtime-n1cctuu6.js";
import { n as resolvePluginCapabilityProviders } from "./capability-provider-runtime-BmXIjgwR.js";
import { n as resolveEffectiveMediaEntryCapabilities, r as normalizeMediaProviderId, t as resolveConfiguredMediaEntryCapabilities } from "./entry-capabilities-BFcJXDES.js";
import { t as loadBundledChannelSecretContractApi } from "./channel-contract-api-B7mHXItG.js";
import { c as pushInactiveSurfaceWarning, l as pushWarning, n as collectSecretInputAssignment } from "./runtime-shared-CZkVIKjO.js";
import { t as collectTtsApiKeyAssignments } from "./runtime-config-collectors-tts-Czk2fY3e.js";
import { o as sortWebFetchProvidersForAutoDetect, r as sortWebSearchProvidersForAutoDetect } from "./web-search-providers.shared-1N1vJBZK.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts, r as resolveBundledExplicitWebFetchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-D7JH81lR.js";
...
const loadResolveManifestContractOwnerPluginId = createLazyRuntimeNamedExport(() => import("./runtime-web-tools-manifest.runtime-BXOuP-pd.js"), "resolveManifestContractOwnerPluginId");
...
const loadRuntimeWebToolsFallbackProviders = createLazyRuntimeSurface(() => import("./runtime-web-tools-fallback.runtime-BRlluBtp.js"), ({ runtimeWebToolsFallbackProviders }) => runtimeWebToolsFallbackProviders);
const loadRuntimeWebToolsPublicArtifacts = createLazyRuntimeSurface(() => import("./runtime-web-tools-public-artifacts.runtime-CMHhrX8A.js"), (mod) => mod);
const loadRuntimeWebToolsManifest = createLazyRuntimeSurface(() => import("./runtime-web-tools-manifest.runtime-BXOuP-pd.js"), (mod) => mod);
