...
import { n as matrixReplaceConfigFile, r as readMatrixRuntimeConfig, t as getMatrixRuntime } from "./runtime-C81KrYiI.js";
import { i as resolveMatrixAccount } from "./accounts-B_DszpRB.js";
import { t as formatMatrixErrorMessage } from "./errors-DFW-R2p9.js";
import { n as resolveMatrixConfigPath } from "./config-paths-BwEdm3c6.js";
import { t as updateMatrixAccountConfig } from "./config-update-KU2B9t_G.js";
import { n as matrixSetupAdapter } from "./setup-core-C_2T7eAR.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-D7kufDfi.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-aaHNQPP5.js";
import { t as withResolvedActionClient } from "./client-Cvw8mOAt.js";
import { r as resolveMatrixAuthContext } from "./config-CFK8o2RH.js";
import "./client-BFP7inOc.js";
import "./runtime-api-DnwD2I16.js";
import { n as summarizeMatrixDeviceHealth, t as isEnclawedManagedMatrixDevice } from "./device-health-CdtkiQ-U.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-DDVwUyF3.js";
import { a as confirmMatrixVerificationSas, c as getMatrixRoomKeyBackupStatus, d as listMatrixVerifications, f as mismatchMatrixVerificationSas, g as runMatrixSelfVerification, h as restoreMatrixRoomKeyBackup, l as getMatrixVerificationSas, m as resetMatrixRoomKeyBackup, n as bootstrapMatrixVerification, p as requestMatrixVerification, r as cancelMatrixVerification, t as acceptMatrixVerification, u as getMatrixVerificationStatus, v as startMatrixVerification, y as verifyMatrixRecoveryKey } from "./verification-BC-f-vxu.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-CNJUcIKt.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-BKJv3xvd.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-B9PvINBC.js");
