...
import { t as createAsyncLock } from "./json-files-dLr22YNm.js";
...
const dreamsFileLocks = resolveGlobalMap(Symbol.for("enclawed.memoryCore.dreamingNarrative.fileLocks"));
function isRequestScopedSubagentRuntimeError(err) {
	return err instanceof RequestScopedSubagentRuntimeError || err instanceof Error && err.name === "RequestScopedSubagentRuntimeError" && extractErrorCode(err) === "ENCLAWED_SUBAGENT_RUNTIME_REQUEST_SCOPE";
}
