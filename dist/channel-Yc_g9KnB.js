...
import { u as getExecApprovalReplyMetadata } from "./exec-approval-reply-DXBP45LV.js";
import { r as createChannelApprovalCapability } from "./approval-delivery-helpers-wVoeC-ve.js";
...
import "./approval-runtime-Cm25E40k.js";
import { t as asOptionalObjectRecord } from "./string-normalize-l3p6ov3Q.js";
import { l as ensurePlatformAdapter, u as getBridgeLogger } from "./resolve-CrYwpb7k.js";
import { a as resolveApprovalTarget } from "./approval-DLXWn1nX.js";
import { a as resolveQQBotAccount, n as applyQQBotAccountConfig, t as DEFAULT_ACCOUNT_ID$1 } from "./config-CZtofqLT.js";
import { a as resolveQQBotExecApprovalConfig, i as matchesQQBotApprovalAccount, n as isQQBotExecApprovalAuthorizedSender, o as shouldHandleQQBotExecApprovalRequest, r as isQQBotExecApprovalClientEnabled, t as isQQBotExecApprovalApprover } from "./exec-approvals-q6ulN9Ll.js";
import { a as qqbotSetupAdapterShared, i as qqbotMeta, n as qqbotSetupWizard, r as qqbotConfigAdapter, t as qqbotChannelConfigSchema } from "./config-schema-DMfYmwyH.js";
import { n as writeEnclawedConfigThroughRuntime, t as toGatewayAccount } from "./narrowing-BB6RWtlF.js";
import { t as getQQBotRuntime } from "./runtime-Cd2JRwmg.js";
import { l as getQQBotDataPath, n as normalizeTarget, t as looksLikeQQBotTarget } from "./target-parser-BwpRJrXw.js";
	...
	return createChannelApprovalCapability({
		...
		nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
			...
			load: async () => {
				...
				return (await import("./handler-runtime-q_F2rCIp.js")).qqbotApprovalNativeRuntime;
			}
		})
	});
}
...
function loadGatewayModule() {
	_gatewayModulePromise ??= import("./gateway-D8F8BpZz.js");
...
const qqbotPlugin = {
	...
	outbound: {
		...
		sendText: async ({ to, text, accountId, replyToId, cfg }) => {
			...
			const { sendText } = await import("./outbound-3jP2zT42.js");
		...
		sendMedia: async ({ to, text, mediaUrl, accountId, replyToId, cfg }) => {
			await loadGatewayModule();
			const account = resolveQQBotAccount(cfg, accountId);
			const { sendMedia } = await import("./outbound-3jP2zT42.js");
