import { c as isSecureWebSocketUrl } from "./net-SK24IRt9.js";
...
import { t as detectBinary } from "./detect-binary-Cm9GM5vc.js";
...
import { n as buildGatewayDiscoveryTarget, t as buildGatewayDiscoveryLabel } from "./gateway-discovery-targets-DBN3vEs6.js";
import "./onboard-helpers-CmGuAQ9e.js";
...
function validateGatewayWebSocketUrl(value) {
	...
	if (!isSecureWebSocketUrl(trimmed, { allowPrivateWs: process.env.ENCLAWED_ALLOW_INSECURE_PRIVATE_WS === "1" })) return "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: ENCLAWED_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.";
}
async function promptRemoteGatewayConfig(cfg, prompter, options) {
	...
	if (!hasBonjourTool) await prompter.note(["Bonjour discovery requires dns-sd (macOS) or avahi-browse (Linux).", "Docs: https://docs.enclawed.ai/gateway/discovery"].join("\n"), "Discovery");
	if (wantsDiscover) {
