...
import { c as resolveOpenDmAllowlistAccess } from "./dm-policy-shared-WwSCqkD6.js";
import "./reply-history-DxyJROVM.js";
import { t as createReplyPrefixContext } from "./reply-prefix-cViH0nHe.js";
...
import { t as buildAgentMediaPayload } from "./agent-media-payload-c4JEree3.js";
...
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-BN-7jdgi.js";
...
import { n as createChannelPairingController } from "./channel-pairing-DMiPQjvN.js";
import { n as createPersistentDedupe } from "./persistent-dedupe-C2n6Cmd7.js";
import { c as readWebhookBodyOrReject, r as applyBasicWebhookRequestGuards } from "./webhook-request-guards-DNwhOQWV.js";
import "./webhook-ingress-B3JS-8GF.js";
import { t as buildFeishuConversationId } from "./conversation-id-CpxP5n5r.js";
import { i as resolveReceiveIdType } from "./targets-DIvWZHWy.js";
import { n as createFeishuThreadBindingManager } from "./thread-bindings-CzDZbRYj.js";
import { _ as buildFeishuCommentTarget, d as extractReplyText, g as readString$2, h as parseCommentContentElements, l as resolveFeishuRuntimeAccount, m as normalizeString, p as isRecord$2, u as encodeQuery, v as normalizeCommentFileType } from "./accounts-B_eDKV2M.js";
import { i as decodeFeishuCardAction, n as buildFeishuCardActionTextFallback, r as createFeishuCardInteractionEnvelope } from "./card-interaction-BgNItGA4.js";
import { i as resolveFeishuGroupConfig, n as isFeishuGroupAllowed, o as resolveFeishuReplyPolicy, r as resolveFeishuAllowlistMatch, t as hasExplicitFeishuGroupConfig } from "./policy-C3GorrWS.js";
import { t as getFeishuRuntime } from "./runtime-D3_UVQOm.js";
import { a as createEventDispatcher, c as getFeishuUserAgent, o as createFeishuClient, s as createFeishuWSClient } from "./client-CBOTQN_g.js";
import { c as getChatInfo, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-TOLYmx-C.js";
import "./runtime-api-CXADeECJ.js";
import { _ as normalizeFeishuExternalKey, a as sendCardFeishu, c as sendStructuredCardFeishu, d as extractMentionTargets, f as isFeishuBroadcastMention, g as sendMediaFeishu, h as downloadMessageResourceFeishu, i as resolveFeishuCardTemplate, l as parsePostContent, m as isFeishuGroupChatType, n as getMessageFeishu, p as isMentionForwardRequest, r as listFeishuThreadMessages, s as sendMessageFeishu, u as buildMentionedCardContent } from "./send-CjRFb8fW.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-gXagGopE.js";
import { a as feishuWebhookRateLimiter, c as wsClients, i as botOpenIds, l as fetchBotIdentityForMonitor, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as httpServers, r as botNames, s as recordWebhookStatus, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS } from "./monitor.state-BL5dsoVN.js";
...
async function resolveFeishuAudioPreflightTranscript(params) {
	...
	try {
		const { transcribeFirstAudio } = await import("./audio-preflight.runtime-CcZySMKC.js");
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-BoK-IJoe.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-BoK-IJoe.js");
