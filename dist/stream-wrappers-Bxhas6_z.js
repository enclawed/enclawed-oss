...
import { o as normalizeFastMode } from "./thinking.shared-DCWjwvfv.js";
import { r as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-BEDMtsHT.js";
import { A as applyAnthropicPayloadPolicyToParams, b as stripTrailingAnthropicAssistantPrefillWhenThinking, j as resolveAnthropicPayloadPolicy, n as createAnthropicThinkingPrefillPayloadWrapper, t as composeProviderStreamWrappers, y as stripNullHeaderValues } from "./provider-stream-shared-emBXIITC.js";
...
function createAnthropicBetaHeadersWrapper(baseStreamFn, betas) {
	...
	return (model, context, options) => {
		...
		return underlying(model, context, {
			...options,
			headers: mergeAnthropicBetaHeader(stripNullHeaderValues(options?.headers), allBetas)
		});
	};
}
