...
import { p as resolvePayloadMediaUrls, x as sendTextMediaPayload, y as sendPayloadMediaSequenceOrFallback } from "./reply-payload-Dibp0yeY.js";
import { t as resolveOutboundSendDep } from "./send-deps-eU6qsNNS.js";
import { n as retryAsync, t as resolveRetryConfig } from "./retry-Cq7bvr48.js";
import "./text-runtime-BSsrP5ac.js";
import { t as createReplyToFanout } from "./outbound-runtime-DxP_PG_O.js";
...
import { a as chunkDiscordTextWithMode, i as normalizeDiscordOutboundTarget } from "./normalize-BAQCPs3C.js";
...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-D8vFNosC.js").then((module) => module.sendDiscordComponentMessage);
	return await (await discordComponentSendPromise)(...args);
}
function loadDiscordSharedInteractive() {
	discordSharedInteractivePromise ??= import("./shared-interactive-CR8tYjRE.js");
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-BfFXmp-c.js");
