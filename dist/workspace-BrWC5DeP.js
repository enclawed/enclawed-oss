...
import { i as resolveOsHomeDir } from "./home-dir-yzjXRaUx.js";
import { n as resolveEnclawedPackageRootSync } from "./enclawed-root-CTcOq9RL.js";
import { g as resolveUserPath, h as resolveHomeDir, t as CONFIG_DIR } from "./utils-BcQ7uNrT.js";
import { t as createSubsystemLogger } from "./subsystem-WGqvYWrS.js";
import { t as getFlavor } from "./flavor-DhzvlYLU.js";
import { r as isPathInsideWithRealpath } from "./scan-paths-1r_5YRip.js";
import { s as isPathInside } from "./boundary-path-DV1omZV7.js";
import { t as openVerifiedFileSync } from "./safe-open-sync-DrJ5gCV7.js";
import { c as resolveEffectivePluginActivationState, l as resolveMemorySlotDecision, s as normalizePluginsConfigWithResolver, t as loadPluginManifestRegistry } from "./manifest-registry-B1LtZC7a.js";
import { r as hasKind } from "./slots-BVkLJktp.js";
import { n as normalizeSkillFilter } from "./filter-CCBUPTet.js";
import { n as resolveEffectiveAgentSkillsLimits, t as resolveEffectiveAgentSkillFilter } from "./agent-filter-Dlk3jK4I.js";
import { i as resolveSandboxPath } from "./sandbox-paths-AfYJvOXd.js";
import { a as shouldIncludeSkill, c as resolveSkillInvocationPolicy, o as parseFrontmatter, s as resolveEnclawedMetadata } from "./config-Dz1_JZZD.js";
...
function loadSkillsFromDirSafe(params) {
	if (getFlavor() === "enclaved") return { skills: [] };
...
function buildEscapedSkillPathReason(params) {
	...
	if (params.source === "enclawed-bundled" && candidateIsSymlink) return {
	...
	if (params.source === "enclawed-bundled") return {
...
function resolveWorkspaceSkillPromptState(workspaceDir, opts) {
	...
	return {
		...
		prompt: [
			remoteNote,
			truncated ? `⚠️ Skills truncated: included ${skillsForPrompt.length} of ${resolvedSkills.length}${compact ? " (compact format, descriptions omitted)" : ""}. Run \`enclawed skills check\` to audit.` : compact ? `⚠️ Skills catalog using compact format (descriptions omitted). Run \`enclawed skills check\` to audit.` : "",
