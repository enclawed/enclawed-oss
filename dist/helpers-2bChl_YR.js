...
import { n as sanitizeImageBlocks } from "./tool-images-BfMc3nWK.js";
...
import { n as detectImageReferences, r as loadImageFromRef } from "./images-CYJy1nqo.js";
import { t as KeyedAsyncQueue } from "./keyed-async-queue-DcWy94M0.js";
import { n as CLI_RESUME_WATCHDOG_DEFAULTS, r as CLI_WATCHDOG_MIN_TIMEOUT_MS, t as CLI_FRESH_WATCHDOG_DEFAULTS } from "./cli-watchdog-defaults-Br81XGOc.js";
...
const CLI_BACKEND_LOG_OUTPUT_ENV = "ENCLAWED_CLI_BACKEND_LOG_OUTPUT";
const LEGACY_CLAUDE_CLI_LOG_OUTPUT_ENV = "ENCLAWED_CLAUDE_CLI_LOG_OUTPUT";
//#endregion
...
function resolveCliImageRoot(params) {
	if (params.backend.imagePathScope === "workspace") return path.join(params.workspaceDir, ".enclawed-cli-images");
...
async function writeCliSystemPromptFile(params) {
	...
	const tempDir = await fs.mkdtemp(path.join(resolvePreferredEnclawedTmpDir(), "enclawed-cli-system-prompt-"));
