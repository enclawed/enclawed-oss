...
import { d as resolveNodeManagerOptions } from "./onboard-helpers-DnqWC8bO.js";
...
async function setupSkills(cfg, workspaceDir, runtime, prompter) {
	...
	if (installable.length > 0) {
		...
		for (const name of selected) {
			...
			runtime.log(`Tip: run \`${formatCliCommand("enclawed doctor")}\` to review skills + requirements.`);
