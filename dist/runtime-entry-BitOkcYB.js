...
import { C as resolveRealtimeVoiceAgentConsultTools, f as consultRealtimeVoiceAgent, m as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, t as convertPcmToMulaw8k, w as resolveRealtimeVoiceAgentConsultToolsAllow, x as parseRealtimeVoiceAgentConsultArgs } from "./realtime-voice-BrO7P2-a.js";
import { t as resolveConfiguredCapabilityProvider } from "./provider-selection-runtime-BlanjEm8.js";
import { n as getActiveMemorySearchManager } from "./memory-host-search-Bkg_C8tb.js";
...
import "./api-CMuf6-kN.js";
import { a as validateProviderConfig, i as resolveVoiceCallConfig, n as normalizeVoiceCallConfig, o as deepMergeDefined, r as resolveTwilioAuthToken } from "./config-D14-Qh6c.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-XFEgWw9o.js";
import { t as resolveVoiceResponseModel } from "./response-model-DsbWd3R3.js";
import { t as isProviderStatusTerminal } from "./call-status-CX9MVP2R.js";
import { t as getHeader } from "./http-headers-DDyb6w2W.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-DnRgD10q.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-ChaA1tmU.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-Cx6cUl7j.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-eoasCfWL.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-DxYg6Ezr.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-DQIVsVnd.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-Dhluat9X.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-BSzwMiRs.js");
