import { i as FALLBACK_CODEX_MODELS, r as CODEX_PROVIDER_ID } from "./provider-catalog-B0HzmpYS.js";
import { i as resolveCodexAppServerRuntimeOptions } from "./config-CZygc85A.js";
import { a as readCodexErrorNotification, c as readCodexTurnCompletedNotification, n as assertCodexThreadStartResponse, r as assertCodexTurnStartResponse } from "./protocol-validators-jl4aCFxv.js";
import { r as readModelListResult } from "./models-CXUFVpJH.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-Be1PRIHV.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
