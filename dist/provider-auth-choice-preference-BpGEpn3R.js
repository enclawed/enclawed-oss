import { n as resolveManifestProviderAuthChoice } from "./provider-auth-choices-CxzcmGk1.js";
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-CHGL_x_L.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-BfAkQjKQ.js");
