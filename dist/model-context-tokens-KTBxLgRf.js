...
import { n as isAbortError } from "./unhandled-rejections-C09iJ5eo.js";
import { l as isRecord } from "./utils-BcQ7uNrT.js";
import { t as createSubsystemLogger } from "./subsystem-WGqvYWrS.js";
import { a as logWarn, t as logDebug } from "./logger-CKs2nJWp.js";
import { i as openBoundaryFileSync, r as openBoundaryFile } from "./boundary-file-read-CQh3KACR.js";
...
import { i as normalizeChannelId } from "./registry-BnDtOQsV.js";
import { t as DEFAULT_CONTEXT_TOKENS } from "./defaults-DkpvRRFC.js";
import { t as applyMergePatch } from "./merge-patch-DiggvcXH.js";
import { p as resolveSessionAgentId, y as resolveAgentContextLimits } from "./agent-scope-Bv7XD6OT.js";
import { a as normalizePluginsConfig, s as resolveEffectivePluginActivationState } from "./config-state-DPvzxDpF.js";
import { t as parseDurationMs } from "./parse-duration-BlGD04_4.js";
import { t as rawDataToString } from "./ws-D-1OZ_PR.js";
import { a as normalizeInputProvenance, n as applyInputProvenanceToUserMessage, r as hasInterSessionUserProvenance } from "./input-provenance-DwdRnS02.js";
import { a as getCompactionProvider } from "./registry-HWND2Ug6.js";
...
import { B as resolveProviderWebSocketSessionPolicyWithPlugin, D as resolveProviderCacheTtlEligibility, L as resolveProviderTransportTurnStateWithPlugin, U as sanitizeProviderReplayHistoryWithPlugin, q as validateProviderReplayTurnsWithPlugin } from "./provider-runtime-BcnUyz_Y.js";
import { o as updateSessionStore } from "./store-BkF3pYvh.js";
import "./sessions-D71lwKID.js";
import { t as acquireSessionWriteLock } from "./session-write-lock-B7HIVMq0.js";
import { c as createExpiringMapCache, d as resolveCacheTtlMs, u as isCacheEnabled } from "./store-cache-C5kXTwF0.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-2sHHP1Ow.js";
import { u as resolveGatewaySessionStoreTarget } from "./session-utils-DY67z3Wl.js";
import { a as normalizeUsage, i as makeZeroUsageSnapshot } from "./usage-BAoTEYmL.js";
import { a as normalizeAssistantPhase, o as parseAssistantTextSignature, t as encodeAssistantTextSignature } from "./chat-message-content-C5zS33r4.js";
import { o as resolveContextWindowInfo } from "./context-window-guard-r1MxOqwW.js";
import { a as isSilentReplyText } from "./tokens-DgKTURQ1.js";
...
import { n as applyOwnerOnlyToolPolicy, o as mergeAlsoAllowPolicy, u as resolveToolProfilePolicy } from "./tool-policy-Bkov0fJO.js";
import { u as getPluginToolMeta } from "./channel-tools-CQ0awn7Q.js";
import { s as sanitizeGoogleTurnOrdering } from "./google-Cj1b_loh.js";
import { n as matchesAnyGlobPattern, t as compileGlobPatterns } from "./glob-pattern-DNv0R-UL.js";
import { c as extractToolCallsFromAssistant, d as downgradeOpenAIFunctionCallReasoningPairs, f as downgradeOpenAIReasoningBlocks, l as extractToolResultId, n as validateGeminiTurns, s as sanitizeSessionMessagesImages, t as validateAnthropicTurns, u as sanitizeToolCallIdsForCloudCodeAssist } from "./pi-embedded-helpers-4LE2bkL2.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-CoyKSbHr.js";
import { a as isTimeoutError } from "./failover-error-DwwfFRmS.js";
import { _ as normalizeOpenAIStrictToolParameters, d as mergeTransportMetadata, g as mapOpenAIReasoningEffortForModel, h as normalizeOpenAIReasoningEffort, v as resolveOpenAIStrictToolFlagForInventory, y as resolveOpenAIStrictToolSetting } from "./openai-transport-stream-2zQDCfMK.js";
import { d as resolveDebugProxySettings, n as captureWsEvent, u as createDebugProxyWebSocketAgent } from "./runtime-DbNBFyCA.js";
import { D as isAnthropicModelRef, E as isAnthropicFamilyCacheTtlEligible } from "./provider-stream-shared-emBXIITC.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-ChD2IjV1.js";
import { i as getModelProviderRequestTransport, l as resolveProviderRequestPolicyConfig, r as buildProviderRequestTlsClientOptions } from "./provider-request-config-CI4bNJoc.js";
import { t as log$4 } from "./logger-C7Wcy8qx.js";
import { b as resolveOpenAITextVerbosity } from "./proxy-stream-wrappers-D1vd0LoW.js";
import { i as createBoundaryAwareStreamFnForModel } from "./provider-stream-BVePDhj8.js";
import { n as loadEnabledBundleLspConfig } from "./bundle-lsp-DjGJmi_w.js";
import { a as loadEmbeddedPiMcpConfig, o as describeStdioMcpServerLaunchConfig, s as resolveStdioMcpServerLaunchConfig } from "./pi-bundle-mcp-tools-BhFwMZoh.js";
import { t as collectTextContentBlocks } from "./content-blocks-CTobxsLi.js";
import { r as applyPiCompactionSettingsFromConfig } from "./pi-settings-wQsDlBDF.js";
import { a as toToolDefinitions } from "./pi-tool-definition-adapter-DFJCg3mX.js";
import { a as resolveGroupToolPolicy, i as resolveGroupContextFromSessionKey, r as resolveEffectiveToolPolicy, s as resolveSubagentToolPolicyForSession } from "./read-capability-BBdqCvWu.js";
import { n as buildDefaultToolPolicyPipelineSteps, t as applyToolPolicyPipeline } from "./tool-policy-pipeline-7Fqdxg0u.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-z7gd-T-R.js";
import { i as resolveSkillRuntimeConfig } from "./env-overrides-DsNLUx1S.js";
import "./skills-DaEl7xQn.js";
import { i as setRawSessionAppendMessage, n as rewriteTranscriptEntriesInSessionManager, r as getRawSessionAppendMessage } from "./transcript-rewrite-cAzmfavv.js";
import { a as sanitizeToolUseResultPairing, i as sanitizeToolCallInputs, n as makeMissingToolResult, o as stripToolResultDetails, r as repairToolUseResultPairing } from "./session-transcript-repair-ASFMvVB-.js";
import { i as resolveUserTimezone } from "./date-time-BUvC9tLv.js";
import { i as shouldAllowProviderOwnedThinkingReplay, r as resolveTranscriptPolicy } from "./compaction-runtime-context-CnLMYsZY.js";
import { a as isGooglePromptCacheEligible } from "./extra-params-QWMPNneg.js";
import { t as withTimeout } from "./with-timeout-Cy9IeSq-.js";
import { n as resolveCronStyleNow } from "./current-time-Cai7esVx.js";
import { n as retryAsync } from "./retry-hubNFPI9.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-mq1Jge4r.js";
import "./query-DZxJa_ls.js";
import { i as wrapUntrustedPromptDataBlock, t as buildAgentSystemPrompt } from "./system-prompt-UN51SC0P.js";
import { t as estimateStringChars } from "./cjk-chars-DQW4XLsF.js";
import { t as createAnthropicVertexStreamFnForModel } from "./anthropic-vertex-stream-DmNV4F8A.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-Dp532dSh.js";
...
function readLastCacheTtlTimestamp(sessionManager, context) {
	...
	try {
		...
		for (let i = entries.length - 1; i >= 0; i--) {
			...
			if (entry?.type !== "custom" || entry?.customType !== "enclawed.cache-ttl") continue;
...
//#endregion
export { releaseWsSession as $, hasMeaningfulConversationContent as A, guardSessionManager as B, validateReplayTurns as C, buildEmbeddedExtensionFactories as D, limitHistoryTurns as E, applyFinalEffectiveToolPolicy as F, truncateOversizedToolResultsInSessionManager as G, resolveLiveToolResultMaxChars as H, compactWithSafetyTimeout as I, repairSessionFileIfNeeded as J, installContextEngineLoopHook as K, resolveCompactionTimeoutMs as L, readPostCompactionContext as M, consumeCompactionSafeguardCancelReason as N, SAFETY_MARGIN as O, setCompactionSafeguardCancelReason as P, createBundleLspToolRuntime as Q, isCacheTtlEligibleProvider as R, sanitizeSessionHistory as S, getDmHistoryLimitFromSessionKey as T, sessionLikelyHasOversizedToolResults as U, estimateToolResultReductionPotential as V, truncateOversizedToolResultsInSession as W, assessLastAssistantMessage as X, createPreparedEmbeddedPiSettingsManager as Y, dropThinkingBlocks as Z, resolveEmbeddedAgentBaseStreamFn as _, runAfterCompactionHooks as a, isHeartbeatUserMessage as at, prewarmSessionFile as b, flushPendingToolResultsAfterIdle as c, getSessionCompactionCheckpoint as ct, collectAllowedToolNames as d, resolveSessionCompactionCheckpointReason as dt, buildStreamErrorAssistantMessage as et, applySystemPromptOverrideToSession as f, resolveEmbeddedAgentApiKey as g, describeEmbeddedAgentStreamStrategy as h, estimateTokensAfterCompaction as i, isHeartbeatOkResponse as it, isRealConversationMessage as j, estimateMessagesTokens as k, mapThinkingLevel as l, listSessionCompactionCheckpoints as lt, createSystemPromptOverride as m, asCompactionHookRunner as n, resolveChannelCapabilities as nt, runBeforeCompactionHooks as o, captureCompactionCheckpointSnapshot as ot, buildEmbeddedSystemPrompt as p, installToolResultContextGuard as q, buildBeforeCompactionHookMetrics as r, filterHeartbeatPairs as rt, runPostCompactionSideEffects as s, cleanupCompactionCheckpointSnapshot as st, readPiModelContextTokens as t, buildUsageWithNoCost as tt, splitSdkTools as u, persistSessionCompactionCheckpoint as ut, resolveEmbeddedAgentStreamFn as v, buildEmbeddedMessageActionDiscoveryInput as w, trackSessionManagerAccess as x, resolveEmbeddedRunSkillEntries as y, readLastCacheTtlTimestamp as z };
