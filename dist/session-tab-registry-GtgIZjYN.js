...
import { n as getBridgeAuthForPort } from "./bridge-auth-registry-C9wAcXAF.js";
import { h as resolveBrowserRateLimitMessage } from "./cdp.helpers-DQ31Jv-3.js";
import { n as resolveBrowserControlAuth } from "./control-auth-8xwxFyoD.js";
...
async function fetchBrowserJson(url, init) {
	...
	try {
		...
		const { dispatchBrowserControlRequest } = await import("./local-dispatch.runtime-BmqJgxti.js");
