...
import "./accounts-BMu6tQRi.js";
import "./runtime-api-CyFyeAhh.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-DxK3TJJX.js";
import { t as sendMessageZalo } from "./send-Bl5Fnali.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-JnndLhex.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-BNDC0UFr.js");
