...
import { S as shouldSkipMutatingLoggingConfigRead, a as getLogger, f as formatLocalIsoWithOffset, g as loggingState, h as resolveEnvLogLevelOverride, i as getChildLogger, p as formatTimestamp, s as isFileLogLevelEnabled, v as levelToMinLevel, x as readLoggingConfig, y as normalizeLogLevel } from "./logger-wuQoU2z2.js";
import { r as normalizeChatChannelId } from "./ids-DIOx3XOb.js";
import { t as redact } from "./dlp-scanner-D1fAx4SR.js";
...
import { r as stripAnsi } from "./ansi-haTfqSzd.js";
...
function normalizeConsoleLevel(level) {
	...
	if (!level && process.env.VITEST === "true" && process.env.ENCLAWED_TEST_CONSOLE !== "1") return "silent";
...
function resolveConsoleSettings() {
	...
	if (process.env.VITEST === "true" && process.env.ENCLAWED_TEST_CONSOLE !== "1" && !isVerbose() && !envLevel && !loggingState.overrideSettings) return {
		level: "silent",
	...
	const emitLog = (level, message, meta) => {
		...
		if (enclawed) {
			...
			if (meta && typeof meta === "object") {
				const redacted = {};
				for (const [k, v] of Object.entries(meta)) redacted[k] = typeof v === "string" ? redact(v) : v;
				meta = redacted;
			}
