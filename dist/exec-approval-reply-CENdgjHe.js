...
import { r as listChannelPlugins, t as getChannelPlugin } from "./registry-BnDtOQsV.js";
import "./config-BDd-c7HD.js";
import { s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-CP7lSRvA.js";
import "./message-channel-core-mjm4W8wY.js";
import { n as resolveChannelApprovalCapability } from "./plugins-aoBJbOTG.js";
import { w as resolveExecApprovalAllowedDecisions } from "./exec-approvals-C0ZBCFVO.js";
...
function buildGenericNativeExecApprovalFallbackText(params) {
	...
	return clients ? `Approve it from the Web UI or terminal UI, or enable a native chat approval client such as ${clients}. If those accounts already know your owner ID via allowFrom or owner config, Enclawed can often infer approvers automatically.` : "Approve it from the Web UI or terminal UI.";
}
