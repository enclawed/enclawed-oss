...
import { c as resolveFreshestSessionEntryFromStoreKeys, u as resolveGatewaySessionStoreTarget } from "./session-utils-BHb7olSM.js";
import { i as readSessionMessages, t as attachEnclawedTranscriptMeta } from "./session-utils.fs-Bz4LmaEr.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-DDMQcD4D.js";
import { S as setSseHeaders, a as getHeader, b as sendMethodNotAllowed, p as resolveTrustedHttpOperatorScopes, r as authorizeGatewayHttpRequestOrReply, v as sendInvalidRequest, y as sendJson } from "./http-utils-B-NU8is7.js";
import { r as sanitizeChatHistoryMessages, t as DEFAULT_CHAT_HISTORY_TEXT_MAX_CHARS } from "./chat-D0lr9SoL.js";
...
var SessionHistorySseState = class SessionHistorySseState {
	...
	appendInlineMessage(update) {
		...
		const sanitized = sanitizeChatHistoryMessages([attachEnclawedTranscriptMeta(update.message, {
