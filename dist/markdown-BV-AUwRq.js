...
import { i as normalizeToken, o as resolveTwitchToken } from "./twitch-gI1i4cwN.js";
import { a as __read, i as __generator, n as __decorate, o as __spreadArray, r as __extends, s as init_tslib_es6, t as __awaiter } from "./tslib.es6-BJlmTI-S.js";
	...
	*/
	async getClient(account, cfg, accountId) {
		...
		if (!tokenResolution.token) {
			this.logger.error(`Missing Twitch token for account ${account.username} (set channels.twitch.accounts.${account.username}.token or ENCLAWED_TWITCH_ACCESS_TOKEN for default)`);
