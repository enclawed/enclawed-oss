...
import { t as getActiveMatrixClient } from "./active-client-CCgpAi5I.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-DlDBXgML.js"), import("./shared-BmnQWXp0.js")]).then(([clientModule, sharedModule]) => ({
