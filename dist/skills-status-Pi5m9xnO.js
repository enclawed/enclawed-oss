...
import { d as resolveBundledSkillsDir, o as loadWorkspaceSkillEntries, u as loadSkillsFromDirSafe } from "./workspace-z7gd-T-R.js";
import { n as hasBinary } from "./config-eval-DCmfx_Zm.js";
import { i as resolveSkillConfig, n as isConfigPathTruthy, r as resolveBundledAllowlist, t as isBundledSkillAllowed } from "./config-DAvUdyf6.js";
...
import { t as evaluateEntryRequirementsForCurrentPlatform } from "./entry-status-BXUoanU8.js";
...
function buildSkillStatus(entry, config, prefs, eligibility, bundledNames) {
	...
	const bundled = skillSource === "enclawed-bundled" || skillSource === "unknown" && bundledNames?.has(entry.skill.name) === true;
