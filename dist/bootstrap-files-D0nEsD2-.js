...
import { f as filterBootstrapFilesForSession, g as loadWorkspaceBootstrapFiles, i as DEFAULT_HEARTBEAT_FILENAME } from "./workspace-dcdTJd2I.js";
...
import { r as getOrLoadBootstrapFiles } from "./bootstrap-cache-D43YkfWV.js";
import { n as shouldIncludeHeartbeatGuidanceForSystemPrompt } from "./heartbeat-system-prompt-h7kutsRA.js";
import { i as resolveBootstrapMaxChars, n as buildBootstrapContextFiles, o as resolveBootstrapTotalMaxChars } from "./google-BrzdI_S_.js";
...
const FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE = "enclawed:bootstrap-context:full";
	...
	try {
		...
		try {
			...
			for (let i = records.length - 1; i >= 0; i--) {
				...
				if (record?.type === "custom" && record.customType === "enclawed:bootstrap-context:full") return !compactedAfterLatestAssistant;
			}
			return false;
		} finally {
			await fh.close();
