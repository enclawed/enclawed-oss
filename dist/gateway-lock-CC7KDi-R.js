import { _ as resolveStateDir, l as resolveGatewayLockDir, o as resolveConfigPath } from "./paths-CDjhyzOH.js";
import { d as parseProcCmdline, f as parseWindowsCmdline, u as isGatewayArgv } from "./restart-stale-pids-Cupz8fFw.js";
import { t as safeParseJsonWithSchema } from "./zod-parse-DrvB8WE0.js";
import { n as isPidAlive } from "./pid-alive-BNYj-JTl.js";
...
async function acquireGatewayLock(opts = {}) {
	...
	if (env.ENCLAWED_ALLOW_MULTI_GATEWAY === "1" || !allowInTests && (env.VITEST || env.NODE_ENV === "test")) return null;
