...
import { i as classifyToolAgainstSandboxToolPolicy, n as resolveSandboxConfigForAgent, o as resolveSandboxToolPolicyForAgent } from "./config-DwgI9V2b.js";
...
function formatSandboxToolPolicyBlockedMessage(params) {
	...
	const explainCommand = runtime.sessionKey ? hasUnsafeControlChars(runtime.sessionKey) ? `enclawed sandbox explain --agent ${runtime.agentId}` : `enclawed sandbox explain --session ${shellEscapeSingleArg(runtime.sessionKey)}` : "enclawed sandbox explain";
