...
import { a as loadConfig, u as readConfigFileSnapshotForWrite } from "./io-Dzvn-wpi.js";
import { c as normalizeAgentId, u as resolveAgentIdFromSessionKey } from "./session-key-D8SZau-8.js";
...
import { _ as listAgentIds, b as resolveAgentDir, l as resolveAgentSkillsFilter, p as resolveSessionAgentId, u as resolveEffectiveModelFallbacks, x as resolveAgentWorkspaceDir } from "./agent-scope-5o1jve-2.js";
import { f as resolveMessageChannel } from "./message-channel-BZ78qqgM.js";
import { n as ensureAuthProfileStore } from "./store-J7Io5AUg.js";
import { f as modelKey, m as parseModelRef, p as normalizeModelRef } from "./model-selection-cli-DrzfE0gz.js";
import { c as normalizeThinkLevel, d as normalizeVerboseLevel, n as formatXHighModelHint } from "./thinking.shared-BxNIEx-D.js";
import { d as resolveConfiguredModelRef, f as resolveDefaultModelForAgent, t as buildAllowedModelSet, x as resolveThinkingDefault } from "./model-selection-3QcDboLc.js";
import { r as loadModelCatalog } from "./model-catalog-DQh8b8if.js";
import { o as normalizeAccountId } from "./delivery-context.shared-B7S7hCmE.js";
import { i as supportsXHighThinking, t as formatThinkingLevels } from "./thinking-DWHN3uH-.js";
import { i as emitAgentEvent, t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-m_o42nBy.js";
import { i as LiveSessionModelSwitchError, r as runWithModelFallback } from "./model-fallback-C9WX3Pud.js";
import { t as getAgentRuntimeCommandSecretTargetIds } from "./command-secret-targets-D-Xq2bfy.js";
...
import { n as AGENT_LANE_SUBAGENT } from "./lanes-DKb_iZxL.js";
import { t as resolveAgentTimeoutMs } from "./timeout-CZTBoioj.js";
import { n as normalizeSpawnedRunMetadata } from "./spawned-context-BqCA2bpH.js";
import { r as resolveSession } from "./live-model-switch-Dg37eaoZ.js";
import { n as resolveSendPolicy } from "./send-policy-DyvnrMuc.js";
import { t as clearSessionAuthProfileOverride } from "./session-override-DVe4C0g6.js";
import { n as applyVerboseOverride } from "./level-overrides-DZAfmP1D.js";
import { n as prependInternalEventContext, t as persistSessionEntry$1 } from "./attempt-execution.shared-DA8WfG4M.js";
...
async function resolveAgentRuntimeConfig(runtime, params) {
	...
	}) ? (await (await import("./command-config-resolution.runtime-C-1dy3gc.js")).resolveCommandConfigWithSecrets({
		config: loadedRaw,
		commandName: "agent",
...
function loadAttemptExecutionRuntime() {
	attemptExecutionRuntimePromise ??= import("./attempt-execution.runtime-FjPQW8eE.js");
	return attemptExecutionRuntimePromise;
}
function loadAcpManagerRuntime() {
	acpManagerRuntimePromise ??= import("./manager-BZog3Nq6.js");
	return acpManagerRuntimePromise;
}
function loadAcpPolicyRuntime() {
	acpPolicyRuntimePromise ??= import("./policy-DOsES7IC.js");
	return acpPolicyRuntimePromise;
}
function loadAcpRuntimeErrorsRuntime() {
	acpRuntimeErrorsRuntimePromise ??= import("./errors-9s9gyZXj.js");
	return acpRuntimeErrorsRuntimePromise;
}
function loadAcpSessionIdentifiersRuntime() {
	acpSessionIdentifiersRuntimePromise ??= import("./session-identifiers-QVb_IcMQ.js");
	return acpSessionIdentifiersRuntimePromise;
}
function loadDeliveryRuntime() {
	deliveryRuntimePromise ??= import("./delivery.runtime-B7iXdUvH.js");
	return deliveryRuntimePromise;
}
function loadSessionStoreRuntime() {
	sessionStoreRuntimePromise ??= import("./session-store.runtime-3y3krkC_.js");
	return sessionStoreRuntimePromise;
}
function loadTranscriptResolveRuntime() {
	transcriptResolveRuntimePromise ??= import("./transcript-resolve.runtime-CvsFtGVF.js");
	return transcriptResolveRuntimePromise;
}
function loadCliDepsRuntime() {
	cliDepsRuntimePromise ??= import("./deps-Bdgcz28s.js");
	return cliDepsRuntimePromise;
}
function loadExecDefaultsRuntime() {
	execDefaultsRuntimePromise ??= import("./exec-defaults-BOdGiBXC.js");
	return execDefaultsRuntimePromise;
}
function loadSkillsRuntime() {
	skillsRuntimePromise ??= import("./skills-Bqg7YNpZ.js");
	return skillsRuntimePromise;
}
function loadSkillsFilterRuntime() {
	skillsFilterRuntimePromise ??= import("./filter-Dk4NkR6P.js");
	return skillsFilterRuntimePromise;
}
function loadSkillsRefreshStateRuntime() {
	skillsRefreshStateRuntimePromise ??= import("./refresh-state-DXycJl2L.js");
	return skillsRefreshStateRuntimePromise;
}
function loadSkillsRemoteRuntime() {
	skillsRemoteRuntimePromise ??= import("./skills-remote-Cl2PyUIN.js");
...
async function prepareAgentCommandExecution(opts, runtime) {
	...
	if (agentIdOverride) {
		if (!listAgentIds(cfg).includes(agentIdOverride)) throw new Error(`Unknown agent id "${agentIdOverrideRaw}". Use "${formatCliCommand("enclawed agents list")}" to see configured agents.`);
	}
