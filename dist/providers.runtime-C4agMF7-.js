import { r as hasExplicitPluginIdScope } from "./channel-configured-BwotNV-L.js";
import { c as resolveActivatableProviderOwnerPluginIds, d as resolveDiscoverableProviderOwnerPluginIds, f as resolveDiscoveredProviderPluginIds, g as withBundledProviderVitestCompat, h as resolveOwningPluginIdsForProvider, l as resolveBundledProviderCompatPluginIds, m as resolveOwningPluginIdsForModelRefs, p as resolveEnabledProviderPluginIds } from "./plugin-auto-enable-BE3SC6M5.js";
import { r as withActivatedPluginIds, t as resolveBundledPluginCompatibleActivationInputs } from "./activation-context-DgfpIQA5.js";
import { t as resolveManifestActivationPluginIds } from "./activation-planner-Cv82maTu.js";
import { a as resolveRuntimePluginRegistry, r as loadEnclawedPlugins, t as isPluginRegistryLoadInFlight } from "./loader-oqr3fQSf.js";
import { o as getActivePluginRegistryWorkspaceDir } from "./runtime-CO-f4q2v.js";
import { n as buildPluginRuntimeLoadOptionsFromValues, r as createPluginRuntimeLoaderLogger } from "./load-context-BaqRro7n.js";
...
function resolvePluginProviders(params) {
	...
	if (params.mode === "setup") {
		...
		if (!loadState) return [];
		return loadEnclawedPlugins(loadState.loadOptions).providers.map((entry) => ({
			...entry.provider,
