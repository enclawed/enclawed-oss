...
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, u as createComputedAccountStatusAdapter } from "./status-helpers-D2DtBiBO.js";
import { a as listIMessageAccountIds, n as resolveIMessageAttachmentRoots, o as resolveDefaultIMessageAccountId, r as resolveIMessageRemoteAttachmentRoots, s as resolveIMessageAccount } from "./media-contract-CFKV2-3b.js";
import { c as looksLikeIMessageExplicitTargetId, d as parseIMessageTarget, i as resolveIMessageConversationIdFromTarget, l as normalizeIMessageHandle, n as matchIMessageAcpConversation, o as inferIMessageTargetChatType, p as normalizeIMessageMessagingTarget, r as normalizeIMessageAcpConversationId } from "./conversation-id-CWEtEd_4.js";
import { n as createIMessageConversationBindingManager } from "./conversation-bindings-CpBLpbIZ.js";
import { n as resolveIMessageGroupToolPolicy, t as resolveIMessageGroupRequireMention } from "./group-policy-DBySRZBO.js";
import { a as imessageSetupAdapter, n as createIMessageSetupWizardProxy } from "./setup-core-CbUwpw_x.js";
import { t as IMessageChannelConfigSchema } from "./config-schema-DHCGKF-m.js";
//#region extensions/imessage/src/shared.ts
const IMESSAGE_CHANNEL = "imessage";
async function loadIMessageChannelRuntime$1() {
	return await import("./channel.runtime-DY1uJMku.js");
}
...
const loadIMessageChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-DY1uJMku.js"));
