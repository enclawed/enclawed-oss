...
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute } from "./core-DBv8LeUb.js";
...
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-B0J8p_YE.js";
...
import { n as createChannelNativeOriginTargetResolver, t as createChannelApproverDmTargetResolver } from "./approval-native-helpers-is03TAKZ.js";
...
import "./param-readers-D6XauKtt.js";
...
import { a as resolveSlackAccount, i as resolveDefaultSlackAccountId, l as resolveSlackReplyToMode, n as listSlackAccountIds, o as resolveSlackAccountAllowFrom } from "./accounts-BfvqCUJB.js";
...
import { a as normalizeSlackApproverId, c as shouldSuppressLocalSlackExecApprovalPrompt, i as isSlackExecApprovalClientEnabled, o as resolveSlackExecApprovalTarget, r as isSlackExecApprovalAuthorizedSender, s as shouldHandleSlackExecApprovalRequest, t as getSlackExecApprovalApprovers } from "./exec-approvals-CzLcTneH.js";
import { n as buildSlackPresentationBlocks, r as resolveSlackInteractiveBlockOffsets, t as buildSlackInteractiveBlocks } from "./blocks-render-yJjKnqXs.js";
import { t as SLACK_TEXT_LIMIT } from "./limits-DF-WZ7gY.js";
import { n as extractSlackToolSend, t as describeSlackMessageTool } from "./message-tool-api-nxEowoNe.js";
import { n as isSlackInteractiveRepliesEnabled, t as compileSlackInteractiveReplies } from "./interactive-replies-D0Wp5Ksn.js";
import "./channel-api-uTiepbZY.js";
import { r as createSlackWebClient } from "./client-CIsnLhdz.js";
import { r as normalizeAllowListLower } from "./allow-list-C8BsINNi.js";
import { n as resolveSlackGroupToolPolicy, t as resolveSlackGroupRequireMention } from "./group-policy-TOTRbROu.js";
import { t as resolveSlackReplyBlocks } from "./reply-blocks-DZM5sFux.js";
import { t as getOptionalSlackRuntime } from "./runtime-BVDTi1jM.js";
import { i as slackSecurityAdapter, n as isSlackPluginAccountConfigured, r as slackConfigAdapter, t as createSlackPluginBase } from "./shared-UEX9T1bp.js";
import { i as SLACK_CHANNEL, n as createSlackSetupWizardProxy, r as slackSetupAdapter } from "./setup-core-BBUeH76K.js";
import { n as resolveSlackThreadTsValue, t as normalizeSlackThreadTsCandidate } from "./thread-ts-CfBdPLbc.js";
...
const slackApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-Dna9xztN.js")).slackApprovalNativeRuntime
	})
});
...
async function loadSlackActionRuntime$1() {
	slackActionRuntimePromise$1 ??= import("./action-runtime.runtime-DbKlPSZy.js");
...
const loadSlackSetupSurfaceModule = createLazyRuntimeModule(() => import("./setup-surface-DhMgWysI.js"));
const loadSlackScopesModule = createLazyRuntimeModule(() => import("./scopes-qco2SLay.js"));
const loadSlackOutboundAdapterModule = createLazyRuntimeModule(() => import("./outbound-adapter--cSeDc3t.js"));
...
const loadSlackDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-CdlDrbo-.js"));
const loadSlackResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-Cp8hzE29.js"));
const loadSlackResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-DYBehf15.js"));
async function loadSlackActionRuntime() {
	slackActionRuntimePromise ??= import("./action-runtime.runtime-DbKlPSZy.js");
	return await slackActionRuntimePromise;
}
async function loadSlackSendRuntime() {
	slackSendRuntimePromise ??= import("./send.runtime-Cz_y4lsC.js");
	return await slackSendRuntimePromise;
}
async function loadSlackProbeModule() {
	slackProbeModulePromise ??= import("./probe-qGP5CQPj.js");
	return await slackProbeModulePromise;
}
async function loadSlackMonitorModule() {
	slackMonitorModulePromise ??= import("./monitor-CdR2tnES.js");
	return await slackMonitorModulePromise;
}
async function loadSlackDirectoryLiveModule() {
	slackDirectoryLiveModulePromise ??= import("./directory-live-C1gw4G9r.js");
