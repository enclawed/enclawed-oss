...
import { r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-BOVAZCiV.js";
import { i as isSystemdUserServiceAvailable } from "./systemd-B-zqDlea.js";
...
import { n as listConfiguredWebSearchProviders } from "./runtime-C60Gg9GD.js";
...
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-D5UWvDQv.js";
import { i as formatControlUiSshHint, m as waitForGatewayReachable, u as probeGatewayReachable } from "./onboard-helpers-DnqWC8bO.js";
...
import { t as runTui } from "./tui-DTBCD9FO.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-CvUMXtOH.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-BIspmwlu.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-BIspmwlu.js");
