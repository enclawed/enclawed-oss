...
import { r as buildChannelConfigSchema } from "./config-schema-DK9qgQyA.js";
...
import { d as readNumberParam, h as readStringParam, i as createActionGate, n as ToolAuthorizationError } from "./common-BLKrO58o.js";
import { t as adaptScopedAccountAccessor, u as createScopedDmSecurityResolver } from "./channel-config-helpers-bOV5DWOp.js";
import { C as projectAccountConfigWarningCollector, g as createAllowlistProviderOpenWarningCollector } from "./channel-policy-Lbd6vG46.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-y8PfDL9x.js";
...
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-Cp6Nf0m-.js";
import "./routing-8oE5PYNN.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-DkhpVqWx.js";
import "./approval-delivery-runtime-D9kbMbHR.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-CdRxDZz6.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-ueBMJzB3.js";
import { n as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-DrW6NECE.js";
import "./approval-native-runtime-O3EEIifi.js";
...
import { i as createPairingPrefixStripper } from "./channel-pairing-DIV-o5ud.js";
import "./session-store-runtime-DAI6Gz6C.js";
import "./string-coerce-runtime-C3fIEV8B.js";
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-BjB94cGc.js";
...
import { a as resolveMatrixAccountConfig } from "./account-config-D1al0QIu.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-Bx-avSOy.js";
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-D6eOS-6W.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-jqDWWAdf.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-SYpoCi5T.js";
import { n as normalizeMatrixUserId } from "./allowlist-BUfcg6Rq.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-DGcEG9jN.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-iJcIpxU7.js";
import { t as formatMatrixErrorMessage } from "./errors-D19xOr-n.js";
import { n as matrixConfigAdapter, t as MatrixConfigSchema } from "./config-schema-BjnkID8B.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-BOWQxFDo.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-BgLmzYPn.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-Dap0yRlU.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-D1fONMQN.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-CZQBQqgs.js";
import { i as autoPrepareLegacyMatrixCrypto, o as autoMigrateLegacyMatrixState, r as resolveMatrixMigrationStatus } from "./matrix-migration.runtime-BqFPOwTJ.js";
import { t as maybeCreateMatrixMigrationSnapshot } from "./migration-snapshot-backup-OIB7RnX1.js";
import { n as resolveMatrixInboundConversation } from "./thread-binding-api--VALh4h4.js";
...
const matrixMessageActions = {
	...
	handleAction: async (ctx) => {
		const { handleMatrixAction } = await import("./tool-actions.runtime-BAKThKY2.js");
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-BToBrbis.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixChannelRuntime$1 = createLazyRuntimeNamedExport(() => import("./resolver.runtime-DN9HYv5_.js"), "matrixResolverRuntime");
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-CR3YHjy4.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-CQVAyVnD.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixDoctor = {
	...
	runConfigSequence: async ({ cfg, env, shouldRepair }) => await (await import("./doctor-xkEhsEq9.js")).runMatrixDoctorSequence({
		cfg,
		env,
		shouldRepair
	}),
	cleanStaleConfig: async ({ cfg }) => await (await import("./doctor-xkEhsEq9.js")).cleanStaleMatrixPluginConfig(cfg)
};
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-CpsG2Zoh.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
