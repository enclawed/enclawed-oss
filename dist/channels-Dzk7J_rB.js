...
import { i as loadAuthProfileStore } from "./store-DxE5HEh1.js";
import "./plugins-DlBOVsJe.js";
import "./logging-BIHkOBbx.js";
import { c as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-CwRVJANb.js";
...
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-icsK1N4v.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-N8CZo8-E.js";
import { n as withProgress } from "./progress-CDY9v3hd.js";
import { t as createClackPrompter } from "./clack-prompter-7FBHiOy4.js";
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-gSVoZfus.js";
import { n as formatUsageReportLines, t as loadProviderUsageSummary } from "./provider-usage-DZfTUOwK.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-BkdIwyjy.js";
import { n as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-AIsmz71u.js";
import { t as parseLogLine } from "./parse-log-line-z5aX-fy5.js";
import { r as describeBinding, t as applyAgentBindings } from "./agents.bindings-VrgtezGE.js";
import { n as requireValidConfigSnapshot, t as requireValidConfigFileSnapshot } from "./config-validation-BUjwIImB.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-KgedkU-B.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-ZjFPCBbi.js";
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	const { listChannelPluginCatalogEntries } = await import("./catalog-mNU4a_WM.js");
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-VkYxT2r9.js"), import("./onboard-channels-BIq6KAj7.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-Z6drg7aW.js");
	...
	if (!channel && catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-DdVc0jxQ.js");
		if (!isCatalogChannelInstalled({
			cfg: nextConfig,
			entry: catalogEntry,
			workspaceDir
		})) {
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-Z6drg7aW.js");
			const prompter = createClackPrompter();
	...
	if (afterAccountConfigWritten) {
		const { runCollectedChannelOnboardingPostWriteHooks } = await import("./onboard-channels-BIq6KAj7.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = !useWizard && rawChannel && (!channel || !getChannelPlugin(channel)) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-BcA5WawY.js");
