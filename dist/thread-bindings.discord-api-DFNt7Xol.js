...
import { t as SYSTEM_MARK } from "./system-message-D2Q3YloJ.js";
import "./runtime-env-B5KyN2vw.js";
import "./conversation-runtime-CmgvpfjG.js";
import { Y as createChannelWebhook, st as getChannel } from "./discord-BHTBWkOx.js";
...
import { c as createThreadDiscord, s as sendWebhookMessageDiscord } from "./send-CEL1xMBe.js";
import { t as sendMessageDiscord } from "./send.outbound-DlKnHQCB.js";
import { i as REUSABLE_WEBHOOKS_BY_ACCOUNT_CHANNEL, k as toReusableWebhookKey, m as rememberReusableWebhook, t as BINDINGS_BY_THREAD_ID } from "./thread-bindings.state-gyBKCNYE.js";
...
async function createWebhookForChannel(params) {
	try {
		...
		const created = await createChannelWebhook(rest, params.channelId, { body: { name: "Enclawed Agents" } });
