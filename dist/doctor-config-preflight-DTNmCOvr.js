...
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-DOM5eiKZ.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-DdgGNOLa.js");
