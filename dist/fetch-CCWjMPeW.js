...
import { n as isWSL2Sync } from "./wsl-B2FYKJDu.js";
import { f as resolveEffectiveDebugProxyUrl, t as captureHttpExchange } from "./runtime-DbNBFyCA.js";
import { n as hasEnvHttpProxyAgentConfigured, o as resolveEnvHttpProxyAgentOptions } from "./proxy-env-C6YBem4U.js";
import { o as createPinnedLookup } from "./ssrf-DQDx1s1G.js";
import { n as getProxyUrlFromFetch, r as makeProxyFetch } from "./proxy-fetch-D3Mzuk-U.js";
...
import { t as resolveFetch } from "./fetch-C6H-2Bpf.js";
...
const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV = "ENCLAWED_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "ENCLAWED_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
const TELEGRAM_DNS_RESULT_ORDER_ENV = "ENCLAWED_TELEGRAM_DNS_RESULT_ORDER";
let wsl2SyncCache;
...
function resolveTelegramAutoSelectFamilyDecision(params) {
	...
	if (isTruthyEnvValue(env["ENCLAWED_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY"])) return {
		value: true,
		source: `env:${TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV}`
	};
	if (isTruthyEnvValue(env["ENCLAWED_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY"])) return {
		value: false,
...
function resolveEnclawedProxyUrlForTelegram(env = process.env) {
...
function resolveTelegramTransport(proxyFetch, options) {
	...
	const managedProxyUrl = !effectiveProxyFetch && !hasEnvProxy ? resolveEnclawedProxyUrlForTelegram() : void 0;
