...
import { v as shortenHomeInString, y as shortenHomePath } from "./utils-BcQ7uNrT.js";
...
import { V as resolveMemoryRemDreamingConfig } from "./dreaming-CUK7e7lT.js";
...
import { n as withProgress, r as withProgressTotals } from "./progress-DZ7JU7SC.js";
import { r as withManager } from "./cli-utils-C-5n8CQ2.js";
import { c as listMemoryFiles, l as normalizeExtraMemoryPaths } from "./internal-eXimu566.js";
import "./memory-core-host-status-r59IOCJR.js";
import "./memory-core-host-runtime-cli-BHhRVyOM.js";
import "./memory-core-host-runtime-core-DT0H1zK9.js";
import "./memory-core-host-runtime-files-B2v8COgb.js";
import { a as readShortTermRecallEntries, c as recordShortTermRecalls, d as resolveShortTermRecallLockPath, f as resolveShortTermRecallStorePath, i as rankShortTermPromotionCandidates, l as removeGroundedShortTermCandidates, n as applyShortTermPromotions, r as auditShortTermPromotionArtifacts, s as recordGroundedShortTermCandidates, u as repairShortTermPromotionArtifacts } from "./short-term-promotion-BSJ-MOj3.js";
import "./dreaming-shared-ClG8Ai8P.js";
import { i as seedHistoricalDailyMemorySignals, n as resolveShortTermPromotionDreamingConfig, r as previewRemDreaming } from "./dreaming-BzK8yMTP.js";
import { i as writeBackfillDiaryEntries, r as removeBackfillDiaryEntries } from "./dreaming-narrative-D6NYu42q.js";
import { n as getMemorySearchManager } from "./memory-SyyZlXwP.js";
import { t as previewGroundedRemMarkdown } from "./rem-evidence-BTH8GqKv.js";
import { n as repairDreamingArtifacts, t as auditDreamingArtifacts } from "./dreaming-repair-D_nM7sxW.js";
...
async function createHistoricalRemHarnessWorkspace(params) {
	...
	const workspaceDir = await fs$1.mkdtemp(path.join(resolvePreferredEnclawedTmpDir(), "enclawed-rem-harness-"));
...
async function runMemoryStatus(opts) {
	...
	for (const result of allResults) {
		...
		if (audit?.issues.length) {
			...
			if (!opts.fix) lines.push(`  ${muted(`Fix: enclawed memory status --fix --agent ${agentId}`)}`);
		}
...
async function runMemoryRemBackfill(opts) {
	...
	await withMemoryManagerForAgent({
		...
		run: async (manager) => {
			...
			const scratchDir = await fs$1.mkdtemp(path.join(resolvePreferredEnclawedTmpDir(), "enclawed-rem-backfill-"));
			try {
