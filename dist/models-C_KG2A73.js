...
import { i as getRuntimeConfig, p as readSourceConfigSnapshotForWrite, r as createConfigIO } from "./io-CXz21W7w.js";
...
import { o as shouldEnableShellEnvFallback, t as getShellEnvAppliedKeys } from "./shell-env-BtkruzZd.js";
...
import { S as resolveDefaultAgentId, b as resolveAgentDir, i as resolveAgentExplicitModelPrimary, s as resolveAgentModelFallbacksOverride, x as resolveAgentWorkspaceDir } from "./agent-scope-n27Qvudk.js";
import { t as parseDurationMs } from "./parse-duration-BlGD04_4.js";
import "./config-D3uukyZR.js";
import { c as resolveAuthStatePathForDisplay, u as resolveAuthStorePathForDisplay } from "./source-check-DLSm69AH.js";
import { a as loadAuthProfileStoreForRuntime, n as ensureAuthProfileStore } from "./store-DMcipGx3.js";
...
import { _ as resolveProviderEnvApiKeyCandidates, u as isNonSecretApiKeyMarker } from "./model-auth-markers-BlOgnMrs.js";
import { f as modelKey, m as parseModelRef, t as isCliProvider } from "./model-selection-cli-BC0OF3q6.js";
import { t as modelKey$1 } from "./model-ref-shared-BVYR9WKg.js";
import { d as resolveConfiguredModelRef, f as resolveDefaultModelForAgent, i as buildModelAliasIndex, m as resolveModelRefFromString } from "./model-selection-CRPDotcW.js";
...
import { t as resolveAuthProfileDisplayLabel } from "./auth-profiles-A-k-drnz.js";
import { a as setAuthProfileOrder, n as listProfilesForProvider, o as upsertAuthProfile } from "./profiles-DyPWHaU8.js";
import { d as resolveProfileUnusableUntilForDisplay, i as clearAuthProfileCooldown } from "./order-CkRYvBja.js";
import { i as getCustomProviderApiKey, l as resolveUsableCustomProviderApiKey, o as hasUsableCustomProviderApiKey, s as resolveApiKeyForProvider } from "./model-auth-C20TpuWJ.js";
import "./command-secret-gateway-Bc23JeZV.js";
import { r as getModelsCommandSecretTargetIds } from "./command-secret-targets-AiCLh2A8.js";
import { n as shouldSuppressBuiltInModel } from "./model-suppression-BtLG7H0X.js";
import { r as resolveModelWithRegistry } from "./model-C7zvosT-.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-DgfPLz6z.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-BH0Zyuwu.js";
import { r as withProgressTotals } from "./progress-Bnz7HAqX.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-CmnB9id7.js";
import { t as createClackPrompter } from "./clack-prompter-CEq8K4xW.js";
import { n as logConfigUpdated } from "./logging-CeUbXqw6.js";
import { t as normalizeAlias } from "./alias-name-BIi1uP8h.js";
import { a as loadValidConfigOrThrow, c as resolveModelKeysFromEntries, d as upsertCanonicalModelConfigEntry, f as isLocalBaseUrl, i as formatTokenK, l as resolveModelTarget, n as ensureFlagCompatibility, o as mergePrimaryFallbackConfig, r as formatMs, s as resolveKnownAgentId, t as applyDefaultModelPrimaryUpdate, u as updateConfig } from "./shared-COfGXvY-.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-C5MV7yLo.js";
import { t as maskApiKey } from "./mask-api-key-zAKlmDn8.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-DETi_iss.js";
import { t as isRemoteEnvironment } from "./remote-env-DcfFQc7e.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow--mwMbPbw.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-HRpyA68v.js";
import "./list.runtime-CWv5kuuV.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-S6TW8FRO.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-0oJKb3qA.js");
				await openUrl(url);
			},
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore, ensureEnclawedModelsJson } = await import("./list.runtime-Dl5JRoAg.js");
...
function loadProviderUsageRuntime() {
	providerUsageRuntimePromise ??= import("./provider-usage-BmQTzq-e.js");
...
async function modelsStatusCommand(opts, runtime) {
	...
	let probeSummary;
	if (opts.probe) {
		const [{ withProgressTotals }, { runAuthProbes }] = await Promise.all([import("./progress-BePQsLk4.js"), import("./list.probe-DFjSVywk.js")]);
	...
	if (missingProvidersInUse.length > 0) {
		const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-Bphr2PEl.js");
		runtime.log("");
	...
	if (probeSummary) {
		const [{ getTerminalTableWidth, renderTable }, { describeProbeSummary, formatProbeLatency, sortProbeResults }] = await Promise.all([import("./table-C4DIkmLG.js"), import("./list.probe-DFjSVywk.js")]);
		runtime.log("");
