import { i as normalizeLegacyChannelAliases, t as asObjectRecord } from "./runtime-doctor-nqJvDwbH.js";
...
const legacyConfigRules = [
	{
		...
		message: "channels.discord.voice.tts.<provider> keys (openai/elevenlabs/microsoft/edge) are legacy; use channels.discord.voice.tts.providers.<provider>. Run \"enclawed doctor --fix\".",
	...
	},
	{
		...
		message: "channels.discord.accounts.<id>.voice.tts.<provider> keys (openai/elevenlabs/microsoft/edge) are legacy; use channels.discord.accounts.<id>.voice.tts.providers.<provider>. Run \"enclawed doctor --fix\".",
