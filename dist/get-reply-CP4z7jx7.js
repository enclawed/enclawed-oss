...
import { i as normalizeChannelId, r as listChannelPlugins, t as getChannelPlugin } from "./registry-DMBHPRsB.js";
...
import { d as resetRegisteredAgentHarnessSessions } from "./registry-CfvjI940.js";
...
import { S as resolveGroupSessionKey, f as resolveMaintenanceConfigFromInput, h as resolveSessionStoreEntry, o as updateSessionStore, v as deriveSessionMetaPatch } from "./store-CJURmbu1.js";
...
import { n as resolveSessionKey } from "./session-key-D-jWAL0J.js";
...
import { a as resolveAndPersistSessionFile } from "./transcript-CvYC9_pK.js";
...
import { r as disposeSessionMcpRuntime } from "./pi-bundle-mcp-tools-aP3ZebGK.js";
...
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, p as fireAndForgetHook, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-BaJinTSo.js";
...
import { t as resolveQueueSettings } from "./queue-CMMblsxY.js";
...
import { r as normalizeCommandBody } from "./commands-registry-normalize-BJb1sP1K.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-6rz3ruWW.js";
import { t as hasControlCommand } from "./command-detection-CRup7r9Q.js";
import "./commands-registry-Fu-L616i.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-s3gOWN3j.js";
import { t as resolveRunTypingPolicy } from "./typing-policy-Ce4-Rrnb.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-Ce_yYk_9.js";
import { t as finalizeInboundContext } from "./inbound-context-DjKXVLCX.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-DwJPPFkz.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-DOIBvmLZ.js";
import { t as resolveChannelModelOverride } from "./model-overrides-B4cC1lhi.js";
import { t as normalizeGroupActivation } from "./group-activation-iBBwSTJB.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-C7tIelCB.js";
import { t as resolveFastModeState } from "./fast-mode-GiI7UlqZ.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-cXxxfVUH.js";
import { t as resolveCommandAuthorization } from "./command-auth-CKx_ptD_.js";
import { t as buildCommandContext } from "./commands-context-B1pCpB44.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-MhCRc6uq.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-rEq5ECHx.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-CvElY4rb.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-CPTMDX_f.js";
import { t as resolveStoredModelOverride } from "./stored-model-override-C7U3-jXQ.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-QxD5ijMh.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-D2gLD6Ik.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-BHlK_Hhe.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-B8XTJi_L.js";
import { n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-CGEKVczQ.js";
...
import { t as drainFormattedSystemEvents } from "./session-system-events-CKtVqiPi.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-CIMiGj_E.js";
import { n as buildSessionStartHookPayload, t as buildSessionEndHookPayload } from "./session-hooks-CbZ-sWdK.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-jKAmBfDe.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-2JaK2KUg.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-0Dy8nVZy.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-BsEFUSyu.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-NJX02itD.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-BYAgjoDH.js");
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-xiyt_Aik.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-rUTmaqtR.js");
...
async function handleInlineActions(params) {
	...
	const skillCommands = shouldLoadSkillCommands && params.skillCommands ? params.skillCommands : shouldLoadSkillCommands ? (await import("./skill-commands.runtime-rUTmaqtR.js")).listSkillCommandsForWorkspace({
		workspaceDir,
		cfg,
		agentId,
		skillFilter
	...
	if (skillInvocation) {
		...
		if (dispatch?.kind === "tool") {
			...
			const { createEnclawedTools } = await import("./enclawed-tools.runtime-DUDLYdGM.js");
	...
	if (!isStopLikeInbound && targetSessionEntry) {
		...
		if (cutoff) await (await import("./abort-cutoff.runtime-B0dYh29i.js")).clearAbortCutoffInSessionRuntime({
			sessionEntry: targetSessionEntry,
			sessionStore,
			sessionKey,
			storePath
	...
	if (handleInlineStatus) {
		const { buildStatusReply } = await import("./commands.runtime-BVHQqeci.js");
	...
	const runCommands = async (commandInput) => {
		const { handleCommands } = await import("./commands.runtime-BVHQqeci.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-DBcs034g.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-D_R-Atj7.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-B9IiKPFf.js");
	return agentRunnerRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-DcpBro6f.js");
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-CuDXqfBD.js");
...
async function forkSessionFromParent(params) {
	return (await import("./session-fork.runtime-NWX8GUIe.js")).forkSessionFromParentRuntime(params);
}
//#endregion
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime-CF_EZBVY.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-BLSppK9j.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-D3qLbUDA.js");
...
function loadOriginRouting() {
	originRoutingPromise ??= import("./origin-routing-C-dv25Qn.js");
...
async function applyMediaUnderstandingIfNeeded(params) {
	...
	const { applyMediaUnderstanding } = await import("./apply.runtime-CvWdCliU.js");
	await applyMediaUnderstanding(params);
	return true;
}
async function applyLinkUnderstandingIfNeeded(params) {
	if (!hasLinkCandidate(params.ctx)) return false;
	const { applyLinkUnderstanding } = await import("./apply.runtime-do9tpaxb.js");
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	const maybeEmitMissingResetHooks = async () => {
		...
		const { emitResetCommandHooks } = await import("./commands-core.runtime-B6H3iWP7.js");
