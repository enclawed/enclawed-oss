...
import { i as resolveMatrixAccount } from "./accounts-BVN2WxrR.js";
...
import { t as updateMatrixAccountConfig } from "./config-update-CGXNOFyk.js";
import { n as matrixSetupAdapter } from "./setup-core-Dvt0YfhF.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-DPO5XU9A.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-DJAtpcbF.js";
import { t as withResolvedActionClient } from "./client-Dckt1P9R.js";
import { r as resolveMatrixAuthContext } from "./config-CpX35Zzt.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-DBridVO1.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-DNIGAqz2.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-ByDSYsXE.js");
