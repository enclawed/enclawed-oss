...
import { a as coerceTransportToolCallArguments, c as failTransportStream, f as sanitizeTransportPayloadText, l as finalizeTransportStream, m as buildGuardedModelFetch, o as createEmptyTransportUsage, p as transformTransportMessages, s as createWritableTransportEventStream, u as mergeTransportHeaders } from "./openai-transport-stream-CxpYV6p1.js";
import { d as isGoogleGemini3FlashModel, f as isGoogleGemini3ProModel, g as resolveGoogleGemini3ThinkingLevel, u as isGoogleGemini25ThinkingBudgetModel, v as stripInvalidGoogleThinkingBudget, y as stripNullHeaderValues } from "./provider-stream-shared-emBXIITC.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-ChD2IjV1.js";
import { g as createProviderHttpError } from "./shared-B9jviejS.js";
import "./provider-http-UY3EBR2N.js";
import "./text-runtime-Co0Dyh7P.js";
import "./provider-transport-runtime-BTxSzW2Q.js";
import "./thinking-api-MGhQz3KZ.js";
import { r as normalizeGoogleApiBaseUrl } from "./provider-policy-CrtnO9TN.js";
import { t as parseGeminiAuth } from "./gemini-auth-DEQ1Tasd.js";
import { i as resolveGoogleVertexAuthorizedUserHeaders, n as isGoogleVertexCredentialsMarker } from "./vertex-adc-Bt1AzsGI.js";
...
function buildGoogleHeaders(model, apiKey, optionHeaders) {
	...
	}, authHeaders, model.headers, optionHeaders) ?? {
		"Content-Type": "application/json",
		accept: "text/event-stream"
	};
}
async function buildGoogleVertexHeaders(model, apiKey, optionHeaders, fetchImpl) {
	const authHeaders = isGoogleVertexCredentialsMarker(apiKey) ? await resolveGoogleVertexAuthorizedUserHeaders(fetchImpl) : { "x-goog-api-key": apiKey };
	return mergeTransportHeaders({
		"Content-Type": "application/json",
		accept: "text/event-stream"
	}, authHeaders, model.headers, optionHeaders) ?? {
			...
			try {
				...
				const response = await guardedFetch(buildGoogleTransportRequestUrl(kind, model, options), {
					...
					headers: await buildGoogleTransportHeaders({
						...
						model,
						apiKey,
						optionHeaders: stripNullHeaderValues(options?.headers),
