...
import { n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-DkhpVqWx.js";
...
import { r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-Bg1zeJL9.js";
import { i as isDiscordExecApprovalClientEnabled, n as getDiscordExecApprovalApprovers, r as isDiscordExecApprovalApprover, t as shouldHandleDiscordApprovalRequest } from "./approval-shared-3MH5H9P5.js";
...
function createDiscordApprovalCapability(configOverride) {
	return createApproverRestrictedNativeApprovalCapability({
		...
		nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
			...
			load: async () => (await import("./approval-handler.runtime-sYTEcONI.js")).discordApprovalNativeRuntime
		})
	});
}
