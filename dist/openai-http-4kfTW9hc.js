...
import { a as normalizeUsage, o as toOpenAiChatCompletionsUsage } from "./usage-BAoTEYmL.js";
import { n as estimateBase64DecodedBytes } from "./base64-Ck-PZtY7.js";
import { i as emitAgentEvent, l as onAgentEvent } from "./agent-events-BfuQdc-z.js";
...
import { C as watchClientDisconnect, S as setSseHeaders, c as resolveGatewayRequestContext, d as resolveOpenAiCompatibleHttpOperatorScopes, f as resolveOpenAiCompatibleHttpSenderIsOwner, u as resolveOpenAiCompatModelOverride, w as writeDone, y as sendJson } from "./http-utils-BSyHU5k1.js";
import { a as extractImageContentFromSource, n as DEFAULT_INPUT_IMAGE_MIMES, o as normalizeMimeList, r as DEFAULT_INPUT_TIMEOUT_MS, t as DEFAULT_INPUT_IMAGE_MAX_BYTES } from "./input-files-Bvc4Jn-Z.js";
import { t as handleGatewayPostJsonEndpoint } from "./http-endpoint-helpers-CWEUxr3n.js";
import { n as buildAgentMessageFromConversationEntries, r as resolveAssistantStreamDeltaText, t as normalizeInputHostnameAllowlist } from "./input-allowlist-MklTs1-8.js";
...
function resolveAgentResponseText(result) {
	...
	if (!Array.isArray(payloads) || payloads.length === 0) return "No response from Enclawed.";
