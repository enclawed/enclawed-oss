...
import { n as isRich } from "./theme-BVnTyzuE.js";
import { n as info } from "./globals-D8R_YQwt.js";
...
import { a as resolvePreferredAccountId, t as buildChannelAccountBindings } from "./bindings-4tFW5stN.js";
...
import { t as formatHealthChannelLines } from "./health-format-CSVuh8MT.js";
import { t as styleHealthChannelLine } from "./health-style-pAC3jJQm.js";
import { t as logGatewayConnectionDetails } from "./status.gateway-connection-Dvc7STFU.js";
...
const buildSessionSummary = async (storePath) => {
	const { loadSessionStore } = await import("./store-Cy-Fd4aF.js");
...
async function readBestEffortHealthConfig() {
	const { readBestEffortConfig } = await import("./config-CV5Z1jsi.js");
