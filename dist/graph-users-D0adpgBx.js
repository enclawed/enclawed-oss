...
import { l as isRecord$1 } from "./utils-BcQ7uNrT.js";
import { a as hasConfiguredSecretInput, c as normalizeResolvedSecretInputString, l as normalizeSecretInputString } from "./types.secrets-B-g1z55T.js";
import { u as isPrivateIpAddress } from "./ssrf-DQDx1s1G.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-LpiuL2Me.js";
import "./text-runtime-CAI4yT_W.js";
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, l as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-CRYhPVuv.js";
import "./ssrf-runtime-9LvoQ5Lf.js";
import "./secret-input-CLk7ofM4.js";
import { t as getMSTeamsRuntime } from "./runtime-api-Blpzrvqd.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-D4iXjhWI.js";
...
function resolveEnclawedVersion() {
	try {
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-CZ4UeI1j.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-2j98RZGg.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-CMJRxC7W.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-BjD9u6D8.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
