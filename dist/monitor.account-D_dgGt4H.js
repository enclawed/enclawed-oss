...
import { g as sendMediaWithLeadingCaption, h as resolveTextChunksWithFallback, m as resolveSendableOutboundReplyParts } from "./reply-payload-Dibp0yeY.js";
...
import { c as resolveOpenDmAllowlistAccess } from "./dm-policy-shared-Dt-WdgFq.js";
import "./reply-history-BwfgMhEX.js";
import { t as createReplyPrefixContext } from "./reply-prefix-DxGFQnOx.js";
...
import { t as buildAgentMediaPayload } from "./agent-media-payload-BnMv5vy9.js";
...
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-DFkdbHeY.js";
import "./conversation-runtime-DjOH5oQ8.js";
import "./security-runtime-CbsrjaQi.js";
import "./command-primitives-runtime-B9YZ7ySO.js";
import { r as logTypingFailure } from "./logging-DqRM89Fs.js";
import "./channel-feedback-CPult3sd.js";
import { n as createChannelPairingController } from "./channel-pairing-zOJ_Klee.js";
import { n as createPersistentDedupe } from "./persistent-dedupe-C8av-Zf3.js";
import { c as readWebhookBodyOrReject, r as applyBasicWebhookRequestGuards } from "./webhook-request-guards-BYfyt29F.js";
import "./webhook-ingress-BF2faJ_O.js";
import { t as buildFeishuConversationId } from "./conversation-id-BwrY2rRU.js";
import { i as resolveReceiveIdType } from "./targets-DM3rQm9y.js";
import { n as createFeishuThreadBindingManager } from "./thread-bindings-DT3YC44B.js";
import { _ as buildFeishuCommentTarget, d as extractReplyText, g as readString$2, h as parseCommentContentElements, l as resolveFeishuRuntimeAccount, m as normalizeString, p as isRecord$2, u as encodeQuery, v as normalizeCommentFileType } from "./accounts-CSS0irPO.js";
import { i as decodeFeishuCardAction, n as buildFeishuCardActionTextFallback, r as createFeishuCardInteractionEnvelope } from "./card-interaction-DpJHpZ9X.js";
import { i as resolveFeishuGroupConfig, n as isFeishuGroupAllowed, o as resolveFeishuReplyPolicy, r as resolveFeishuAllowlistMatch, t as hasExplicitFeishuGroupConfig } from "./policy-BSRzVIir.js";
import { t as getFeishuRuntime } from "./runtime-CK2I9cCX.js";
import { a as createEventDispatcher, c as getFeishuUserAgent, o as createFeishuClient, s as createFeishuWSClient } from "./client-CCrFxFUg.js";
import { c as getChatInfo, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-DLAatMMm.js";
import "./runtime-api-TJv_jP8I.js";
import { _ as normalizeFeishuExternalKey, a as sendCardFeishu, c as sendStructuredCardFeishu, d as extractMentionTargets, f as isFeishuBroadcastMention, g as sendMediaFeishu, h as downloadMessageResourceFeishu, i as resolveFeishuCardTemplate, l as parsePostContent, m as isFeishuGroupChatType, n as getMessageFeishu, p as isMentionForwardRequest, r as listFeishuThreadMessages, s as sendMessageFeishu, u as buildMentionedCardContent } from "./send-CZvo47ux.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-DsiNOFJn.js";
import { a as feishuWebhookRateLimiter, c as wsClients, i as botOpenIds, l as fetchBotIdentityForMonitor, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as httpServers, r as botNames, s as recordWebhookStatus, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS } from "./monitor.state-Bdg6tJdS.js";
...
function resolveStateDirFromEnv(env = process.env) {
	...
	if (env.VITEST || env.NODE_ENV === "test") return path.join(os.tmpdir(), ["enclawed-vitest", String(process.pid)].join("-"));
...
async function resolveFeishuAudioPreflightTranscript(params) {
	...
	try {
		const { transcribeFirstAudio } = await import("./audio-preflight.runtime-rzDC5ngi.js");
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-emgtZyu4.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-emgtZyu4.js");
