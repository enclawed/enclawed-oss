...
import { i as logMessageQueued, o as logSessionStateChange } from "./diagnostic-L0RPMr_9.js";
//#region src/auto-reply/reply/reply-run-registry.ts
const replyRunState = resolveGlobalSingleton(Symbol.for("enclawed.replyRunRegistry"), () => ({
...
const embeddedRunState = resolveGlobalSingleton(Symbol.for("enclawed.embeddedRunState"), () => ({
...
function queueEmbeddedPiMessage(sessionId, text, options) {
	...
	handle.queueMessage(text, options);
	return true;
}
