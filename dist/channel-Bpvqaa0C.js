...
import { u as getExecApprovalReplyMetadata } from "./exec-approval-reply-CrNco8sW.js";
import { r as createChannelApprovalCapability } from "./approval-delivery-helpers--RJu1ACo.js";
...
import "./approval-runtime-BDLe4WP_.js";
import { t as asOptionalObjectRecord } from "./string-normalize-Blt_o5di.js";
import { l as ensurePlatformAdapter, u as getBridgeLogger } from "./resolve-CzoIbKW1.js";
import { a as resolveApprovalTarget } from "./approval-CXm3tYWR.js";
import { a as resolveQQBotAccount, n as applyQQBotAccountConfig, t as DEFAULT_ACCOUNT_ID$1 } from "./config-391HlYK_.js";
import { a as resolveQQBotExecApprovalConfig, i as matchesQQBotApprovalAccount, n as isQQBotExecApprovalAuthorizedSender, o as shouldHandleQQBotExecApprovalRequest, r as isQQBotExecApprovalClientEnabled, t as isQQBotExecApprovalApprover } from "./exec-approvals-hKZt-Spw.js";
import { a as qqbotSetupAdapterShared, i as qqbotMeta, n as qqbotSetupWizard, r as qqbotConfigAdapter, t as qqbotChannelConfigSchema } from "./config-schema-Cark3TYD.js";
import { n as writeEnclawedConfigThroughRuntime, t as toGatewayAccount } from "./narrowing-BCE7TUL3.js";
import { t as getQQBotRuntime } from "./runtime-BrZTE2nZ.js";
import { l as getQQBotDataPath, n as normalizeTarget, t as looksLikeQQBotTarget } from "./target-parser-DLnL6VYB.js";
	...
	return createChannelApprovalCapability({
		...
		nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
			...
			load: async () => {
				...
				return (await import("./handler-runtime-DyLDTfkZ.js")).qqbotApprovalNativeRuntime;
			}
		})
	});
}
...
function loadGatewayModule() {
	_gatewayModulePromise ??= import("./gateway-C0rV8vh7.js");
...
const qqbotPlugin = {
	...
	outbound: {
		...
		sendText: async ({ to, text, accountId, replyToId, cfg }) => {
			...
			const { sendText } = await import("./outbound-WJWBbY8H.js");
		...
		sendMedia: async ({ to, text, mediaUrl, accountId, replyToId, cfg }) => {
			await loadGatewayModule();
			const account = resolveQQBotAccount(cfg, accountId);
			const { sendMedia } = await import("./outbound-WJWBbY8H.js");
