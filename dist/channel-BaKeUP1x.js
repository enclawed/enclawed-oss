...
import { i as createActionGate } from "./common-mDzRl__P.js";
import { c as normalizeMessagePresentation, u as renderMessagePresentationFallbackText } from "./payload-DpdJDMrC.js";
import { a as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-D7nTNM6O.js";
...
import { T as projectConfigAccountIdWarningCollector, h as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-DfIhxgaQ.js";
...
import { i as createChatChannelPlugin, l as stripChannelTargetPrefix, t as buildChannelOutboundSessionRoute } from "./core-CoB1mdbz.js";
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-A7VVNxLn.js";
...
import { d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-DAIUgpkS.js";
import "./channel-status-CDe2FHZk.js";
import { t as zod_exports } from "./zod-BG12Rihk.js";
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-C-6eO8b8.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-BkOuOMnC.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, n as inspectFeishuCredentials, p as isRecord, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-BD6ZGK7S.js";
import "./card-interaction-qYF_RPhE.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-CPN08th6.js";
import { t as messageActionTargetAliases } from "./security-audit-at4g-57a.js";
import { a as resolveFeishuGroupToolPolicy } from "./policy-BoiE88FE.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-S2lWL-Ig.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-DxC8bZF7.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-B-XxoYZz.js";
...
async function runScanToCreate(prompter) {
	const { beginAppRegistration, initAppRegistration, pollAppRegistration, printQrCode } = await import("./app-registration-DBrC8Jd5.js");
	try {
...
async function runNewAppFlow(params) {
	...
	if (scanResult) {
		...
		if (appId && appSecretProbeValue) {
			const { getAppOwnerOpenId } = await import("./app-registration-DBrC8Jd5.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, configured }) => {
			...
			if (configured && resolvedCredentials) try {
				const { probeFeishu } = await import("./probe-sWTWvetR.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-BKf5lEKL.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-CWx3lpU0.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-C3SQmVaK.js");
