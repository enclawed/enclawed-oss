...
import { R as isBunRuntime, z as isNodeRuntime } from "./logger-wuQoU2z2.js";
import { l as getMinimalServicePathPartsFromEnv, n as isVersionManagedNodePath, o as resolveSystemNodePath, t as isSystemNodePath } from "./runtime-paths-C0Np3ULF.js";
import { l as resolveLaunchAgentPlistPath } from "./launchd-rGW6yyft.js";
import { s as resolveSystemdUserUnitPath } from "./systemd-CtC8UVM8.js";
...
function auditGatewayToken(command, issues, expectedGatewayToken) {
	...
	issues.push({
		...
		message: "Gateway service ENCLAWED_GATEWAY_TOKEN does not match gateway.auth.token in enclawed.json",
...
function readEmbeddedGatewayToken(command) {
	if (!command) return;
	if (command.environmentValueSources?.ENCLAWED_GATEWAY_TOKEN === "file") return;
