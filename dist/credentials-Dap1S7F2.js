import { a as trimToUndefined, i as trimCredentialToUndefined, t as createGatewayCredentialPlan } from "./credential-planner-BQSKxqU1.js";
...
function resolveGatewayCredentialsFromConfig(params) {
	...
	const localTokenPrecedence = params.localTokenPrecedence ?? (env.ENCLAWED_SERVICE_KIND === "gateway" ? "config-first" : "env-first");
