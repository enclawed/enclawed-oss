...
const LEGACY_CODEX_PLUGIN_SESSION_PREFIXES = ["enclawed-app-server:thread:", "enclawed-codex-app-server:thread:"];
const pendingRequests = resolveGlobalMap(Symbol.for("enclawed.pluginBindingPendingRequests"));
const pluginBindingGlobalState = resolveGlobalSingleton(Symbol.for("enclawed.plugins.binding.global-state"), () => ({
