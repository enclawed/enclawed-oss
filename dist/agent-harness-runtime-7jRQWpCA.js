...
import { F as resolveProviderSystemPromptContribution } from "./provider-runtime-BdkzPi5k.js";
import "./agent-paths-CK1LyoiU.js";
import "./session-write-lock-B7HIVMq0.js";
import { f as normalizeEmbeddedAgentRuntime } from "./attempt.tool-run-context-rTzTxjAc.js";
...
import { o as logProviderToolSchemaDiagnostics, s as normalizeProviderToolSchemas } from "./attempt.thread-helpers-B4dsr4pQ.js";
...
import { d as runContextEngineMaintenance, n as buildAfterTurnRuntimeContextFromUsage, t as buildAfterTurnRuntimeContext } from "./attempt.prompt-helpers-itItKiiC.js";
import { t as callGatewayTool } from "./gateway-D2dPhCzX.js";
import { i as runBeforeToolCallHook, n as consumeAdjustedParamsForToolCall } from "./pi-tools.before-tool-call-D5dNRogZ.js";
...
import { r as resolveTranscriptPolicy } from "./compaction-runtime-context-D3LUIz3I.js";
import { i as resolvePreparedExtraParams } from "./extra-params-BjcAH8CQ.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolveHandlers = async () => {
		...
		resolvedHandlersPromise ??= import("./agent-tool-result-middleware-loader-BIcx-Ga-.js").then(({ loadAgentToolResultMiddlewaresForRuntime }) => loadAgentToolResultMiddlewaresForRuntime({ runtime: ctx.runtime }));
