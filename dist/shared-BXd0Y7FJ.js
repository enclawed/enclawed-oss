...
import { i as resolveDaemonContainerContext, n as buildPlatformServiceStartHints, t as buildPlatformRuntimeLogHints } from "./runtime-hints-BvufIW02.js";
...
function classifyDaemonHintText(text) {
	if (text.includes("enclawed gateway install") || text.startsWith("Service not installed. Run:")) return "install";
