...
import { d as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-CRYhPVuv.js";
...
import { a as resolveMatrixStoragePaths, n as maybeMigrateLegacyStorage, o as writeStorageMeta } from "./storage-TBLxfsNO.js";
import "./config-CpX35Zzt.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-DsFmm9qF.js"), import("./logging-9YvV8aZp.js")]).then(([sdkModule, loggingModule]) => ({
...
async function createMatrixClient(params) {
	...
	const cryptoDatabasePrefix = storagePaths ? `enclawed-matrix-${storagePaths.accountKey}-${storagePaths.tokenHash}` : void 0;
