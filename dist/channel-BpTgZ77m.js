...
import { c as createScopedChannelConfigAdapter, m as formatTrimmedAllowFromEntries, t as adaptScopedAccountAccessor } from "./channel-config-helpers-bOV5DWOp.js";
...
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, u as createComputedAccountStatusAdapter } from "./status-helpers-Z5fKx70K.js";
import { a as listIMessageAccountIds, n as resolveIMessageAttachmentRoots, o as resolveDefaultIMessageAccountId, r as resolveIMessageRemoteAttachmentRoots, s as resolveIMessageAccount } from "./media-contract-C1OPC3sF.js";
import { c as looksLikeIMessageExplicitTargetId, d as parseIMessageTarget, i as resolveIMessageConversationIdFromTarget, l as normalizeIMessageHandle, n as matchIMessageAcpConversation, o as inferIMessageTargetChatType, p as normalizeIMessageMessagingTarget, r as normalizeIMessageAcpConversationId } from "./conversation-id-DHZ6zbUk.js";
import { n as createIMessageConversationBindingManager } from "./conversation-bindings-cEvFGEK6.js";
import { n as resolveIMessageGroupToolPolicy, t as resolveIMessageGroupRequireMention } from "./group-policy-C7bBjP7I.js";
import { a as imessageSetupAdapter, n as createIMessageSetupWizardProxy } from "./setup-core-Ch41FZoo.js";
import { t as IMessageChannelConfigSchema } from "./config-schema-COUCGNys.js";
//#region extensions/imessage/src/shared.ts
const IMESSAGE_CHANNEL = "imessage";
async function loadIMessageChannelRuntime$1() {
	return await import("./channel.runtime-Bij8J7V0.js");
}
...
const loadIMessageChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-Bij8J7V0.js"));
