...
import { o as isSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-BpVPfGSB.js";
import { l as resolveDefaultSecretProviderAlias } from "./ref-contract-CXDupHS0.js";
import { a as findTailscaleBinary } from "./tailscale-B5lOO_gq.js";
import { s as normalizeStringEntries } from "./string-normalization-QLwZvaSN.js";
import { a as loadConfig, l as readConfigFileSnapshot } from "./io-gK4mTn0s.js";
...
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-BbsYBVVM.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-CHvWS1mb.js";
import { r as replaceConfigFile, t as ConfigMutationConflictError } from "./config-zbBVmEjy.js";
...
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-8Se1gSe9.js";
...
import { r as resolveProviderPluginChoice } from "./provider-wizard-D3IJhqpg.js";
import { t as applyPrimaryModel } from "./provider-model-primary-C0GTRhAz.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DXXUIAPU.js";
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-CmGuAQ9e.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-WA0jOKXc.js";
import { n as applyAuthChoice } from "./auth-choice-I7Dv_bP6.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-DmxbP3ra.js";
import { i as setupChannels } from "./onboard-channels-B4GyrjFP.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-wy9xNhvw.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CD0epRaG.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-BT-GQDGR.js";
import { t as promptCustomApiConfig } from "./onboard-custom-B6oewv2I.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-C6-4xkSj.js";
import { n as formatHealthCheckFailure } from "./health-format-BbmrrMnl.js";
import { n as healthCommand } from "./health-cN6w_VLF.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-DOGiUQXS.js";
import { t as setupSkills } from "./onboard-skills-Cr1naw7Q.js";
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-CujqEriv.js");
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-JRbz-ITU.js");
	...
	try {
		...
		if (opts.sections) {
			...
			if (selected.includes("plugins")) {
				const { configurePluginConfig } = await import("./setup.plugin-config-Bdd9x8sD.js");
