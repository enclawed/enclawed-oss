...
import { a as resolveIdentityNamePrefix$1 } from "./identity-BvKgoUTt.js";
import { a as updateLastRoute, o as updateSessionStore } from "./store-BojxuYyw.js";
...
import { f as fireAndForgetBoundedHook, i as toInternalMessageReceivedContext, l as toPluginMessageContext, n as deriveInboundMessageHookContext, u as toPluginMessageReceivedEvent } from "./message-hook-mappers-nnhyMpsE.js";
import { n as resolveBatchedReplyThreadingPolicy } from "./reply-threading-DpSyw8e8.js";
import { a as resolveInboundLastRouteSessionKey, i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-C6pTQjkz.js";
...
import { a as normalizeMentionText, n as buildMentionRegexes } from "./mentions-BnnE3n-g.js";
...
import { d as recordPendingHistoryEntryIfEnabled, i as buildHistoryContextFromEntries } from "./history-fro5qpjb.js";
import { s as hasVisibleChannelTurnDispatch } from "./kernel-46wWFnRV.js";
...
import { t as resolveInboundSessionEnvelopeContext } from "./session-envelope-swbi4ufi.js";
import "./channel-mention-gating-CovKwG7T.js";
import "./session-store-runtime-BrW3M86D.js";
import { t as createClaimableDedupe } from "./persistent-dedupe-C2n6Cmd7.js";
import { a as resolveWhatsAppAccount, s as resolveWhatsAppMediaMaxBytes } from "./accounts-CaFve6Tp.js";
import { t as isWhatsAppGroupJid } from "./normalize-target-VjqidJx3.js";
import { t as resolveWhatsAppReactionLevel } from "./reaction-level-wXvVC4AL.js";
import { n as getStatusCode, t as formatError } from "./session-errors-DC9n8zWL.js";
import { a as resolveJidToE164, i as markdownToWhatsApp, n as isSelfChatMode, o as toWhatsappJid, r as jidToE164 } from "./text-runtime-ejTrrxuU.js";
import { i as prepareWhatsAppOutboundMedia, o as sendWhatsAppOutboundWithRetry, r as normalizeWhatsAppPayloadTextPreservingIndentation, t as normalizeWhatsAppOutboundPayload } from "./outbound-media-contract-N-kM2nqr.js";
import { r as sendReactionWhatsApp } from "./send-BvtpOGNL.js";
import { n as cacheInboundMessageMeta, r as lookupInboundMessageMeta, t as buildQuotedMessageOptions } from "./quoted-message-lhjfwGHi.js";
import { _ as readWebSelfIdentityForDecision, a as getWebAuthAgeMs, h as readWebSelfId, r as WhatsAppAuthUnstableError, s as logoutWeb } from "./auth-store-B8a74NE_.js";
import { a as getSelfIdentity, c as resolveComparableIdentity, i as getReplyContext, n as getMentionIdentities, o as getSenderIdentity, r as getPrimaryIdentityId, s as identitiesOverlap, t as getComparableIdentityValues } from "./identity-CaRBayQZ.js";
import { i as resolveWhatsAppInboundPolicy, n as checkInboundAccessControl, r as resolveWhatsAppCommandAuthorized } from "./access-control-DvNKKPSy.js";
import { c as waitForWaConnection, d as newConnectionId, f as resolveHeartbeatSeconds, l as resolveWhatsAppSocketTiming, n as WhatsAppConnectionController, o as createWaSocket, p as resolveReconnectPolicy, u as DEFAULT_RECONNECT_POLICY } from "./connection-controller-bela7HnO.js";
...
async function processMessage(params) {
	...
	if (params.preflightAudioTranscript === void 0 && hasAudioBody && params.msg.mediaPath) try {
		const { transcribeFirstAudio } = await import("./audio-preflight.runtime-DpJmNuUL.js");
...
function loadReplyResolverRuntime() {
	replyResolverRuntimePromise ??= import("./reply-resolver.runtime-iTcy8C8Y.js");
