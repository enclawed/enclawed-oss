...
const defaultCodexAppServerClientFactory = (startOptions, authProfileId, agentDir) => import("./shared-client-Be1PRIHV.js").then(({ getSharedCodexAppServerClient }) => getSharedCodexAppServerClient({
	startOptions,
	authProfileId,
	agentDir
}));
