...
import { a as mergeModelProviderRequestOverrides, d as sanitizeConfiguredProviderRequest, u as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-DpuK1s8u.js";
import { t as resolveSystemBin } from "./resolve-system-bin-CmyPY75t.js";
import { r as normalizeMediaProviderId } from "./entry-capabilities-Ds57jqx7.js";
import { C as getMediaUnderstandingProvider, _ as DEFAULT_VIDEO_MAX_BASE64_BYTES, a as resolvePrompt, g as DEFAULT_TIMEOUT_SECONDS, n as resolveMaxBytes, r as resolveMaxChars, s as resolveTimeoutMs, u as CLI_OUTPUT_MAX_BUFFER, v as MIN_AUDIO_FILE_BYTES, x as resolveDefaultMediaModel } from "./resolve-vepBcIX0.js";
import { t as describeImageWithModel } from "./image-runtime-BUNJvd_c.js";
import { n as executeWithApiKeyRotation, t as collectProviderApiKeysForExecution } from "./api-key-rotation-fhtApH08.js";
import { t as applyTemplate } from "./templating-CJVXMBoF.js";
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-CYbocpTD.js";
...
async function runCliEntry(params) {
	...
	const outputDir = await fs.mkdtemp(path.join(resolvePreferredEnclawedTmpDir(), "enclawed-media-cli-"));
