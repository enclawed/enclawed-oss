...
import { l as copyPluginToolMeta, t as copyChannelAgentToolMeta } from "./channel-tools-DJBTw8u5.js";
...
*/
var ToolCallBlockedError = class extends Error {
	constructor(reason) {
		super(reason);
		this.blocked = true;
...
*/
function isToolCallBlockedError(value) {
	return value instanceof Error && (value.blocked === true || value.name === "ToolCallBlockedError");
}
...
const loadBeforeToolCallRuntime = createLazyRuntimeSurface(() => import("./pi-tools.before-tool-call.runtime-Yuxj_ZbZ.js"), ({ beforeToolCallRuntime }) => beforeToolCallRuntime);
...
function wrapToolWithBeforeToolCallHook(tool, ctx) {
	...
	const wrappedTool = {
		...
		execute: async (toolCallId, params, signal, onUpdate) => {
			...
			if (outcome.blocked) throw new ToolCallBlockedError(outcome.reason);
			if (toolCallId) {
...
//#endregion
export { isToolWrappedWithBeforeToolCallHook as a, isToolCallBlockedError as i, __testing as n, runBeforeToolCallHook as o, consumeAdjustedParamsForToolCall as r, wrapToolWithBeforeToolCallHook as s, ToolCallBlockedError as t };
