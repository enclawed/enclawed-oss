...
import { n as formatPairingApproveHint } from "./helpers-Db-VEnkz.js";
...
import { n as resolveInboundDirectDmAccessWithRuntime, t as createPreCryptoDirectDmAuthorizer } from "./direct-dm-access-B114mxdy.js";
import { t as createDirectDmPreCryptoGuardPolicy } from "./direct-dm-guard-policy-C5mpM_5l.js";
import { r as buildTrafficStatusSummary, t as buildPassiveChannelStatusSummary } from "./extension-shared-DZrCsUUN.js";
...
import { n as NostrProfileSchema, t as NostrConfigSchema } from "./config-schema-D9yOv0ho.js";
import { t as DEFAULT_RELAYS } from "./default-relays-BSXruY1A.js";
import { a as resolveNostrAccount, i as resolveDefaultNostrAccountId, n as nostrSetupWizard, o as normalizePubkey, r as listNostrAccountIds, s as validatePrivateKey, t as nostrSetupAdapter } from "./setup-surface-nyB0rzV-.js";
...
const startNostrGatewayAccount = async (ctx) => {
	...
	const bus = await startNostrBus({
		...
		onMessage: async (senderPubkey, text, reply, meta) => {
			...
			const { dispatchInboundDirectDmWithRuntime } = await import("./inbound-direct-dm-runtime-DXhUeh8f.js");
