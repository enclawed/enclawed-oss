...
import { a as postJsonRequest, h as assertOkOrThrowProviderError } from "./shared-B9jviejS.js";
import "./provider-http-UY3EBR2N.js";
import "./text-runtime-Co0Dyh7P.js";
import { t as transcodeAudioBufferToOpus } from "./media-runtime-jfomOIuq.js";
import { n as asObject } from "./speech-core-CML0vZ1b.js";
import "./secret-input-BTSKYAzZ.js";
import { t as resolveGoogleGenerativeAiHttpRequestConfig } from "./api-ZU0Rd78T.js";
...
function isEnclawedGoogleAudioProfilePrompt(text) {
...
function buildGoogleSpeechProvider() {
	return {
		...
		prepareSynthesis: (ctx) => {
			...
			if (!(config.promptTemplate === GOOGLE_AUDIO_PROFILE_PROMPT_TEMPLATE || Boolean(config.personaPrompt)) || isEnclawedGoogleAudioProfilePrompt(ctx.text)) return;
