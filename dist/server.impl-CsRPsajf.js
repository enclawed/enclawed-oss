...
import { i as isPlainObject } from "./workspace-dir-BFXVbXDc.js";
import { S as truncateUtf16Safe, b as sleep, g as resolveUserPath, s as ensureDir } from "./utils-CrVQlOZJ.js";
import { n as defaultRuntime } from "./runtime-DVd7lkz0.js";
import { t as sanitizeForLog } from "./ansi-haTfqSzd.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-DMryAe7X.js";
import { n as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-DkSj_7zL.js";
...
import { _ as resolveStateDir, i as isNixMode, r as STATE_DIR } from "./paths-CDjhyzOH.js";
import { n as VERSION, s as resolveRuntimeServiceVersion } from "./version-CeugVlbG.js";
import { o as isSecretRef } from "./types.secrets-BpVPfGSB.js";
import { a as logWarn, t as logDebug } from "./logger-D4q1iOk_.js";
import { i as runExec, r as runCommandWithTimeout } from "./exec-Dn9k-mIx.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-B5lOO_gq.js";
import { t as safeEqualSecret } from "./secret-equal-YvM7lU0c.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-_A2c3oXt.js";
import { _ as resolveRequestClientIp, a as isLoopbackHost, g as resolveHostName, h as resolveGatewayListenHosts, i as isLoopbackAddress, l as isTrustedProxyAddress, m as resolveGatewayBindHost, n as isContainerEnvironment, o as isPrivateOrLoopbackAddress, p as resolveClientIp, r as isLocalishHost, s as isPrivateOrLoopbackHost, t as defaultGatewayBindMode, u as isValidIPv4 } from "./net-SK24IRt9.js";
import { a as createAuthRateLimiter, i as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, n as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, o as normalizeRateLimitClientIp, r as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH } from "./auth-rate-limit-BBOwpYDJ.js";
import { a as resolveEffectiveSharedGatewayAuth, i as isLocalDirectRequest, n as authorizeHttpGatewayConnect, o as resolveGatewayAuth, r as authorizeWsControlUiGatewayConnect, s as checkBrowserOrigin, t as assertGatewayAuthConfigured } from "./auth-0B5TLary.js";
import { t as sameFileIdentity } from "./file-identity-DkOokEOG.js";
import { r as openBoundaryFile } from "./boundary-file-read-CQh3KACR.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-CSNnpnbU.js";
import { D as applyConfigOverrides, S as validateConfigObjectWithPlugins, a as loadConfig, g as writeConfigFile, h as resolveConfigSnapshotHash, i as getRuntimeConfig, l as readConfigFileSnapshot, m as registerConfigWriteListener, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshotForWrite } from "./io-gK4mTn0s.js";
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-NLwi4pC3.js";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-CNyFdmwd.js";
import { r as normalizeProviderId } from "./provider-id-JqYiEozY.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey, o as parseAgentSessionKey, r as isCronRunSessionKey } from "./session-key-utils-Ce7cepnN.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-BV5xNTUp.js";
import { c as normalizeAgentId, h as toAgentStoreSessionKey, l as normalizeMainKey, m as toAgentRequestSessionKey, o as classifySessionKeyShape, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-BOC5unB4.js";
import { i as normalizeChannelId, n as getLoadedChannelPlugin, r as listChannelPlugins, t as getChannelPlugin } from "./registry-DAV2wQ3B.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-DkpvRRFC.js";
import { n as resolveSubagentMaxConcurrent, t as resolveAgentMaxConcurrent } from "./agent-limits-C8U-UBWU.js";
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-56vHbiay.js";
...
import { c as PAIRING_SCOPE, d as WRITE_SCOPE, i as isNodeRoleMethod, l as READ_SCOPE, n as authorizeOperatorScopesForMethod, o as ADMIN_SCOPE$1, s as APPROVALS_SCOPE$1, t as CLI_DEFAULT_OPERATOR_SCOPES, u as TALK_SECRETS_SCOPE } from "./method-scopes-H5HCSsJN.js";
import { n as formatConfigIssueLines } from "./issue-format-B5juDRgp.js";
import { n as pickBestEffortPrimaryLanIPv4 } from "./network-discovery-display-ITOLCHF6.js";
import { i as resolveAssistantAvatarUrl, r as normalizeControlUiBasePath } from "./control-ui-shared-5f83_CtF.js";
import { t as hasAnyAuthProfileStoreSource } from "./source-check-DLSm69AH.js";
import { n as ensureAuthProfileStore } from "./store-DxE5HEh1.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-BDPvwH5t.js";
import { l as disposeRegisteredAgentHarnesses } from "./registry-aeOT3dMj.js";
import { B as resolveMemoryLightDreamingConfig, F as resolveMemoryDeepDreamingConfig, I as resolveMemoryDreamingConfig, L as resolveMemoryDreamingPluginConfig, N as isSameMemoryDreamingDay, V as resolveMemoryRemDreamingConfig, z as resolveMemoryDreamingWorkspaces } from "./dreaming-PRYLPRSr.js";
import { r as loadEnclawedPlugins } from "./loader-sMKY_gGA.js";
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-DlBOVsJe.js";
import { s as getPluginCommandSpecs } from "./command-registration-BkZe4Etf.js";
import { o as runGlobalGatewayStopSafely, t as getGlobalHookRunner } from "./hook-runner-global-D5tYPLdd.js";
import { f as registerInternalHook, h as unregisterInternalHook, i as hasInternalHookListeners, m as triggerInternalHook, n as createInternalHookEvent, p as setInternalHooksEnabled } from "./internal-hooks-Dm-6ahPb.js";
import { i as canonicalizePathVariant, n as PROTECTED_PLUGIN_ROUTE_PREFIXES, r as canonicalizePathForSecurity } from "./http-route-overlap-DnQy3WEl.js";
import { t as createEmptyPluginRegistry } from "./registry-empty-Bh8uxmVA.js";
import { n as withPluginRuntimeGatewayRequestScope, t as getPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-BAy7S6dp.js";
import { f as releasePinnedPluginChannelRegistry, l as pinActivePluginChannelRegistry, p as releasePinnedPluginHttpRouteRegistry, r as getActivePluginRegistry, u as pinActivePluginHttpRouteRegistry, v as resolveActivePluginHttpRouteRegistry, y as setActivePluginRegistry } from "./runtime-v-gfCtZv.js";
import "./logging-BIHkOBbx.js";
import { r as createPluginRuntimeLoaderLogger } from "./load-context-els_tMDv.js";
...
import { a as getModelRefStatus, c as resolveConfiguredModelRef, l as resolveHooksGmailModel, m as parseModelRef, o as normalizeModelSelection, p as normalizeModelRef, s as resolveAllowedModelRef, t as isCliProvider } from "./model-selection-cli-BC0OF3q6.js";
import { a as normalizeElevatedLevel, c as normalizeThinkLevel, d as normalizeVerboseLevel, n as formatXHighModelHint, o as normalizeFastMode, s as normalizeReasoningLevel, u as normalizeUsageDisplay } from "./thinking.shared-DCWjwvfv.js";
import { a as getModelRefStatus$1, d as resolveConfiguredModelRef$1, f as resolveDefaultModelForAgent, l as resolveAllowedModelRef$1, p as resolveHooksGmailModel$1, t as buildAllowedModelSet, x as resolveThinkingDefault, y as resolveSubagentConfiguredModelSelection } from "./model-selection-CRPDotcW.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-DY9_wUGH.js";
import { r as loadModelCatalog } from "./model-catalog-CXh1Bc_3.js";
import { n as resolveAgentIdentity } from "./identity-BnPHYOtG.js";
import { o as updateSessionStore, s as updateSessionStoreEntry, t as archiveRemovedSessionTranscripts } from "./store-CnDX3BCC.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-DhfOziPO.js";
import { n as resolveMainSessionKeyFromConfig, t as extractDeliveryInfo } from "./sessions-CkY_xhZf.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-Lozvxyih.js";
import { l as setSessionRuntimeModel, n as mergeSessionEntry } from "./types-B_nWSksI.js";
import { n as cleanStaleLockFiles } from "./session-write-lock-B7HIVMq0.js";
import { n as readJsonFile, r as writeJsonAtomic, t as createAsyncLock } from "./json-files-dLr22YNm.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-BwL2bjyO.js";
...
import { t as parseSessionThreadInfo } from "./thread-info-BqPEFEYg.js";
import { i as resolveAgentSessionDirs } from "./targets-CjP-xmJE.js";
import { n as sleepWithAbort, t as computeBackoff } from "./backoff-C0maDn7v.js";
import { n as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-DxihbEhC.js";
import { o as startGatewayModelPricingRefresh } from "./usage-format-CC12AyQz.js";
...
import { n as deriveSessionTotalTokens, r as hasNonzeroUsage } from "./usage-BAoTEYmL.js";
import { a as readSessionPreviewItemsFromTranscript, i as readSessionMessages, t as attachEnclawedTranscriptMeta } from "./session-utils.fs-D4KXI-63.js";
import { r as stripInlineDirectiveTagsForDisplay } from "./directive-tags-CuUhPrjG.js";
import { a as resolveSessionTranscriptCandidates, i as cleanupArchivedSessionTranscripts, t as archiveFileOnDisk } from "./session-transcript-files.fs-Bz_prI6u.js";
import { ct as getSessionCompactionCheckpoint, lt as listSessionCompactionCheckpoints } from "./model-context-tokens-Bq4y9A0t.js";
import { n as isDiagnosticsEnabled } from "./diagnostic-events-DPcyBAFM.js";
import { t as CommandLane } from "./lanes-DHUC1f2M.js";
import { i as enqueueCommandInLane, s as getTotalQueueSize, u as setCommandLaneConcurrency } from "./command-queue-CCZ99txj.js";
import { m as resolveEmbeddedAgentRuntime } from "./attempt.tool-run-context-BdlCnv8U.js";
import { n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripLeadingSilentToken } from "./tokens-DEyoRqN5.js";
import { s as stripHeartbeatToken } from "./heartbeat-B7H_Q8MR.js";
import { n as resolveNormalizedAccountEntry, t as resolveAccountEntry } from "./account-lookup-gMqEl4N_.js";
import { t as getMachineDisplayName } from "./machine-name-DQk9-5U8.js";
import { t as detectMime } from "./mime-CwPaZfyo.js";
import { d as PROFILE_OPTIONS, m as resolveCoreToolProfiles, p as listCoreToolSections } from "./tool-policy-Bkov0fJO.js";
import { d as resolvePluginTools, u as getPluginToolMeta } from "./channel-tools-CUMxi4EB.js";
import { C as synthesizeSpeech, S as setTtsProvider, b as setTtsEnabled, c as isTtsEnabled, f as resolveExplicitTtsOverrides, g as resolveTtsProviderOrder, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, p as resolveTtsAutoMode, w as textToSpeech } from "./tts-runtime-Co7RCIN3.js";
import "./tts-CV2S6AJZ.js";
import { n as compactEmbeddedPiSession, r as selectAgentHarness } from "./pi-embedded-runner-CVXeSqY-.js";
import { i as supportsXHighThinking, t as formatThinkingLevels } from "./thinking-DyqDTQLE.js";
import { o as resolveFailoverReasonFromError } from "./failover-error-Cy4poLEJ.js";
import "./auth-profiles-bSqTLkPQ.js";
import { t as SsrFBlockedError } from "./ssrf-DQDx1s1G.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-YqO3vXgq.js";
import { n as createOutboundPayloadPlan, s as projectOutboundPayloadPlanForMirror, t as deliverOutboundPayloads } from "./deliver-DqeU4N-T.js";
import { c as getAgentRunContext, f as sweepStaleRunContexts, l as onAgentEvent, t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-BfuQdc-z.js";
import { i as normalizeCronJobPatch, n as normalizeCronJobCreate, r as normalizeCronJobInput } from "./enclawed-tools-CjwQbk40.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-BBYQhtKI.js";
import { g as writeFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-D-Jjh4zb.js";
...
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-BEtIRV3J.js";
import { i as parseAbsoluteTimeMs } from "./stagger-B4XD9qm3.js";
import { n as assertSafeCronSessionTargetId, r as isInvalidCronSessionTargetIdError, t as normalizeHttpWebhookUrl } from "./webhook-url-Da6Y-5kj.js";
import { a as summarizeRestartSentinel, n as formatDoctorNonInteractiveHint, r as formatRestartSentinelMessage, s as writeRestartSentinel, t as consumeRestartSentinel } from "./restart-sentinel-CiwintAf.js";
import { c as setPreRestartDeferralCheck, n as deferGatewayRestartUntilIdle, o as scheduleGatewaySigusr1Restart, r as emitGatewayRestart, s as setGatewaySigusr1RestartPolicy } from "./restart-BpzfVNVo.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-7RD3YNVT.js";
import { r as cleanOldMedia } from "./store-B5Pdc0kP.js";
import { a as CANVAS_HOST_PATH, c as injectCanvasLiveReload, l as normalizeUrlPath, s as handleA2uiHttpRequest, u as resolveFileWithinRoot } from "./web-media-BRE-xKBd.js";
import { i as isKnownSecretTargetId } from "./target-registry-BudCYa5V.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-secret-gateway-ClSqGmp7.js";
import { i as evaluateGatewayAuthSurfaceStates, r as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-web-tools-OnCOw62p.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-l4BhYm_z.js";
import { n as normalizePollInput } from "./polls-DUmN6raC.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-B3ZYlFEP.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-ne4PJ6z4.js";
import { r as resetDirectoryCache } from "./target-resolver-Cm23RRLY.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-gHeaaIE4.js";
import { l as failDelivery, o as ackDelivery, s as enqueueDelivery } from "./delivery-queue-v8Vrh1sl.js";
import { i as resolveReplyToMode } from "./reply-threading-DpSyw8e8.js";
import { t as buildOutboundSessionContext } from "./session-context-DJOJqwuW.js";
import { r as resolveOutboundTarget } from "./targets-BVfZtZJh.js";
import { t as extractToolPayload } from "./tool-payload-a2I8z-ar.js";
import { i as setHeartbeatsEnabled, n as requestHeartbeatNow } from "./heartbeat-wake-D113vPjP.js";
import { i as enqueueSystemEvent, o as isSystemEventContextChanged } from "./system-events-AQjBSiiK.js";
import { a as createRunningTaskRun, o as failTaskRunByRunId, r as completeTaskRunByRunId } from "./task-executor-CvTx9Gva.js";
import { m as cleanupBrowserSessionsForLifecycleEnd, o as initSubagentRegistry, p as scheduleSubagentOrphanRecovery } from "./subagent-registry-PlqiV4Fr.js";
import { a as clearSessionQueues } from "./queue-CzE8g6JB.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-SYF3lXGF.js";
import { a as isEmbeddedPiRunActive, f as waitForEmbeddedPiRunEnd, r as getActiveEmbeddedRunCount, t as abortEmbeddedPiRun } from "./runs-BnrT3CiH.js";
import { h as stopDiagnosticHeartbeat, m as startDiagnosticHeartbeat } from "./diagnostic-Crt1pFbR.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DsB-Idj6.js";
import { n as movePathToTrash } from "./browser-maintenance-CqiZnXA4.js";
import { n as onSessionLifecycleEvent } from "./session-lifecycle-events-BOahXZNJ.js";
import { t as resolveAgentTimeoutMs } from "./timeout-D3KpBffA.js";
import { n as normalizeSpawnedRunMetadata, r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-zPTWDIGf.js";
import { c as resolveHookExternalContentSource, o as isExternalHookSession, s as mapHookExternalContentSource } from "./external-content-BG0h4WfB.js";
import { r as registerSkillsChangeListener, t as bumpSkillsSnapshotVersion } from "./refresh-state-BnwMFnd_.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-z29yLNhU.js";
import { n as hasBinary } from "./config-eval-DCmfx_Zm.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-CquiyOLv.js";
import { c as roleScopesAllow, o as resolveMissingRequestedScope } from "./pairing-token-Bbqcg77x.js";
import { a as refreshRemoteBinsForConnectedNodes, c as setSkillsRemoteRegistry, d as listNodePairing, f as rejectNodePairing, g as verifyNodeToken, h as updatePairedNodeMetadata, i as recordRemoteNodeInfo, l as approveNodePairing, m as requestNodePairing, n as primeRemoteSkillsCache, o as refreshRemoteNodeBins, p as renamePairedNode, s as removeRemoteNodeInfo, t as getRemoteSkillEligibility, u as getPairedNode } from "./skills-remote-IYkWssEc.js";
import { t as canExecRequestNode } from "./exec-defaults-sijTMULN.js";
import "./skills-B916F3M2.js";
import { n as resolveCronStyleNow } from "./current-time-Cai7esVx.js";
import { n as getActiveMemorySearchManager, r as resolveActiveMemoryBackendConfig } from "./memory-runtime-DnrAe1BZ.js";
import { t as resolveMemorySearchConfig } from "./memory-search-BVso9m1E.js";
import { t as resolveModel } from "./model-CvpDBVgK.js";
import { o as resolvePreferredSessionKeyForSessionIdMatches } from "./live-model-switch-BKw0FTvt.js";
import "./pi-embedded-CrFJRSYH.js";
import { r as listPluginCommands } from "./commands-CYBLX44t.js";
import { n as createPluginRuntime, r as setGatewaySubagentRuntime } from "./runtime-D20GGc35.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-DK6a0QBl.js";
import "./commands-registry-CGDoEh1R.js";
import { o as getTotalPendingReplies } from "./dispatch-DY8kS0dE.js";
import { n as resolveSendPolicy, t as normalizeSendPolicy } from "./send-policy-Bq9hFiZi.js";
import { n as sanitizeInboundSystemTags } from "./inbound-text-BUZcIML4.js";
import { t as getChannelActivity } from "./channel-activity-BFaSvCM_.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-icsK1N4v.js";
import { n as getAcpSessionManager } from "./manager-BnwWIA9w.js";
import { t as primeConfiguredBindingRegistry } from "./binding-registry-BFmHk6vN.js";
import { t as WizardCancelledError } from "./prompts-DZ3FVXpm.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-saH_q6zI.js";
import { c as formatExecApprovalExpiresIn, f as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-reply-D2yEmksv.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "./approval-handler-adapter-runtime-CdRxDZz6.js";
import { n as sanitizeExecApprovalDisplayText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-C5K0qOpe.js";
import { n as createChannelApprovalHandlerFromCapability } from "./approval-handler-runtime-C4Cjbiqq.js";
import { i as watchChannelRuntimeContexts, n as getChannelRuntimeContext, t as createTaskScopedChannelRuntime } from "./channel-runtime-context-D-ycP8vk.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-DLq9HeNi.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-DJ1sno21.js";
import { t as normalizeGroupActivation } from "./group-activation-CbofnQzN.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-Bqm17gkP.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-Cky9Gv7N.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-DJw0JOHh.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-Dx1VFD-Y.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-CwtN2GjT.js";
import { n as resolveAgentOutboundIdentity } from "./identity-CnPME7eg.js";
import { i as parseVerboseOverride, n as applyVerboseOverride, r as parseTraceOverride, t as applyTraceOverride } from "./level-overrides-l_PAoFxN.js";
import { r as agentCommandFromIngress } from "./agent-command-Cuxjz9ix.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-B32KlCw0.js";
import { a as ensureGatewayStartupAuth, i as safeParseJson, n as respondUnavailableOnNodeInvokeError, o as mergeGatewayAuthConfig, r as respondUnavailableOnThrow, s as mergeGatewayTailscaleConfig, t as respondInvalidParams } from "./nodes.helpers-C2FK6MRe.js";
import { i as resolveNodeCommandAllowlist, n as isNodeCommandAllowed, r as normalizeDeclaredNodeCommands } from "./node-command-policy-BKwNXAY_.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs, t as formatForLog } from "./ws-log-WH6t4MvO.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-pFn4LCJL.js";
import { r as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-z_9L1_Lj.js";
import { _ as verifyDeviceToken, a as getPairedDevice, c as listDevicePairing, d as removePairedDevice, f as requestDevicePairing, g as updatePairedDeviceMetadata, h as summarizeDeviceTokens, i as formatDevicePairingForbiddenMessage, l as listEffectivePairedDeviceRoles, m as rotateDeviceToken, n as approveDevicePairing, o as hasEffectivePairedDeviceRole, p as revokeDeviceToken, r as ensureDeviceToken, s as listApprovedPairedDeviceRoles, t as approveBootstrapDevicePairing, u as rejectDevicePairing } from "./device-pairing-BahXa033.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-BhmzzHF2.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-rETxdSmF.js";
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-TJWuMTyu.js";
import "./agent-B8k5h7ly.js";
import { n as shouldIncludeHook } from "./config-iLzV83ml.js";
import "./session-identifiers-CcgaGhHx.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, i as buildSystemRunApprovalEnvBinding, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-9-N4ayAt.js";
import { n as resolveSystemRunApprovalRequestContext, r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-Bml5oq59.js";
import { t as closeMcpLoopbackServer } from "./mcp-http-DWFNStEB.js";
import { A as isSessionKeyAllowedByPrefix, B as resolveHookTargetAgentId, D as getHookChannelError, E as getHookAgentPolicyError, F as readJsonBody, H as applyHookMappings, I as resolveHookChannel, L as resolveHookDeliver, M as normalizeHookDispatchSessionKey, N as normalizeHookHeaders, O as getHookSessionKeyPrefixError, P as normalizeWakePayload, R as resolveHookIdempotencyKey, T as extractHookToken, U as resolveFunctionModuleExport, V as resolveHooksConfig, _ as sendGatewayAuthFailure, a as getHeader, h as loadGatewayModelCatalog, i as getBearerToken, j as normalizeAgentPayload, k as isHookAgentAllowed, l as resolveHttpBrowserOriginPolicy, m as __resetModelCatalogCacheForTest, p as resolveTrustedHttpOperatorScopes, r as authorizeGatewayHttpRequestOrReply, x as setDefaultSecurityHeaders, z as resolveHookSessionKey } from "./http-utils-BSyHU5k1.js";
import { t as createOutboundSendDeps$1 } from "./outbound-send-deps-DOoYZqWt.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-TsSgr-yQ.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-8X9ETsBZ.js";
import { t as loadProviderUsageSummary } from "./provider-usage-DZfTUOwK.js";
import "./refresh-cF6u4sXQ.js";
import { o as fetchClawHubSkillDetail } from "./clawhub-Bbus7za-.js";
import { a as loadSessionUsageTimeSeries, n as loadCostUsageSummary, o as resolveExistingUsageSessionFile, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-DzzFhjjy.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-BAPM--Fv.js";
import { a as performGatewaySessionReset } from "./session-reset-service-Bspi3xmP.js";
import { t as buildChannelUiCatalog } from "./catalog-2SIg0xMc.js";
import { t as ensureEnclawedCliOnPath } from "./path-env-B-wYipvE.js";
import { a as removeBackfillDiaryEntries, c as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeGroundedShortTermCandidates, r as previewGroundedRemMarkdown, s as repairDreamingArtifacts } from "./memory-core-bundled-runtime-ckPlJmPi.js";
import { a as resolveGatewayStartupPluginIds, r as resolveConfiguredDeferredChannelPluginIds } from "./channel-plugin-ids-hHe4N8_N.js";
import { a as redactConfigSnapshot, i as redactConfigObject, o as restoreRedactedValues, r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-l7_Sj9XA.js";
import { a as writeWideAreaGatewayZone, i as resolveWideAreaDiscoveryDomain } from "./widearea-dns-BU7isqq7.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DXXUIAPU.js";
import { t as GatewayLockError } from "./gateway-lock-C9MieHM7.js";
import { t as loadWorkspaceHookEntries } from "./workspace-DUB9R3Dp.js";
import { t as readConfiguredLogTail } from "./log-tail-Cz8YBCV0.js";
import { o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-BJwhCzyw.js";
import { t as getHealthSnapshot } from "./health-cN6w_VLF.js";
import { t as installSkill } from "./skills-install-Dp2Txv-O.js";
import { n as normalizeCronJobIdentityFields, r as runGatewayUpdate, t as runChannelPluginStartupMaintenance } from "./lifecycle-startup-BEcoE1bG.js";
import { m as normalizeUpdateChannel, n as compareSemverStrings, o as resolveNpmChannelTag, t as checkUpdateStatus } from "./update-check-CCLx7fMh.js";
import { i as migrateOrphanedSessionKeys } from "./state-migrations-DFVV3HPe.js";
import { t as runSetupWizard } from "./setup-BdP6_S80.js";
import "./status-Bk9q2BU4.js";
import { t as getStatusSummary } from "./status.summary-CjM6rqN6.js";
import { d as startTaskRegistryMaintenance, f as stopTaskRegistryMaintenance, g as markCronJobActive, h as clearCronJobActive, n as getInspectableTaskRegistrySummary } from "./task-registry.maintenance-OPsyq1Ei.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-BeMVeoVT.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeLogArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-DyenT7FC.js";
import { t as buildChannelAccountSnapshot } from "./status-ZjFPCBbi.js";
import { _ as resolveDeliveryTarget, a as computeJobPreviousRunAtMs, c as findJobOrThrow, d as isJobEnabled, f as nextWakeAtMs, g as resolveJobPayloadTextForMain, h as recordScheduleComputeError, i as computeJobNextRunAtMs, l as hasScheduledNextRunAtMs, m as recomputeNextRunsForMaintenance, n as applyJobPatch, o as createJob, p as recomputeNextRuns, r as assertSupportedJobSpec, s as errorBackoffMs, t as DEFAULT_ERROR_BACKOFF_SCHEDULE_MS, u as isJobDue } from "./jobs-BNRKVjLU.js";
import { a as resolveHeartbeatAckMaxChars$1, i as resolveCronPayloadOutcome, t as isHeartbeatOnlyResponse } from "./helpers-CYrolovo.js";
import { n as markCronSessionPreRun, r as persistCronSkillsSnapshotIfChanged, t as createPersistCronSessionEntry } from "./run-session-state-CP-AAqnC.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-Dwu4fx43.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-rxXJIBEP.js";
import { n as MediaOffloadError, r as parseMessageWithAttachments, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-DRxiD39I.js";
import { a as resolveCronSession, n as runHeartbeatOnce, r as startHeartbeatRunner } from "./heartbeat-runner-CGC-Qaad.js";
import { _ as injectTimestamp, a as DEDUPE_TTL_MS, c as MAX_PAYLOAD_BYTES, d as isSuppressedControlReplyLeadFragment, f as isSuppressedControlReplyText, g as waitForTerminalGatewayDedupe, h as setGatewayDedupeEntry, i as DEDUPE_MAX, l as MAX_PREAUTH_PAYLOAD_BYTES, m as readTerminalSnapshotFromGatewayDedupe, n as chatHandlers, o as HEALTH_REFRESH_INTERVAL_MS, p as abortChatRunById, s as MAX_BUFFERED_BYTES, u as TICK_INTERVAL_MS, v as timestampOptsFromConfig } from "./chat-kd7FBiyv.js";
import { t as truncateCloseReason } from "./close-reason-BofjPZY5.js";
...
function loadExecApprovalForwarderRuntime() {
	execApprovalForwarderRuntimePromise ??= import("./exec-approval-forwarder.runtime-BpAXaaCw.js");
...
async function loadSkillsSnapshotRuntime() {
	skillsSnapshotRuntimePromise ??= import("./skills-snapshot.runtime-gSZt1pdd.js");
...
async function loadCliRunnerRuntime() {
	return await import("./cli-runner.runtime-Dq0n17Zt.js");
}
async function loadUsageFormatRuntime() {
	return await import("./usage-format-Cop0_TXE.js");
}
...
async function loadSessionSubagentReactivationRuntime() {
	return import("./session-subagent-reactivation.runtime-GGB_gLn2.js");
}
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BDeOTVj1.js");
...
const sessionsHandlers = {
	...
	"sessions.reset": async ({ params, respond, context }) => {
		...
		const { performGatewaySessionReset } = await import("./sessions.runtime-Be2jeoY7.js");
		const result = await performGatewaySessionReset({
			key,
			reason,
	...
	"sessions.delete": async ({ params, respond, client, isWebchatConnect, context }) => {
		...
		const { archiveSessionTranscriptsForSessionDetailed, cleanupSessionBeforeMutation, emitGatewaySessionEndPluginHook, emitSessionUnboundLifecycleEvent } = await import("./sessions.runtime-Be2jeoY7.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-DfLkr6_C.js");
...
function recoverPendingOutboundDeliveries(params) {
	(async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-BLSQxWOO.js");
		const { deliverOutboundPayloads } = await import("./deliver-C8kMcTo7.js");
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-rgAqfRvj.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-BqtIDMlZ.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-C2vkEt77.js");
	return embeddingsHttpModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-BzS9qN0-.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-4kfTW9hc.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-DaX0qrEW.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-7_-_ITnw.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-B6MkQb8o.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-UCDTZjJt.js");
