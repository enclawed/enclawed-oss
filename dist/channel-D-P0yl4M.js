...
import { i as createActionGate } from "./common-BLKrO58o.js";
...
import { T as projectConfigAccountIdWarningCollector, h as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-Lbd6vG46.js";
...
import { i as createChatChannelPlugin, l as stripChannelTargetPrefix, t as buildChannelOutboundSessionRoute } from "./core-Cp6Nf0m-.js";
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-CS_53KKZ.js";
...
import { d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-BjB94cGc.js";
import "./channel-status-6EMauR4l.js";
import { t as zod_exports } from "./zod-D31fSMXP.js";
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-B-daS6Z5.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-DW42gJdA.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, n as inspectFeishuCredentials, p as isRecord, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-Bop3Pflv.js";
import "./card-interaction-CZQ-4VDc.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-B3wwkkAl.js";
import { t as messageActionTargetAliases } from "./security-audit-BvcVQb7p.js";
import { a as resolveFeishuGroupToolPolicy } from "./policy-DZwSIMOY.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-cvfBSg3m.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-DzwO3UZV.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-CrPyoXhA.js";
...
async function runScanToCreate(prompter) {
	const { beginAppRegistration, initAppRegistration, pollAppRegistration, printQrCode } = await import("./app-registration-pyFx-wH0.js");
	try {
...
async function runNewAppFlow(params) {
	...
	if (scanResult) {
		...
		if (appId && appSecretProbeValue) {
			const { getAppOwnerOpenId } = await import("./app-registration-pyFx-wH0.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, configured }) => {
			...
			if (configured && resolvedCredentials) try {
				const { probeFeishu } = await import("./probe-CQLefVmr.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-DZq5RG2z.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-B-4CvjSU.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-nbwNYgtr.js");
