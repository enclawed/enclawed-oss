...
import { c as resolveOpenDmAllowlistAccess } from "./dm-policy-shared-DioTCxGL.js";
import "./reply-history-BGJulaMe.js";
import { t as createReplyPrefixContext } from "./reply-prefix-ClzzHSED.js";
...
import { t as buildAgentMediaPayload } from "./agent-media-payload-CuYEjkhL.js";
...
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-WSkWfZVs.js";
...
import { n as createChannelPairingController } from "./channel-pairing-DA3C8ymT.js";
...
import { t as buildFeishuConversationId } from "./conversation-id-BuPxN_a9.js";
import { i as resolveReceiveIdType } from "./targets-B_1CRaRd.js";
import { n as createFeishuThreadBindingManager } from "./thread-bindings-Dyx4jj25.js";
import { _ as buildFeishuCommentTarget, d as extractReplyText, g as readString$2, h as parseCommentContentElements, l as resolveFeishuRuntimeAccount, m as normalizeString, p as isRecord$2, u as encodeQuery, v as normalizeCommentFileType } from "./accounts-DWjsn3FI.js";
import { i as decodeFeishuCardAction, n as buildFeishuCardActionTextFallback, r as createFeishuCardInteractionEnvelope } from "./card-interaction-BbISmqq8.js";
import { i as resolveFeishuGroupConfig, n as isFeishuGroupAllowed, o as resolveFeishuReplyPolicy, r as resolveFeishuAllowlistMatch, t as hasExplicitFeishuGroupConfig } from "./policy-DUstCGjv.js";
...
import { c as getChatInfo, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-NffmynRo.js";
import "./runtime-api-BGwN-maU.js";
import { _ as normalizeFeishuExternalKey, a as sendCardFeishu, c as sendStructuredCardFeishu, d as extractMentionTargets, f as isFeishuBroadcastMention, g as sendMediaFeishu, h as downloadMessageResourceFeishu, i as resolveFeishuCardTemplate, l as parsePostContent, m as isFeishuGroupChatType, n as getMessageFeishu, p as isMentionForwardRequest, r as listFeishuThreadMessages, s as sendMessageFeishu, u as buildMentionedCardContent } from "./send-DX-AbLH7.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-gXagGopE.js";
import { a as feishuWebhookRateLimiter, c as wsClients, i as botOpenIds, l as fetchBotIdentityForMonitor, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as httpServers, r as botNames, s as recordWebhookStatus, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS } from "./monitor.state-DklG0fjU.js";
...
async function resolveFeishuAudioPreflightTranscript(params) {
	...
	try {
		const { transcribeFirstAudio } = await import("./audio-preflight.runtime-pC3XwHHT.js");
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-DXf2Ygz6.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-DXf2Ygz6.js");
