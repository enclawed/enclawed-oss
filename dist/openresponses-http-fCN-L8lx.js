...
import { r as isClientToolNameConflictError } from "./pi-tool-definition-adapter-CjI9dM19.js";
...
import { C as watchClientDisconnect, S as setSseHeaders, a as getHeader, c as resolveGatewayRequestContext, d as resolveOpenAiCompatibleHttpOperatorScopes, f as resolveOpenAiCompatibleHttpSenderIsOwner, i as getBearerToken, o as resolveAgentIdForRequest, u as resolveOpenAiCompatModelOverride, w as writeDone, y as sendJson } from "./http-utils-B-NU8is7.js";
import { t as renderFileContextBlock } from "./file-context-CXwDTUQA.js";
import { a as extractImageContentFromSource, c as resolveInputFileLimits, i as extractFileContentFromSource, n as DEFAULT_INPUT_IMAGE_MIMES, o as normalizeMimeList } from "./input-files-jykxxgaf.js";
...
async function handleOpenResponsesHttpRequest(req, res, opts) {
	...
	unsubscribe = onAgentEvent((evt) => {
		...
		if (evt.stream === "lifecycle") {
			...
			if (phase === "end" || phase === "error") requestFinalize(phase === "error" ? "failed" : "completed", accumulatedText || "No response from Enclawed.");
		}
	});
