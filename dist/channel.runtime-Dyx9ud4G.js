...
import { _ as resolveRequestClientIp } from "./net-DkWIq6k8.js";
import "./error-runtime-BGM6tzrQ.js";
import "./security-runtime-B2-Yl3T5.js";
import "./string-coerce-runtime-C86BPY1x.js";
import { a as createFixedWindowRateLimiter, r as WEBHOOK_RATE_LIMIT_DEFAULTS } from "./webhook-memory-guards-DQrIaEkk.js";
import { a as createWebhookInFlightLimiter, c as readWebhookBodyOrReject } from "./webhook-request-guards-BoGT1AcX.js";
import { t as normalizeWebhookPath } from "./webhook-path-BaQ-Vf05.js";
import { l as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute, s as resolveWebhookTargetWithAuthOrRejectSync } from "./webhook-targets-DkjJHWcs.js";
import "./webhook-ingress-Bua0eRIA.js";
import { F as resolveBlueBubblesEffectiveAllowPrivateNetwork, _ as normalizeWebhookReaction, g as normalizeWebhookMessage, o as probeBlueBubbles, t as fetchBlueBubblesServerInfo, u as asRecord } from "./probe-9iyNntNd.js";
import { t as getBlueBubblesRuntime } from "./runtime-BULLp7MS.js";
import { n as resolveWebhookPathFromConfig } from "./webhook-shared-DHCKBcGj.js";
import { a as resolveBlueBubblesMessageId, b as sendMessageBlueBubbles } from "./reactions-COH6ru0l.js";
import { i as sendBlueBubblesMedia, n as processMessage, r as processReaction, t as logVerbose } from "./monitor-processing-BbA7mgf2.js";
...
async function monitorBlueBubblesProvider(options) {
	...
	return await new Promise((resolve) => {
		...
		import("./catchup-toBrZ7Fg.js").then(({ runBlueBubblesCatchup }) => runBlueBubblesCatchup(target)).catch((err) => {
