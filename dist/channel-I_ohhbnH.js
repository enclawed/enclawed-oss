...
import { r as buildChannelConfigSchema } from "./config-schema-DUCpHehS.js";
...
import { C as projectAccountConfigWarningCollector, g as createAllowlistProviderOpenWarningCollector } from "./channel-policy-DBrWfvvg.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-w7hJ0giC.js";
import { i as createResolvedDirectoryEntriesLister } from "./directory-config-helpers-DVlvNCAU.js";
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-pVL77e8h.js";
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-n0O1TQZv.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-Csabf6e9.js";
import "./routing-Dqh5aJRb.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers--RJu1ACo.js";
import "./approval-delivery-runtime-Cvzv0uQX.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-Dv0QkH7k.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-TxFB2hz7.js";
import { n as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-Iw9i_LqT.js";
import "./approval-native-runtime-uCDVsI10.js";
...
import "./channel-core-CVHH086O.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-DMiPQjvN.js";
import "./session-store-runtime-DP0Ytj-o.js";
import "./string-coerce-runtime-Fz70XADm.js";
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-D2DtBiBO.js";
import "./channel-status-CKyzrO47.js";
import { t as extractToolSend } from "./tool-send-8AzJ_JNQ.js";
import { X as Optional, g as String$1 } from "./build-D6ni3YJD.js";
import { a as resolveMatrixAccountConfig } from "./account-config-BKqZoheG.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-CCnB8oa3.js";
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-CbF1iYQu.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-DhD-Fc2c.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-DtzyuWNQ.js";
import { n as normalizeMatrixUserId } from "./allowlist-BAfHaKya.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-CJ98bdpy.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-B3uCBHLg.js";
import { t as formatMatrixErrorMessage } from "./errors-DTkJb8Y0.js";
import { n as matrixConfigAdapter, t as MatrixConfigSchema } from "./config-schema-BXZo4qDC.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-DaYBMHkq.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-BAqJWQFp.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-DnPDt8a7.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-HUvfqQPb.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-Cne0kbdi.js";
import { i as autoPrepareLegacyMatrixCrypto, o as autoMigrateLegacyMatrixState, r as resolveMatrixMigrationStatus } from "./matrix-migration.runtime-BUFm0iR4.js";
import { t as maybeCreateMatrixMigrationSnapshot } from "./migration-snapshot-backup-BwKngM_n.js";
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-BeKFCU0n.js";
...
const matrixMessageActions = {
	...
	handleAction: async (ctx) => {
		const { handleMatrixAction } = await import("./tool-actions.runtime-CEV4ceMK.js");
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-T5pz42ld.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixChannelRuntime$1 = createLazyRuntimeNamedExport(() => import("./resolver.runtime-E3NL2N4f.js"), "matrixResolverRuntime");
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-DNFT08SO.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-BqT2hBjf.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixDoctor = {
	...
	runConfigSequence: async ({ cfg, env, shouldRepair }) => await (await import("./doctor-DFloAGu7.js")).runMatrixDoctorSequence({
		cfg,
		env,
		shouldRepair
	}),
	cleanStaleConfig: async ({ cfg }) => await (await import("./doctor-DFloAGu7.js")).cleanStaleMatrixPluginConfig(cfg)
};
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-DVk7VVxG.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
