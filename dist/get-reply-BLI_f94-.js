...
import { i as normalizeChannelId, r as listChannelPlugins, t as getChannelPlugin } from "./registry-CI36HBCI.js";
...
import { b as resolveAgentDir, g as listAgentEntries, l as resolveAgentSkillsFilter, p as resolveSessionAgentId, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-D-lQQ64_.js";
...
import { d as resetRegisteredAgentHarnessSessions } from "./registry-Bj1z72i4.js";
...
import { m as resolveModelRefFromString } from "./model-selection-DYKhuAoE.js";
import { S as resolveGroupSessionKey, f as resolveMaintenanceConfigFromInput, h as resolveSessionStoreEntry, o as updateSessionStore, v as deriveSessionMetaPatch } from "./store-BojxuYyw.js";
...
import { n as resolveSessionKey } from "./session-key-BoXmbYjY.js";
...
import { a as resolveAndPersistSessionFile } from "./transcript-DC2vF9Zz.js";
import { t as parseSessionThreadInfo } from "./thread-info-DBjL-slA.js";
import "./delivery-context-B53wctMG.js";
import { o as getQueueSize, r as clearCommandLane } from "./command-queue-AW6crC7V.js";
...
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-JOxthQIt.js";
...
import { r as disposeSessionMcpRuntime } from "./pi-bundle-mcp-tools-CeAO0GrH.js";
...
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, p as fireAndForgetHook, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-nnhyMpsE.js";
...
import { t as resolveQueueSettings } from "./queue-B9HfGcW9.js";
...
import { r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-DajiI9Tv.js";
...
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-BnnE3n-g.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-DOIBvmLZ.js";
import { t as resolveChannelModelOverride } from "./model-overrides-CK4XQ78v.js";
import { t as normalizeGroupActivation } from "./group-activation-iBBwSTJB.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-C0qUyts8.js";
import { t as resolveFastModeState } from "./fast-mode-CYXqc2rG.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-6V_zmbY8.js";
import { t as resolveCommandAuthorization } from "./command-auth-CKx_ptD_.js";
import { t as buildCommandContext } from "./commands-context-Dk_Msbrh.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-CCqoNN5_.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-DUsTHWDn.js";
...
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-Bh30YeNm.js";
...
import { t as drainFormattedSystemEvents } from "./session-system-events-BPe28pYT.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-u_hgjHdU.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-oGmsNPKw.js");
...
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-DCqHOZXb.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-DpvDA5yE.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-o_f_uApe.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-C9lOoAL3.js");
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-B6GjZf0u.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-CqrZHEzw.js");
...
async function handleInlineActions(params) {
	...
	const skillCommands = shouldLoadSkillCommands && params.skillCommands ? params.skillCommands : shouldLoadSkillCommands ? (await import("./skill-commands.runtime-CqrZHEzw.js")).listSkillCommandsForWorkspace({
		workspaceDir,
		cfg,
		agentId,
		skillFilter
	...
	if (skillInvocation) {
		...
		if (dispatch?.kind === "tool") {
			...
			const { createEnclawedTools } = await import("./enclawed-tools.runtime-t6EufZ_3.js");
	...
	if (!isStopLikeInbound && targetSessionEntry) {
		...
		if (cutoff) await (await import("./abort-cutoff.runtime-BKcdkXTQ.js")).clearAbortCutoffInSessionRuntime({
			sessionEntry: targetSessionEntry,
			sessionStore,
			sessionKey,
			storePath
	...
	if (handleInlineStatus) {
		const { buildStatusReply } = await import("./commands.runtime-qfvvrXCf.js");
	...
	const runCommands = async (commandInput) => {
		const { handleCommands } = await import("./commands.runtime-qfvvrXCf.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-DrZlDraf.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-BRBc2NsS.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-BLs59hYK.js");
	return agentRunnerRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-6AxjhcVR.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-BvsECLz1.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime--_8udRiS.js");
...
function loadHookRunnerGlobal() {
	hookRunnerGlobalPromise ??= import("./hook-runner-global-JB0UCiUR.js");
...
async function applyMediaUnderstandingIfNeeded(params) {
	...
	const { applyMediaUnderstanding } = await import("./apply.runtime-DuyS02xL.js");
	await applyMediaUnderstanding(params);
	return true;
}
async function applyLinkUnderstandingIfNeeded(params) {
	if (!hasLinkCandidate(params.ctx)) return false;
	const { applyLinkUnderstanding } = await import("./apply.runtime-h3r4sHUX.js");
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	const maybeEmitMissingResetHooks = async () => {
		...
		const { emitResetCommandHooks } = await import("./commands-core.runtime-BH8cxcMt.js");
