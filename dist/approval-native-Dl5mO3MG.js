...
import { n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-wVoeC-ve.js";
...
import { r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-CgccMlcy.js";
import { i as isDiscordExecApprovalClientEnabled, n as getDiscordExecApprovalApprovers, r as isDiscordExecApprovalApprover, t as shouldHandleDiscordApprovalRequest } from "./approval-shared-Bwy_zTMs.js";
...
function createDiscordApprovalCapability(configOverride) {
	return createApproverRestrictedNativeApprovalCapability({
		...
		nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
			...
			load: async () => (await import("./approval-handler.runtime-Dvr6gwSw.js")).discordApprovalNativeRuntime
		})
	});
}
