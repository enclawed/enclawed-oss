...
import { c as parseThreadSessionSuffix } from "./session-key-utils-qXY7QK1H.js";
...
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-CTKnZsG3.js";
import { d as readNumberParam, h as readStringParam, i as createActionGate, n as ToolAuthorizationError } from "./common-mDzRl__P.js";
import { t as adaptScopedAccountAccessor, u as createScopedDmSecurityResolver } from "./channel-config-helpers-D7nTNM6O.js";
import { C as projectAccountConfigWarningCollector, g as createAllowlistProviderOpenWarningCollector } from "./channel-policy-DfIhxgaQ.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-YugaiADj.js";
import { i as createResolvedDirectoryEntriesLister } from "./directory-config-helpers-DuXnr2sr.js";
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-BAYshBO_.js";
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-DE0EqXg8.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-CoB1mdbz.js";
import "./routing-_SeFXPvp.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-wVoeC-ve.js";
import "./approval-delivery-runtime-C-Iwr8HP.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-BP4xZui2.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-C6A8BT1H.js";
import { n as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-CNt_mGUd.js";
import "./approval-native-runtime-DHe_Npc8.js";
import "./outbound-runtime-D6Dcqfxk.js";
import "./conversation-runtime-zROIv0RL.js";
import { t as chunkTextForOutbound } from "./text-chunking-iilEkJUO.js";
...
import "./channel-core-udr8tdM6.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-BXQZOLtw.js";
import "./session-store-runtime-cT4Gqcbg.js";
import "./string-coerce-runtime-C86BPY1x.js";
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-DAIUgpkS.js";
import "./channel-status-CDe2FHZk.js";
import { t as extractToolSend } from "./tool-send-D2BcSm_h.js";
import { X as Optional, g as String$1 } from "./build-C8OtfxIR.js";
import { a as resolveMatrixAccountConfig } from "./account-config-DvbL3CQO.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-DJrvnFnW.js";
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-DdrHrSSw.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-ENajVOSq.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-B_DszpRB.js";
import { n as normalizeMatrixUserId } from "./allowlist-jjZs5N28.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-M5wdPLdN.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-XPB5a9ga.js";
import { t as formatMatrixErrorMessage } from "./errors-DFW-R2p9.js";
import { n as matrixConfigAdapter, t as MatrixConfigSchema } from "./config-schema-nsTz7jKi.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-uMiPaYED.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-Cdc70irs.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-Bekc698k.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-Bd6oV3Kd.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-C_2T7eAR.js";
import { i as autoPrepareLegacyMatrixCrypto, o as autoMigrateLegacyMatrixState, r as resolveMatrixMigrationStatus } from "./matrix-migration.runtime-iMZ-Y0VH.js";
import { t as maybeCreateMatrixMigrationSnapshot } from "./migration-snapshot-backup-B5v3eT80.js";
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-uDpnzfeT.js";
...
const MATRIX_PROFILE_MEDIA_PROPERTIES = {
	avatarUrl: Optional(String$1({ description: "Profile avatar URL for Matrix self-profile update actions. Matrix accepts mxc:// and http(s) URLs." })),
	avatar_url: Optional(String$1({ description: "snake_case alias of avatarUrl for Matrix self-profile update actions. Matrix accepts mxc:// and http(s) URLs." })),
	avatarPath: Optional(String$1({ description: "Local avatar file path for Matrix self-profile update actions. Matrix uploads this file and sets the resulting MXC URI." })),
	avatar_path: Optional(String$1({ description: "snake_case alias of avatarPath for Matrix self-profile update actions. Matrix uploads this file and sets the resulting MXC URI." }))
};
...
function buildMatrixProfileToolSchema() {
	return {
		actions: ["set-profile"],
		properties: {
			displayName: Optional(String$1({ description: "Profile display name for Matrix self-profile update actions." })),
			display_name: Optional(String$1({ description: "snake_case alias of displayName for Matrix self-profile update actions." })),
...
const matrixMessageActions = {
	...
	handleAction: async (ctx) => {
		const { handleMatrixAction } = await import("./tool-actions.runtime-C6awRERy.js");
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-YgAIddGP.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixChannelRuntime$1 = createLazyRuntimeNamedExport(() => import("./resolver.runtime-y4aFfbfb.js"), "matrixResolverRuntime");
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-Desy4vbi.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-DTaN57d7.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixDoctor = {
	...
	runConfigSequence: async ({ cfg, env, shouldRepair }) => await (await import("./doctor-CqdoctG3.js")).runMatrixDoctorSequence({
		cfg,
		env,
		shouldRepair
	}),
	cleanStaleConfig: async ({ cfg }) => await (await import("./doctor-CqdoctG3.js")).cleanStaleMatrixPluginConfig(cfg)
};
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-DdAbpWUu.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
