...
import { nn as ErrorCodes, rn as errorShape } from "./protocol-COkGKyb_.js";
import { c as jsonResult, h as readStringParam, s as imageResultFromFile } from "./common-BMEsSwt3.js";
import { t as callGatewayTool } from "./gateway-u_c4UwFM.js";
import { a as selectDefaultNodeFromList, i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-DPEN7Eok.js";
import { i as wrapExternalContent } from "./external-content-BG0h4WfB.js";
import "./text-runtime-CAI4yT_W.js";
import { t as startLazyPluginServiceModule } from "./lazy-service-module-ZbpNpvJC.js";
import { n as respondUnavailableOnNodeInvokeError } from "./nodes.helpers-CK-Ku7wc.js";
import { i as resolveNodeCommandAllowlist, n as isNodeCommandAllowed } from "./node-command-policy-BKwNXAY_.js";
import { t as BrowserToolSchema } from "./browser-tool.schema-B-0BEGWO.js";
import { t as withTimeout } from "./sdk-node-runtime-B7kNE_AM.js";
import "./sdk-security-runtime-DQ2o4Mo0.js";
import { D as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./cdp.helpers-Dodvjzj3.js";
import "./control-auth-C-gwKOQn.js";
import { c as resolveExistingPathsWithinRoot, i as resolveProfile, n as resolveBrowserConfig, s as DEFAULT_UPLOAD_DIR } from "./config-D7LuOO2G.js";
import "./sdk-setup-tools-CTPRMojk.js";
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-C51PaQrh.js";
import { c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as isPersistentBrowserProfileMutation, l as browserAct, n as persistBrowserProxyFiles, o as resolveRequestedBrowserProfile, p as browserScreenshotAction, s as browserConsoleMessages, t as applyBrowserProxyPaths, u as browserArmDialog } from "./browser-runtime-DfCK3pCM.js";
import { r as getBrowserProfileCapabilities } from "./target-id-YIJLvu42.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-DZTcSLrk.js"),
