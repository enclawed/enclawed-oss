import { t as createPluginRegistry } from "./registry-HWND2Ug6.js";
import { t as createPluginRecord } from "./status.test-helpers-xXq_mwtn.js";
...
function resolveExtensionDirByManifestId(pluginId) {
	...
	if (readJson(path.join(pluginDir, "enclawed.plugin.json"))?.id === pluginId) return pluginDir;
