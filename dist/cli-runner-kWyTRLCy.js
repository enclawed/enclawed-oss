...
import { f as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-V9eb4Uwu.js";
import "./pi-embedded-helpers-4LE2bkL2.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-DwwfFRmS.js";
//#region src/agents/cli-runner.ts
async function runCliAgent(params) {
	const { prepareCliRunContext } = await import("./prepare.runtime-GsLXCdBr.js");
	return runPreparedCliAgent(await prepareCliRunContext(params));
}
async function runPreparedCliAgent(context) {
	const { executePreparedCliRun } = await import("./execute.runtime-D_JO9LSZ.js");
