...
import { n as resolveGlobalDedupeCache } from "./dedupe-DHLZFhbO.js";
import { r as clearCommandLane } from "./command-queue-CCZ99txj.js";
import { n as normalizeQueueDropPolicy, r as normalizeQueueMode } from "./directive-CULTOAHk.js";
import { t as resolveEmbeddedSessionLane } from "./lanes-C8D3Qf2R.js";
import { t as isRoutableChannel } from "./route-reply-ia9gkxVj.js";
...
function waitForQueueDebounce(queue) {
	if (process.env.ENCLAWED_TEST_FAST === "1") return Promise.resolve();
...
const FOLLOWUP_QUEUES = resolveGlobalMap(Symbol.for("enclawed.followupQueues"));
...
const FOLLOWUP_RUN_CALLBACKS = resolveGlobalMap(Symbol.for("enclawed.followupDrainCallbacks"));
...
const RECENT_QUEUE_MESSAGE_IDS = resolveGlobalDedupeCache(Symbol.for("enclawed.recentQueueMessageIds"), {
	ttlMs: 300 * 1e3,
	maxSize: 1e4
});
