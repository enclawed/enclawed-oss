...
import { t as ensureMatrixCryptoRuntime } from "./deps-BIVpYWeO.js";
import { n as LogService, r as noop } from "./logger-CasR-M3r.js";
import { i as MATRIX_IDB_SNAPSHOT_LOCK_OPTIONS, n as isRepairableSecretStorageAccessError } from "./recovery-key-store-eiqOq52V.js";
...
async function loadMatrixCryptoNodeRuntime() {
	matrixCryptoNodeRuntimePromise ??= import("./crypto-node.runtime-DgLjxnLZ.js").catch((error) => {
...
function resolveDefaultIdbSnapshotPath() {
	const stateDir = process.env.ENCLAWED_STATE_DIR || path.join(process.env.HOME || "/tmp", ".enclawed");
