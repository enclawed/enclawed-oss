...
import { i as getChildLogger } from "./logger-wuQoU2z2.js";
...
import { d as resolveThreadSessionKeys, f as sanitizeAgentId, r as buildAgentMainSessionKey } from "./session-key-D8SZau-8.js";
import { i as getRuntimeConfigSnapshot } from "./runtime-snapshot-CZqO77WE.js";
import { S as resolveDefaultAgentId, b as resolveAgentDir } from "./agent-scope-5o1jve-2.js";
import { r as replaceConfigFile } from "./config-DOKACpaG.js";
import { s as getPluginCommandSpecs } from "./command-registration-DVi1CVoR.js";
import { t as createDedupeCache } from "./dedupe-B1sYMVJP.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-DSYfb2-U.js";
import { f as resolveDefaultModelForAgent } from "./model-selection-3QcDboLc.js";
import { a as modelSupportsVision, n as findModelInCatalog, r as loadModelCatalog } from "./model-catalog-DQh8b8if.js";
import { t as resolveAckReaction } from "./identity-IAiNDSmy.js";
import { h as resolveSessionStoreEntry, o as updateSessionStore } from "./store-eo7yB1I1.js";
...
import { a as projectOutboundPayloadPlanForDelivery, n as createOutboundPayloadPlan } from "./deliver-CNl357yl.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-ULobvdLo.js";
import { c as stripReasoningTagsFromText, d as isInsideCode, u as findCodeRegions } from "./assistant-visible-text-BKlRMt-f.js";
import { o as formatReasoningMessage } from "./pi-embedded-utils-DeN3F8e5.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-HJUX4WNh.js";
import { t as MediaFetchError } from "./fetch-xY5AfZMg.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy--05mfb-H.js";
import { c as resolveChannelStreamingPreviewToolProgress, i as resolveChannelStreamingBlockEnabled } from "./channel-streaming-DVpBWz6e.js";
import { c as resolveTextChunkLimit, s as resolveChunkMode } from "./chunk-_i16mZcD.js";
import { i as toInternalMessageReceivedContext, p as fireAndForgetHook } from "./message-hook-mappers-Cxw_O6Ld.js";
import { g as resolveChannelConfigWrites } from "./channel-config-helpers-D7nTNM6O.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-BDbWw8vc.js";
...
import { n as maybeResolveTextAlias, r as normalizeCommandBody } from "./commands-registry-normalize-CoM1FF5X.js";
import { n as isAbortRequestText } from "./abort-primitives-eBUWHlCF.js";
import { t as hasControlCommand } from "./command-detection-D2374ct_.js";
import { c as listNativeCommandSpecsForConfig, d as resolveCommandArgMenu, i as formatCommandArgMenuTitle, l as parseCommandArgs, n as buildCommandTextFromArgs, r as findCommandByNativeName, s as listNativeCommandSpecs } from "./commands-registry-kc2RkbyN.js";
...
import { i as matchesMentionWithExplicit, n as buildMentionRegexes } from "./mentions-Bgg__hqZ.js";
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher-CMHCJV5M.js";
import { i as shouldAckReaction, n as removeAckReactionAfterReply } from "./ack-reactions-C9zISXOO.js";
import { n as resolveControlCommandGate, t as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-DLPAMnWl.js";
import { n as resolveInboundMentionDecision, t as implicitMentionKindWhen } from "./mention-gating-ClUrSSKZ.js";
import { c as clearHistoryEntriesIfEnabled, d as recordPendingHistoryEntryIfEnabled, o as buildPendingHistoryContextFromMap } from "./history-biycvTyX.js";
import { o as hasFinalChannelTurnDispatch } from "./kernel-D_Cmk4cs.js";
import { t as evaluateSupplementalContextVisibility } from "./context-visibility-qBMmaAxw.js";
import { t as resolveMarkdownTableMode } from "./markdown-tables-CxdhDl6o.js";
import { a as readChannelAllowFromStore, d as upsertChannelPairingRequest } from "./pairing-store-f0EMbN2m.js";
import { t as firstDefined } from "./allow-from-B9qoXme1.js";
import "./channel-policy-DfIhxgaQ.js";
import "./reply-history-Dq3jEIjW.js";
...
import { d as parseExecApprovalCommandText } from "./exec-approval-reply-DXBP45LV.js";
import "./approval-reply-runtime-Zicxp9b0.js";
import { t as resolveChannelContextVisibilityMode } from "./context-visibility-BXXCt_ZN.js";
...
import "./config-mutation-B_Es1P3Q.js";
import { t as resolveCommandAuthorization } from "./command-auth-xz02w0V2.js";
import { t as resolveStoredModelOverride } from "./stored-model-override-B1cGekJY.js";
import { n as isBtwRequestText } from "./btw-command-R4uy827T.js";
import { t as generateConversationLabel } from "./reply-runtime-wZGG7VqN.js";
...
import "./outbound-runtime-D6Dcqfxk.js";
import "./runtime-config-snapshot-DpwiPgJG.js";
import "./model-session-runtime-BfqkiSQt.js";
import "./media-runtime-C7OYyRri.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-CF48GUmH.js";
import "./conversation-runtime-zROIv0RL.js";
import { d as resolveThreadBindingSpawnPolicy, l as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel } from "./thread-bindings-policy-s3DnUDZm.js";
...
import "./hook-runtime-CqXCQjt4.js";
import "./markdown-table-runtime-kkOyy7R8.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-BKUk3ajD.js";
...
import { n as formatModelsAvailableHeader } from "./commands-models-DPl-KNMU.js";
import "./command-auth-native-CDVz1MqF.js";
import "./command-primitives-runtime-QaQdq4Pd.js";
import "./command-status-B89DN2-P.js";
import "./command-detection-BrQCGMGn.js";
import "./command-surface-ZZVdflf4.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-Dy0jyfcu.js";
import { n as DEFAULT_EMOJIS, r as DEFAULT_TIMING } from "./channel-feedback-BOMZTn-y.js";
import { n as shouldDebounceTextInbound } from "./channel-inbound-BMrCQUzu.js";
import { n as toLocationContext, t as formatLocationText } from "./location-Cy2FRXmC.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-BXQZOLtw.js";
import "./session-store-runtime-cT4Gqcbg.js";
import "./models-provider-runtime-DaMo8YgG.js";
import "./skill-commands-runtime-xiHLlOwD.js";
import "./native-command-config-runtime-DDSxjUK0.js";
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-DrX0pE1m.js";
import { $ as withResolvedTelegramForumFlag, A as isSafeToRetrySendError, B as buildTelegramRoutingTarget, C as withTelegramApiErrorLogging, D as renderTelegramHtmlText, F as tagTelegramNetworkError, H as buildTypingThreadParams, I as buildGroupLabel, J as resolveTelegramForumThreadId, K as resolveTelegramDirectPeerId, L as buildTelegramGroupFrom, Q as resolveTelegramThreadSpec, R as buildTelegramGroupPeerId, U as describeReplyTarget, V as buildTelegramThreadParams, W as extractTelegramForumFlag, X as resolveTelegramReplyId, Y as resolveTelegramGroupAllowFromContext, Z as resolveTelegramStreamMode, a as editMessageTelegram, at as hasBotMention, dt as normalizeAllowFrom, et as buildSenderLabel, ft as normalizeDmAllowFromWithStore, g as recordSentMessage, it as getTelegramTextParts, j as isTelegramClientRejection, k as isRecoverableTelegramNetworkError, lt as resolveTelegramPrimaryMedia, nt as expandTextLinks, pt as resolveSenderAllowMatch, q as resolveTelegramForumFlag, rt as extractTelegramLocation, st as normalizeForwardedContext, tt as buildSenderName, ut as isSenderAllowed, x as buildInlineKeyboard, z as buildTelegramParentPeer } from "./send-Dymk4nAw.js";
import { o as normalizeTelegramApiRoot, r as resolveTelegramTransport } from "./fetch-DzfhkcBF.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-BO43JBD7.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-XjQhnYuH.js";
import { d as buildModelsKeyboard, g as resolveModelSelection, h as parseModelCallbackData, m as getModelsPageSize, o as buildTelegramModelsMenuButtons, p as calculateTotalPages, t as buildCommandsPaginationKeyboard } from "./command-ui-x8rtUjSD.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-CsIJbDxK.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-DH_EyX4_.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-BjPFdWLw.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-C2A3I57L.js";
import { a as buildPluginTelegramMenuCommands, i as buildCappedTelegramMenuCommands, n as resolveTelegramExecApproval, o as syncTelegramMenuCommands, r as createTelegramDraftStream, t as defaultTelegramBotDeps } from "./bot-deps-CR46ZL8u.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-Bo4HYw6K.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-BpTXuRGq.js");
...
async function loadTelegramNativeCommandDeliveryRuntime() {
	telegramNativeCommandDeliveryRuntimePromise ??= import("./bot-native-commands.delivery.runtime-_jH7EuS2.js");
...
async function loadTelegramNativeCommandRuntime() {
	telegramNativeCommandRuntimePromise ??= import("./bot-native-commands.runtime-BrmZkoWJ.js");
...
function loadStickerVisionRuntime() {
	stickerVisionRuntimePromise ??= import("./sticker-vision.runtime-2MFXsbYT.js");
	return stickerVisionRuntimePromise;
}
function loadMediaUnderstandingRuntime() {
	mediaUnderstandingRuntimePromise ??= import("./media-understanding.runtime-HsNrFBXA.js");
...
async function loadTelegramMessageContextSessionRuntime(runtime) {
	...
	return {
		...await import("./bot-message-context.session.runtime-CcEEjTUv.js"),
		...runtime
	};
}
...
async function loadTelegramMessageContextRuntime() {
	telegramMessageContextRuntimePromise ??= import("./bot-message-context.runtime-DLLsHtU8.js");
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-C4gCTCfg.js")).defaultTelegramBotDeps;
...
const createTelegramMessageProcessor = (deps) => {
	...
	return async (primaryCtx, allMedia, storeAllowFrom, options, replyMedia) => {
		...
		const ingressDebugEnabled = shouldLogVerbose() || process.env.ENCLAWED_DEBUG_TELEGRAM_INGRESS === "1";
		...
		try {
			...
			if (is401Error(error)) {
				...
				if (consecutive401Failures >= maxConsecutive401) {
					suspended = true;
					logger(`CRITICAL: sendChatAction suspended after ${consecutive401Failures} consecutive 401 errors. Bot token is likely invalid. Telegram may DELETE the bot if requests continue. Replace the token and restart: enclawed channels restart telegram`);
