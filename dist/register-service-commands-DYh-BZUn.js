...
function loadDaemonInstallModule() {
	daemonInstallModulePromise ??= import("./install.runtime-Bx6HmKgo.js");
	return daemonInstallModulePromise;
}
function loadDaemonLifecycleModule() {
	daemonLifecycleModulePromise ??= import("./lifecycle.runtime-Ch-IcbSD.js");
	return daemonLifecycleModulePromise;
}
function loadDaemonStatusModule() {
	daemonStatusModulePromise ??= import("./status.runtime-Dq1UUbLZ.js");
