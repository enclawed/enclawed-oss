...
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-CTqQIWT8.js";
...
import { i as hasNonEmptyString } from "./channel-target-BNUY5Oi4.js";
...
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-B3xhHVp3.js");
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-B-qX5vSJ.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-DCXPceRl.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-BbbzhNM6.js");
...
async function loadPluginMetadataRegistryLoaderModule() {
	pluginMetadataRegistryLoaderModulePromise ??= import("./metadata-registry-loader-Co7v0U5U.js");
...
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-ta4R4V_n.js"),
		import("./probe-auth-DAr-Sefc.js"),
		import("./probe-BZSPzflL.js")
