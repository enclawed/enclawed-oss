...
import { d as readStringValue, i as normalizeLowercaseStringOrEmpty, s as normalizeOptionalString$1 } from "./string-coerce-BUSzWgUA.js";
...
import { L as withNoProxyForCdpUrl, c as isWebSocketUrl, i as fetchJson, l as normalizeCdpHttpBaseForJsonEndpoints, n as assertCdpEndpointAllowed, o as getHeadersWithAuth, p as withCdpSocket, t as appendCdpPath } from "./cdp.helpers-D-cV1SL9.js";
import { c as BrowserTabNotFoundError } from "./errors-N-pAFIK4.js";
import { a as DEFAULT_DOWNLOAD_DIR, l as resolveStrictExistingPathsWithinRoot, o as DEFAULT_TRACE_DIR, s as DEFAULT_UPLOAD_DIR } from "./config-BGK7hjIz.js";
import "./tmp-enclawed-dir-BV_knU9X.js";
import { C as assertBrowserNavigationResultAllowed, S as assertBrowserNavigationRedirectChainAllowed, T as withBrowserNavigationPolicy, b as InvalidBrowserNavigationUrlError, f as formatAriaSnapshot, l as AX_REF_PATTERN, p as normalizeCdpWsUrl, t as getChromeWebSocketUrl, x as assertBrowserNavigationAllowed } from "./chrome-Cly_bXYW.js";
...
import { n as markPwAiLoaded } from "./pw-ai-state-CLvHGiid.js";
...
const BROWSER_REF_MARKER_ATTRIBUTE = "data-enclawed-browser-ref";
...
async function screenshotWithLabelsViaPlaywright(opts) {
	...
	try {
		if (boxes.length > 0) await page.evaluate((labels) => {
			document.querySelectorAll("[data-enclawed-labels]").forEach((el) => el.remove());
...
async function responseBodyViaPlaywright(opts) {
	...
	const resp = await new Promise((resolve, reject) => {
		...
		timer = setTimeout(() => {
			...
			cleanup();
			reject(/* @__PURE__ */ new Error(`Response not found for url pattern "${pattern}". Run 'enclawed browser requests' to inspect recent network activity.`));
		}, timeout);
	});
	const url = resp.url?.() || "";
