...
import { a as hasConfiguredSecretInput, c as normalizeResolvedSecretInputString, l as normalizeSecretInputString } from "./types.secrets-C7GHgMrh.js";
import { u as isPrivateIpAddress } from "./ssrf-DjpVlwtu.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-CgHO6oDe.js";
import "./text-runtime-DwWuUy-T.js";
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, l as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-BIENEBhb.js";
import "./ssrf-runtime-DcbzcBnU.js";
import "./secret-input-D4aoy0EX.js";
import { t as getMSTeamsRuntime } from "./runtime-api-D9njCW4Q.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-D1_eXbbK.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-EyQL0rNb.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-CaljsYyn.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-CMDlw9Ti.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-Bz_ceBOO.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
