...
import { r as toPosixPath } from "./runtime-parse-B4f0N4H3.js";
import { c as resolveGatewayLogPaths } from "./launchd-rGW6yyft.js";
import { t as formatRuntimeStatusWithDetails } from "./runtime-status-B5-wgtyw.js";
//#region src/daemon/container-context.ts
function resolveDaemonContainerContext(env = process.env) {
	return normalizeOptionalString(env.ENCLAWED_CONTAINER_HINT) || normalizeOptionalString(env.ENCLAWED_CONTAINER) || null;
}
//#endregion
