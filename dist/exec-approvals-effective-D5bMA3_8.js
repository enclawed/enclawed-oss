...
import { D as resolveExecApprovalsFromFile, f as minSecurity, t as DEFAULT_EXEC_APPROVAL_ASK_FALLBACK, u as maxAsk, w as resolveExecApprovalAllowedDecisions } from "./exec-approvals-C0ZBCFVO.js";
...
function formatRequestedSource(params) {
	return params.sourcePath === "__default__" ? `Enclawed default (${params.defaultValue})` : `${params.sourcePath}.${params.field}`;
}
...
function formatHostFieldSource(params) {
	...
	if (params.field === "askFallback") return `Enclawed default (${DEFAULT_EXEC_APPROVAL_ASK_FALLBACK})`;
...
function resolveExecPolicyScopeSnapshot(params) {
	...
	return {
		...
		host: {
			...
			requestedSource: requestedHost.sourcePath === "__default__" ? "Enclawed default (auto)" : `${requestedHost.sourcePath === "scope" ? params.configPath : requestedHost.sourcePath}.host`
		},
		security: {
