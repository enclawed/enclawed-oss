...
import { r as buildChannelConfigSchema, t as AllowFromListSchema } from "./config-schema-DK9qgQyA.js";
import "./account-id-BV5xNTUp.js";
import { n as deleteAccountFromConfigSection, r as setAccountEnabledInConfigSection } from "./config-helpers-DeB0V4rE.js";
import "./channel-config-schema-DzHc6HwP.js";
import { t as applyAccountNameToChannelSection } from "./setup-helpers-N8CZo8-E.js";
import "./core-Cp6Nf0m-.js";
import { J as setSetupChannelEnabled, f as createStandardChannelSetupStatus } from "./setup-wizard-helpers-CS_53KKZ.js";
import "./setup-DmN38teW.js";
import "./setup-tools-DtD8PoC1.js";
import { r as buildSecretInputSchema } from "./secret-input-BTSKYAzZ.js";
import { n as normalizeLowercaseStringOrEmpty } from "./string-normalize-DWA3ypgp.js";
import { a as isAccountConfigured, i as formatAllowFrom, n as applyAccountConfig, r as describeAccount } from "./resolve-BCPINIhA.js";
import { a as resolveQQBotAccount, i as resolveDefaultQQBotAccountId, n as applyQQBotAccountConfig, r as listQQBotAccountIds } from "./config-PiNYbSCI.js";
import { z } from "zod";
...
async function linkViaQrCode(params) {
	try {
		const { qrConnect } = await import("./esm-uupkcgZq.js");
		const accounts = await qrConnect({ source: "enclawed" });
...
async function finalizeQQBotSetup(params) {
	...
	else if (!configured) await params.prompter.note(["您可以稍后运行以下命令重新选择 QQ Bot 进行配置：", "  enclawed channels add"].join("\n"), "QQ Bot");
	return { cfg: next };
}
//#endregion
