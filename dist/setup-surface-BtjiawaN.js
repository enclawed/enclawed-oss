...
import { Q as splitSetupEntries, f as createStandardChannelSetupStatus, g as createTopLevelChannelGroupPolicySetter, m as createTopLevelChannelDmPolicy, p as createTopLevelChannelAllowFromSetter, v as mergeAllowFromEntries } from "./setup-wizard-helpers-DFTrn_L5.js";
import "./setup-VPD7U-J0.js";
import "./setup-tools-DPe9M99N.js";
import { D as formatUnknownError, g as saveDelegatedTokens, h as resolveMSTeamsCredentials, p as hasConfiguredMSTeamsCredentials } from "./graph-users-BEmleYbC.js";
import { c as resolveMSTeamsUserAllowlist, o as parseMSTeamsTeamEntry, s as resolveMSTeamsChannelAllowlist } from "./resolve-allowlist-CuaGPv6T.js";
	...
	finalize: async (params) => {
		...
		if (finalCreds?.type === "secret") {
			if (await params.prompter.confirm({
				...
				try {
					const { loginMSTeamsDelegated } = await import("./oauth-CI-SQ8Db.js");
					const { shouldUseManualOAuthFlow } = await import("./oauth.flow-Bf_1drbj.js");
