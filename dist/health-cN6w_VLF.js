...
import { n as isRich } from "./theme-hNdBadll.js";
...
import { a as resolvePreferredAccountId, t as buildChannelAccountBindings } from "./bindings-DkIEOd2Q.js";
...
import { t as styleHealthChannelLine } from "./health-style-DalvBDPS.js";
import { t as logGatewayConnectionDetails } from "./status.gateway-connection-t2XEWN-o.js";
//#region src/commands/health.ts
const DEFAULT_TIMEOUT_MS = 1e4;
const debugHealth = (...args) => {
	if (isTruthyEnvValue(process.env.ENCLAWED_DEBUG_HEALTH)) console.warn("[health:debug]", ...args);
};
...
const buildSessionSummary = async (storePath) => {
	const { loadSessionStore } = await import("./store-DXi-tACm.js");
...
async function readBestEffortHealthConfig() {
	const { readBestEffortConfig } = await import("./config-oH4g1wOm.js");
