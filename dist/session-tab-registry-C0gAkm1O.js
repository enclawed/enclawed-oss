...
import { n as getBridgeAuthForPort } from "./bridge-auth-registry-nydUwQ7V.js";
import { h as resolveBrowserRateLimitMessage } from "./cdp.helpers-D-cV1SL9.js";
import { n as resolveBrowserControlAuth } from "./control-auth-sGa336au.js";
...
async function fetchBrowserJson(url, init) {
	...
	try {
		...
		const { dispatchBrowserControlRequest } = await import("./local-dispatch.runtime-DFeaMBrm.js");
