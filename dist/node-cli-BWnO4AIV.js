...
import { r as theme, t as colorize } from "./theme-hNdBadll.js";
import { t as formatCliCommand } from "./command-format-CAEA84sd.js";
import { c as sanitizeSystemRunEnvOverrides, o as sanitizeHostExecEnv, t as inspectHostExecEnvOverrides } from "./host-env-security-CSPdLugP.js";
import { _ as resolveNodeSystemdServiceName, g as resolveNodeLaunchAgentLabel, u as formatNodeServiceDescription, v as resolveNodeWindowsTaskName } from "./paths-HxbQFXGH.js";
import { a as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-D6IJGPbR.js";
import { n as VERSION } from "./version-CeugVlbG.js";
import { s as buildNodeServiceEnvironment } from "./runtime-paths-C0Np3ULF.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-3pRKLH22.js";
import { a as logWarn } from "./logger-CKs2nJWp.js";
...
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-B3GobEpJ.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-CjD0p234.js";
...
import { _ as resolvePlannedSegmentArgv, c as describeInterpreterInlineEval, d as analyzeArgvCommand, l as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-DnhLAGDd.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-Ckl9uf2z.js";
...
import { t as resolveGatewayConnectionAuth } from "./connection-auth-Dwv4UUJb.js";
import { t as formatHelpExamples } from "./help-format-02fn-Ugc.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-9-N4ayAt.js";
import { t as ensureEnclawedCliOnPath } from "./path-env-BbNnc4Ca.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-B55_sTkx.js";
import { t as resolveNodeService } from "./node-service-BjL1_CxY.js";
...
async function loadSystemRunConfig(opts) {
	...
	const { loadConfig } = await import("./config-RgefBQTR.js");
	return loadConfig();
}
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-SHk4luyl.js");
