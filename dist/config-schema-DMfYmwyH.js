...
import { r as buildChannelConfigSchema, t as AllowFromListSchema } from "./config-schema-D28_eKLn.js";
import "./account-id-6Mvnxe99.js";
import { n as deleteAccountFromConfigSection, r as setAccountEnabledInConfigSection } from "./config-helpers-CaWg62VO.js";
import "./channel-config-schema-BBS54TxV.js";
import { t as applyAccountNameToChannelSection } from "./setup-helpers-Dsxp4-4J.js";
import "./core-CoB1mdbz.js";
import { J as setSetupChannelEnabled, f as createStandardChannelSetupStatus } from "./setup-wizard-helpers-A7VVNxLn.js";
import "./setup-D1QaGmiu.js";
import "./setup-tools-CKf2a8Ba.js";
import { r as buildSecretInputSchema } from "./secret-input-D4aoy0EX.js";
import { n as normalizeLowercaseStringOrEmpty } from "./string-normalize-l3p6ov3Q.js";
import { a as isAccountConfigured, i as formatAllowFrom, n as applyAccountConfig, r as describeAccount } from "./resolve-CrYwpb7k.js";
import { a as resolveQQBotAccount, i as resolveDefaultQQBotAccountId, n as applyQQBotAccountConfig, r as listQQBotAccountIds } from "./config-CZtofqLT.js";
import { z } from "zod";
...
async function linkViaQrCode(params) {
	try {
		const { qrConnect } = await import("./esm-uh7eS6VH.js");
