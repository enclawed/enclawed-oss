...
import { S as resolveDefaultAgentId, b as resolveAgentDir } from "./agent-scope-D-lQQ64_.js";
import { r as replaceConfigFile } from "./config-DDWYoiuw.js";
...
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-DME9Vvkn.js";
...
import { t as resolveAckReaction } from "./identity-BvKgoUTt.js";
import { h as resolveSessionStoreEntry, o as updateSessionStore } from "./store-BojxuYyw.js";
...
import { a as projectOutboundPayloadPlanForDelivery, n as createOutboundPayloadPlan } from "./deliver-Cm9sSV1G.js";
...
import { t as MediaFetchError } from "./fetch-OzBqub2H.js";
...
import { i as toInternalMessageReceivedContext, p as fireAndForgetHook } from "./message-hook-mappers-nnhyMpsE.js";
import { g as resolveChannelConfigWrites } from "./channel-config-helpers-bOV5DWOp.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-C6pTQjkz.js";
...
import { c as listNativeCommandSpecsForConfig, d as resolveCommandArgMenu, i as formatCommandArgMenuTitle, l as parseCommandArgs, n as buildCommandTextFromArgs, r as findCommandByNativeName, s as listNativeCommandSpecs } from "./commands-registry-D3ZZcZ9T.js";
...
import { i as matchesMentionWithExplicit, n as buildMentionRegexes } from "./mentions-BnnE3n-g.js";
...
import { c as clearHistoryEntriesIfEnabled, d as recordPendingHistoryEntryIfEnabled, o as buildPendingHistoryContextFromMap } from "./history-fro5qpjb.js";
import { o as hasFinalChannelTurnDispatch } from "./kernel-46wWFnRV.js";
...
import "./reply-history-BGJulaMe.js";
...
import { d as parseExecApprovalCommandText } from "./exec-approval-reply-CqCsY5Z2.js";
...
import "./config-mutation-C6rVmDBS.js";
...
import { n as isBtwRequestText } from "./btw-command-CSYUNVrR.js";
import { t as generateConversationLabel } from "./reply-runtime-Dtx8ZDJ1.js";
...
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-WSkWfZVs.js";
import "./conversation-runtime-BItojExU.js";
import { d as resolveThreadBindingSpawnPolicy, l as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel } from "./thread-bindings-policy-DErtLNPQ.js";
...
import "./hook-runtime-C4TJpzwG.js";
import "./markdown-table-runtime-B0MD3AFy.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-grR85B5e.js";
...
import { n as formatModelsAvailableHeader } from "./commands-models-6puivz43.js";
import "./command-auth-native-_fJa7XRr.js";
import "./command-primitives-runtime-CgZF3nEt.js";
import "./command-status-DBLHLbln.js";
import "./command-detection-DwXRvySF.js";
import "./command-surface-CxqKthCW.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-Cru0oRjv.js";
import { n as DEFAULT_EMOJIS, r as DEFAULT_TIMING } from "./channel-feedback-CZzltw2Y.js";
import { n as shouldDebounceTextInbound } from "./channel-inbound-B7ctqE9N.js";
...
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-C5fCbvrI.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-Cqd83Hdi.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-B6zwGvS-.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-DEk1wC7M.js";
import { a as buildPluginTelegramMenuCommands, i as buildCappedTelegramMenuCommands, n as resolveTelegramExecApproval, o as syncTelegramMenuCommands, r as createTelegramDraftStream, t as defaultTelegramBotDeps } from "./bot-deps-B_mcjYrk.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-h_QWQGaZ.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-BdHmo4Kc.js");
...
async function loadTelegramNativeCommandDeliveryRuntime() {
	telegramNativeCommandDeliveryRuntimePromise ??= import("./bot-native-commands.delivery.runtime-_gshraGn.js");
...
async function loadTelegramNativeCommandRuntime() {
	telegramNativeCommandRuntimePromise ??= import("./bot-native-commands.runtime-rdNIv77M.js");
...
function loadStickerVisionRuntime() {
	stickerVisionRuntimePromise ??= import("./sticker-vision.runtime-ClZMIHU2.js");
	return stickerVisionRuntimePromise;
}
function loadMediaUnderstandingRuntime() {
	mediaUnderstandingRuntimePromise ??= import("./media-understanding.runtime-BuJUrmAV.js");
...
async function loadTelegramMessageContextSessionRuntime(runtime) {
	...
	return {
		...await import("./bot-message-context.session.runtime-_peTtXUc.js"),
		...runtime
	};
}
...
async function loadTelegramMessageContextRuntime() {
	telegramMessageContextRuntimePromise ??= import("./bot-message-context.runtime-CcYD7Dp1.js");
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-BQ5NdnuH.js")).defaultTelegramBotDeps;
