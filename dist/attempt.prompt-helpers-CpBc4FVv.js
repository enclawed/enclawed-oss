...
import { v as shortenHomeInString } from "./utils-BcQ7uNrT.js";
import { a as isSubagentSessionKey, i as isCronSessionKey } from "./session-key-utils-qXY7QK1H.js";
import { s as joinPresentTextSegments } from "./hook-runner-global-mFbFyRwr.js";
import { n as sleepWithAbort } from "./backoff-D8FAZIeO.js";
import { t as derivePromptTokens } from "./usage-CwW0G6C9.js";
import { i as enqueueCommandInLane, o as getQueueSize } from "./command-queue-DQC1ydD8.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-h7kutsRA.js";
import { n as prependSystemPromptAdditionAfterCacheBoundary } from "./system-prompt-cache-boundary-fpsgXwVt.js";
import { t as log } from "./logger-UWzJtLV8.js";
import { r as resolveToolDisplay } from "./tool-display-DE5dx1yB.js";
import { r as resolveEffectiveToolFsWorkspaceOnly } from "./tool-fs-policy-DADdFRh7.js";
import { d as findActiveSessionTask, n as buildActiveVideoGenerationTaskPromptContextForSession, s as buildActiveMusicGenerationTaskPromptContextForSession } from "./video-generation-task-status-CUdNG2Dn.js";
import { c as recordTaskRunProgressByRunId, d as startTaskRunByRunId, i as createQueuedTaskRun, o as failTaskRunByRunId, r as completeTaskRunByRunId, u as setDetachedTaskDeliveryStatusByRunId } from "./task-executor-DF7aWa4R.js";
import { r as resolveSessionLane } from "./lanes-DniDWYPx.js";
import { c as updateTaskNotifyPolicyForOwner, i as findTaskByRunIdForOwner, n as cancelTaskByIdForOwner } from "./task-owner-access-BuNFdXJg.js";
import { n as rewriteTranscriptEntriesInSessionManager, t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-BLt_Z1Fd.js";
import { t as buildEmbeddedCompactionRuntimeContext } from "./compaction-runtime-context-BQb8cE6I.js";
...
/**
* Wrap a tool detail as an inline code span.
*
* This used to return the value UNWRAPPED whenever it contained a backtick --
* the one case where wrapping matters most. Tool details carry command lines,
* paths and arguments, i.e. content the far side can influence, and an
* unwrapped detail is emitted straight into a markdown message where its
* backticks are then interpreted.
*
* CommonMark allows a code span to be delimited by any run of backticks longer
* than the longest run inside it, with one space of padding that the renderer
* strips. So a detail containing a single backtick is delimited by two.
*/
