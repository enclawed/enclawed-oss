import { i as verifyTelnyxWebhook, t as guardedJsonApiRequest } from "./guarded-json-api-BEdSZHFk.js";
...
var TelnyxProvider = class {
	...
	*/
	async answerCall(input) {
		await this.apiRequest(`/calls/${input.providerCallId}/actions/answer`, { command_id: `enclawed-answer-${input.callId}` });
	}
	/**
