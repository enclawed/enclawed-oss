...
import { f as resolveConfigDir, g as resolveUserPath, l as isRecord } from "./utils-BcQ7uNrT.js";
...
import { d as resolveSecretInputRef, i as coerceSecretRef } from "./types.secrets-C7GHgMrh.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, l as resolveDefaultSecretProviderAlias, o as isValidExecSecretRefId, u as secretRefKey } from "./ref-contract-UQhW34sh.js";
import { t as danger } from "./globals-D8R_YQwt.js";
import { t as runTasksWithConcurrency } from "./run-with-concurrency-CuRwaxi7.js";
import { a as parseEnvValue, i as parseDotPath, l as writeTextFileAtomic, n as isNonEmptyString, s as toDotPath } from "./shared-S-P3eT9D.js";
import { a as resolveSecretRefValue, o as resolveSecretRefValues, r as isProviderScopedSecretResolutionError } from "./resolve-DVl7buUu.js";
import { t as isSafeExecutableValue } from "./exec-safety-CSu8zMTE.js";
import { w as SecretProviderSchema } from "./zod-schema.core-VW7GXHL-.js";
...
import { r as listKnownSecretEnvVarNames, t as getProviderEnvVars } from "./provider-env-vars-reCe_d7o.js";
import { S as resolveDefaultAgentId, _ as listAgentIds, b as resolveAgentDir, v as resolveAgentConfig } from "./agent-scope-5o1jve-2.js";
import "./config-DOKACpaG.js";
import { l as resolveAuthStorePath } from "./source-check-WHC0RF1m.js";
import { f as coercePersistedAuthProfileStore, o as loadAuthProfileStoreForSecretsRuntime, p as loadPersistedAuthProfileStore } from "./store-J7Io5AUg.js";
import { f as isSecretRefHeaderValueMarker, u as isNonSecretApiKeyMarker } from "./model-auth-markers-CZACM95M.js";
import "./model-selection-3QcDboLc.js";
import "./auth-profiles-CWIWzE4_.js";
import { a as prepareSecretsRuntimeSnapshot } from "./runtime-Bbe-15LK.js";
import { n as getPath, r as setPathCreateStrict, t as deletePathStrict } from "./path-utils-ClUbo6wq.js";
import { n as hasConfiguredPlaintextSecretValue, r as isExpectedResolvedSecretValue, t as assertExpectedResolvedSecretValue } from "./secret-value-Dzdbs38i.js";
import { a as listAuthProfileSecretTargetEntries, c as resolvePlanTargetAgainstRegistry, n as discoverConfigSecretTargets, t as discoverAuthProfileSecretTargets } from "./target-registry-se_Ryd0R.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-CiMkSrD5.js";
...
function buildConfigureCandidatesForScope(params) {
	...
	const enclawedCandidates = discoverConfigSecretTargets(params.config).filter((entry) => entry.entry.includeInConfigure).map((entry) => {
	...
	return [...enclawedCandidates, ...authCandidates].toSorted((a, b) => configureCandidateSortKey(a).localeCompare(configureCandidateSortKey(b)));
}
	...
	if (!params.providersOnly) {
		...
		while (true) {
			...
			const options = visibleCandidates.map((candidate) => ({
				...
				hint: [candidate.configFile === "auth-profiles.json" ? "auth-profiles.json" : "enclawed.json", candidate.isDerived === true ? "derived" : void 0].filter(Boolean).join(" | ")
			}));
			options.push({
