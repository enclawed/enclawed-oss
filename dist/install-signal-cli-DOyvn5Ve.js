...
import { t as runPluginCommandWithTimeout } from "./run-command-3f57TTjs.js";
import { o as extractArchive } from "./archive-BEBKNivK.js";
...
async function installSignalCliFromRelease(runtime) {
	...
	const tmpDir = await fs$1.mkdtemp(path.join(resolvePreferredEnclawedTmpDir(), "enclawed-signal-"));
