...
function formatPairingApproveHint(channelId) {
	return `Approve via: ${formatCliCommand(`enclawed pairing list ${channelId}`)} / ${formatCliCommand(`enclawed pairing approve ${channelId} <code>`)}`;
}
