...
import { n as formatRawAssistantErrorForUi, t as extractLeadingHttpStatus } from "./assistant-error-format-CC5yyFEh.js";
import { n as classifyOAuthRefreshFailure } from "./oauth-refresh-failure-BUBecYZm.js";
import { a as formatTransportErrorCopy, c as isLikelyHttpErrorText, g as formatExecDeniedUserMessage, i as formatRateLimitOrOverloadedErrorCopy, l as isRawApiErrorPayload, n as formatBillingErrorMessage, r as formatDiskSpaceErrorCopy, s as isInvalidStreamingEventOrderError } from "./sanitize-user-facing-text-DC3SMoyx.js";
import { t as isModelNotFoundErrorMessage } from "./live-model-errors-DSEB4lQk.js";
import { t as formatSandboxToolPolicyBlockedMessage } from "./runtime-status-B4BSehWa.js";
...
function classifyFailoverReason(raw, opts) {
	...
	const reasonFrom402Text = leadingStatus?.code === 402 ? classifyFailoverReasonFrom402Text(trimmed) : null;
	if (leadingStatus?.code === 402 && !reasonFrom402Text && !isHtmlErrorResponse(trimmed, leadingStatus.code)) return null;
