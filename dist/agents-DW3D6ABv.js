...
import { c as normalizeAgentId, t as DEFAULT_AGENT_ID } from "./session-key-BOC5unB4.js";
...
import { l as resolveAuthStorePath } from "./source-check-DLSm69AH.js";
...
import { i as listRouteBindings, t as isRouteBinding } from "./bindings-CnWs55RG.js";
...
import { i as parseIdentityMarkdown, t as identityHasValues } from "./identity-file-CwtN2GjT.js";
import { r as ensureWorkspaceAndSessions, s as moveToTrash } from "./onboard-helpers-CmGuAQ9e.js";
import { i as parseBindingSpecs, n as buildChannelBindings, r as describeBinding$1, t as applyAgentBindings } from "./agents.bindings-VrgtezGE.js";
import { n as requireValidConfigSnapshot, t as requireValidConfigFileSnapshot$1 } from "./config-validation-BUjwIImB.js";
import { i as loadAgentIdentity, n as buildAgentSummaries, o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-BJwhCzyw.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-WA0jOKXc.js";
import { n as applyAuthChoice, t as warnIfModelConfigLooksOff } from "./auth-choice-I7Dv_bP6.js";
...
async function resolveParsedBindingsOrExit(params) {
	...
	const { parseBindingSpecs } = await import("./agents.bindings-C06VUMR8.js");
...
async function agentsBindCommand(opts, runtime = defaultRuntime) {
	...
	if (!parsed) return;
	const { applyAgentBindings } = await import("./agents.bindings-C06VUMR8.js");
...
async function agentsUnbindCommand(opts, runtime = defaultRuntime) {
	...
	if (!parsed) return;
	const { removeAgentBindings } = await import("./agents.bindings-C06VUMR8.js");
