...
import { t as getActiveMatrixClient } from "./active-client-BPpme1MS.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-Bj0GjjiR.js"), import("./shared-CeD22_BC.js")]).then(([clientModule, sharedModule]) => ({
