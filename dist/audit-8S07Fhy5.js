...
import { _ as resolveStateDir, o as resolveConfigPath } from "./paths-Z7drr_SN.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-C7GHgMrh.js";
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-DWewBKcU.js";
import { o as resolveGatewayAuth } from "./auth-BO-EkmdB.js";
import { n as asNullableRecord } from "./record-coerce-CMKPGWB_.js";
import { t as DEFAULT_AGENT_ID } from "./session-key-D8SZau-8.js";
import { i as normalizeTrustedSafeBinDirs, o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-BPXCunOZ.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-BE3SC6M5.js";
import { i as hasNonEmptyString } from "./channel-target-D8NjVbAx.js";
import { t as hasPotentialConfiguredChannels } from "./config-presence-BgRnIAii.js";
...
import { u as isInterpreterLikeAllowlistPattern } from "./exec-approvals-allowlist-B65p4mjI.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-CwYbONan.js";
...
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-BHXWyGYb.js");
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-D0v238xT.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-Dg2EOtLt.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-tCiKrmrG.js");
...
async function loadPluginMetadataRegistryLoaderModule() {
	pluginMetadataRegistryLoaderModulePromise ??= import("./metadata-registry-loader-CZyZgdot.js");
...
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-DQSxtoqh.js"),
		import("./probe-auth-D5O1nZpE.js"),
		import("./probe-Dbd4qncX.js")
