...
if (!isMainModule({
	...
	try {
		...
		const { logInfo } = await import("./logger-BG6aLQPO.js");
	...
	const { bootstrapEnclawed } = await import("./bootstrap-Co7Fwmyn.js");
...
function runMainOrRootHelp(argv) {
	...
	import("./run-main-DVYj3Y3-.js").then(({ runCli }) => runCli(argv)).catch((error) => {
