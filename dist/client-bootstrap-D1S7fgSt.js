...
import { t as getActiveMatrixClient } from "./active-client-BZoPlzGr.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-CjQ3hE5M.js"), import("./shared-CibNlN0i.js")]).then(([clientModule, sharedModule]) => ({
