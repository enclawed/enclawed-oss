...
import { i as resolveOsHomeDir, t as expandHomePrefix } from "./home-dir-yzjXRaUx.js";
import { S as truncateUtf16Safe, g as resolveUserPath, l as isRecord } from "./utils-BcQ7uNrT.js";
import { t as createSubsystemLogger } from "./subsystem-WGqvYWrS.js";
import { a as shouldLogVerbose, r as logVerbose } from "./globals-D8R_YQwt.js";
import { t as logDebug } from "./logger-B8mPHfvt.js";
import { a as loadConfig, h as resolveConfigSnapshotHash, o as parseConfigJson5 } from "./io-Dzvn-wpi.js";
import { n as resolveManifestContractOwnerPluginId } from "./manifest-registry-B1LtZC7a.js";
import { r as normalizeProviderId } from "./provider-id-CxDLTf9A.js";
import { c as parseThreadSessionSuffix, o as parseAgentSessionKey } from "./session-key-utils-qXY7QK1H.js";
import { n as normalizeAccountId } from "./account-id-6Mvnxe99.js";
import { c as normalizeAgentId, f as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-D8SZau-8.js";
import { o as normalizeChannelId } from "./registry-BRuATCor.js";
import { i as normalizeChannelId$1, r as listChannelPlugins, t as getChannelPlugin } from "./registry-BZZmrGdc.js";
import { t as applyMergePatch } from "./merge-patch-BGy6BHu_.js";
import { t as getProviderEnvVars } from "./provider-env-vars-reCe_d7o.js";
import { n as resolveAgentModelPrimaryValue, t as resolveAgentModelFallbackValues } from "./model-input-fnfl6j7e.js";
import { m as resolveSessionAgentIds, p as resolveSessionAgentId, r as resolveAgentExecutionContract, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-5o1jve-2.js";
...
import { h as GATEWAY_CLIENT_MODES, m as GATEWAY_CLIENT_IDS, u as normalizeMessageChannel } from "./message-channel-BZ78qqgM.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-DiqXDzpD.js";
import "./plugins-BRuVcg7S.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-DB4wLsLH.js";
import { t as ensureEnclawedModelsJson } from "./models-config-DKRsyF92.js";
import { f as modelKey, p as normalizeModelRef } from "./model-selection-cli-DrzfE0gz.js";
import { f as resolveDefaultModelForAgent, i as buildModelAliasIndex, m as resolveModelRefFromString, t as buildAllowedModelSet } from "./model-selection-3QcDboLc.js";
...
import { a as discoverModels, i as discoverAuthStorage } from "./pi-model-discovery-DHrfMAXr.js";
import { o as updateSessionStore } from "./store-eo7yB1I1.js";
import { t as extractDeliveryInfo } from "./sessions-Dq3XJ_x5.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-CADYkZ1j.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-B7S7hCmE.js";
import { t as loadSessionStore } from "./store-load-C5fhLNaT.js";
import { n as resolveSessionConversationRef } from "./session-conversation-DMzR2J6m.js";
import "./delivery-context-BeA2CFhs.js";
import { d as resolveSessionModelIdentityRef } from "./session-utils-BHb7olSM.js";
import { l as jsonUtf8Bytes, n as capArrayByJsonBytes } from "./session-utils.fs-Bz4LmaEr.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-pnu38gX0.js";
import { i as imageMimeFromFormat, t as detectMime } from "./mime-Bs8vyLeZ.js";
import { C as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY, D as describeSessionsSendTool, E as describeSessionsListTool, O as describeSessionsSpawnTool, S as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, T as describeSessionsHistoryTool, b as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, h as CRON_TOOL_DISPLAY_SUMMARY, k as describeUpdatePlanTool, v as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, w as describeSessionStatusTool, x as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, y as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY } from "./tool-policy-D994AhXf.js";
import { a as listChannelSupportedActions, d as resolvePluginTools, r as listAllChannelSupportedActions } from "./channel-tools-DJBTw8u5.js";
import { w as textToSpeech } from "./tts-runtime-DWqtv1Yz.js";
import "./tts-DA5Tz0Sd.js";
import { a as getImageMetadata } from "./image-ops-B58JkOb8.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-BfMc3nWK.js";
import { a as resolveChannelMessageToolSchemaProperties, n as channelSupportsMessageCapabilityForChannel, t as channelSupportsMessageCapability } from "./message-action-discovery-koEgVT7h.js";
import { r as getApiKeyForModel } from "./model-auth-CEwjo3Cm.js";
import { t as SsrFBlockedError } from "./ssrf-DjpVlwtu.js";
import { u as parseReplyDirectives } from "./deliver-CNl357yl.js";
import { n as runWithImageModelFallback } from "./model-fallback-C9WX3Pud.js";
import { t as extractTextFromChatContent } from "./chat-content-CO_i1YqO.js";
import { c as stripReasoningTagsFromText } from "./assistant-visible-text-BKlRMt-f.js";
import { t as extractAssistantText } from "./pi-embedded-utils-DeN3F8e5.js";
import { r as callGateway } from "./call-D6zBw8Jl.js";
import { c as jsonResult, d as readNumberParam, h as readStringParam$1, o as imageResult, p as readStringArrayParam, r as ToolInputError, y as readSnakeCaseParamRaw } from "./common-mDzRl__P.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-B2xBY4c_.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-C3irXap3.js";
import { t as isWindowsDrivePath } from "./archive-path-CgzHlKoC.js";
import { o as trySafeFileURLToPath, r as hasEncodedFileUrlSeparator } from "./local-file-access-BqYOmV4w.js";
import { n as assertSandboxPath } from "./sandbox-paths-AfYJvOXd.js";
import { c as normalizeWorkspaceDir, f as toRelativeWorkspacePath, l as resolveWorkspaceRoot } from "./read-capability-P7UkKFgm.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata } from "./runtime-Bbe-15LK.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-BWzj1Unl.js";
import { a as createSessionVisibilityGuard, c as resolveDisplaySessionKey, d as resolveSessionReference, f as resolveVisibleSessionReference, i as createAgentToAgentPolicy, l as resolveInternalSessionKey, n as deriveChannel, o as resolveEffectiveSessionToolsVisibility, p as shouldResolveSessionIdInput, r as resolveSessionToolContext, s as resolveSandboxedSessionToolContext, t as classifySessionKind, u as resolveMainSessionAlias } from "./sessions-helpers-NoUCec1k.js";
import { r as stripToolMessages } from "./chat-history-text-KKTM9zZD.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-DItUfZuS.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-HJUX4WNh.js";
import { i as stringEnum, n as channelTargetsSchema, r as optionalStringEnum, t as channelTargetSchema } from "./typebox-_VWptI-d.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-DAwOANiS.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-BuMFf3R4.js";
...
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-B-DlEGEO.js";
import { n as formatDoctorNonInteractiveHint, s as writeRestartSentinel } from "./restart-sentinel-kYCIe5kw.js";
import { o as scheduleGatewaySigusr1Restart } from "./restart-kOaImqWJ.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-19YzSsn6.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-CyI0b3H3.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-BP8uOV4t.js";
import { l as saveMediaBuffer } from "./store-C1zvYuUA.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-CyP1yxk5.js";
import { r as getDefaultLocalRoots } from "./local-media-access-Cp7X1OvG.js";
import { a as coerceImageModelConfig, c as resolveProviderVisionModelFromConfig, d as hasAuthForProvider, f as hasToolModelConfig, l as buildToolModelConfigFromCandidates, n as isMinimaxVlmProvider, o as decodeDataUrl, p as resolveDefaultModelRef, u as coerceToolModelConfig } from "./minimax-vlm-CS-q4xqw.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-BHUCZ9vh.js";
import { C as getMediaUnderstandingProvider, E as resolveBundledDefaultMediaModel, T as resolveBundledAutoMediaKeyProviders, b as resolveAutoMediaKeyProviders, w as bundledProviderSupportsNativePdfDocument, x as resolveDefaultMediaModel } from "./resolve-vepBcIX0.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-BUNJvd_c.js";
import { t as buildProviderRegistry } from "./runner-BuxlE2-j.js";
import "./media-understanding-4qRdMovR.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-b03Cx2TM.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-DhBMjDV3.js";
import { a as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-D-Xq2bfy.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-D9fHzFoO.js";
import { t as sendMessage } from "./message-DZCurZ-p.js";
import { n as resolveMusicGenerationModeCapabilities, t as listSupportedMusicGenerationModes } from "./capabilities-D3sOtkVm.js";
import { r as parseMusicGenerationModelRef } from "./provider-registry-BmYlLICH.js";
import { n as listRuntimeMusicGenerationProviders, t as generateMusic } from "./runtime-BOXqgiZN.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-Zkadyh_M.js";
...
import { a as createRunningTaskRun, c as recordTaskRunProgressByRunId, o as failTaskRunByRunId, r as completeTaskRunByRunId } from "./task-executor-DF7aWa4R.js";
import "./task-registry-delivery-runtime-DlzTo10J.js";
import { t as formatAgentInternalEventsForPrompt } from "./internal-events-C9mhM6zX.js";
import { _ as REPLY_SKIP_TOKEN, b as deliverSubagentAnnouncement, d as registerSubagentRun, g as ANNOUNCE_SKIP_TOKEN, h as runAgentStep, v as isAnnounceSkip, y as isReplySkip } from "./subagent-registry-BAXhdRAB.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-gjOynqxx.js";
import { t as parseTimeoutMs } from "./parse-timeout-Dfuh0hr0.js";
import { t as extractPdfContent } from "./pdf-extract-Ckgj6a6_.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DAldxFPt.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-BuNFdXJg.js";
import { t as AGENT_LANE_NESTED } from "./lanes-DKb_iZxL.js";
import { i as waitForAgentRunAndReadUpdatedAssistantReply, n as readLatestAssistantReplySnapshot, r as waitForAgentRun, t as readLatestAssistantReply } from "./run-wait-C1bXBEoc.js";
import { n as SUBAGENT_SPAWN_MODES, t as spawnSubagentDirect } from "./subagent-spawn-Cdf1li2r.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-FVUwjiFK.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-B_t-jvW9.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-DgY8z7dJ.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-DWPQ9mMC.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-CPiMgHUi.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-DVMYTLPU.js";
import { a as runWebSearch, i as resolveWebSearchDefinition, l as resolveWebProviderConfig } from "./runtime-DwQynVDO.js";
import { r as resolveWebFetchDefinition } from "./runtime-DISLdnoO.js";
import { i as markdownToText, n as extractReadableContent, o as truncateText$1, r as htmlToMarkdown, t as extractBasicHtmlContent } from "./web-fetch-utils-CJ7f9UzF.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds, u as fetchWithWebToolsNetworkGuard } from "./web-shared-CE6YFcHE.js";
import "./web-search-provider-common-DZe5vH7v.js";
...
//#endregion
//#region src/agents/enclawed-tools.plugin-context.ts
function resolveEnclawedPluginToolInputs(params) {
...
//#endregion
//#region src/agents/enclawed-plugin-tools.ts
function resolveEnclawedPluginToolsForOptions(params) {
...
function createSandboxedReadTool(params) {
	return createEnclawedReadTool(createReadTool(params.root, { operations: createSandboxReadOperations(params) }), {
...
function createEnclawedReadTool(base, options) {
	return {
		...base,
...
//#endregion
//#region src/agents/enclawed-tools.nodes-workspace-guard.ts
...
//#endregion
//#region src/agents/enclawed-tools.registration.ts
function collectPresentEnclawedTools(candidates) {
	return candidates.filter((tool) => tool !== null && tool !== void 0);
}
function isUpdatePlanToolEnabledForEnclawedTools(params) {
...
function createAgentsListTool(opts) {
	return {
		label: "Agents",
		name: "agents_list",
		description: "List Enclawed agent ids you can target with `sessions_spawn` when `runtime=\"subagent\"` (based on subagent allowlists).",
...
const ENCLAWED_OWNER_ONLY_CORE_TOOL_NAME_SET = new Set([
	"cron",
	"gateway",
	"nodes"
]);
function isEnclawedOwnerOnlyCoreToolName(toolName) {
...
const ImageGenerateToolSchema = Type.Object({
	...
	filename: Type.Optional(Type.String({ description: "Optional output filename hint. Enclawed preserves the basename and saves under its managed media directory." })),
...
function buildMessageToolSchemaFromActions(actions, options) {
	const properties = buildMessageToolSchemaProps(options);
	return Type.Object({
...
function createMusicGenerateTool(options) {
	...
	return {
		...
		description: "Generate music using configured providers. Generated tracks are saved under Enclawed-managed media storage and delivered automatically as attachments.",
...
function loadCommandsStatusRuntime() {
	commandsStatusRuntimePromise ??= import("./session-status.runtime-DH_cd5vk.js");
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-DQSxtoqh.js");
...
async function loadAcpSpawnModule() {
	acpSpawnModulePromise ??= import("./acp-spawn-lNt_B5hQ.js");
...
const VideoGenerateToolSchema = Type.Object({
	...
	durationSeconds: Type.Optional(Type.Number({
		description: "Optional target duration in seconds. Enclawed may round this to the nearest provider-supported duration.",
		minimum: 1
	})),
...
function createVideoGenerateTool(options) {
	...
	return {
		...
		description: "Generate videos using configured providers. Generated videos are saved under Enclawed-managed media storage and delivered automatically as attachments. Duration requests may be rounded to the nearest provider-supported value.",
...
let enclawedToolsDeps = { callGateway };
...
//#endregion
export { createEnclawedReadTool as a, createSandboxedEditTool as c, wrapToolMemoryFlushAppendOnlyWrite as d, wrapToolWorkspaceRootGuard as f, isStrictAgenticSupportedProviderModel as h, normalizeCronJobPatch as i, createSandboxedReadTool as l, isStrictAgenticExecutionContractActive as m, normalizeCronJobCreate as n, createHostWorkspaceEditTool as o, wrapToolWorkspaceRootGuardWithOptions as p, normalizeCronJobInput as r, createHostWorkspaceWriteTool as s, createEnclawedTools as t, createSandboxedWriteTool as u };
