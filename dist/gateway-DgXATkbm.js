import { s as resolveRuntimeServiceVersion } from "./version-CeugVlbG.js";
...
import { c as getPlatformAdapter, i as normalizeOptionalString, n as normalizeLowercaseStringOrEmpty, o as readStringField, s as sanitizeFileName, t as asOptionalObjectRecord } from "./string-normalize-DWA3ypgp.js";
import { d as setBridgeLogger, l as ensurePlatformAdapter, s as resolveAccountBase } from "./resolve-BOH8DRoV.js";
import { i as parseApprovalButtonData } from "./approval-C7MBQicF.js";
import { t as toGatewayAccount } from "./narrowing-DGnYGTR4.js";
import { B as StreamInputMode, C as debugLog, E as getNextMsgSeq, I as formatDuration, L as formatErrorMessage, N as getImageMimeType, P as getMaxUploadSize, R as MediaFileType, S as debugError, V as StreamInputState, a as createRawInputNotifyFn, b as withTokenRetry, c as getMessageApi, d as initSender, f as onMessageSent, g as sendText, h as sendMedia, i as clearTokenCache, j as formatFileSize, k as downloadFile, l as getPluginUserAgent, m as sendInputNotify, n as acknowledgeInteraction, o as getAccessToken, p as registerAccount, r as buildDeliveryTarget, s as getGatewayUrl, t as accountToCreds, u as initApiConfig, v as startBackgroundTokenRefresh, w as debugWarn, x as openLocalFile, y as stopBackgroundTokenRefresh, z as StreamContentType } from "./sender-CMwlkX03.js";
import { n as getQQBotRuntimeForEngine, t as getQQBotRuntime } from "./runtime-DoOxghHT.js";
import { a as detectFfmpeg, c as getQQBotDataDir, f as getTempDir, g as resolveQQBotPayloadLocalFilePath, h as normalizePath$1, i as checkSilkWasmAvailable, l as getQQBotDataPath, m as isWindows, o as getHomeDir, p as isLocalPath, s as getPlatform, u as getQQBotMediaDir } from "./target-parser-1u6fcDu9.js";
import { a as getPluginVersion, i as getFrameworkVersion, n as runWithRequestContext, o as initCommands, s as matchSlashCommand } from "./request-context-DI7NiD84.js";
import { C as DEFAULT_MEDIA_SEND_ERROR, T as setOutboundAudioPort, _ as resolveUserFacingMediaError, a as encodePayloadForCron, c as parseQQBotPayload, g as sendVoice, h as sendVideoMsg, l as normalizeMediaTags, m as sendPhoto, n as sendMedia$1, o as isCronReminderPayload, p as sendDocument, s as isMediaPayload } from "./outbound-B1I653lx.js";
...
function resolveSessionStorePath(cfg, agentId) {
	...
	const stateDir = process.env.ENCLAWED_STATE_DIR?.trim() || process.env.CLAWDBOT_STATE_DIR?.trim() || path.join(process.env.HOME || process.env.USERPROFILE || "", ".enclawed");
