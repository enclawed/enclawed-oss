...
function resolveVersionFromRuntimeSources(params) {
	return firstNonEmpty(...params.preference === "env-first" ? [params.env["ENCLAWED_VERSION"], params.runtimeVersion] : [params.runtimeVersion, params.env["ENCLAWED_VERSION"]], params.env["ENCLAWED_SERVICE_VERSION"], params.env["npm_package_version"]) ?? params.fallback;
}
...
const VERSION = resolveBinaryVersion({
	...
	injectedVersion: typeof __ENCLAWED_VERSION__ === "string" ? __ENCLAWED_VERSION__ : void 0,
