...
import { D as DEFAULT_AI_SNAPSHOT_MAX_CHARS, E as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, N as DEFAULT_BROWSER_SCREENSHOT_TIMEOUT_MS, d as parseBrowserHttpUrl, n as assertCdpEndpointAllowed, p as withCdpSocket } from "./cdp.helpers-DZMnXnxy.js";
...
import { a as deriveDefaultBrowserCdpPortRange } from "./control-auth-CNgUvKUj.js";
import { a as DEFAULT_DOWNLOAD_DIR, c as resolveExistingPathsWithinRoot, i as resolveProfile, o as DEFAULT_TRACE_DIR, r as resolveManagedBrowserHeadlessMode, s as DEFAULT_UPLOAD_DIR, u as resolveWritablePathWithinRoot } from "./config-DyQGXjQ7.js";
import { r as resolveBrowserExecutableForPlatform } from "./chrome.executables-BUSlq57-.js";
import { n as normalizeString } from "./record-shared-R-BgSIo9.js";
import "./sdk-setup-tools-jKpBoJXs.js";
import { t as movePathToTrash } from "./trash-BOm2HQqX.js";
import { C as assertBrowserNavigationResultAllowed, T as withBrowserNavigationPolicy, _ as INTERACTIVE_ROLES, a as resolveEnclawedUserDataDir, g as CONTENT_ROLES, h as snapshotRoleViaCdp, m as snapshotAria, t as getChromeWebSocketUrl, u as captureScreenshot, v as STRUCTURAL_ROLES, x as assertBrowserNavigationAllowed, y as resolveBrowserNavigationProxyMode } from "./chrome-Zui3qUOn.js";
import { E as uploadChromeMcpFile, T as takeChromeMcpSnapshot, _ as navigateChromeMcpPage, a as closeChromeMcpTab, c as evaluateChromeMcpScript, f as getChromeMcpPid, l as fillChromeMcpElement, m as hoverChromeMcpElement, n as clickChromeMcpCoords, o as dragChromeMcpElement, r as clickChromeMcpElement, u as fillChromeMcpForm, w as takeChromeMcpScreenshot, x as resizeChromeMcpPage, y as pressChromeMcpKey } from "./chrome-mcp-2AKy0Omh.js";
import { a as shouldUsePlaywrightForAriaSnapshot, i as resolveDefaultSnapshotFormat, n as getPwAiModule$1, o as shouldUsePlaywrightForScreenshot, r as getBrowserProfileCapabilities, t as resolveTargetIdFromTabs } from "./target-id-DCq4gnFS.js";
import { c as ACT_MAX_CLICK_DELAY_MS, l as ACT_MAX_WAIT_TIME_MS, o as normalizeBrowserFormField, p as matchBrowserUrlPattern, r as getRoleSnapshotStats, u as normalizeActBoundedNonNegativeMs } from "./pw-role-snapshot-CZs-YjJ9.js";
...
async function runBrowserLiveProbe(req, ctx) {
	...
	try {
		...
		if (capabilities.usesChromeMcp) {
			const { takeChromeMcpSnapshot } = await import("./chrome-mcp-t8CcSwt2.js");
