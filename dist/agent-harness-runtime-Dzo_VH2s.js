...
import { s as joinPresentTextSegments, t as getGlobalHookRunner } from "./hook-runner-global-D5tYPLdd.js";
import { r as PluginApprovalResolutions } from "./types-VxFFQ_Ma.js";
import { r as getActivePluginRegistry } from "./runtime-v-gfCtZv.js";
import { F as resolveProviderSystemPromptContribution } from "./provider-runtime-CChIRNbc.js";
import "./agent-paths-CK1LyoiU.js";
import "./session-write-lock-B7HIVMq0.js";
import { f as normalizeEmbeddedAgentRuntime } from "./attempt.tool-run-context-BdlCnv8U.js";
...
import { o as logProviderToolSchemaDiagnostics, s as normalizeProviderToolSchemas } from "./attempt.thread-helpers-BOH5Px3v.js";
...
import { d as runContextEngineMaintenance, n as buildAfterTurnRuntimeContextFromUsage, t as buildAfterTurnRuntimeContext } from "./attempt.prompt-helpers-xNQoeXDO.js";
import { t as callGatewayTool } from "./gateway-MCF4vbZ5.js";
import { i as runBeforeToolCallHook, n as consumeAdjustedParamsForToolCall } from "./pi-tools.before-tool-call-sv5v0r0O.js";
...
import { r as resolveTranscriptPolicy } from "./compaction-runtime-context-Dz3gewka.js";
import { i as resolvePreparedExtraParams } from "./extra-params-CmdjxAoD.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolveHandlers = async () => {
		...
		resolvedHandlersPromise ??= import("./agent-tool-result-middleware-loader-XEiXr4bI.js").then(({ loadAgentToolResultMiddlewaresForRuntime }) => loadAgentToolResultMiddlewaresForRuntime({ runtime: ctx.runtime }));
