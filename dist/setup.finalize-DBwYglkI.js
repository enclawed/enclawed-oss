...
import { d as pathExists, g as resolveUserPath } from "./utils-CrVQlOZJ.js";
import { n as resolveCliName } from "./cli-name-CIwCxoN0.js";
...
import { r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-Dg5fnKWT.js";
import { i as isSystemdUserServiceAvailable } from "./systemd-CtC8UVM8.js";
...
import { n as listConfiguredWebSearchProviders } from "./runtime-CKHBHaOQ.js";
...
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-CvDNHZOo.js";
import { i as formatControlUiSshHint, m as waitForGatewayReachable, u as probeGatewayReachable } from "./onboard-helpers-DL_wxoBY.js";
...
import { t as runTui } from "./tui-BZ5rhiEW.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DcRBzgYG.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DvDW4ySu.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DvDW4ySu.js");
