import { o as createMigrationItem, v as summarizeMigrationItems } from "./migration-DOSnICX3.js";
import { r as buildConfigItems } from "./config-DV0MSeEB.js";
import { t as buildMemoryItems } from "./memory-CjMpJF7o.js";
import { n as buildSkillItems } from "./skills-wELPWzNG.js";
import { n as hasClaudeSource, t as discoverClaudeSource } from "./source-DhoQ6m6g.js";
import { t as resolveTargets } from "./targets-wT422dvj.js";
...
async function buildClaudePlan(ctx) {
	...
	const warnings = [
		...
		...items.some((item) => item.kind === "archive") ? ["Some Claude files are archive-only. They will be copied into the migration report for manual review, not loaded into Enclawed."] : [],
