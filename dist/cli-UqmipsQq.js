...
import { o as normalizeSingleOrTrimmedStringList } from "./string-normalization-QLwZvaSN.js";
import { S as resolveDefaultAgentId, p as resolveSessionAgentId } from "./agent-scope-D-lQQ64_.js";
import { c as listActiveMemoryPublicArtifacts } from "./memory-state-CFyyWZvk.js";
import "./text-runtime-BSsrP5ac.js";
import "./memory-host-core-52oktMO3.js";
...
import { d as resolveMemoryWikiConfig, o as WIKI_SEARCH_BACKENDS, s as WIKI_SEARCH_CORPORA } from "./config-Bcd2oK0B.js";
...
const WIKI_RELATED_START_MARKER = "<!-- enclawed:wiki:related:start -->";
const WIKI_RELATED_END_MARKER = "<!-- enclawed:wiki:related:end -->";
...
async function initializeMemoryWikiVault(config, options) {
	...
	await writeFileIfMissing(path.join(rootDir, ".enclawed-wiki", "state.json"), withTrailingNewline(JSON.stringify({
		version: 1,
...
const AGENT_DIGEST_PATH$1 = ".enclawed-wiki/cache/agent-digest.json";
const CLAIMS_DIGEST_PATH$1 = ".enclawed-wiki/cache/claims.jsonl";
