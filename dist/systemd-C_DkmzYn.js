...
import { n as readStateDirDotEnvVarsFromStateDir } from "./state-dir-dotenv-C2cfNhIh.js";
import { _ as resolveStateDir } from "./paths-Z7drr_SN.js";
import { f as resolveGatewayServiceDescription, n as resolveHomeDir, o as LEGACY_GATEWAY_SYSTEMD_SERVICE_NAMES, p as resolveGatewaySystemdServiceName } from "./paths-YeCWuIy9.js";
...
import { a as splitArgsPreservingQuotes, i as writeFormattedLines, n as formatLine, r as toPosixPath, t as parseKeyValueOutput } from "./runtime-parse-BInpa07j.js";
import { t as execFileUtf8 } from "./exec-file-DFy7IG9b.js";
...
async function activateSystemdService(params) {
	const unitName = `${resolveGatewaySystemdServiceName(params.env.ENCLAWED_PROFILE)}.service`;
...
async function uninstallSystemdService({ env, stdout }) {
	...
	await execSystemctlUser(env, [
		"disable",
		"--now",
		`${resolveGatewaySystemdServiceName(env.ENCLAWED_PROFILE)}.service`
	]);
	const unitPath = resolveSystemdUnitPath(env);
	try {
