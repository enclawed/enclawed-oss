...
import { S as truncateUtf16Safe } from "./utils-BcQ7uNrT.js";
import { n as CHAT_CHANNEL_ORDER } from "./ids-BArxFn_a.js";
...
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-BWhNVcLY.js";
import { a as loadConfig } from "./io-Dzvn-wpi.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey, o as parseAgentSessionKey } from "./session-key-utils-qXY7QK1H.js";
import { c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey } from "./session-key-D8SZau-8.js";
import { a as normalizeAnyChannelId } from "./registry-BRuATCor.js";
import { t as getLoadedChannelPluginById } from "./registry-loaded-Ds121q4C.js";
import { i as normalizeChannelId, r as listChannelPlugins, t as getChannelPlugin } from "./registry-BZZmrGdc.js";
import "./defaults-Dzck2uJH.js";
import { t as applyMergePatch } from "./merge-patch-BGy6BHu_.js";
import { d as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-dcdTJd2I.js";
import { b as resolveAgentDir, g as listAgentEntries, l as resolveAgentSkillsFilter, p as resolveSessionAgentId, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-5o1jve-2.js";
import "./config-DOKACpaG.js";
import { d as resolveGatewayMessageChannel, r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-BZ78qqgM.js";
import "./message-channel-core-DiqXDzpD.js";
import { i as isInterSessionInputProvenance } from "./input-provenance-BiaaGm3T.js";
import { d as resetRegisteredAgentHarnessSessions } from "./registry-nxcy40tP.js";
...
import { m as requireActivePluginChannelRegistry, n as getActivePluginChannelRegistryVersion } from "./runtime-CO-f4q2v.js";
import { c as normalizeThinkLevel, d as normalizeVerboseLevel, n as formatXHighModelHint } from "./thinking.shared-BxNIEx-D.js";
import { m as resolveModelRefFromString } from "./model-selection-3QcDboLc.js";
import { S as resolveGroupSessionKey, f as resolveMaintenanceConfigFromInput, h as resolveSessionStoreEntry, o as updateSessionStore, v as deriveSessionMetaPatch } from "./store-eo7yB1I1.js";
import { t as normalizeChatType } from "./chat-type-DYfGJDST.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-DWqaDaEZ.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-CADYkZ1j.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-BBvDQ1eb.js";
import { c as resolveSessionResetPolicy, i as resolveThreadFlag, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-CcILeDDI.js";
import { n as resolveSessionKey } from "./session-key-C6lvJcrM.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-B7S7hCmE.js";
import { t as loadSessionStore } from "./store-load-C5fhLNaT.js";
import { a as resolveAndPersistSessionFile } from "./transcript-CdDH2u9f.js";
import { t as parseSessionThreadInfo } from "./thread-info-C6jU7FZH.js";
import "./delivery-context-BeA2CFhs.js";
import { o as getQueueSize, r as clearCommandLane } from "./command-queue-DQC1ydD8.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-pnu38gX0.js";
import { n as applyOwnerOnlyToolPolicy } from "./tool-policy-D994AhXf.js";
import { t as isReasoningTagProvider } from "./provider-utils--Wo4gBHl.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-D43YkfWV.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-4BY4qquV.js";
import { i as supportsXHighThinking } from "./thinking-DWHN3uH-.js";
import { r as disposeSessionMcpRuntime } from "./pi-bundle-mcp-tools-B8kFOn8E.js";
import { t as collectTextContentBlocks } from "./content-blocks-BuI8YPKB.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy--05mfb-H.js";
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, p as fireAndForgetHook, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-Cxw_O6Ld.js";
...
import { t as resolveQueueSettings } from "./queue-K1Qq4xfA.js";
import { r as getSessionBindingService } from "./session-binding-service-Dy45eAgg.js";
import { t as resolveAgentTimeoutMs } from "./timeout-CZTBoioj.js";
import { r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-BqCA2bpH.js";
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-BtHKtFOp.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-CoM1FF5X.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-eBUWHlCF.js";
import { t as hasControlCommand } from "./command-detection-D2374ct_.js";
import "./commands-registry-kc2RkbyN.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-DTSFWzJ1.js";
import { t as resolveRunTypingPolicy } from "./typing-policy-hPs6NkOE.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-BbAL1S_Q.js";
import { t as finalizeInboundContext } from "./inbound-context-BtJAUPkD.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-Bgg__hqZ.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-DNhlO-8V.js";
import { t as resolveChannelModelOverride } from "./model-overrides-DDWaKu7D.js";
import { t as normalizeGroupActivation } from "./group-activation-BSdDNYPx.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-CzYCEonC.js";
import { t as resolveFastModeState } from "./fast-mode-DbeYiePJ.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-CqMWTPPe.js";
import { t as resolveCommandAuthorization } from "./command-auth-xz02w0V2.js";
import { t as buildCommandContext } from "./commands-context-Qyd3QqcP.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-RLi7UMAA.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-BNdggbH0.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-C5RsRgg_.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-DVe4C0g6.js";
import { t as resolveStoredModelOverride } from "./stored-model-override-B1cGekJY.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-Db6GD3KP.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-BbBhCsPM.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-Dxowk2wx.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-BDN1aS-x.js";
import { n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-C5zXOsA8.js";
...
import { t as drainFormattedSystemEvents } from "./session-system-events-Bt3ovNsJ.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-BjvzH1AS.js";
import { n as buildSessionStartHookPayload, t as buildSessionEndHookPayload } from "./session-hooks-C2j0pf_S.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-Byxe6-R0.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-DEXiLHyb.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-CMYCu5ev.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-9Y897gai.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-CpVGGwqc.js");
...
function isSlowReplyTestAllowed(env = process.env) {
	return env.ENCLAWED_ALLOW_SLOW_REPLY_TESTS === "1" || env.ENCLAWED_STRICT_FAST_REPLY_CONFIG === "0";
}
...
function resolveGetReplyConfig(params) {
	...
	if (params.isFastTestEnv && !isCompleteReplyConfig(configOverride) && !isSlowReplyTestAllowed()) throw new Error("Fast reply tests must pass with withFastReplyConfig()/markCompleteReplyConfig(); set ENCLAWED_ALLOW_SLOW_REPLY_TESTS=1 to opt out.");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-BhredpNB.js");
...
function buildGroupIntro(params) {
	...
	return [
		...
		activation === "always" ? `If no response is needed, reply with exactly "${params.silentToken}" (and nothing else) so Enclawed stays silent. Do not add any other words, punctuation, tags, markdown/code blocks, or explanations.` : void 0,
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-BFEdUsdg.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-g8TkJn59.js");
...
async function handleInlineActions(params) {
	...
	const skillCommands = shouldLoadSkillCommands && params.skillCommands ? params.skillCommands : shouldLoadSkillCommands ? (await import("./skill-commands.runtime-g8TkJn59.js")).listSkillCommandsForWorkspace({
		workspaceDir,
		cfg,
		agentId,
		skillFilter
	...
	if (skillInvocation) {
		...
		if (dispatch?.kind === "tool") {
			...
			const { createEnclawedTools } = await import("./enclawed-tools.runtime-DZzDd_Ys.js");
			const tool = applyOwnerOnlyToolPolicy(createEnclawedTools({
	...
	if (!isStopLikeInbound && targetSessionEntry) {
		...
		if (cutoff) await (await import("./abort-cutoff.runtime-BWXNFhRS.js")).clearAbortCutoffInSessionRuntime({
			sessionEntry: targetSessionEntry,
			sessionStore,
			sessionKey,
			storePath
	...
	if (handleInlineStatus) {
		const { buildStatusReply } = await import("./commands.runtime-Dpq0KlyT.js");
	...
	const runCommands = async (commandInput) => {
		const { handleCommands } = await import("./commands.runtime-Dpq0KlyT.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-DuKMY82T.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-CMJ0H8Rx.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-DE_UKUcR.js");
	return agentRunnerRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-CB1VK4xj.js");
...
async function runPreparedReply(params) {
	...
	const skillResult = process.env.ENCLAWED_TEST_FAST === "1" ? {
		sessionEntry,
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-2-5C9Rni.js");
...
async function forkSessionFromParent(params) {
	return (await import("./session-fork.runtime-CAta08iN.js")).forkSessionFromParentRuntime(params);
}
//#endregion
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime--8X-3s20.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-_iwp4tNR.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-Z85EcHvo.js");
...
function loadHookRunnerGlobal() {
	hookRunnerGlobalPromise ??= import("./hook-runner-global-BdXusIF8.js");
	return hookRunnerGlobalPromise;
}
function loadOriginRouting() {
	originRoutingPromise ??= import("./origin-routing-yzGNBewk.js");
...
async function applyMediaUnderstandingIfNeeded(params) {
	...
	const { applyMediaUnderstanding } = await import("./apply.runtime-mRUOmbA-.js");
	await applyMediaUnderstanding(params);
	return true;
}
async function applyLinkUnderstandingIfNeeded(params) {
	if (!hasLinkCandidate(params.ctx)) return false;
	const { applyLinkUnderstanding } = await import("./apply.runtime-pqb3WVPB.js");
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	const maybeEmitMissingResetHooks = async () => {
		...
		const { emitResetCommandHooks } = await import("./commands-core.runtime-CPXqLmZx.js");
