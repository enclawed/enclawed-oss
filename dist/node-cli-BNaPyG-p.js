...
import { r as theme, t as colorize } from "./theme-BVnTyzuE.js";
import { t as formatCliCommand } from "./command-format-C19Ii5s1.js";
import { c as sanitizeSystemRunEnvOverrides, o as sanitizeHostExecEnv, t as inspectHostExecEnvOverrides } from "./host-env-security-9zf-JImt.js";
import { _ as resolveNodeSystemdServiceName, g as resolveNodeLaunchAgentLabel, u as formatNodeServiceDescription, v as resolveNodeWindowsTaskName } from "./paths-YeCWuIy9.js";
import { a as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-As_fUgdd.js";
import { n as VERSION } from "./version-CqzZ9FH6.js";
import { s as buildNodeServiceEnvironment } from "./runtime-paths-C8OzEP0r.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-BVdi_jl7.js";
...
import { A as unwrapKnownShellMultiplexerInvocation, L as unwrapKnownDispatchWrapperInvocation, N as resolveInlineCommandMatch, O as isShellWrapperInvocation, P as extractEnvAssignmentKeysFromDispatchWrappers, R as normalizeExecutableToken, S as POSIX_SHELL_WRAPPERS, d as resolveApprovalAuditCandidatePath, j as POSIX_INLINE_COMMAND_FLAGS, k as resolveShellWrapperTransportArgv, p as resolveCommandResolutionFromArgv, y as resolveExecutableFromPathEnv } from "./exec-safe-bin-trust-BPXCunOZ.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-BZtv1d1b.js";
import { n as buildPlatformServiceStartHints, r as formatRuntimeStatus, t as buildPlatformRuntimeLogHints } from "./runtime-hints-DKzy5EJY.js";
import { t as parsePort } from "./parse-port-AfpIY7eM.js";
import "./config-DOKACpaG.js";
import { t as GatewayClient } from "./client-ATvMQY9h.js";
import { n as loadOrCreateDeviceIdentity } from "./device-identity-CEc1YLN9.js";
import { g as GATEWAY_CLIENT_NAMES, h as GATEWAY_CLIENT_MODES } from "./message-channel-BZ78qqgM.js";
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-BOSuIRXs.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-BMM0kv2g.js";
import { r as getActivePluginRegistry } from "./runtime-CO-f4q2v.js";
import { t as getMachineDisplayName } from "./machine-name-F6tJyR7x.js";
import { t as splitShellArgs } from "./shell-argv-DxZFgpXp.js";
import { _ as resolvePlannedSegmentArgv, c as describeInterpreterInlineEval, d as analyzeArgvCommand, l as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-B65p4mjI.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-CwYbONan.js";
...
import { t as resolveGatewayConnectionAuth } from "./connection-auth-BorfocIB.js";
import { t as formatHelpExamples } from "./help-format-Cc7aGPm0.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-LMrUq756.js";
import { t as ensureEnclawedCliOnPath } from "./path-env-eo6X4A_D.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-aRgF1ihW.js";
import { t as resolveNodeService } from "./node-service-DtsIjzjr.js";
...
async function loadSystemRunConfig(opts) {
	...
	const { loadConfig } = await import("./config-CV5Z1jsi.js");
	return loadConfig();
}
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-D7STU_wQ.js");
...
const execHostEnforced = normalizeLowercaseStringOrEmpty(process.env.ENCLAWED_NODE_EXEC_HOST ?? "") === "app";
const execHostFallbackAllowed = normalizeLowercaseStringOrEmpty(process.env.ENCLAWED_NODE_EXEC_FALLBACK ?? "") !== "0";
...
async function buildNodeInstallPlan(params) {
	...
	return {
		...
		workingDirectory,
		environment,
		description: formatNodeServiceDescription({ version: environment.ENCLAWED_SERVICE_VERSION })
	};
}
//#endregion
...
function registerNodeCli(program) {
	const node = program.command("node").description("Run and manage the headless node host service").addHelpText("after", () => `\n${theme.heading("Examples:")}\n${formatHelpExamples([
		["enclawed node run --host 127.0.0.1 --port 18789", "Run the node host in the foreground."],
