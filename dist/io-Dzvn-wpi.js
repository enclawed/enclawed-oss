...
import { g as resolveUserPath, l as isRecord$1 } from "./utils-BcQ7uNrT.js";
import { t as resolveBundledPluginsDir } from "./bundled-dir-CTIT23Am.js";
import { r as normalizeChatChannelId, t as CHANNEL_IDS } from "./ids-BArxFn_a.js";
import { n as containsEnvVarReference, r as resolveConfigEnvVars } from "./env-substitution-CcyPnYwm.js";
import { r as applyConfigEnvVars } from "./state-dir-dotenv-C2cfNhIh.js";
import { _ as resolveStateDir, n as DEFAULT_GATEWAY_PORT, o as resolveConfigPath } from "./paths-Z7drr_SN.js";
import { n as VERSION } from "./version-CqzZ9FH6.js";
import { i as coerceSecretRef } from "./types.secrets-C7GHgMrh.js";
import { i as isCanonicalDottedDecimalIPv4, u as isLoopbackIpAddress } from "./ip-Dj8Zkbwl.js";
import { t as ensureOwnerDisplaySecret } from "./owner-display-BavYQbOP.js";
import { n as discoverEnclawedPlugins, r as resolvePluginCacheInputs } from "./discovery-Yk6Slu1A.js";
import { t as getBootstrapChannelPlugin } from "./bootstrap-registry-Ba7OKrIO.js";
import { t as isSafeExecutableValue } from "./exec-safety-CSu8zMTE.js";
import { t as getCachedPluginJitiLoader } from "./jiti-loader-cache-C0hYtv34.js";
...
import { n as resolveManifestContractOwnerPluginId, r as resolveManifestContractPluginIds, t as loadPluginManifestRegistry } from "./manifest-registry-B1LtZC7a.js";
import { r as hasKind } from "./slots-BVkLJktp.js";
import { t as isBlockedObjectKey } from "./prototype-keys-DQs5ogOu.js";
import { a as resolveGatewayPortWithDefault, i as isGatewayNonLoopbackBindMode, r as hasConfiguredControlUiAllowedOrigins, t as buildDefaultControlUiAllowedOrigins } from "./gateway-control-ui-origins-T6Kfp_L4.js";
import { r as normalizeProviderId } from "./provider-id-CxDLTf9A.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-6Mvnxe99.js";
import { c as normalizeAgentId } from "./session-key-D8SZau-8.js";
import { t as resolveSingleAccountKeysToMove } from "./setup-promotion-helpers-B1xOThX6.js";
import { t as DEFAULT_CONTEXT_TOKENS } from "./defaults-Dzck2uJH.js";
import { n as normalizeTalkConfig, r as normalizeTalkSection } from "./talk-B8CWnI5T.js";
import { r as resolveProviderEndpoint } from "./provider-attribution-BhAkATy2.js";
import { t as loadDotEnv } from "./dotenv-WMwTFYA6.js";
import { a as shouldDeferShellEnvFallback, i as resolveShellEnvFallbackTimeoutMs, o as shouldEnableShellEnvFallback, r as loadShellEnvFallback } from "./shell-env-Bb4wWnVF.js";
import { t as sanitizeTerminalText } from "./safe-text-CNdk9l9T.js";
import { a as resolveConfigIncludes, i as readConfigIncludeFileWithGuards, n as ConfigIncludeError } from "./includes-D1aKGRXg.js";
import { t as applyMergePatch } from "./merge-patch-BGy6BHu_.js";
import { V as normalizeSafeBinProfileFixtures, i as normalizeTrustedSafeBinDirs } from "./exec-safe-bin-trust-BPXCunOZ.js";
import { a as getRuntimeConfigSnapshotRefreshHandler, c as notifyRuntimeConfigWriteListeners, i as getRuntimeConfigSnapshot, l as registerRuntimeConfigWriteListener, n as createRuntimeConfigWriteNotification, o as getRuntimeConfigSourceSnapshot, r as finalizeRuntimeSnapshotWrite, s as loadPinnedRuntimeConfig } from "./runtime-snapshot-CZqO77WE.js";
import { n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-reCe_d7o.js";
import { S as resolveDefaultAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-5o1jve-2.js";
import { t as withBundledPluginAllowlistCompat } from "./bundled-compat-DELuo9-N.js";
import { a as normalizePluginsConfig, l as resolveMemorySlotDecision, s as resolveEffectivePluginActivationState } from "./config-state-DbwRF0HU.js";
import { t as resolveManifestCommandAliasOwner } from "./manifest-command-aliases.runtime-CLmHJO3U.js";
import { n as appendAllowedValuesHint, r as summarizeAllowedValues, t as validateJsonSchemaValue } from "./schema-validator-BNH_bxuQ.js";
import { c as isWindowsAbsolutePath, i as isAvatarHttpUrl, n as hasAvatarUriScheme, o as isPathWithinRoot, r as isAvatarDataUrl } from "./avatar-policy-BmKYbEtK.js";
import { t as EnclawedSchema } from "./zod-schema-DMQIXdwE.js";
import { n as comparePrereleaseIdentifiers, r as normalizeLegacyDotBetaVersion } from "./semver-compare-DxAnq9a5.js";
...
const LEGACY_CONFIG_MIGRATIONS_CHANNELS = [
	defineLegacyConfigMigration({
		...
		legacyRules: [{
			...
			message: "session.threadBindings.ttlHours was renamed to session.threadBindings.idleHours. Run \"enclawed doctor --fix\".",
			match: (value) => hasLegacyThreadBindingTtl(value)
		}, {
			path: ["channels"],
			message: "channels.<id>.threadBindings.ttlHours was renamed to channels.<id>.threadBindings.idleHours. Run \"enclawed doctor --fix\".",
		...
		legacyRules: [
			{
				...
				message: "channels.telegram.streamMode, channels.telegram.streaming (scalar), chunkMode, blockStreaming, draftChunk, and blockStreamingCoalesce are legacy; use channels.telegram.streaming.{mode,chunkMode,preview.chunk,block.enabled,block.coalesce} instead. Run \"enclawed doctor --fix\".",
			...
			},
			{
				...
				message: "channels.telegram.accounts.<id>.streamMode, streaming (scalar), chunkMode, blockStreaming, draftChunk, and blockStreamingCoalesce are legacy; use channels.telegram.accounts.<id>.streaming.{mode,chunkMode,preview.chunk,block.enabled,block.coalesce} instead. Run \"enclawed doctor --fix\".",
				match: (value) => hasLegacyKeysInAccounts(value, hasLegacyTelegramStreamingKeys)
			},
			{
				path: ["channels", "slack"],
				message: "channels.slack.streamMode, channels.slack.streaming (scalar), chunkMode, blockStreaming, blockStreamingCoalesce, and nativeStreaming are legacy; use channels.slack.streaming.{mode,chunkMode,block.enabled,block.coalesce,nativeTransport} instead. Run \"enclawed doctor --fix\".",
			...
			},
			{
				...
				message: "channels.slack.accounts.<id>.streamMode, streaming (scalar), chunkMode, blockStreaming, blockStreamingCoalesce, and nativeStreaming are legacy; use channels.slack.accounts.<id>.streaming.{mode,chunkMode,block.enabled,block.coalesce,nativeTransport} instead. Run \"enclawed doctor --fix\".",
	...
	defineLegacyConfigMigration({
		...
		legacyRules: [
			{
				path: ["channels", "slack"],
				message: "channels.slack.channels.<id>.allow is legacy; use channels.slack.channels.<id>.enabled instead. Run \"enclawed doctor --fix\".",
			...
			},
			{
				...
				message: "channels.slack.accounts.<id>.channels.<id>.allow is legacy; use channels.slack.accounts.<id>.channels.<id>.enabled instead. Run \"enclawed doctor --fix\".",
				match: (value) => hasLegacyKeysInAccounts(value, hasLegacySlackChannelAllowAlias)
			},
			{
				path: ["channels", "googlechat"],
				message: "channels.googlechat.groups.<id>.allow is legacy; use channels.googlechat.groups.<id>.enabled instead. Run \"enclawed doctor --fix\".",
			...
			},
			{
				...
				message: "channels.googlechat.accounts.<id>.groups.<id>.allow is legacy; use channels.googlechat.accounts.<id>.groups.<id>.enabled instead. Run \"enclawed doctor --fix\".",
				match: (value) => hasLegacyKeysInAccounts(value, hasLegacyGoogleChatGroupAllowAlias)
			},
			{
				path: ["channels", "discord"],
				message: "channels.discord.guilds.<id>.channels.<id>.allow is legacy; use channels.discord.guilds.<id>.channels.<id>.enabled instead. Run \"enclawed doctor --fix\".",
			...
			},
			{
				...
				message: "channels.discord.accounts.<id>.guilds.<id>.channels.<id>.allow is legacy; use channels.discord.accounts.<id>.guilds.<id>.channels.<id>.enabled instead. Run \"enclawed doctor --fix\".",
...
const MEMORY_SEARCH_RULE = {
	path: ["memorySearch"],
	message: "top-level memorySearch was moved; use agents.defaults.memorySearch instead. Run \"enclawed doctor --fix\"."
};
...
const LEGACY_SANDBOX_SCOPE_RULES = [{
	...
	message: "agents.defaults.sandbox.perSession is legacy; use agents.defaults.sandbox.scope instead. Run \"enclawed doctor --fix\".",
	match: (value) => hasLegacySandboxPerSession(value)
}, {
	path: ["agents", "list"],
	message: "agents.list[].sandbox.perSession is legacy; use agents.list[].sandbox.scope instead. Run \"enclawed doctor --fix\".",
...
const GATEWAY_BIND_RULE = {
	path: ["gateway", "bind"],
	message: "gateway.bind host aliases (for example 0.0.0.0/localhost) are legacy; use bind modes (lan/loopback/custom/tailnet/auto) instead. Run \"enclawed doctor --fix\".",
...
const LEGACY_CONFIG_MIGRATIONS_RUNTIME_PROVIDERS = [defineLegacyConfigMigration({
	...
	legacyRules: [{
		...
		message: "tools.web.x_search.apiKey moved to the xAI plugin; use plugins.entries.xai.config.webSearch.apiKey instead. Run \"enclawed doctor --fix\"."
	}],
	apply: (raw, changes) => {
...
const LEGACY_CONFIG_MIGRATIONS_RUNTIME_TTS = [defineLegacyConfigMigration({
	...
	legacyRules: [{
		path: ["messages", "tts"],
		message: "messages.tts.<provider> keys (openai/elevenlabs/microsoft/edge) are legacy; use messages.tts.providers.<provider>. Run \"enclawed doctor --fix\".",
		match: (value) => hasLegacyTtsProviderKeys(value)
	}, {
		path: ["plugins", "entries"],
		message: "plugins.entries.voice-call.config.tts.<provider> keys (openai/elevenlabs/microsoft/edge) are legacy; use plugins.entries.voice-call.config.tts.providers.<provider>. Run \"enclawed doctor --fix\".",
...
const LEGACY_WEB_SEARCH_RULES = [{
	...
	message: "tools.web.search provider-owned config moved to plugins.entries.<plugin>.config.webSearch. Run \"enclawed doctor --fix\".",
...
function parseEnclawedVersion(raw) {
	if (!raw) return null;
...
function normalizeEnclawedVersionBase(raw) {
	const parsed = parseEnclawedVersion(raw);
	if (!parsed) return null;
	return `${parsed.major}.${parsed.minor}.${parsed.patch}`;
}
function isSameEnclawedStableFamily(a, b) {
...
function compareEnclawedVersions(a, b) {
	const parsedA = parseEnclawedVersion(a);
	const parsedB = parseEnclawedVersion(b);
...
function shouldWarnOnTouchedVersion(current, touched) {
	...
	if (isSameEnclawedStableFamily(current, touched)) return false;
...
function warnIfConfigFromFuture(cfg, logger) {
	...
	if (!touched) return;
	if (shouldWarnOnTouchedVersion(VERSION, touched)) logger.warn(`Config was last written by a newer Enclawed (${touched}); current version is ${VERSION}.`);
}
...
//#endregion
export { collectRelevantDoctorPluginIds as $, setConfigOverride as A, normalizeLegacyBrowserConfig as B, collectChannelSchemaMetadata as C, applyConfigOverrides as D, resolveShellEnvExpectedKeys as E, unsetConfigValueAtPath as F, seedMissingDefaultAccountsFromSingleAccountBase as G, normalizeLegacyMediaProviderOptions as H, asResolvedSourceConfig as I, resolveBundledProviderPolicySurface as J, normalizeLegacyTalkConfig as K, asRuntimeConfig as L, getConfigValueAtPath as M, parseConfigPath as N, getConfigOverrides as O, setConfigValueAtPath as P, applyChannelDoctorCompatibilityMigrations as Q, findLegacyConfigIssues as R, validateConfigObjectWithPlugins as S, GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA as T, normalizeLegacyMistralModelMaxTokens as U, normalizeLegacyCrossContextMessageConfig as V, normalizeLegacyNanoBananaSkill as W, migrateLegacyWebSearchConfig as X, applyLegacyDoctorMigrations as Y, migrateLegacyXSearchConfig as Z, normalizeEnclawedVersionBase as _, loadConfig as a, validateConfigObjectRaw as b, readBestEffortConfig as c, readSourceConfigBestEffort as d, listPluginDoctorLegacyConfigRules as et, readSourceConfigSnapshot as f, writeConfigFile as g, resolveConfigSnapshotHash as h, getRuntimeConfig as i, unsetConfigOverride as j, resetConfigOverrides as k, readConfigFileSnapshot as l, registerConfigWriteListener as m, clearConfigCache as n, parseConfigJson5 as o, readSourceConfigSnapshotForWrite as p, normalizeGoogleApiBaseUrl as q, createConfigIO as r, projectConfigOntoRuntimeSourceSnapshot as s, ConfigRuntimeRefreshError as t, readConfigFileSnapshotForWrite as u, collectUnsupportedSecretRefPolicyIssues as v, collectPluginSchemaMetadata as w, validateConfigObjectRawWithPlugins as x, validateConfigObject as y, migrateLegacyWebFetchConfig as z };
