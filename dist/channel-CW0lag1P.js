...
import { T as projectConfigAccountIdWarningCollector, h as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-DBrWfvvg.js";
...
import { i as createChatChannelPlugin, l as stripChannelTargetPrefix, t as buildChannelOutboundSessionRoute } from "./core-Csabf6e9.js";
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-DFTrn_L5.js";
...
import { d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-D2DtBiBO.js";
import "./channel-status-CKyzrO47.js";
import { t as zod_exports } from "./zod-BjTCjsWs.js";
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-CpxP5n5r.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-DIvWZHWy.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, n as inspectFeishuCredentials, p as isRecord, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-B_eDKV2M.js";
import "./card-interaction-BgNItGA4.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-DBBGXjXo.js";
import { t as messageActionTargetAliases } from "./security-audit-zFEpWpo9.js";
import { a as resolveFeishuGroupToolPolicy } from "./policy-C3GorrWS.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-Ct8KApKo.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-a2mqXlya.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-DbqZ9mdC.js";
...
async function runScanToCreate(prompter) {
	const { beginAppRegistration, initAppRegistration, pollAppRegistration, printQrCode } = await import("./app-registration-CLebSTW0.js");
	try {
...
async function runNewAppFlow(params) {
	...
	if (scanResult) {
		...
		if (appId && appSecretProbeValue) {
			const { getAppOwnerOpenId } = await import("./app-registration-CLebSTW0.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, configured }) => {
			...
			if (configured && resolvedCredentials) try {
				const { probeFeishu } = await import("./probe-CwhkRJB3.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-Ck5ChXQ5.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-BOnBJNjE.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-CvtBUJqA.js");
