...
import { _ as safeParseJson } from "./utils-BcQ7uNrT.js";
import { i as getRuntimeConfig } from "./io-Dzvn-wpi.js";
import { nn as ErrorCodes, rn as errorShape } from "./protocol-G22L7yBL.js";
import { c as jsonResult, h as readStringParam, s as imageResultFromFile } from "./common-mDzRl__P.js";
import { t as callGatewayTool } from "./gateway-B2xBY4c_.js";
import { a as selectDefaultNodeFromList, i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-DAwOANiS.js";
import { i as wrapExternalContent } from "./external-content-DVMYTLPU.js";
import "./text-runtime-DwWuUy-T.js";
import { t as startLazyPluginServiceModule } from "./lazy-service-module-wSLYsF2a.js";
import { n as respondUnavailableOnNodeInvokeError } from "./nodes.helpers-BM2xTE9o.js";
import { i as resolveNodeCommandAllowlist, n as isNodeCommandAllowed } from "./node-command-policy-cRTZg7hq.js";
import { t as BrowserToolSchema } from "./browser-tool.schema-BHPuqpjT.js";
import { t as withTimeout } from "./sdk-node-runtime-COp-xn78.js";
import "./sdk-security-runtime-BDLG7JaF.js";
import { D as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./cdp.helpers-o2dWzlsd.js";
import "./control-auth-EjiHiuJO.js";
import { c as resolveExistingPathsWithinRoot, i as resolveProfile, n as resolveBrowserConfig, s as DEFAULT_UPLOAD_DIR } from "./config-DdC3GGxL.js";
import "./sdk-setup-tools-Dx5xwcMI.js";
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-BRUKsHqz.js";
import { c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as isPersistentBrowserProfileMutation, l as browserAct, n as persistBrowserProxyFiles, o as resolveRequestedBrowserProfile, p as browserScreenshotAction, s as browserConsoleMessages, t as applyBrowserProxyPaths, u as browserArmDialog } from "./browser-runtime-Djtwd-J6.js";
import { r as getBrowserProfileCapabilities } from "./target-id-Rq5XjHPE.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-BFXD91md.js"),
