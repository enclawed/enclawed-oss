...
import { n as isRich, r as theme } from "./theme-BVnTyzuE.js";
import { n as info$1 } from "./globals-D8R_YQwt.js";
...
import { c as capEntryCount, d as resolveMaintenanceConfig, g as enforceSessionDiskBudget, o as updateSessionStore, u as pruneStaleEntries } from "./store-eo7yB1I1.js";
...
import { D as deleteTaskFlowRecordById, I as resolveTaskFlowForLookupToken, M as getTaskFlowRegistryRestoreFailure, N as listTaskFlowRecords, d as listTasksForFlowId, j as getTaskFlowById, o as getTaskById, t as cancelTaskById, w as updateTaskNotifyPolicyById, z as updateFlowRecordByIdExpectedRevision } from "./task-registry-DpuV3HbM.js";
import { n as summarizeTaskRecords } from "./task-registry.summary-BbME_1TC.js";
import "./runtime-internal-Btgq8Iri.js";
import { s as getFlowTaskSummary, t as cancelFlowById } from "./task-executor-DF7aWa4R.js";
import { t as formatHelpExamples } from "./help-format-Cc7aGPm0.js";
import { n as parsePositiveIntOrUndefined } from "./helpers-CZiCYYWJ.js";
import { n as runCommandWithRuntime } from "./cli-utils-C-5n8CQ2.js";
import { n as healthCommand } from "./health-DUkkyEAc.js";
import { a as formatSessionModelCell, c as resolveSessionDisplayModel, i as formatSessionKeyCell, l as resolveSessionStoreTargetsOrExit, n as formatSessionAgeCell, o as toSessionDisplayRows, r as formatSessionFlagsCell, s as resolveSessionDisplayDefaults, t as sessionsCommand } from "./sessions-CET_Vsr3.js";
import { t as statusCommand } from "./status-Cvq_8XzQ.js";
import { _ as listTaskAuditFindings, a as reconcileInspectableTasks, i as previewTaskRegistryMaintenance, l as runTaskRegistryMaintenance, n as getInspectableTaskRegistrySummary, o as reconcileTaskLookupToken, t as getInspectableTaskAuditSummary, v as summarizeTaskAuditFindings } from "./task-registry.maintenance-muGtbKwY.js";
...
async function tasksMaintenanceCommand(opts, runtime) {
	...
	if (!opts.apply) runtime.log("Dry run only. Re-run with `enclawed tasks maintenance --apply` to write changes.");
}
//#endregion
...
function registerStatusHealthSessionsCommands(program) {
	program.command("status").description("Show channel health and recent session recipients").option("--json", "Output JSON instead of text", false).option("--all", "Full diagnosis (read-only, pasteable)", false).option("--usage", "Show model provider usage/quota snapshots", false).option("--deep", "Probe channels (WhatsApp Web + Telegram + Discord + Slack + Signal)", false).option("--timeout <ms>", "Probe timeout in milliseconds", "10000").option("--verbose", "Verbose logging", false).option("--debug", "Alias for --verbose", false).addHelpText("after", () => `\n${theme.heading("Examples:")}\n${formatHelpExamples([
		...
		["enclawed status --deep", "Run channel probes (WA + Telegram + Discord + Slack + Signal)."],
	...
	sessionsCmd.command("cleanup").description("Run session-store maintenance now").option("--store <path>", "Path to session store (default: resolved from config)").option("--agent <id>", "Agent id to maintain (default: configured default agent)").option("--all-agents", "Run maintenance across all configured agents", false).option("--dry-run", "Preview maintenance actions without writing", false).option("--enforce", "Apply maintenance even when configured mode is warn", false).option("--fix-missing", "Remove store entries whose transcript files are missing (bypasses age/count retention)", false).option("--active-key <key>", "Protect this session key from budget-eviction").option("--json", "Output JSON", false).addHelpText("after", () => `\n${theme.heading("Examples:")}\n${formatHelpExamples([
		...
		["enclawed sessions cleanup --dry-run --fix-missing", "Also preview pruning entries with missing transcript files."],
		...
		["enclawed sessions cleanup --enforce --store ./tmp/sessions.json", "Use a specific store."]
