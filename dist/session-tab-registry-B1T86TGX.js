...
import { n as getBridgeAuthForPort } from "./bridge-auth-registry-tlhZKpVW.js";
import { h as resolveBrowserRateLimitMessage } from "./cdp.helpers-DZMnXnxy.js";
import { n as resolveBrowserControlAuth } from "./control-auth-CNgUvKUj.js";
...
async function fetchBrowserJson(url, init) {
	...
	try {
		...
		const { dispatchBrowserControlRequest } = await import("./local-dispatch.runtime-DhzqSiha.js");
