...
import { r as resolveDangerousNameMatchingEnabled } from "./dangerous-name-matching-B7pmnOd3.js";
import { J as setSetupChannelEnabled, Q as splitSetupEntries, a as createAllowFromSection, f as createStandardChannelSetupStatus, v as mergeAllowFromEntries } from "./setup-wizard-helpers-A7VVNxLn.js";
import "./setup-D1QaGmiu.js";
import { i as listCombinedAccountIds, s as resolveMergedAccountConfig } from "./account-helpers-CsS6ODQv.js";
...
const synologyChatSetupWizard = {
	...
	textInputs: [{
		...
		helpLines: ["Use the incoming webhook URL from Synology Chat integrations.", "This is the URL Enclawed uses to send replies back to Chat."],
