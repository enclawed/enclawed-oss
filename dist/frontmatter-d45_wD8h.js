...
import { n as MANIFEST_KEY, t as LEGACY_MANIFEST_KEYS } from "./legacy-names-CmFGZWLL.js";
import { r as normalizeCsvOrLooseStringList } from "./string-normalization-QLwZvaSN.js";
...
function resolveEnclawedManifestBlock(params) {
...
function resolveEnclawedManifestRequires(metadataObj) {
...
function resolveEnclawedManifestInstall(metadataObj, parseInstallSpec) {
	return (Array.isArray(metadataObj.install) ? metadataObj.install : []).map((entry) => parseInstallSpec(entry)).filter((entry) => Boolean(entry));
}
function resolveEnclawedManifestOs(metadataObj) {
	return normalizeStringList(metadataObj.os);
}
function parseEnclawedManifestInstallBase(input, allowedKinds) {
...
function applyEnclawedManifestInstallCommonFields(spec, parsed) {
...
//#endregion
export { parseFrontmatterBool as a, resolveEnclawedManifestOs as c, parseEnclawedManifestInstallBase as i, resolveEnclawedManifestRequires as l, getFrontmatterString as n, resolveEnclawedManifestBlock as o, normalizeStringList as r, resolveEnclawedManifestInstall as s, applyEnclawedManifestInstallCommonFields as t, parseFrontmatterBlock as u };
