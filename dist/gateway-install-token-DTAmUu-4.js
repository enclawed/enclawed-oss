...
import { i as normalizeEnvVarKey, n as isDangerousHostEnvOverrideVarName, r as isDangerousHostEnvVarName } from "./host-env-security-9zf-JImt.js";
import { t as collectDurableServiceEnvVars } from "./state-dir-dotenv-C2cfNhIh.js";
import { d as resolveGatewayLaunchAgentLabel } from "./paths-YeCWuIy9.js";
import { i as resolveGatewayProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-As_fUgdd.js";
import { c as buildServiceEnvironment } from "./runtime-paths-C8OzEP0r.js";
...
import { g as writeConfigFile, u as readConfigFileSnapshotForWrite } from "./io-Dzvn-wpi.js";
...
function loadDaemonInstallAuthProfileSourceRuntime() {
	daemonInstallAuthProfileSourceRuntimePromise ??= import("./daemon-install-auth-profiles-source.runtime-byqFU9jt.js");
	return daemonInstallAuthProfileSourceRuntimePromise;
}
function loadDaemonInstallAuthProfileStoreRuntime() {
	daemonInstallAuthProfileStoreRuntimePromise ??= import("./daemon-install-auth-profiles-store.runtime-XEdmTir1.js");
