...
import { o as resolveWindowsCommandShim, s as spawnWithFallback } from "./exec-DNo2Rb1n.js";
import { t as killProcessTree } from "./kill-tree-CVXDk07v.js";
import { n as getShellConfig } from "./shell-utils-nNPgdWW8.js";
...
function createProcessSupervisor() {
	...
	const spawn = async (input) => {
		...
		try {
			...
			const { warnProcessSupervisorSpawnFailure } = await import("./supervisor-log.runtime-Di_b23Hg.js");
