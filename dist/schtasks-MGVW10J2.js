...
import { f as resolveGatewayServiceDescription, m as resolveGatewayWindowsTaskName, t as resolveGatewayStateDir } from "./paths-HxbQFXGH.js";
import { t as getWindowsInstallRoots } from "./windows-install-roots-Hh_aHtDc.js";
import { a as parseCmdScriptCommandLine, c as parseCmdSetAssignment, d as parseProcCmdline, i as readWindowsProcessArgsSync, l as renderCmdSetAssignment, n as findGatewayPidsOnPortSync, o as quoteCmdScriptArg, r as readWindowsListeningPidsOnPortSync, s as assertNoCmdLineBreak, u as isGatewayArgv } from "./restart-stale-pids-Cupz8fFw.js";
import { i as writeFormattedLines, n as formatLine, t as parseKeyValueOutput } from "./runtime-parse-B4f0N4H3.js";
import { a as inspectPortUsage } from "./ports-DZ1rIgxx.js";
...
async function resolveScheduledTaskPort(env) {
	...
	return parsePortFromProgramArguments(command?.programArguments) ?? parsePositivePort(command?.environment?.ENCLAWED_GATEWAY_PORT) ?? resolveConfiguredGatewayPort(env);
}
