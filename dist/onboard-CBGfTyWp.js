...
import { u as resolveGatewayPort } from "./paths-Z7drr_SN.js";
import { t as assertSupportedRuntime } from "./runtime-guard-_x9R7u4P.js";
import "./daemon-runtime-BVdi_jl7.js";
import { d as resolveSecretInputRef, s as isValidEnvSecretRefId } from "./types.secrets-C7GHgMrh.js";
...
import { l as readConfigFileSnapshot } from "./io-Dzvn-wpi.js";
...
import { c as normalizeGatewayTokenInput, m as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-CHJZcheF.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-C0GxJLiC.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-AxTMzL4O.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-MU42GO_9.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-BIuG77mY.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
		workspaceDir,
		env: process.env
	});
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-Cna-jmOw.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-CRC7-yo0.js");
