...
import { f as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-C0XxPilZ.js";
import "./pi-embedded-helpers-Ba-zbzdj.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-D2xeI4Un.js";
//#region src/agents/cli-runner.ts
async function runCliAgent(params) {
	const { prepareCliRunContext } = await import("./prepare.runtime-Cp-gV2p6.js");
	return runPreparedCliAgent(await prepareCliRunContext(params));
}
async function runPreparedCliAgent(context) {
	const { executePreparedCliRun } = await import("./execute.runtime-Bn6sG8jU.js");
