...
import { a as require_axios, i as require_logging, n as require_lib$2, r as require_http$2, t as require_dist$3 } from "./dist-BB2VGfBl.js";
import { t as require_jsonwebtoken } from "./jsonwebtoken-CJ0WM-H7.js";
import { t as require_src } from "./src-3fafo_9R.js";
	...
	var App = class {
		...
		*/
		...
		constructor(options = {}) {
			...
			this.graphBaseUrl = /^(https?:\/\/[^/]+)/i.exec((this.cloud.graphScope ?? "").trim())?.[1];
