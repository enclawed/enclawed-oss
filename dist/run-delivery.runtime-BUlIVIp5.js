...
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey } from "./main-session-DWqaDaEZ.js";
...
import { a as hasReplyPayloadContent } from "./payload-DpdJDMrC.js";
import { _ as resolveDeliveryTarget, l as hasScheduledNextRunAtMs } from "./jobs-BwPMOAgT.js";
import { n as pickLastNonEmptyTextFromPayloads, r as pickSummaryFromOutput } from "./helpers-lIvNpLKi.js";
import { n as isLikelyInterimCronMessage, t as expectsSubagentFollowup } from "./subagent-followup-hints-D4wKwOAi.js";
...
async function loadGatewayCallRuntime() {
	gatewayCallRuntimePromise ??= import("./call.runtime-BIBi0m5Z.js");
	return await gatewayCallRuntimePromise;
}
async function loadDeliveryOutboundRuntime() {
	deliveryOutboundRuntimePromise ??= import("./delivery-outbound.runtime-C17zQMEL.js");
	return await deliveryOutboundRuntimePromise;
}
async function loadDeliverySubagentRegistryRuntime() {
	deliverySubagentRegistryRuntimePromise ??= import("./delivery-subagent-registry.runtime-xB-4h50W.js");
	return await deliverySubagentRegistryRuntimePromise;
}
async function loadDeliveryLoggerRuntime() {
	deliveryLoggerRuntimePromise ??= import("./delivery-logger.runtime-Cg4xXYRS.js");
	return await deliveryLoggerRuntimePromise;
}
async function loadSubagentFollowupRuntime() {
	subagentFollowupRuntimePromise ??= import("./subagent-followup.runtime-BUZ3oHf5.js");
...
function pruneCompletedDirectCronDeliveries(now) {
	const ttlMs = process.env.ENCLAWED_TEST_FAST === "1" ? 6e4 : 1440 * 60 * 1e3;
