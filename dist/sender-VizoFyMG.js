import { c as getPlatformAdapter, i as normalizeOptionalString, n as normalizeLowercaseStringOrEmpty, s as sanitizeFileName } from "./string-normalize-Blt_o5di.js";
...
function initSender(options) {
	...
	if (options.enclawedVersion) _enclawedVersion = options.enclawedVersion;
}
/** Update the Enclawed framework version in the User-Agent (called after runtime injection). */
function setEnclawedVersion(version) {
	if (version) _enclawedVersion = version;
}
