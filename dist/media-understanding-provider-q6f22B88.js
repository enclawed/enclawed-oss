...
import { r as readModelListResult } from "./models-G8CY2Zai.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-C-HzGoVn.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
