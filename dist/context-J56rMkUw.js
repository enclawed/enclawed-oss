...
import { I as consumeRootOptionToken } from "./logger-wuQoU2z2.js";
...
import { t as computeBackoff } from "./backoff-D8FAZIeO.js";
...
function isLikelyEnclawedCliProcess(argv = process.argv) {
	const entryBasename = normalizeLowercaseStringOrEmpty(path.basename(argv[1] ?? ""));
	return entryBasename === "enclawed" || entryBasename === "enclawed.mjs" || entryBasename === "entry.js" || entryBasename === "entry.mjs";
}
...
function shouldEagerWarmContextWindowCache(argv = process.argv) {
	if (!isLikelyEnclawedCliProcess(argv)) return false;
