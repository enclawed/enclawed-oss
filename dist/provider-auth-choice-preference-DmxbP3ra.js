import { n as resolveManifestProviderAuthChoice } from "./provider-auth-choices-93b9XNNY.js";
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-B3JhGG4l.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-CzX-Ic2c.js");
