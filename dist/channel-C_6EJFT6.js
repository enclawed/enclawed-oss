...
import { u as getExecApprovalReplyMetadata } from "./exec-approval-reply-D2yEmksv.js";
import { r as createChannelApprovalCapability } from "./approval-delivery-helpers-DkhpVqWx.js";
...
import "./approval-runtime-C7CNP27N.js";
import { t as asOptionalObjectRecord } from "./string-normalize-DWA3ypgp.js";
import { l as ensurePlatformAdapter, u as getBridgeLogger } from "./resolve-BCPINIhA.js";
import { a as resolveApprovalTarget } from "./approval-C7MBQicF.js";
import { a as resolveQQBotAccount, n as applyQQBotAccountConfig, t as DEFAULT_ACCOUNT_ID$1 } from "./config-PiNYbSCI.js";
import { a as resolveQQBotExecApprovalConfig, i as matchesQQBotApprovalAccount, n as isQQBotExecApprovalAuthorizedSender, o as shouldHandleQQBotExecApprovalRequest, r as isQQBotExecApprovalClientEnabled, t as isQQBotExecApprovalApprover } from "./exec-approvals-DU6R-hX6.js";
import { a as qqbotSetupAdapterShared, i as qqbotMeta, n as qqbotSetupWizard, r as qqbotConfigAdapter, t as qqbotChannelConfigSchema } from "./config-schema-CTDCxYrP.js";
import { n as writeEnclawedConfigThroughRuntime, t as toGatewayAccount } from "./narrowing-DGnYGTR4.js";
import { t as getQQBotRuntime } from "./runtime-DoOxghHT.js";
import { l as getQQBotDataPath, n as normalizeTarget, t as looksLikeQQBotTarget } from "./target-parser-1u6fcDu9.js";
	...
	return createChannelApprovalCapability({
		...
		nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
			...
			load: async () => {
				...
				return (await import("./handler-runtime-Ciz15GWi.js")).qqbotApprovalNativeRuntime;
			}
		})
	});
}
...
function loadGatewayModule() {
	_gatewayModulePromise ??= import("./gateway-BcdpmkWc.js");
...
const qqbotPlugin = {
	...
	outbound: {
		...
		sendText: async ({ to, text, accountId, replyToId, cfg }) => {
			...
			const { sendText } = await import("./outbound-1Gsv409G.js");
		...
		sendMedia: async ({ to, text, mediaUrl, accountId, replyToId, cfg }) => {
			await loadGatewayModule();
			const account = resolveQQBotAccount(cfg, accountId);
			const { sendMedia } = await import("./outbound-1Gsv409G.js");
	...
	gateway: {
		...
		logoutAccount: async ({ accountId, cfg }) => {
			...
			if (changed) await writeEnclawedConfigThroughRuntime(getQQBotRuntime(), nextCfg);
