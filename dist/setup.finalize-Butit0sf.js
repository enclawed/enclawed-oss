...
import { r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-k9VV8iuP.js";
import { i as isSystemdUserServiceAvailable } from "./systemd-BbsYBVVM.js";
...
import { n as listConfiguredWebSearchProviders } from "./runtime-Dp3L5kY5.js";
...
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-DOTxLQDc.js";
import { i as formatControlUiSshHint, m as waitForGatewayReachable, u as probeGatewayReachable } from "./onboard-helpers-CmGuAQ9e.js";
...
import { t as runTui } from "./tui-DIOv50xo.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DE5pmvrs.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-CujqEriv.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-CujqEriv.js");
