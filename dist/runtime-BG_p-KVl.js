...
import { c as jsonResult, d as readNumberParam, f as readReactionParams, h as readStringParam, l as parseAvailableTags, p as readStringArrayParam } from "./common-mDzRl__P.js";
import { t as assertMediaNotDataUrl } from "./sandbox-paths-AfYJvOXd.js";
import { r as resolvePollMaxSelections } from "./polls-D5ZMaO90.js";
import { t as readBooleanParam } from "./boolean-param-C-UoHESx.js";
import { a as withNormalizedTimestamp } from "./date-time-DP4nP88x.js";
import "./text-runtime-DwWuUy-T.js";
import { o as resolveDefaultDiscordAccountId, t as createDiscordActionGate } from "./accounts-CgccMlcy.js";
import { s as resolveDiscordChannelId } from "./normalize-CL-TAjzv.js";
import { r as sendDiscordComponentMessage } from "./send.components-C-1jX3Mh.js";
import { n as getGateway, o as getPresence } from "./gateway-registry-CxE2CyON.js";
import { D as hasAnyGuildPermissionDiscord, N as createDiscordRuntimeAccountContext, d as resolveDiscordTargetChannelId, w as fetchChannelPermissionsDiscord } from "./send.shared-euVHoeJy.js";
import { A as timeoutMemberDiscord, C as fetchRoleInfoDiscord, D as listScheduledEventsDiscord, E as listGuildChannelsDiscord, F as deleteChannelDiscord, I as editChannelDiscord, L as moveChannelDiscord, M as uploadEmojiDiscord, N as uploadStickerDiscord, O as removeRoleDiscord, P as createChannelDiscord, R as removeChannelPermissionDiscord, S as fetchMemberInfoDiscord, T as kickMemberDiscord, _ as unpinMessageDiscord, b as createScheduledEventDiscord, c as createThreadDiscord, d as fetchMessageDiscord, f as listPinsDiscord, g as searchMessagesDiscord, h as readMessagesDiscord, i as removeReactionDiscord, j as listGuildEmojisDiscord, k as resolveEventCoverImage, l as deleteMessageDiscord, m as pinMessageDiscord, n as reactMessageDiscord, o as sendVoiceMessageDiscord, p as listThreadsDiscord, r as removeOwnReactionsDiscord, t as fetchReactionsDiscord, u as editMessageDiscord, v as addRoleDiscord, w as fetchVoiceStatusDiscord, x as fetchChannelInfoDiscord, y as banMemberDiscord, z as setChannelPermissionDiscord } from "./send-uWG-Q4mt.js";
import { n as sendPollDiscord, r as sendStickerDiscord, t as sendMessageDiscord } from "./send.outbound-DxstxCn9.js";
import { s as readDiscordComponentSpec } from "./components-3nZNHDxk.js";
import "./targets-CNPM-PPM.js";
