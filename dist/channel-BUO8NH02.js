...
import { J as setSetupChannelEnabled, a as createAllowFromSection, d as createPromptParsedAllowFromForAccount, f as createStandardChannelSetupStatus, h as createTopLevelChannelDmPolicySetter, p as createTopLevelChannelAllowFromSetter } from "./setup-wizard-helpers-A7VVNxLn.js";
...
import { f as runStoppablePassiveMonitor } from "./extension-shared-BQ6EyDfP.js";
...
import { d as createDefaultChannelRuntimeState, n as buildBaseChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-DAIUgpkS.js";
...
import { t as IrcChannelConfigSchema } from "./config-schema-OXHbdwoC.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-DubSxuLK.js";
...
async function loadIrcChannelRuntime$1() {
	ircChannelRuntimePromise$1 ??= import("./channel-runtime-DnWqYLyH.js");
	...
	textInputs: [
		...
		},
		{
			...
			initialValue: ({ cfg, accountId, credentialValues }) => resolveIrcAccount({
				cfg,
				accountId
			}).config.username || credentialValues.token || "enclawed",
			validate: ({ value }) => normalizeStringifiedOptionalString(value) ? void 0 : "Required",
			normalizeValue: ({ value }) => normalizeStringifiedOptionalString(value) ?? "",
			applySet: async ({ cfg, accountId, value }) => updateIrcAccountConfig(cfg, accountId, {
				enabled: true,
...
async function loadIrcChannelRuntime() {
	ircChannelRuntimePromise ??= import("./channel-runtime-DnWqYLyH.js");
