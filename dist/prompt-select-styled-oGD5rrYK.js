...
import { _ as resolveStateDir, d as resolveIsNixMode, h as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-Z7drr_SN.js";
import { d as resolveGatewayLaunchAgentLabel, g as resolveNodeLaunchAgentLabel, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName } from "./paths-YeCWuIy9.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-C8OzEP0r.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-DTAmUu-4.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-BVdi_jl7.js";
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-C7GHgMrh.js";
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-XS0-R8Dy.js";
import { i as runExec, r as runCommandWithTimeout } from "./exec-LGLh3vyF.js";
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-DKGSlh-e.js";
import { a as isLoopbackHost, m as resolveGatewayBindHost } from "./net-DkWIq6k8.js";
import { o as resolveGatewayAuth } from "./auth-BO-EkmdB.js";
import { l as normalizeTrimmedStringList, s as normalizeStringEntries } from "./string-normalization-BWhNVcLY.js";
import { i as listBundledChannelPluginIds } from "./bootstrap-registry-Ba7OKrIO.js";
import { $ as collectRelevantDoctorPluginIds, B as normalizeLegacyBrowserConfig, G as seedMissingDefaultAccountsFromSingleAccountBase, H as normalizeLegacyMediaProviderOptions, K as normalizeLegacyTalkConfig, Q as applyChannelDoctorCompatibilityMigrations, R as findLegacyConfigIssues, S as validateConfigObjectWithPlugins, U as normalizeLegacyMistralModelMaxTokens, V as normalizeLegacyCrossContextMessageConfig, W as normalizeLegacyNanoBananaSkill, X as migrateLegacyWebSearchConfig, Y as applyLegacyDoctorMigrations, Z as migrateLegacyXSearchConfig, et as listPluginDoctorLegacyConfigRules, g as writeConfigFile, l as readConfigFileSnapshot, z as migrateLegacyWebFetchConfig } from "./io-Dzvn-wpi.js";
import { t as asNullableObjectRecord } from "./record-coerce-CMKPGWB_.js";
import { t as loadPluginManifestRegistry } from "./manifest-registry-B1LtZC7a.js";
import { o as parseAgentSessionKey } from "./session-key-utils-qXY7QK1H.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId } from "./account-id-6Mvnxe99.js";
import { c as normalizeAgentId } from "./session-key-D8SZau-8.js";
import { r as listChannelPlugins } from "./registry-BZZmrGdc.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-Dzck2uJH.js";
import { b as resolveExecutablePath } from "./exec-safe-bin-trust-BPXCunOZ.js";
import { t as DEFAULT_AGENTS_FILENAME } from "./workspace-dcdTJd2I.js";
import { S as resolveDefaultAgentId, b as resolveAgentDir, g as listAgentEntries, x as resolveAgentWorkspaceDir } from "./agent-scope-5o1jve-2.js";
import { t as randomToken } from "./random-token-DdPIkzUf.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-CPJpcgtM.js";
import { a as inspectPortUsage, s as formatPortDiagnostics } from "./ports-DerTpJXR.js";
import { d as uninstallLegacySystemdUnits, i as isSystemdUserServiceAvailable, p as classifySystemdUnavailableDetail } from "./systemd-C_DkmzYn.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-DqJgm0kR.js";
import { i as resolveDaemonContainerContext, r as formatRuntimeStatus, t as buildPlatformRuntimeLogHints } from "./runtime-hints-DKzy5EJY.js";
...
import { a as readEmbeddedGatewayToken, i as needsNodeRuntimeMigration, n as auditGatewayServiceConfig, t as SERVICE_AUDIT_CODES } from "./service-audit-KO791Jrm.js";
import { n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail } from "./systemd-hints-NbApvQHj.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-BQW4KldW.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-BH2Ml4gn.js";
import { n as findExtraGatewayServices, r as renderGatewayServiceCleanupHints } from "./inspect-DqftEvIg.js";
import { u as resolveAuthStorePathForDisplay } from "./source-check-WHC0RF1m.js";
import { S as readClaudeCliCredentialsCached, T as CLAUDE_CLI_PROFILE_ID, n as ensureAuthProfileStore } from "./store-J7Io5AUg.js";
import { a as runPluginSetupConfigMigrations, t as applyPluginAutoEnable } from "./plugin-auto-enable-BE3SC6M5.js";
import { t as hasBundledChannelPersistedAuthState } from "./persisted-auth-state-9ayWII2b.js";
import "./plugins-BRuVcg7S.js";
import "./logging-DotYzX7j.js";
import { a as getModelRefStatus, d as resolveConfiguredModelRef, p as resolveHooksGmailModel } from "./model-selection-3QcDboLc.js";
...
import { n as isPrimarySessionTranscriptFileName, t as formatSessionArchiveTimestamp } from "./artifacts-CxM5l-NG.js";
import { i as resolveMainSessionKey } from "./main-session-DWqaDaEZ.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent, u as resolveStorePath } from "./paths-CADYkZ1j.js";
...
import { n as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-BpYVYL-p.js";
import { i as resolveBootstrapContextForRun } from "./bootstrap-files-D0nEsD2-.js";
import { i as resolveBootstrapMaxChars, o as resolveBootstrapTotalMaxChars } from "./google-BrzdI_S_.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-DXl0_Jy7.js";
import { l as DEFAULT_SANDBOX_IMAGE, r as resolveSandboxScope, s as DEFAULT_SANDBOX_BROWSER_IMAGE } from "./config-CS3yaNEN.js";
import "./pi-embedded-helpers-g589tXhs.js";
import "./auth-profiles-CWIWzE4_.js";
import { a as formatAuthDoctorHint, n as repairOAuthProfileIdMismatch, t as resolveApiKeyForProfile } from "./oauth-BXnnL9He.js";
import { d as resolveProfileUnusableUntilForDisplay } from "./order-B81rwr6N.js";
import { s as resolveApiKeyForProvider } from "./model-auth-CEwjo3Cm.js";
import { n as buildGatewayConnectionDetails, r as callGateway } from "./call-D6zBw8Jl.js";
import { l as loadExecApprovals } from "./exec-approvals-CSCQWe00.js";
import { i as TrimmedNonEmptyStringFieldSchema, n as LowercaseNonEmptyStringFieldSchema, o as parseOptionalField, t as DeliveryThreadIdFieldSchema } from "./delivery-field-schemas-BuMFf3R4.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-DPAlfj2L.js";
import { t as inferLegacyName } from "./normalize-BCN370Zm.js";
import { i as listRouteBindings } from "./bindings-CQlzwnhb.js";
import { N as listTaskFlowRecords, d as listTasksForFlowId } from "./task-registry-DpuV3HbM.js";
import "./runtime-internal-Btgq8Iri.js";
...
import { a as readChannelAllowFromStore } from "./pairing-store-f0EMbN2m.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-DX-_B8DN.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-Cjs3mv3M.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-CPWYQlir.js";
import { t as note$1 } from "./note-Cir9GyFK.js";
import { n as logConfigUpdated } from "./logging-YqCQnNxV.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-nw80NvNs.js";
import { c as repairShortTermPromotionArtifacts, i as getBuiltinMemoryEmbeddingProviderDoctorMetadata, n as auditDreamingArtifacts, o as listBuiltinAutoSelectMemoryEmbeddingProviderDoctorMetadata, r as auditShortTermPromotionArtifacts, s as repairDreamingArtifacts } from "./memory-core-engine-runtime-DOjsojCR.js";
import "./engine-embeddings-_CpcCUSS.js";
import { t as hasConfiguredMemorySecretInput } from "./secret-input-DYs3LF35.js";
import { t as checkQmdBinaryAvailability } from "./engine-qmd-PE3eK5Dl.js";
import { t as resolveMemoryBackendConfig } from "./backend-config-DUgC4uH2.js";
import "./engine-storage-B_mB3Pwz.js";
import "./secret-v5L0u4l0.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DzqerXvt.js";
import { i as buildPluginDiagnosticsReport, r as buildPluginCompatibilityWarnings } from "./status-CcPrdmqQ.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-DkCz9DT0.js";
import { n as resolveExecPolicyScopeSnapshot } from "./exec-approvals-effective-kB8r0OfL.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-DiGXQLRG.js";
import { a as guardCancel, l as printWizardHeader, n as applyWizardMetadata } from "./onboard-helpers-CHJZcheF.js";
import { a as collectChannelDoctorStaleConfigMutations, i as collectChannelDoctorRepairMutations, n as collectChannelDoctorMutableAllowlistWarnings, o as runChannelDoctorConfigSequences, t as collectChannelDoctorEmptyAllowlistExtraWarnings } from "./channel-doctor-Yz_PNUpo.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-ycVRvOcx.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-r_C9aX9C.js";
import { n as formatHealthCheckFailure } from "./health-format-CSVuh8MT.js";
import { n as healthCommand } from "./health-DUkkyEAc.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-DuLjsKqF.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-BNTpsSph.js";
import { n as maybeRepairOpenPolicyAllowFrom, r as resolveAllowFromMode } from "./open-policy-allowfrom-Cdt77XWb.js";
import { n as hasAllowFromEntries, t as scanEmptyAllowlistPolicyWarnings } from "./empty-allowlist-scan-D6i6sJEs.js";
import { t as asObjectRecord } from "./object-CiHRzaOT.js";
import { n as maybeRepairBundledPluginLoadPaths } from "./bundled-plugin-load-paths-o1RtzSi7.js";
import { r as maybeRepairExecSafeBinProfiles } from "./exec-safe-bins-NORIjKqH.js";
import { n as maybeRepairLegacyToolsBySenderKeys } from "./legacy-tools-by-sender-Cz4X5dfB.js";
import { r as maybeRepairStalePluginConfig } from "./stale-plugin-config-DotojZd4.js";
...
import { n as doctorShellCompletion } from "./doctor-completion-sE2-RiSC.js";
import { t as coerceFiniteScheduleNumber } from "./schedule-BDI6WHn8.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-BwMp7fxR.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-CKT0AwJI.js";
import { a as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./state-migrations-q2ucIIkZ.js";
import "./doctor-state-migrations-CcGSl3iG.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-Bx0jhyvv.js";
...
async function collectDoctorPreviewWarnings(params) {
	...
	const channelPluginRuntime = hasChannelConfig && hasExplicitChannelPluginBlockerConfig(params.cfg) ? await import("./channel-plugin-blockers-DW9Tp5kB.js") : void 0;
	...
	if (hasChannelConfig) {
		const { collectChannelDoctorPreviewWarnings } = await import("./channel-doctor-Cpe0A0su.js");
		...
		const { collectOpenPolicyAllowFromWarnings, maybeRepairOpenPolicyAllowFrom } = await import("./open-policy-allowfrom-ChhC_Nak.js");
	...
	if (hasPluginConfig) {
		const { collectStalePluginConfigWarnings, isStalePluginAutoRepairBlocked, scanStalePluginConfig } = await import("./stale-plugin-config-D5yU5syd.js");
	...
	if (hasPluginLoadPaths(params.cfg)) {
		const { collectBundledPluginLoadPathWarnings, scanBundledPluginLoadPathMigrations } = await import("./bundled-plugin-load-paths-yWAcg-tO.js");
	...
	if (hasChannelConfig) {
		const { collectChannelDoctorEmptyAllowlistExtraWarnings } = await import("./channel-doctor-Cpe0A0su.js");
		const { scanEmptyAllowlistPolicyWarnings } = await import("./empty-allowlist-scan-Bfy1GkK8.js");
	...
	if (hasToolsBySenderKey(params.cfg)) {
		const { collectLegacyToolsBySenderWarnings, scanLegacyToolsBySenderKeys } = await import("./legacy-tools-by-sender-2ts9VB34.js");
	...
	if (hasConfiguredSafeBins(params.cfg)) {
		const { collectExecSafeBinCoverageWarnings, collectExecSafeBinTrustedDirHintWarnings, scanExecSafeBinCoverage, scanExecSafeBinTrustedDirHints } = await import("./exec-safe-bins-CXjpQdXR.js");
...
async function loadProviderRuntime() {
	return import("./providers.runtime-BaFGYqzz.js");
}
async function loadNoteRuntime() {
	return import("./note-4f1TJuz_.js");
}
