import { a as createMigrationConfigPatchItem, c as hasMigrationConfigPatchConflict, i as applyMigrationManualItem, n as MIGRATION_REASON_TARGET_EXISTS, r as applyMigrationConfigPatchItem, s as createMigrationManualItem } from "./migration-DOSnICX3.js";
import { a as isRecord, l as sanitizeName, n as childRecord, o as readJsonObject } from "./helpers-B_H3MFRs.js";
...
async function buildConfigItems(params) {
	...
	for (const settingsPath of [
		...
		if (settingsPath && settings.env !== void 0) items.push(createMigrationManualItem({
			...
			recommendation: "Move non-secret values manually and store credentials through Enclawed credential flows."
		}));
	}
	return items;
}
