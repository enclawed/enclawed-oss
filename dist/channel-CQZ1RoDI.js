...
import { r as createLazyRuntimeModule } from "./lazy-runtime-CTKnZsG3.js";
import { d as readNumberParam, h as readStringParam } from "./common-mDzRl__P.js";
import { c as normalizeMessagePresentation, s as normalizeInteractiveReply } from "./payload-DpdJDMrC.js";
...
import { t as adaptScopedAccountAccessor } from "./channel-config-helpers-D7nTNM6O.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-YugaiADj.js";
import { t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-BAYshBO_.js";
import "./text-runtime-DwWuUy-T.js";
import { n as buildOutboundBaseSessionKey } from "./thread-id-CrPQ131v.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute } from "./core-CoB1mdbz.js";
import "./routing-_SeFXPvp.js";
import { t as resolveApprovalApprovers } from "./approval-approvers-CdGGCa_z.js";
import { t as createResolvedApproverActionAuthAdapter } from "./approval-auth-helpers-Bg8u_RR6.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-wVoeC-ve.js";
...
import { n as createChannelNativeOriginTargetResolver, t as createChannelApproverDmTargetResolver } from "./approval-native-helpers-CNt_mGUd.js";
import "./approval-native-runtime-DHe_Npc8.js";
import { o as resolveConfiguredFromRequiredCredentialStatuses, r as projectCredentialSnapshotFields } from "./account-snapshot-fields-BYK6RaDL.js";
import "./reply-reference-DAR27atf.js";
import { o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter, s as createFlatAllowlistOverrideResolver } from "./allowlist-config-edit-B6HiUXj_.js";
...
import "./param-readers-CgjVYaJ2.js";
import { d as createDefaultChannelRuntimeState, u as createComputedAccountStatusAdapter } from "./status-helpers-DAIUgpkS.js";
import { h as stringifyRouteThreadId, o as channelRouteTargetsMatchExact } from "./channel-route-BrUPxTuc.js";
import { a as resolveSlackAccount, i as resolveDefaultSlackAccountId, l as resolveSlackReplyToMode, n as listSlackAccountIds, o as resolveSlackAccountAllowFrom } from "./accounts-BrRDFkXi.js";
import { i as resolveSlackChannelId, n as normalizeSlackMessagingTarget, r as parseSlackTarget, t as looksLikeSlackTargetId } from "./target-parsing-bujcSxWZ.js";
...
import { n as buildSlackPresentationBlocks, r as resolveSlackInteractiveBlockOffsets, t as buildSlackInteractiveBlocks } from "./blocks-render-CaE6Ek-m.js";
import { t as SLACK_TEXT_LIMIT } from "./limits-C-YbXgiX.js";
import { n as extractSlackToolSend, t as describeSlackMessageTool } from "./message-tool-api-Cb95eQ_N.js";
import { n as isSlackInteractiveRepliesEnabled, t as compileSlackInteractiveReplies } from "./interactive-replies-DqQNAO8a.js";
import "./channel-api-l2oqUwqk.js";
import { r as createSlackWebClient } from "./client-Dxzjc1Z5.js";
import { r as normalizeAllowListLower } from "./allow-list-DcumjEMR.js";
import { n as resolveSlackGroupToolPolicy, t as resolveSlackGroupRequireMention } from "./group-policy-BBvY_LsS.js";
import { t as resolveSlackReplyBlocks } from "./reply-blocks-B-a26Bh8.js";
import { t as getOptionalSlackRuntime } from "./runtime-CVs6OylH.js";
import { i as slackSecurityAdapter, n as isSlackPluginAccountConfigured, r as slackConfigAdapter, t as createSlackPluginBase } from "./shared-CuLIo1O8.js";
import { i as SLACK_CHANNEL, n as createSlackSetupWizardProxy, r as slackSetupAdapter } from "./setup-core-D_Ok8gky.js";
import { n as resolveSlackThreadTsValue, t as normalizeSlackThreadTsCandidate } from "./thread-ts-B4DHv_GD.js";
...
const slackApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-D5ssmx3a.js")).slackApprovalNativeRuntime
	})
});
...
async function loadSlackActionRuntime$1() {
	slackActionRuntimePromise$1 ??= import("./action-runtime.runtime-Y4k2DfCD.js");
...
const loadSlackSetupSurfaceModule = createLazyRuntimeModule(() => import("./setup-surface-Dt-3O0fU.js"));
const loadSlackScopesModule = createLazyRuntimeModule(() => import("./scopes-BDdByDH7.js"));
const loadSlackOutboundAdapterModule = createLazyRuntimeModule(() => import("./outbound-adapter-BUsKJf1t.js"));
...
const loadSlackDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-CD4qRfnY.js"));
const loadSlackResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-XaBX3iIF.js"));
const loadSlackResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-vyOtZreY.js"));
async function loadSlackActionRuntime() {
	slackActionRuntimePromise ??= import("./action-runtime.runtime-Y4k2DfCD.js");
	return await slackActionRuntimePromise;
}
async function loadSlackSendRuntime() {
	slackSendRuntimePromise ??= import("./send.runtime-D-vFsAuM.js");
	return await slackSendRuntimePromise;
}
async function loadSlackProbeModule() {
	slackProbeModulePromise ??= import("./probe-CoywvBc0.js");
	return await slackProbeModulePromise;
}
async function loadSlackMonitorModule() {
	slackMonitorModulePromise ??= import("./monitor-Bsk-9BvD.js");
	return await slackMonitorModulePromise;
}
async function loadSlackDirectoryLiveModule() {
	slackDirectoryLiveModulePromise ??= import("./directory-live-CRlVffXK.js");
