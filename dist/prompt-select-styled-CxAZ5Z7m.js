...
import { o as getResolvedLoggerSettings } from "./logger-wuQoU2z2.js";
import { o as resolveRequiredHomeDir } from "./home-dir-yzjXRaUx.js";
import { n as resolveEnclawedPackageRootSync, t as resolveEnclawedPackageRoot } from "./enclawed-root-CTcOq9RL.js";
import { b as sleep, g as resolveUserPath, l as isRecord, y as shortenHomePath } from "./utils-BcQ7uNrT.js";
...
import { t as isTruthyEnvValue$1 } from "./env-DMXNDA06.js";
import { t as formatCliCommand } from "./command-format-CAEA84sd.js";
import { _ as resolveStateDir, d as resolveIsNixMode, h as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-CDjhyzOH.js";
import { d as resolveGatewayLaunchAgentLabel, g as resolveNodeLaunchAgentLabel, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName } from "./paths-HxbQFXGH.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-C0Np3ULF.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-Ci3WWnvN.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-3pRKLH22.js";
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-B-g1z55T.js";
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-AUB01Xjb.js";
import { i as runExec, r as runCommandWithTimeout } from "./exec-_4N1gSjx.js";
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-BVdJ5G2_.js";
import { a as isLoopbackHost, m as resolveGatewayBindHost } from "./net-SK24IRt9.js";
import { o as resolveGatewayAuth } from "./auth-B8XaTaMr.js";
import { l as normalizeTrimmedStringList, s as normalizeStringEntries } from "./string-normalization-QLwZvaSN.js";
import { i as listBundledChannelPluginIds } from "./bootstrap-registry-B1qQzh3i.js";
import { $ as collectRelevantDoctorPluginIds, B as normalizeLegacyBrowserConfig, G as seedMissingDefaultAccountsFromSingleAccountBase, H as normalizeLegacyMediaProviderOptions, K as normalizeLegacyTalkConfig, Q as applyChannelDoctorCompatibilityMigrations, R as findLegacyConfigIssues, S as validateConfigObjectWithPlugins, U as normalizeLegacyMistralModelMaxTokens, V as normalizeLegacyCrossContextMessageConfig, W as normalizeLegacyNanoBananaSkill, X as migrateLegacyWebSearchConfig, Y as applyLegacyDoctorMigrations, Z as migrateLegacyXSearchConfig, et as listPluginDoctorLegacyConfigRules, g as writeConfigFile, l as readConfigFileSnapshot, z as migrateLegacyWebFetchConfig } from "./io-BPigC1a6.js";
import { t as asNullableObjectRecord } from "./record-coerce-NLwi4pC3.js";
import { t as loadPluginManifestRegistry } from "./manifest-registry-BSUm5sVB.js";
import { o as parseAgentSessionKey } from "./session-key-utils-Ce7cepnN.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId } from "./account-id-BV5xNTUp.js";
import { c as normalizeAgentId } from "./session-key-BOC5unB4.js";
import { r as listChannelPlugins } from "./registry-BnDtOQsV.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-DkpvRRFC.js";
import { b as resolveExecutablePath } from "./exec-safe-bin-trust-D84Sn_gf.js";
import { t as DEFAULT_AGENTS_FILENAME } from "./workspace-BOVAZCiV.js";
import { S as resolveDefaultAgentId, b as resolveAgentDir, g as listAgentEntries, x as resolveAgentWorkspaceDir } from "./agent-scope-Bv7XD6OT.js";
import { t as randomToken } from "./random-token-DoUTBrWj.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-DLvjqB_1.js";
import { a as inspectPortUsage, s as formatPortDiagnostics } from "./ports-CNWE5-2x.js";
import { d as uninstallLegacySystemdUnits, i as isSystemdUserServiceAvailable, p as classifySystemdUnavailableDetail } from "./systemd-B-zqDlea.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-DafdpbVq.js";
import { i as resolveDaemonContainerContext, r as formatRuntimeStatus, t as buildPlatformRuntimeLogHints } from "./runtime-hints-JaQ37b3Y.js";
import "./config-BDd-c7HD.js";
import { n as safeParseWithSchema, t as safeParseJsonWithSchema } from "./zod-parse-DrvB8WE0.js";
import { n as formatConfigIssueLines } from "./issue-format-B5juDRgp.js";
import { a as readEmbeddedGatewayToken, i as needsNodeRuntimeMigration, n as auditGatewayServiceConfig, t as SERVICE_AUDIT_CODES } from "./service-audit-ChVpjWAb.js";
import { n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail } from "./systemd-hints-CCexgvGB.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-B2FYKJDu.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-21WZiFgV.js";
import { n as findExtraGatewayServices, r as renderGatewayServiceCleanupHints } from "./inspect-CU9-zFpD.js";
import { u as resolveAuthStorePathForDisplay } from "./source-check-CaRahOH0.js";
import { S as readClaudeCliCredentialsCached, T as CLAUDE_CLI_PROFILE_ID, n as ensureAuthProfileStore } from "./store-D3mjjSwW.js";
import { a as runPluginSetupConfigMigrations, t as applyPluginAutoEnable } from "./plugin-auto-enable-DfzfHwyb.js";
import { t as hasBundledChannelPersistedAuthState } from "./persisted-auth-state-DPyL9dmX.js";
import "./plugins-aoBJbOTG.js";
import "./logging-0C4iM3er.js";
import { a as getModelRefStatus, d as resolveConfiguredModelRef, p as resolveHooksGmailModel } from "./model-selection-CSCqfmCj.js";
import { r as loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader-CCp-QjCs.js";
import { r as loadModelCatalog } from "./model-catalog-C85zwax4.js";
import { n as isPrimarySessionTranscriptFileName, t as formatSessionArchiveTimestamp } from "./artifacts-CF4LrKnT.js";
import { i as resolveMainSessionKey } from "./main-session-DhfOziPO.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent, u as resolveStorePath } from "./paths-Lozvxyih.js";
...
import { n as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-Dcs_bNw0.js";
import { i as resolveBootstrapContextForRun } from "./bootstrap-files-Dc9WBd6b.js";
import { i as resolveBootstrapMaxChars, o as resolveBootstrapTotalMaxChars } from "./google-Cj1b_loh.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-BUBecYZm.js";
import { l as DEFAULT_SANDBOX_IMAGE, r as resolveSandboxScope, s as DEFAULT_SANDBOX_BROWSER_IMAGE } from "./config-DwgI9V2b.js";
import "./pi-embedded-helpers-4LE2bkL2.js";
import "./auth-profiles-CyL93P03.js";
import { a as formatAuthDoctorHint, n as repairOAuthProfileIdMismatch, t as resolveApiKeyForProfile } from "./oauth-SFCqfZs4.js";
import { d as resolveProfileUnusableUntilForDisplay } from "./order-C2aADdvY.js";
import { s as resolveApiKeyForProvider } from "./model-auth-B85ng6CG.js";
import { n as buildGatewayConnectionDetails, r as callGateway } from "./call-DtxbZweG.js";
import { l as loadExecApprovals } from "./exec-approvals-C0ZBCFVO.js";
import { i as TrimmedNonEmptyStringFieldSchema, n as LowercaseNonEmptyStringFieldSchema, o as parseOptionalField, t as DeliveryThreadIdFieldSchema } from "./delivery-field-schemas-DUg2Fmkx.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-B4XD9qm3.js";
import { t as inferLegacyName } from "./normalize-C3AZr1xr.js";
import { i as listRouteBindings } from "./bindings-CnWs55RG.js";
import { N as listTaskFlowRecords, d as listTasksForFlowId } from "./task-registry-Dcu8g5TY.js";
import "./runtime-internal-oc_AWWTn.js";
...
import { a as readChannelAllowFromStore } from "./pairing-store-BTDKxast.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-Dt-WdgFq.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-CIGs3ldx.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-CzJ_oiKn.js";
import { t as note$1 } from "./note-Bp_TyB4j.js";
import { n as logConfigUpdated } from "./logging-BXCVRuW0.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-C9Ql8L2w.js";
import { c as repairShortTermPromotionArtifacts, i as getBuiltinMemoryEmbeddingProviderDoctorMetadata, n as auditDreamingArtifacts, o as listBuiltinAutoSelectMemoryEmbeddingProviderDoctorMetadata, r as auditShortTermPromotionArtifacts, s as repairDreamingArtifacts } from "./memory-core-engine-runtime-B47PYOEY.js";
import "./engine-embeddings-BfqWk1fy.js";
import { t as hasConfiguredMemorySecretInput } from "./secret-input-CyewOACv.js";
import { t as checkQmdBinaryAvailability } from "./engine-qmd-D5gqt0fA.js";
import { t as resolveMemoryBackendConfig } from "./backend-config-DkAv28sk.js";
import "./engine-storage-D4hA1XRj.js";
import "./secret-0NY6mCR7.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-Pi5m9xnO.js";
import { i as buildPluginDiagnosticsReport, r as buildPluginCompatibilityWarnings } from "./status-DcaEkiOH.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-Bh5T7j5N.js";
import { n as resolveExecPolicyScopeSnapshot } from "./exec-approvals-effective-xVqty50k.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-DBgVwg6a.js";
import { a as guardCancel, l as printWizardHeader, n as applyWizardMetadata } from "./onboard-helpers-DnqWC8bO.js";
import { a as collectChannelDoctorStaleConfigMutations, i as collectChannelDoctorRepairMutations, n as collectChannelDoctorMutableAllowlistWarnings, o as runChannelDoctorConfigSequences, t as collectChannelDoctorEmptyAllowlistExtraWarnings } from "./channel-doctor-D1E5eL0X.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-C560vhVG.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-fwvA4WdM.js";
import { n as formatHealthCheckFailure } from "./health-format-Dsj_tywR.js";
import { n as healthCommand } from "./health-CQWi5t2a.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-DOM5eiKZ.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-DTNmCOvr.js";
import { n as maybeRepairOpenPolicyAllowFrom, r as resolveAllowFromMode } from "./open-policy-allowfrom-BenWrdYe.js";
import { n as hasAllowFromEntries, t as scanEmptyAllowlistPolicyWarnings } from "./empty-allowlist-scan-CVAAyzSV.js";
import { t as asObjectRecord } from "./object-vs_B7CS9.js";
import { n as maybeRepairBundledPluginLoadPaths } from "./bundled-plugin-load-paths-B0_pQ4n7.js";
import { r as maybeRepairExecSafeBinProfiles } from "./exec-safe-bins-dxZ4vbql.js";
import { n as maybeRepairLegacyToolsBySenderKeys } from "./legacy-tools-by-sender-CbTes3O_.js";
import { r as maybeRepairStalePluginConfig } from "./stale-plugin-config-DuEtRQKz.js";
...
import { n as doctorShellCompletion } from "./doctor-completion-Cne52U_K.js";
import { t as coerceFiniteScheduleNumber } from "./schedule-w7rb2cue.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-C0Yz10Az.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-CgBNXjXY.js";
import { a as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./state-migrations-Ct0v-_Mv.js";
import "./doctor-state-migrations-D9X2280E.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-Cl_nkidX.js";
...
async function collectDoctorPreviewWarnings(params) {
	...
	const channelPluginRuntime = hasChannelConfig && hasExplicitChannelPluginBlockerConfig(params.cfg) ? await import("./channel-plugin-blockers-DkuUGxw_.js") : void 0;
	const channelPluginBlockerHits = channelPluginRuntime?.scanConfiguredChannelPluginBlockers(params.cfg, process.env) ?? [];
	...
	if (hasChannelConfig) {
		const { collectChannelDoctorPreviewWarnings } = await import("./channel-doctor-CrJk8uUi.js");
		...
		const { collectOpenPolicyAllowFromWarnings, maybeRepairOpenPolicyAllowFrom } = await import("./open-policy-allowfrom-DYCQQ06Q.js");
	...
	if (hasPluginConfig) {
		const { collectStalePluginConfigWarnings, isStalePluginAutoRepairBlocked, scanStalePluginConfig } = await import("./stale-plugin-config-BnfJO2V1.js");
	...
	if (hasPluginLoadPaths(params.cfg)) {
		const { collectBundledPluginLoadPathWarnings, scanBundledPluginLoadPathMigrations } = await import("./bundled-plugin-load-paths-oQbx_uHA.js");
	...
	if (hasChannelConfig) {
		const { collectChannelDoctorEmptyAllowlistExtraWarnings } = await import("./channel-doctor-CrJk8uUi.js");
		const { scanEmptyAllowlistPolicyWarnings } = await import("./empty-allowlist-scan-XqeEPvzA.js");
		...
		if (emptyAllowlistWarnings.length > 0) {
			const { sanitizeForLog } = await import("./ansi-CqWGfkxl.js");
			warnings.push(emptyAllowlistWarnings.map((line) => sanitizeForLog(line)).join("\n"));
		}
	}
	if (hasToolsBySenderKey(params.cfg)) {
		const { collectLegacyToolsBySenderWarnings, scanLegacyToolsBySenderKeys } = await import("./legacy-tools-by-sender-7aFRWUVf.js");
	...
	if (hasConfiguredSafeBins(params.cfg)) {
		const { collectExecSafeBinCoverageWarnings, collectExecSafeBinTrustedDirHintWarnings, scanExecSafeBinCoverage, scanExecSafeBinTrustedDirHints } = await import("./exec-safe-bins-IkeGB9ur.js");
...
async function noteMacLaunchAgentOverrides() {
	...
	const markerPath = [path.join(home, ".enclawed", "disable-launchagent")].find((candidate) => fs.existsSync(candidate));
...
async function noteMacLaunchctlGatewayEnvOverrides(cfg, deps) {
	...
	const tokenEntries = [["ENCLAWED_GATEWAY_TOKEN", await getenv("ENCLAWED_GATEWAY_TOKEN")]];
	const passwordEntries = [["ENCLAWED_GATEWAY_PASSWORD", await getenv("ENCLAWED_GATEWAY_PASSWORD")]];
	...
	const lines = [
		...
		envPassword ? `- \`${envPasswordKey ?? "ENCLAWED_GATEWAY_PASSWORD"}\` is set; it overrides config passwords.` : void 0,
...
function noteStartupOptimizationHints(env = process.env, deps) {
	...
	if (noRespawn !== "1") lines.push("- ENCLAWED_NO_RESPAWN is not set to 1; set it to avoid extra startup overhead from self-respawn.");
...
function resolveDoctorRepairMode(options) {
	...
	const updateInProgress = isTruthyEnvValue$1(process.env.ENCLAWED_UPDATE_IN_PROGRESS);
	return {
		shouldRepair,
		shouldForce,
		nonInteractive,
...
async function detectEnclawedGitCheckout(root) {
...
async function maybeOfferUpdateBeforeDoctor(params) {
	if (!(!isTruthyEnvValue$1(process.env.ENCLAWED_UPDATE_IN_PROGRESS) && params.options.nonInteractive !== true && params.options.yes !== true && params.options.repair !== true && process.stdin.isTTY) || !params.root) return { updated: false };
	...
	if (git === "not-git") note$1(["This install is not a git checkout.", `Run \`${formatCliCommand("enclawed update")}\` to update via your package manager (npm/pnpm), then rerun doctor.`].join("\n"), "Update");
	return { updated: false };
}
//#endregion
//#region src/commands/doctor-auth-legacy-oauth.ts
async function loadProviderRuntime() {
	return import("./providers.runtime-DEtoladW.js");
}
async function loadNoteRuntime() {
	return import("./note-CqkJWKif.js");
}
...
async function maybeRepairBundledPluginRuntimeDeps(params) {
	const packageRoot = params.packageRoot ?? resolveEnclawedPackageRootSync({
		argv1: process.argv[1],
		cwd: process.cwd(),
		moduleUrl: import.meta.url
	});
...
function formatWorkspaceHealthLine(workspaceDir, health) {
	...
	if (health === "missing") return `- Workspace: ${display} (missing; Enclawed will create it on first run).`;
...
function noteClaudeCliHealth(cfg, deps) {
	...
	if (credential) lines.push(`- Headless Claude auth: OK (${formatCredentialLabel(credential)}).`);
		...
		fixHints.push(`- Fix: run ${formatCliCommand("claude auth login")}, then ${formatCliCommand("enclawed models auth login --provider anthropic --method cli --set-default")}.`);
	}
	if (!storedProfile) {
		lines.push(`- enclawed auth profile: missing (${CLAUDE_CLI_PROFILE_ID}) in ${authStorePath}.`);
		fixHints.push(`- Fix: run ${formatCliCommand("enclawed models auth login --provider anthropic --method cli --set-default")}.`);
	} else if (storedProfile.provider !== CLAUDE_CLI_PROVIDER) {
		lines.push(`- enclawed auth profile: ${CLAUDE_CLI_PROFILE_ID} is wired to provider "${storedProfile.provider}" instead of "${CLAUDE_CLI_PROVIDER}".`);
		fixHints.push(`- Fix: rerun ${formatCliCommand("enclawed models auth login --provider anthropic --method cli --set-default")} to rewrite the profile cleanly.`);
	} else lines.push(`- enclawed auth profile: ${CLAUDE_CLI_PROFILE_ID} (provider ${CLAUDE_CLI_PROVIDER}).`);
...
async function maybeRepairGatewayDaemon(params) {
	...
	if (process.platform === "darwin") {
		...
		note$1(`LaunchAgent loaded; stopping requires "${formatCliCommand("enclawed gateway stop")}" or launchctl bootout gui/$UID/${label}.`, "Gateway");
	}
	if (serviceRuntime?.status === "running") {
		if (await params.prompter.confirmRuntimeRepair({
...
async function maybeRepairGatewayServiceConfig(cfg, mode, runtime, prompter) {
	...
	if (tokenRefConfigured && serviceToken) audit.issues.push({
		...
		message: "Gateway service ENCLAWED_GATEWAY_TOKEN should be unset when gateway.auth.token is SecretRef-managed",
...
async function maybeScanExtraGatewayServices(options, runtime, prompter) {
	...
	if (legacyServices.length > 0) {
		if (await prompter.confirmRuntimeRepair({
			...
			if (removed.length > 0) runtime.log("Legacy gateway services removed. Installing Enclawed gateway next.");
		}
	}
...
function buildMemoryRecallIssueNote(audit) {
	...
	const guidance = audit.issues.some((issue) => issue.fixable) ? `Fix: ${formatCliCommand("enclawed doctor --fix")} or ${formatCliCommand("enclawed memory status --fix")}` : `Verify: ${formatCliCommand("enclawed memory status --deep")}`;
	return [
...
function buildDreamingArtifactIssueNote(audit) {
	...
	return [
		...
		hasFixableIssue ? `Fix: ${formatCliCommand("enclawed doctor --fix")} or ${formatCliCommand("enclawed memory status --fix")}` : `Verify: ${formatCliCommand("enclawed memory status --deep")}`
	].join("\n");
}
	...
	if (resolved.provider !== "auto") {
		if (resolved.provider === "local") {
			...
			note$1([
				...
				suggestedRemoteProvider ? `- Switch to a remote provider: ${formatCliCommand(`enclawed config set agents.defaults.memorySearch.provider ${suggestedRemoteProvider}`)}` : `- Switch to a remote embedding provider in config`,
				"",
				`Verify: ${formatCliCommand("enclawed memory status --deep")}`
			].join("\n"), "Memory search");
			return;
...
async function maybeRepairSandboxImages(cfg, runtime, prompter) {
	...
	await handleMissingSandboxImage({
		kind: "base",
		image: dockerImage,
		buildScript: dockerImage === "enclawed-sandbox-common:bookworm-slim" ? "scripts/sandbox-common-setup.sh" : dockerImage === "enclawed-sandbox:bookworm-slim" ? "scripts/sandbox-setup.sh" : void 0,
		updateConfig: (image) => {
...
async function noteSecurityWarnings(cfg) {
	...
	if (cfg.approvals?.exec?.enabled === false) warnings.push("- Note: approvals.exec.enabled=false disables approval forwarding only.", "  Host exec gating still comes from ~/.enclawed/exec-approvals.json.", `  Check local policy with: ${formatCliCommand("enclawed approvals get --gateway")}`);
	...
	if (isExposed) if (!hasSharedSecret) {
		const authFixLines = resolvedAuth.mode === "password" ? [`  Fix: ${formatCliCommand("enclawed configure")} to set a password`, `  Or switch to token: ${formatCliCommand("enclawed config set gateway.auth.mode token")}`] : [`  Fix: ${formatCliCommand("enclawed doctor --fix")} to generate a token`, `  Or set token directly: ${formatCliCommand("enclawed config set gateway.auth.mode token")}`];
		warnings.push(`- CRITICAL: Gateway bound to ${bindDescriptor} without authentication.`, `  Anyone on your network (or internet if port-forwarded) can fully control your agent.`, `  Fix: ${formatCliCommand("enclawed config set gateway.bind loopback")}`, ...saferRemoteAccessLines, ...authFixLines);
	...
	const warnDmPolicy = async (params) => {
		...
		if (dmScope === "main" && isMultiUserDm) warnings.push(`- ${params.label} DMs: multiple senders share the main session; run: ` + formatCliCommand("enclawed config set session.dmScope \"per-channel-peer\"") + " (or \"per-account-channel-peer\" for multi-account channels) to isolate sessions.");
	};
...
function shouldRequireOAuthDir(cfg, env) {
	if (env.ENCLAWED_OAUTH_DIR?.trim()) return true;
...
function noteWorkspaceBackupTip(workspaceDir) {
	...
	note$1([
		...
		`- Keep ${shortenHomePath(workspaceDir)} out of git; it contains credentials and session history.`,
...
async function runGatewayConfigHealth(ctx) {
	if (!ctx.cfg.gateway?.mode) {
		...
		if (!fs.existsSync(ctx.configPath)) lines.push(`Missing config: run ${formatCliCommand("enclawed setup")} first.`);
		note$1(lines.join("\n"), "Gateway");
	}
...
async function runWriteConfigHealth(ctx) {
	...
	if (!ctx.prompter.shouldRepair) ctx.runtime.log(`Run "${formatCliCommand("enclawed doctor --fix")}" to apply changes.`);
}
