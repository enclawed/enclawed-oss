...
import { n as normalizeMessageChannel, t as isDeliverableMessageChannel } from "./message-channel-core-DiqXDzpD.js";
...
import { n as parseExplicitTargetForLoadedChannel, r as resolveComparableTargetForLoadedChannel, t as comparableChannelTargetsShareRoute } from "./target-parsing-loaded-BFsSMpSV.js";
//#region src/infra/outbound/targets-resolve-shared.ts
function buildWebChatDeliveryError() {
	return /* @__PURE__ */ new Error(`Delivering to WebChat is not supported via \`${formatCliCommand("enclawed agent")}\`; use WhatsApp/Telegram or run with --deliver=false.`);
}
