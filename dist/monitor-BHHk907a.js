...
import { n as normalizeAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-6Mvnxe99.js";
import { a as buildGroupHistoryKey, c as normalizeAgentId$1, d as resolveThreadSessionKeys, n as DEFAULT_MAIN_KEY, r as buildAgentMainSessionKey } from "./session-key-D8SZau-8.js";
import { o as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-CZqO77WE.js";
...
import { a as resolveIdentityNamePrefix$1 } from "./identity-IAiNDSmy.js";
import { a as updateLastRoute, o as updateSessionStore } from "./store-eo7yB1I1.js";
...
import { g as sendMediaWithLeadingCaption, m as resolveSendableOutboundReplyParts, u as isReasoningReplyPayload } from "./reply-payload-ULobvdLo.js";
...
import { c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, s as resolveChunkMode } from "./chunk-_i16mZcD.js";
import { f as fireAndForgetBoundedHook, i as toInternalMessageReceivedContext, l as toPluginMessageContext, n as deriveInboundMessageHookContext, u as toPluginMessageReceivedEvent } from "./message-hook-mappers-Cxw_O6Ld.js";
import { n as resolveBatchedReplyThreadingPolicy } from "./reply-threading-DgnXLXTC.js";
import { a as resolveInboundLastRouteSessionKey, i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-BDbWw8vc.js";
import { i as enqueueSystemEvent } from "./system-events-BDxISYT2.js";
import { r as formatDurationPrecise } from "./format-duration-BKnM5WuD.js";
import { i as shouldComputeCommandAuthorized, t as hasControlCommand } from "./command-detection-D2374ct_.js";
import { r as formatInboundEnvelope } from "./envelope-DTSFWzJ1.js";
...
import { a as normalizeMentionText, n as buildMentionRegexes } from "./mentions-Bgg__hqZ.js";
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher-CMHCJV5M.js";
import { a as shouldAckReactionForWhatsApp, r as removeAckReactionHandleAfterReply, t as createAckReactionHandle } from "./ack-reactions-C9zISXOO.js";
...
import { d as recordPendingHistoryEntryIfEnabled, i as buildHistoryContextFromEntries } from "./history-biycvTyX.js";
import { s as hasVisibleChannelTurnDispatch } from "./kernel-D_Cmk4cs.js";
import { n as filterSupplementalContextItems, t as evaluateSupplementalContextVisibility } from "./context-visibility-qBMmaAxw.js";
import { t as resolveMarkdownTableMode } from "./markdown-tables-CxdhDl6o.js";
import { n as recordChannelActivity } from "./channel-activity-BGbOMrtA.js";
import { t as convertMarkdownTables } from "./tables-CRx1wXum.js";
...
import { n as parseActivationCommand, t as normalizeGroupActivation } from "./group-activation-BSdDNYPx.js";
import "./reply-runtime-wZGG7VqN.js";
import "./reply-reference-DAR27atf.js";
...
import "./account-core-bas333oy.js";
import "./command-detection-BrQCGMGn.js";
import { t as logAckFailure } from "./logging-Dy0jyfcu.js";
...
import { t as resolveInboundSessionEnvelopeContext } from "./session-envelope-BDM5diHE.js";
import "./channel-mention-gating-BwsjfCmo.js";
import "./session-store-runtime-cT4Gqcbg.js";
import { t as createClaimableDedupe } from "./persistent-dedupe-tm33CCqc.js";
import { a as resolveWhatsAppAccount, s as resolveWhatsAppMediaMaxBytes } from "./accounts-GA33UQfL.js";
import { t as isWhatsAppGroupJid } from "./normalize-target-jU_LT9ku.js";
import { t as resolveWhatsAppReactionLevel } from "./reaction-level-CO0LvCwg.js";
import { n as getStatusCode, t as formatError } from "./session-errors-B-5gDpya.js";
import { a as resolveJidToE164, i as markdownToWhatsApp, n as isSelfChatMode, o as toWhatsappJid, r as jidToE164 } from "./text-runtime-D3dEeWWF.js";
import { i as prepareWhatsAppOutboundMedia, o as sendWhatsAppOutboundWithRetry, r as normalizeWhatsAppPayloadTextPreservingIndentation, t as normalizeWhatsAppOutboundPayload } from "./outbound-media-contract-Bl_kg5Mg.js";
import { r as sendReactionWhatsApp } from "./send-ccu0AMt0.js";
import { n as cacheInboundMessageMeta, r as lookupInboundMessageMeta, t as buildQuotedMessageOptions } from "./quoted-message-BpfYWbh7.js";
import { _ as readWebSelfIdentityForDecision, a as getWebAuthAgeMs, h as readWebSelfId, r as WhatsAppAuthUnstableError, s as logoutWeb } from "./auth-store-kaif7PfY.js";
import { a as getSelfIdentity, c as resolveComparableIdentity, i as getReplyContext, n as getMentionIdentities, o as getSenderIdentity, r as getPrimaryIdentityId, s as identitiesOverlap, t as getComparableIdentityValues } from "./identity-CfbBxRHF.js";
import { i as resolveWhatsAppInboundPolicy, n as checkInboundAccessControl, r as resolveWhatsAppCommandAuthorized } from "./access-control-CXHg76Ia.js";
import { c as waitForWaConnection, d as newConnectionId, f as resolveHeartbeatSeconds, l as resolveWhatsAppSocketTiming, n as WhatsAppConnectionController, o as createWaSocket, p as resolveReconnectPolicy, u as DEFAULT_RECONNECT_POLICY } from "./connection-controller-C7VjfLZL.js";
...
async function processMessage(params) {
	...
	if (params.preflightAudioTranscript === void 0 && hasAudioBody && params.msg.mediaPath) try {
		const { transcribeFirstAudio } = await import("./audio-preflight.runtime-ChLRyz0g.js");
...
function loadReplyResolverRuntime() {
	replyResolverRuntimePromise ??= import("./reply-resolver.runtime-Bm3SJsE3.js");
...
async function clearTerminalWebAuthState(params) {
	try {
		...
		params.runtime.error(`WhatsApp Web cleanup failed after terminal close (status ${params.statusLabel}). Run \`${formatCliCommand("enclawed channels logout --channel whatsapp")}\`, then relink with \`${formatCliCommand("enclawed channels login --channel whatsapp")}\`.`);
	}
}
		...
		while (true) {
			...
			if (decision.action === "stop") {
				...
				if (decision.healthState === "logged-out") {
					...
					runtime.error(`WhatsApp session logged out. Run \`${formatCliCommand("enclawed channels login --channel whatsapp")}\` to relink.`);
					...
					runtime.error(`WhatsApp Web connection closed (status ${decision.normalized.statusLabel}: session conflict). Resolve conflicting WhatsApp Web sessions, then relink with \`${formatCliCommand("enclawed channels login --channel whatsapp")}\`. Stopping web monitoring.`);
				} else {
					reconnectLogger.warn({
						connectionId: connection.connectionId,
						status: decision.normalized.statusLabel,
...
//#endregion
export { extractMediaPlaceholder as a, whatsappHeartbeatLog as c, extractLocationData as i, monitorWebInbox as n, extractText as o, extractContactContext as r, resetWebInboundDedupe as s, monitorWebChannel as t };
