...
import { n as resolveProviderIdForAuth } from "./provider-auth-aliases-C4ux7awf.js";
import "./agent-scope-5o1jve-2.js";
import "./registry-nxcy40tP.js";
import { s as joinPresentTextSegments, t as getGlobalHookRunner } from "./hook-runner-global-mFbFyRwr.js";
import { r as PluginApprovalResolutions } from "./types-DxUerZ_e.js";
import { r as getActivePluginRegistry } from "./runtime-CO-f4q2v.js";
import { F as resolveProviderSystemPromptContribution } from "./provider-runtime-DB4wLsLH.js";
import "./agent-paths-Pa0y6OT5.js";
import "./session-write-lock-CtXlB9QZ.js";
import { f as normalizeEmbeddedAgentRuntime } from "./attempt.tool-run-context-SXAp9gZ1.js";
import { r as isSilentReplyPayloadText } from "./tokens-pnu38gX0.js";
import { l as normalizeToolName } from "./tool-policy-D994AhXf.js";
import "./model-auth-CEwjo3Cm.js";
import { o as logProviderToolSchemaDiagnostics, s as normalizeProviderToolSchemas } from "./attempt.thread-helpers-B8zkwd__.js";
...
import { d as runContextEngineMaintenance, n as buildAfterTurnRuntimeContextFromUsage, t as buildAfterTurnRuntimeContext } from "./attempt.prompt-helpers-CpBc4FVv.js";
import { t as callGatewayTool } from "./gateway-B2xBY4c_.js";
import { o as runBeforeToolCallHook, r as consumeAdjustedParamsForToolCall } from "./pi-tools.before-tool-call-C52866db.js";
import "./nodes-utils-DAwOANiS.js";
import "./runs-DYuSrnq1.js";
import "./sandbox-f-aJNLxY.js";
import { h as isGpt5ModelId } from "./provider-model-shared-CbMZtQ7U.js";
import { r as resolveTranscriptPolicy } from "./compaction-runtime-context-BQb8cE6I.js";
import { i as resolvePreparedExtraParams } from "./extra-params-Cw1yZTVu.js";
...
function buildAgentRuntimeDeliveryPlan(_params) {
	return {
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolveHandlers = async () => {
		...
		resolvedHandlersPromise ??= import("./agent-tool-result-middleware-loader-C7Pv8JBc.js").then(({ loadAgentToolResultMiddlewaresForRuntime }) => loadAgentToolResultMiddlewaresForRuntime({ runtime: ctx.runtime }));
