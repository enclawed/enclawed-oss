...
import { a as isSubagentSessionKey, o as parseAgentSessionKey } from "./session-key-utils-qXY7QK1H.js";
import { c as normalizeAgentId, p as scopedHeartbeatWakeOptions, u as resolveAgentIdFromSessionKey } from "./session-key-D8SZau-8.js";
import { i as normalizeChannelId, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-BZZmrGdc.js";
import { S as resolveDefaultAgentId, v as resolveAgentConfig } from "./agent-scope-5o1jve-2.js";
...
import { i as normalizeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-B7S7hCmE.js";
import { t as loadSessionStore } from "./store-load-C5fhLNaT.js";
import { r as resolveSessionTranscriptFile } from "./transcript-CdDH2u9f.js";
import { n as resolveConversationDeliveryTarget, t as formatConversationTarget } from "./delivery-context-BeA2CFhs.js";
import { a as normalizeAssistantPhase } from "./chat-message-content-CcFUU_mI.js";
...
import { l as resolveInternalSessionKey, u as resolveMainSessionAlias } from "./sessions-helpers-NoUCec1k.js";
import { n as requestHeartbeatNow, t as areHeartbeatsEnabled } from "./heartbeat-wake-C3o6lVAm.js";
import { i as enqueueSystemEvent } from "./system-events-BDxISYT2.js";
import { a as createRunningTaskRun, c as recordTaskRunProgressByRunId } from "./task-executor-DF7aWa4R.js";
import { i as normalizeConversationTargetRef } from "./conversation-id-RlIGw1i7.js";
import { i as isSessionBindingError, r as getSessionBindingService } from "./session-binding-service-Dy45eAgg.js";
import { t as resolveConversationIdFromTargets } from "./conversation-id-CClA8-ZP.js";
import { i as resolveSpawnedWorkspaceInheritance } from "./spawned-context-BqCA2bpH.js";
import { n as getAcpSessionManager } from "./manager-PnokQ4wk.js";
import { n as readAcpSessionEntry } from "./session-meta-BxTrsTOF.js";
import { i as resolveThreadBindingThreadName, r as resolveThreadBindingIntroText } from "./thread-bindings-messages-D3tKsGWi.js";
import { d as resolveThreadBindingSpawnPolicy, l as resolveThreadBindingMaxAgeMsForChannel, n as formatThreadBindingSpawnDisabledError, o as resolveThreadBindingIdleTimeoutMsForChannel, t as formatThreadBindingDisabledError } from "./thread-bindings-policy-s3DnUDZm.js";
import { i as resolveAcpAgentPolicyError, r as isAcpEnabledByPolicy } from "./policy-BJcD2nvG.js";
import { a as resolveAcpThreadSessionDetailLines, n as resolveAcpSessionCwd } from "./session-identifiers-qSSSoR0s.js";
...
function prepareAcpThreadBinding(params) {
	...
	const placementToUse = getLoadedChannelPlugin(policy.channel)?.conversationBindings?.defaultTopLevelPlacement ?? resolveBundledChannelThreadBindingDefaultPlacement(policy.channel) ?? getChannelPlugin(policy.channel)?.conversationBindings?.defaultTopLevelPlacement ?? resolvePlacementWithoutChannelPlugin({
		channel: policy.channel,
		capabilities
	});
