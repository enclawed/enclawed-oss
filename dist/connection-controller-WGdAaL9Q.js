import { d as toPinoLikeLogger, i as getChildLogger } from "./logger-wuQoU2z2.js";
import { g as resolveUserPath, n as clamp, s as ensureDir } from "./utils-CrVQlOZJ.js";
...
import { c as shouldUseEnvHttpProxyForUrl, s as resolveEnvHttpProxyUrl } from "./proxy-env-C6YBem4U.js";
import "./text-runtime-BRbvmj_h.js";
import "./runtime-env-CUR54nHA.js";
import { n as renderQrTerminal } from "./media-runtime-CgNDNwow.js";
import "./cli-runtime-Bfl0MLcu.js";
import "./fetch-runtime-ylGtuF3a.js";
import { n as resolveWebCredsBackupPath, r as resolveWebCredsPath } from "./creds-files-C_h9MiPu.js";
import { n as registerWhatsAppConnectionController, r as unregisterWhatsAppConnectionController } from "./connection-controller-registry-Bu8zXQ1P.js";
import { n as getStatusCode, t as formatError } from "./session-errors-DC9n8zWL.js";
import { C as waitForCredsSaveQueueWithTimeout, l as readCredsJsonRaw, s as logoutWeb, v as resolveDefaultWebAuthDir, w as writeCredsJsonAtomically, x as enqueueCredsSave, y as restoreCredsFromBackupIfNeeded } from "./auth-store-BUBPgsD7.js";
import { a as makeWASocket, i as makeCacheableSignalKeyStore, n as DisconnectReason$1, o as useMultiFileAuthState, r as fetchLatestBaileysVersion } from "./session.runtime-BejQ8AqU.js";
...
async function createWaSocket(printQr, verbose, opts = {}) {
	...
	sock.ev.on("connection.update", async (update) => {
		try {
			...
			if (connection === "close") {
				if (getStatusCode(lastDisconnect?.error) === LOGGED_OUT_STATUS$1) console.error(danger(`WhatsApp session logged out. Run: ${formatCliCommand("enclawed channels login")}`));
			}
...
const WHATSAPP_LOGGED_OUT_RELINK_MESSAGE = "WhatsApp reported the session is logged out. Cleared cached web session; please rerun enclawed channels login and scan the QR again.";
