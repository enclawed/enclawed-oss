...
import { i as createActionGate } from "./common-BMEsSwt3.js";
import { c as normalizeMessagePresentation, u as renderMessagePresentationFallbackText } from "./payload-CN10T53l.js";
import { a as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-bOV5DWOp.js";
...
import { T as projectConfigAccountIdWarningCollector, h as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-C02m4wT2.js";
...
import { i as createChatChannelPlugin, l as stripChannelTargetPrefix, t as buildChannelOutboundSessionRoute } from "./core-CHriktlm.js";
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-DSNPYAi8.js";
...
import { d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-Z5fKx70K.js";
import "./channel-status-lBa-A1_e.js";
import { t as zod_exports } from "./zod-D31fSMXP.js";
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-BwrY2rRU.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-DM3rQm9y.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, n as inspectFeishuCredentials, p as isRecord, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-CSS0irPO.js";
import "./card-interaction-DpJHpZ9X.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-Btg6i84q.js";
import { t as messageActionTargetAliases } from "./security-audit-Bk6ZZnRZ.js";
import { a as resolveFeishuGroupToolPolicy } from "./policy-BSRzVIir.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-DsM7aETY.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-iDVic4BK.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-BjClmOqw.js";
...
async function runScanToCreate(prompter) {
	const { beginAppRegistration, initAppRegistration, pollAppRegistration, printQrCode } = await import("./app-registration-CufXqQbQ.js");
	try {
...
async function runNewAppFlow(params) {
	...
	if (scanResult) {
		...
		if (appId && appSecretProbeValue) {
			const { getAppOwnerOpenId } = await import("./app-registration-CufXqQbQ.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, configured }) => {
			...
			if (configured && resolvedCredentials) try {
				const { probeFeishu } = await import("./probe-CDvWU6tB.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-DjE3mmhk.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-03v2uqtx.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-NkOUAk06.js");
