...
import { a as loadConfig, u as readConfigFileSnapshotForWrite } from "./io-BPigC1a6.js";
import { c as normalizeAgentId, u as resolveAgentIdFromSessionKey } from "./session-key-BOC5unB4.js";
...
import { _ as listAgentIds, b as resolveAgentDir, l as resolveAgentSkillsFilter, p as resolveSessionAgentId, u as resolveEffectiveModelFallbacks, x as resolveAgentWorkspaceDir } from "./agent-scope-Bv7XD6OT.js";
import { f as resolveMessageChannel } from "./message-channel-CP7lSRvA.js";
import { n as ensureAuthProfileStore } from "./store-D3mjjSwW.js";
import { f as modelKey, m as parseModelRef, p as normalizeModelRef } from "./model-selection-cli-CfVfEtdt.js";
import { c as normalizeThinkLevel, d as normalizeVerboseLevel, n as formatXHighModelHint } from "./thinking.shared-DCWjwvfv.js";
import { d as resolveConfiguredModelRef, f as resolveDefaultModelForAgent, t as buildAllowedModelSet, x as resolveThinkingDefault } from "./model-selection-CSCqfmCj.js";
import { r as loadModelCatalog } from "./model-catalog-C85zwax4.js";
import { o as normalizeAccountId } from "./delivery-context.shared-CIWKeEct.js";
import { i as supportsXHighThinking, t as formatThinkingLevels } from "./thinking-DyqDTQLE.js";
import { i as emitAgentEvent, t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-BfuQdc-z.js";
import { i as LiveSessionModelSwitchError, r as runWithModelFallback } from "./model-fallback-D9hl20Un.js";
import { t as getAgentRuntimeCommandSecretTargetIds } from "./command-secret-targets-BhK2K9pt.js";
...
import { n as AGENT_LANE_SUBAGENT } from "./lanes-e7slEYtV.js";
import { t as resolveAgentTimeoutMs } from "./timeout-D3KpBffA.js";
import { n as normalizeSpawnedRunMetadata } from "./spawned-context-DP71yFXM.js";
import { r as resolveSession } from "./live-model-switch-3exhqQ93.js";
import { n as resolveSendPolicy } from "./send-policy-Bq9hFiZi.js";
import { t as clearSessionAuthProfileOverride } from "./session-override-BU5ENP86.js";
import { n as applyVerboseOverride } from "./level-overrides-l_PAoFxN.js";
import { n as prependInternalEventContext, t as persistSessionEntry$1 } from "./attempt-execution.shared-xYDY2wyC.js";
...
async function resolveAgentRuntimeConfig(runtime, params) {
	...
	}) ? (await (await import("./command-config-resolution.runtime-CxpHMN4d.js")).resolveCommandConfigWithSecrets({
		config: loadedRaw,
		commandName: "agent",
...
function loadAttemptExecutionRuntime() {
	attemptExecutionRuntimePromise ??= import("./attempt-execution.runtime-89ORN2Lx.js");
	return attemptExecutionRuntimePromise;
}
function loadAcpManagerRuntime() {
	acpManagerRuntimePromise ??= import("./manager-Bnq8g8m5.js");
	return acpManagerRuntimePromise;
}
function loadAcpPolicyRuntime() {
	acpPolicyRuntimePromise ??= import("./policy-B2BRRt98.js");
	return acpPolicyRuntimePromise;
}
function loadAcpRuntimeErrorsRuntime() {
	acpRuntimeErrorsRuntimePromise ??= import("./errors-CAZ1ybhm.js");
	return acpRuntimeErrorsRuntimePromise;
}
function loadAcpSessionIdentifiersRuntime() {
	acpSessionIdentifiersRuntimePromise ??= import("./session-identifiers-61nGx2j8.js");
	return acpSessionIdentifiersRuntimePromise;
}
function loadDeliveryRuntime() {
	deliveryRuntimePromise ??= import("./delivery.runtime-kP4PXi31.js");
	return deliveryRuntimePromise;
}
function loadSessionStoreRuntime() {
	sessionStoreRuntimePromise ??= import("./session-store.runtime-B_hauzLY.js");
	return sessionStoreRuntimePromise;
}
function loadTranscriptResolveRuntime() {
	transcriptResolveRuntimePromise ??= import("./transcript-resolve.runtime-B9hPVfWY.js");
	return transcriptResolveRuntimePromise;
}
function loadCliDepsRuntime() {
	cliDepsRuntimePromise ??= import("./deps-DBuWTldA.js");
	return cliDepsRuntimePromise;
}
function loadExecDefaultsRuntime() {
	execDefaultsRuntimePromise ??= import("./exec-defaults-COk59f97.js");
	return execDefaultsRuntimePromise;
}
function loadSkillsRuntime() {
	skillsRuntimePromise ??= import("./skills-CJMUe_pt.js");
	return skillsRuntimePromise;
}
function loadSkillsFilterRuntime() {
	skillsFilterRuntimePromise ??= import("./filter-D364qDVX.js");
	return skillsFilterRuntimePromise;
}
function loadSkillsRefreshStateRuntime() {
	skillsRefreshStateRuntimePromise ??= import("./refresh-state-DhTfHYKe.js");
	return skillsRefreshStateRuntimePromise;
}
function loadSkillsRemoteRuntime() {
	skillsRemoteRuntimePromise ??= import("./skills-remote-DBQL58FX.js");
