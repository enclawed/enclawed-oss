...
import { f as resolveRunModelFallbacksOverride, p as resolveSessionAgentId, t as hasConfiguredModelFallbacks } from "./agent-scope-Bv7XD6OT.js";
import "./config-BDd-c7HD.js";
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-CP7lSRvA.js";
import { _ as resolveMemoryFlushPlan } from "./memory-state-CFyyWZvk.js";
import { t as isCliProvider } from "./model-selection-cli-CfVfEtdt.js";
import { d as normalizeVerboseLevel, f as resolveResponseUsageMode } from "./thinking.shared-DCWjwvfv.js";
import "./model-selection-CSCqfmCj.js";
import { S as resolveGroupSessionKey, o as updateSessionStore, s as updateSessionStoreEntry } from "./store-BkF3pYvh.js";
import "./sessions-D71lwKID.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-Lozvxyih.js";
import { c as resolveSessionPluginTraceLines, o as resolveFreshSessionTotalTokens, s as resolveSessionPluginStatusLines } from "./types-B_nWSksI.js";
import { t as loadSessionStore } from "./store-load-NgoHF_53.js";
import { a as resolveContextTokensForModel } from "./context-BzAlA_nT.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-DEmHsOwP.js";
import { a as normalizeUsage, n as deriveSessionTotalTokens, r as hasNonzeroUsage, t as derivePromptTokens } from "./usage-BAoTEYmL.js";
import { i as readSessionMessages } from "./session-utils.fs-D4KXI-63.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-Bz_prI6u.js";
import { M as readPostCompactionContext, k as estimateMessagesTokens } from "./model-context-tokens-KTBxLgRf.js";
import { n as isDiagnosticsEnabled, t as emitDiagnosticEvent } from "./diagnostic-events-DPcyBAFM.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-DMUvsGAm.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripLeadingSilentToken } from "./tokens-DgKTURQ1.js";
import { s as stripHeartbeatToken } from "./heartbeat-CPFn2O50.js";
import { a as isAudioFileName } from "./mime-CwPaZfyo.js";
import { a as isLikelyExecutionAckPrompt, t as runEmbeddedPiAgent } from "./pi-embedded-runner-CAMRin2M.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-Dcs_bNw0.js";
...
import { t as BILLING_ERROR_USER_MESSAGE, u as sanitizeUserFacingText } from "./sanitize-user-facing-text-DC3SMoyx.js";
import { n as resolveSandboxConfigForAgent } from "./config-DwgI9V2b.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-B4BSehWa.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-DSKxz_I-.js";
import { g as isTransientHttpError, l as isCompactionFailureError, p as isLikelyContextOverflowError, u as isContextOverflowError } from "./errors-V9eb4Uwu.js";
import "./pi-embedded-helpers-4LE2bkL2.js";
import { c as resolveModelAuthMode } from "./model-auth-B85ng6CG.js";
import { n as setReplyPayloadMetadata, t as getReplyPayloadMetadata } from "./reply-payload-BoHBuWWM.js";
...
import { i as emitAgentEvent, u as registerAgentRunContext } from "./agent-events-BfuQdc-z.js";
import { i as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-D9hl20Un.js";
import { a as generateSecureUuid } from "./secure-random-CoURpmDF.js";
import { i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-BjQAnfTj.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-Dxw5vxwl.js";
import { n as filterMessagingToolMediaDuplicates, r as shouldSuppressMessagingToolReplies, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-BqcIhgVT.js";
import { i as enqueueSystemEvent } from "./system-events-C58tIl-I.js";
import { o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession } from "./queue-Dhv10X4K.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-DFobtYEg.js";
import { h as replyRunRegistry, m as createReplyOperation, p as ReplyRunAlreadyActiveError, s as queueEmbeddedPiMessage } from "./runs-cE9sGCqK.js";
import "./sandbox-C9-diPyu.js";
import "./pi-embedded-s4ol6YCX.js";
import { n as resolveCronStorePath, t as loadCronStore } from "./store-C9Ql8L2w.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-7iVsWZaN.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-DeJ7coXn.js";
import { r as resolveActiveRunQueueAction, t as createTypingSignaler } from "./typing-mode-GM9wdAgx.js";
import { t as runCliAgent } from "./cli-runner-kWyTRLCy.js";
import { n as getCliSessionBinding, o as setCliSessionBinding, s as setCliSessionId } from "./cli-session-fUzKqQw6.js";
import { t as formatProviderModelRef } from "./model-runtime-B4ju1j7V.js";
import { a as resolveModelFallbackOptions, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyExecutionConfig, r as formatBunFetchSocketError, s as resolveQueuedReplyRuntimeConfig, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-DjaaTO-U.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-CW0nO2Th.js";
import { t as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-CVXPhsFz.js";
...
async function compactEmbeddedPiSessionDefault(...args) {
	const { compactEmbeddedPiSession } = await import("./pi-embedded-K7wfiWqg.js");
	return await compactEmbeddedPiSession(...args);
}
async function runEmbeddedPiAgentDefault(...args) {
	const { runEmbeddedPiAgent } = await import("./pi-embedded-K7wfiWqg.js");
...
function loadReplyPayloadsDedupeRuntime() {
	replyPayloadsDedupeRuntimePromise ??= import("./reply-payloads-dedupe.runtime-BPO1CJuv.js");
