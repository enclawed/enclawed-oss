...
import { t as updateMatrixAccountConfig } from "./config-update-XkSPx1Re.js";
import { n as matrixSetupAdapter } from "./setup-core-7l6wBn-6.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-L_Fn8LAC.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-BQ6VmIAI.js";
import { t as withResolvedActionClient } from "./client-B8YwhF6A.js";
import { r as resolveMatrixAuthContext } from "./config-BMRiH1kf.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-CRAAIXzw.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-C4qAw2dw.js");
