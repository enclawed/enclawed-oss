...
import { s as resolveApiKeyForProvider$1 } from "./model-auth-m8tj01Sr.js";
import "./api-key-rotation-BSxyUmui.js";
	...
	return new Promise((resolve, reject) => {
		...
		const server = createServer((req, res) => {
			try {
				...
				res.end(`<!doctype html><html><head><meta charset='utf-8'/></head><body><h2>${escapedSuccessTitle}</h2><p>You can close this window and return to Enclawed.</p></body></html>`);
				finish(void 0, {
					code,
					state
				});
...
//#endregion
export { waitForLocalOAuthCallback as a, resolveApiKeyForProvider as i, getRuntimeAuthForModel as n, parseOAuthCallbackInput as r, generateOAuthState as t };
