...
import { c as isBlockedHostnameOrIp } from "./ssrf-DjpVlwtu.js";
...
import { C as resolveRealtimeVoiceAgentConsultTools, f as consultRealtimeVoiceAgent, m as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, t as convertPcmToMulaw8k, w as resolveRealtimeVoiceAgentConsultToolsAllow, x as parseRealtimeVoiceAgentConsultArgs } from "./realtime-voice-ChsEBQrQ.js";
import { t as resolveConfiguredCapabilityProvider } from "./provider-selection-runtime-DABfTCkg.js";
import { n as getActiveMemorySearchManager } from "./memory-host-search-BsvwTJY6.js";
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-BoGT1AcX.js";
import "./webhook-ingress-Bua0eRIA.js";
import { t as zod_exports } from "./zod-BG12Rihk.js";
import "./api-BlNTjdQb.js";
import { a as validateProviderConfig, i as resolveVoiceCallConfig, n as normalizeVoiceCallConfig, o as deepMergeDefined, r as resolveTwilioAuthToken } from "./config-DLT91K2r.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-CDg5RVEP.js";
import { t as resolveVoiceResponseModel } from "./response-model-BYYr0Dpk.js";
import { t as isProviderStatusTerminal } from "./call-status-BI74XbIx.js";
import { t as getHeader } from "./http-headers-DO8F0rrj.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-CPVuOyDe.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-Ddwsa0UG.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-BJKkw-bj.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-CIafQdG2.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-CtxFz42b.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-_ScNWTJn.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-BzkM78cZ.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-BiPr55Lk.js");
