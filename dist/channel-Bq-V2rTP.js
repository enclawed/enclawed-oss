...
import { r as createLazyRuntimeModule } from "./lazy-runtime-n1cctuu6.js";
import { d as readNumberParam, h as readStringParam } from "./common-BMEsSwt3.js";
...
import { t as adaptScopedAccountAccessor } from "./channel-config-helpers-bOV5DWOp.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-CCHy2XBt.js";
import { t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-W6w9c0NC.js";
import "./text-runtime-CAI4yT_W.js";
import { n as buildOutboundBaseSessionKey } from "./thread-id-D2afCFv1.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute } from "./core-CHriktlm.js";
import "./routing-Cs1E5kjm.js";
import { t as resolveApprovalApprovers } from "./approval-approvers-lm6t_PZT.js";
import { t as createResolvedApproverActionAuthAdapter } from "./approval-auth-helpers-B1r2wd9W.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-C9jGJ-IK.js";
...
import { n as createChannelNativeOriginTargetResolver, t as createChannelApproverDmTargetResolver } from "./approval-native-helpers-DS_rF55O.js";
import "./approval-native-runtime-Dxwwp1fR.js";
import { o as resolveConfiguredFromRequiredCredentialStatuses, r as projectCredentialSnapshotFields } from "./account-snapshot-fields-BY0sxg0K.js";
import "./reply-reference-CjqbGKOO.js";
import { o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter, s as createFlatAllowlistOverrideResolver } from "./allowlist-config-edit-CH69C8W1.js";
...
import "./param-readers-8Yxcrhsi.js";
import { d as createDefaultChannelRuntimeState, u as createComputedAccountStatusAdapter } from "./status-helpers-Z5fKx70K.js";
import { h as stringifyRouteThreadId, o as channelRouteTargetsMatchExact } from "./channel-route-DDGQjdxk.js";
import { a as resolveSlackAccount, i as resolveDefaultSlackAccountId, l as resolveSlackReplyToMode, n as listSlackAccountIds, o as resolveSlackAccountAllowFrom } from "./accounts-F61kB8jf.js";
import { i as resolveSlackChannelId, n as normalizeSlackMessagingTarget, r as parseSlackTarget, t as looksLikeSlackTargetId } from "./target-parsing-HkojbzEf.js";
import { a as normalizeSlackApproverId, c as shouldSuppressLocalSlackExecApprovalPrompt, i as isSlackExecApprovalClientEnabled, o as resolveSlackExecApprovalTarget, r as isSlackExecApprovalAuthorizedSender, s as shouldHandleSlackExecApprovalRequest, t as getSlackExecApprovalApprovers } from "./exec-approvals-Cj9PEKw8.js";
import { n as buildSlackPresentationBlocks, r as resolveSlackInteractiveBlockOffsets, t as buildSlackInteractiveBlocks } from "./blocks-render-BF7OlL-k.js";
import { t as SLACK_TEXT_LIMIT } from "./limits-BoDX0g2L.js";
import { n as extractSlackToolSend, t as describeSlackMessageTool } from "./message-tool-api-BZj36Xt8.js";
import { n as isSlackInteractiveRepliesEnabled, t as compileSlackInteractiveReplies } from "./interactive-replies-D4JWL4q-.js";
import "./channel-api-Ch6e2hNf.js";
import { r as createSlackWebClient } from "./client-CE6AdAQZ.js";
import { r as normalizeAllowListLower } from "./allow-list-CQUkcjJZ.js";
import { n as resolveSlackGroupToolPolicy, t as resolveSlackGroupRequireMention } from "./group-policy-BglINenu.js";
import { t as resolveSlackReplyBlocks } from "./reply-blocks-DRdiY4qj.js";
import { t as getOptionalSlackRuntime } from "./runtime-C4Afjosr.js";
import { i as slackSecurityAdapter, n as isSlackPluginAccountConfigured, r as slackConfigAdapter, t as createSlackPluginBase } from "./shared-B7h-Z63X.js";
import { i as SLACK_CHANNEL, n as createSlackSetupWizardProxy, r as slackSetupAdapter } from "./setup-core-B5wRadRj.js";
import { n as resolveSlackThreadTsValue, t as normalizeSlackThreadTsCandidate } from "./thread-ts-BLxLjZDd.js";
...
const slackApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-C9N2XL5g.js")).slackApprovalNativeRuntime
	})
});
...
async function loadSlackActionRuntime$1() {
	slackActionRuntimePromise$1 ??= import("./action-runtime.runtime-EuIK0e_M.js");
...
const loadSlackSetupSurfaceModule = createLazyRuntimeModule(() => import("./setup-surface-C1NRVKuS.js"));
const loadSlackScopesModule = createLazyRuntimeModule(() => import("./scopes-Bs8UcuPA.js"));
const loadSlackOutboundAdapterModule = createLazyRuntimeModule(() => import("./outbound-adapter-Dkge8JDY.js"));
...
const loadSlackDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-inrDWvpn.js"));
const loadSlackResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-eVSwAa-6.js"));
const loadSlackResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users--vlQc-rk.js"));
async function loadSlackActionRuntime() {
	slackActionRuntimePromise ??= import("./action-runtime.runtime-EuIK0e_M.js");
	return await slackActionRuntimePromise;
}
async function loadSlackSendRuntime() {
	slackSendRuntimePromise ??= import("./send.runtime-Z3jojWXE.js");
	return await slackSendRuntimePromise;
}
async function loadSlackProbeModule() {
	slackProbeModulePromise ??= import("./probe-rdlLjARU.js");
	return await slackProbeModulePromise;
}
async function loadSlackMonitorModule() {
	slackMonitorModulePromise ??= import("./monitor-DMaHcxoM.js");
	return await slackMonitorModulePromise;
}
async function loadSlackDirectoryLiveModule() {
	slackDirectoryLiveModulePromise ??= import("./directory-live-DZNDtySL.js");
