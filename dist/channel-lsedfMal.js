...
import { h as resolvePinnedHostnameWithPolicy } from "./ssrf-DQDx1s1G.js";
import { a as createHybridChannelConfigAdapter, u as createScopedDmSecurityResolver } from "./channel-config-helpers-bOV5DWOp.js";
...
import { C as projectAccountConfigWarningCollector, m as composeWarningCollectors, w as projectAccountWarningCollector, y as createConditionalWarningCollector } from "./channel-policy-DBrWfvvg.js";
...
import { t as attachChannelToResult } from "./channel-send-result-D4EOYlIo.js";
import { a as createFixedWindowRateLimiter } from "./webhook-memory-guards-CmETXjdv.js";
...
import { i as resolveAccount, n as synologyChatSetupWizard, r as listAccountIds, t as synologyChatSetupAdapter } from "./setup-surface-QEc-uztE.js";
import { t as collectSynologyChatSecurityAuditFindings } from "./security-audit-BtTWTR_Y.js";
import { z } from "zod";
...
function extractTokenFromHeaders(req) {
	const explicit = headerValue(req.headers["x-synology-token"]) ?? headerValue(req.headers["x-webhook-token"]) ?? headerValue(req.headers["x-enclawed-token"]);
