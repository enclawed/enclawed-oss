...
import { r as replaceConfigFile } from "./config-D3uukyZR.js";
...
import { a as modelSupportsVision, n as findModelInCatalog, r as loadModelCatalog } from "./model-catalog-CRDyvMk8.js";
import { t as resolveAckReaction } from "./identity-BnPHYOtG.js";
import { h as resolveSessionStoreEntry, o as updateSessionStore } from "./store-CJURmbu1.js";
...
import { a as projectOutboundPayloadPlanForDelivery, n as createOutboundPayloadPlan } from "./deliver-BtvrfctW.js";
...
import { i as toInternalMessageReceivedContext, p as fireAndForgetHook } from "./message-hook-mappers-BaJinTSo.js";
...
import { n as maybeResolveTextAlias, r as normalizeCommandBody } from "./commands-registry-normalize-BJb1sP1K.js";
import { n as isAbortRequestText } from "./abort-primitives-6rz3ruWW.js";
import { t as hasControlCommand } from "./command-detection-CRup7r9Q.js";
import { c as listNativeCommandSpecsForConfig, d as resolveCommandArgMenu, i as formatCommandArgMenuTitle, l as parseCommandArgs, n as buildCommandTextFromArgs, r as findCommandByNativeName, s as listNativeCommandSpecs } from "./commands-registry-Fu-L616i.js";
...
import { i as matchesMentionWithExplicit, n as buildMentionRegexes } from "./mentions-DwJPPFkz.js";
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher-Bmz4nJge.js";
import { i as shouldAckReaction, n as removeAckReactionAfterReply } from "./ack-reactions-3wh6mjC7.js";
import { n as resolveControlCommandGate, t as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-D8entc7F.js";
import { n as resolveInboundMentionDecision, t as implicitMentionKindWhen } from "./mention-gating-BMMQ_gM0.js";
import { c as clearHistoryEntriesIfEnabled, d as recordPendingHistoryEntryIfEnabled, o as buildPendingHistoryContextFromMap } from "./history-C_ZzaNvX.js";
import { o as hasFinalChannelTurnDispatch } from "./kernel-C26WyjBY.js";
import { t as evaluateSupplementalContextVisibility } from "./context-visibility-BDldVrBu.js";
import { t as resolveMarkdownTableMode } from "./markdown-tables-CCy6CAl_.js";
import { a as readChannelAllowFromStore, d as upsertChannelPairingRequest } from "./pairing-store-06vkVxSR.js";
import { t as firstDefined } from "./allow-from-Bn5XAwEi.js";
import "./channel-policy-DBrWfvvg.js";
import "./reply-history-DxyJROVM.js";
...
import { d as parseExecApprovalCommandText } from "./exec-approval-reply-CrNco8sW.js";
import "./approval-reply-runtime-zCZY5-_A.js";
import { t as resolveChannelContextVisibilityMode } from "./context-visibility-Dv_CxVZ4.js";
...
import "./config-mutation-ZDuPm-5K.js";
import { t as resolveCommandAuthorization } from "./command-auth-CKx_ptD_.js";
import { t as resolveStoredModelOverride } from "./stored-model-override-C7U3-jXQ.js";
import { n as isBtwRequestText } from "./btw-command-CK4onjmj.js";
import { t as generateConversationLabel } from "./reply-runtime-2P-x4N0j.js";
...
import "./outbound-runtime-DADal0x2.js";
import "./runtime-config-snapshot-BH43vWzl.js";
import "./model-session-runtime-7smWk6Vd.js";
import "./media-runtime-CgNDNwow.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-BN-7jdgi.js";
import "./conversation-runtime-Cx88RJQE.js";
import { d as resolveThreadBindingSpawnPolicy, l as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel } from "./thread-bindings-policy-C7l1qVrR.js";
...
import "./hook-runtime-wo-Ghhhv.js";
import "./markdown-table-runtime-Dy_UIANy.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-BaTZ9yrb.js";
...
import { n as formatModelsAvailableHeader } from "./commands-models-BtGJihAQ.js";
import "./command-auth-native-Bktn2oV7.js";
import "./command-primitives-runtime-a0aX5ozU.js";
import "./command-status-DuEfy4lm.js";
import "./command-detection-DwXRvySF.js";
import "./command-surface-C6w_wTfc.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-Cru0oRjv.js";
import { n as DEFAULT_EMOJIS, r as DEFAULT_TIMING } from "./channel-feedback-iT7xWzbd.js";
import { n as shouldDebounceTextInbound } from "./channel-inbound-BZsHA3Pp.js";
import { n as toLocationContext, t as formatLocationText } from "./location-CoQJEKJG.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-DMiPQjvN.js";
import "./session-store-runtime-DP0Ytj-o.js";
import "./models-provider-runtime-BTMlxl6v.js";
import "./skill-commands-runtime-B0sfoDj0.js";
import "./native-command-config-runtime-CwnfTFQg.js";
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-DAvGfmlM.js";
import { $ as withResolvedTelegramForumFlag, A as isSafeToRetrySendError, B as buildTelegramRoutingTarget, C as withTelegramApiErrorLogging, D as renderTelegramHtmlText, F as tagTelegramNetworkError, H as buildTypingThreadParams, I as buildGroupLabel, J as resolveTelegramForumThreadId, K as resolveTelegramDirectPeerId, L as buildTelegramGroupFrom, Q as resolveTelegramThreadSpec, R as buildTelegramGroupPeerId, U as describeReplyTarget, V as buildTelegramThreadParams, W as extractTelegramForumFlag, X as resolveTelegramReplyId, Y as resolveTelegramGroupAllowFromContext, Z as resolveTelegramStreamMode, a as editMessageTelegram, at as hasBotMention, dt as normalizeAllowFrom, et as buildSenderLabel, ft as normalizeDmAllowFromWithStore, g as recordSentMessage, it as getTelegramTextParts, j as isTelegramClientRejection, k as isRecoverableTelegramNetworkError, lt as resolveTelegramPrimaryMedia, nt as expandTextLinks, pt as resolveSenderAllowMatch, q as resolveTelegramForumFlag, rt as extractTelegramLocation, st as normalizeForwardedContext, tt as buildSenderName, ut as isSenderAllowed, x as buildInlineKeyboard, z as buildTelegramParentPeer } from "./send-GW4Oi8oh.js";
import { o as normalizeTelegramApiRoot, r as resolveTelegramTransport } from "./fetch-awrhoutC.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-CVLccLjX.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-D3cmkg29.js";
import { d as buildModelsKeyboard, g as resolveModelSelection, h as parseModelCallbackData, m as getModelsPageSize, o as buildTelegramModelsMenuButtons, p as calculateTotalPages, t as buildCommandsPaginationKeyboard } from "./command-ui-ChCRkDpa.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-CMhUBNzT.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-BZhK8IGk.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-DCekkXzz.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-BHs_l3k3.js";
import { a as buildPluginTelegramMenuCommands, i as buildCappedTelegramMenuCommands, n as resolveTelegramExecApproval, o as syncTelegramMenuCommands, r as createTelegramDraftStream, t as defaultTelegramBotDeps } from "./bot-deps-IjuyG-aI.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-DKb_Uqrm.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-DhGI-cyq.js");
...
async function loadTelegramNativeCommandDeliveryRuntime() {
	telegramNativeCommandDeliveryRuntimePromise ??= import("./bot-native-commands.delivery.runtime-CzI0uqZj.js");
...
async function loadTelegramNativeCommandRuntime() {
	telegramNativeCommandRuntimePromise ??= import("./bot-native-commands.runtime-3RQiB8Tt.js");
...
function loadStickerVisionRuntime() {
	stickerVisionRuntimePromise ??= import("./sticker-vision.runtime-Dxskx3Cp.js");
	return stickerVisionRuntimePromise;
}
function loadMediaUnderstandingRuntime() {
	mediaUnderstandingRuntimePromise ??= import("./media-understanding.runtime-CkClfEHs.js");
...
async function loadTelegramMessageContextSessionRuntime(runtime) {
	...
	return {
		...await import("./bot-message-context.session.runtime-8up1A2hl.js"),
		...runtime
	};
}
...
async function loadTelegramMessageContextRuntime() {
	telegramMessageContextRuntimePromise ??= import("./bot-message-context.runtime-BXio3GC2.js");
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-W0xNshst.js")).defaultTelegramBotDeps;
