...
import { s as hasOutboundReplyContent } from "./reply-payload-Dibp0yeY.js";
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-CF_5zmiu.js";
...
import { t as resolveConfiguredTtsMode } from "./tts-config-Cc4IMp_t.js";
import { r as prefixSystemMessage } from "./system-message-C8DKTFdl.js";
import { i as toAcpRuntimeError } from "./errors-D8CuPRkH.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-B0SYWukT.js";
import { r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-6V_zmbY8.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-qb8ELSws.js";
import { a as resolveAcpDispatchPolicyError, i as resolveAcpAgentPolicyError } from "./policy-B_jFNNXP.js";
import { a as resolveAcpThreadSessionDetailLines } from "./session-identifiers-BTcRHbkC.js";
import { r as createBlockReplyPipeline } from "./block-reply-pipeline-1vzMUExw.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-BjBwi7Ef.js";
...
function loadDispatchAcpMediaRuntime() {
	dispatchAcpMediaRuntimePromise ??= import("./dispatch-acp-media.runtime-Bl_p0Q4f.js");
...
function loadDispatchAcpTtsRuntime$1() {
	dispatchAcpTtsRuntimePromise$1 ??= import("./dispatch-acp-tts.runtime-DbxHLc1N.js");
	return dispatchAcpTtsRuntimePromise$1;
}
function loadChannelPluginRuntime() {
	channelPluginRuntimePromise ??= import("./plugins-DIr0Y9o_.js");
	return channelPluginRuntimePromise;
}
function loadMessageActionRuntime() {
	messageActionRuntimePromise ??= import("./message-action-runner-BGepxQnx.js");
...
function loadDispatchAcpManagerRuntime() {
	dispatchAcpManagerRuntimePromise ??= import("./dispatch-acp-manager.runtime-CA8YUmFX.js");
	return dispatchAcpManagerRuntimePromise;
}
function loadDispatchAcpSessionRuntime() {
	dispatchAcpSessionRuntimePromise ??= import("./dispatch-acp-session.runtime-DToovc0u.js");
	return dispatchAcpSessionRuntimePromise;
}
function loadDispatchAcpTtsRuntime() {
	dispatchAcpTtsRuntimePromise ??= import("./dispatch-acp-tts.runtime-DbxHLc1N.js");
