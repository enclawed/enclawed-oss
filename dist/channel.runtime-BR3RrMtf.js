...
import { F as resolveBlueBubblesEffectiveAllowPrivateNetwork, _ as normalizeWebhookReaction, g as normalizeWebhookMessage, o as probeBlueBubbles, t as fetchBlueBubblesServerInfo, u as asRecord } from "./probe-DCQ1Odg2.js";
import { t as getBlueBubblesRuntime } from "./runtime-DdSclW7c.js";
import { n as resolveWebhookPathFromConfig } from "./webhook-shared-cqdJ1anI.js";
import { a as resolveBlueBubblesMessageId, b as sendMessageBlueBubbles } from "./reactions-Bdl_IFAV.js";
import { i as sendBlueBubblesMedia, n as processMessage, r as processReaction, t as logVerbose } from "./monitor-processing-yXjiOicy.js";
...
async function monitorBlueBubblesProvider(options) {
	...
	return await new Promise((resolve) => {
		...
		import("./catchup-DcWEY0f3.js").then(({ runBlueBubblesCatchup }) => runBlueBubblesCatchup(target)).catch((err) => {
