...
import { n as isRich$1, r as theme, t as colorize } from "./theme-hNdBadll.js";
...
import { i as getRuntimeConfig, p as readSourceConfigSnapshotForWrite, r as createConfigIO } from "./io-BPigC1a6.js";
...
import { o as shouldEnableShellEnvFallback, t as getShellEnvAppliedKeys } from "./shell-env-B4_eUMEy.js";
import { f as setRuntimeConfigSnapshot } from "./runtime-snapshot-DH7TJdvG.js";
import { n as resolveAgentModelPrimaryValue, r as toAgentModelListLike, t as resolveAgentModelFallbackValues } from "./model-input-BdUVhsjK.js";
import { _ as resolveDefaultAgentWorkspaceDir } from "./workspace-BOVAZCiV.js";
import { S as resolveDefaultAgentId, b as resolveAgentDir, i as resolveAgentExplicitModelPrimary, s as resolveAgentModelFallbacksOverride, x as resolveAgentWorkspaceDir } from "./agent-scope-Bv7XD6OT.js";
import { t as parseDurationMs } from "./parse-duration-BlGD04_4.js";
import "./config-BDd-c7HD.js";
import { c as resolveAuthStatePathForDisplay, u as resolveAuthStorePathForDisplay } from "./source-check-CaRahOH0.js";
import { a as loadAuthProfileStoreForRuntime, n as ensureAuthProfileStore } from "./store-D3mjjSwW.js";
...
import { _ as resolveProviderEnvApiKeyCandidates, u as isNonSecretApiKeyMarker } from "./model-auth-markers-Cg1NPhS6.js";
import { f as modelKey, m as parseModelRef, t as isCliProvider } from "./model-selection-cli-CfVfEtdt.js";
import { t as modelKey$1 } from "./model-ref-shared-BVYR9WKg.js";
import { d as resolveConfiguredModelRef, f as resolveDefaultModelForAgent, i as buildModelAliasIndex, m as resolveModelRefFromString } from "./model-selection-CSCqfmCj.js";
import { t as resolveEnvApiKey } from "./model-auth-env-CZCejaXu.js";
import { n as resolveAwsSdkEnvVarName } from "./model-auth-runtime-shared-CjC0BpkZ.js";
...
import { a as setAuthProfileOrder, n as listProfilesForProvider, o as upsertAuthProfile } from "./profiles-Dy1jyl8K.js";
import { d as resolveProfileUnusableUntilForDisplay, i as clearAuthProfileCooldown } from "./order-C2aADdvY.js";
import { i as getCustomProviderApiKey, l as resolveUsableCustomProviderApiKey, o as hasUsableCustomProviderApiKey, s as resolveApiKeyForProvider } from "./model-auth-B85ng6CG.js";
import "./command-secret-gateway-CFMzEmB3.js";
import { r as getModelsCommandSecretTargetIds } from "./command-secret-targets-BhK2K9pt.js";
import { n as shouldSuppressBuiltInModel } from "./model-suppression-C4GNU9Oz.js";
import { r as resolveModelWithRegistry } from "./model-CFohagLT.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-DyZq7lFX.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-DKh0FrhA.js";
import { r as withProgressTotals } from "./progress-CDY9v3hd.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-CzJ_oiKn.js";
import { t as createClackPrompter } from "./clack-prompter-7FBHiOy4.js";
import { n as logConfigUpdated } from "./logging-BXCVRuW0.js";
import { t as normalizeAlias } from "./alias-name-738De9jY.js";
import { a as loadValidConfigOrThrow, c as resolveModelKeysFromEntries, d as upsertCanonicalModelConfigEntry, f as isLocalBaseUrl, i as formatTokenK, l as resolveModelTarget, n as ensureFlagCompatibility, o as mergePrimaryFallbackConfig, r as formatMs, s as resolveKnownAgentId, t as applyDefaultModelPrimaryUpdate, u as updateConfig } from "./shared-CthropOt.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-Bh5T7j5N.js";
import { t as maskApiKey } from "./mask-api-key-EsTLR3lI.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-D73gihNw.js";
...
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-3yLqZ5Ru.js";
import "./list.runtime-DhfFVVXH.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-BZfRaTih.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-b9TTkz0v.js");
				await openUrl(url);
			},
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore, ensureEnclawedModelsJson } = await import("./list.runtime-BDa6Ea_j.js");
...
function loadProviderUsageRuntime() {
	providerUsageRuntimePromise ??= import("./provider-usage-nUX4MVI_.js");
...
async function modelsStatusCommand(opts, runtime) {
	...
	let probeSummary;
	if (opts.probe) {
		const [{ withProgressTotals }, { runAuthProbes }] = await Promise.all([import("./progress-CGzhbybH.js"), import("./list.probe-qaxy3GBw.js")]);
	...
	if (missingProvidersInUse.length > 0) {
		const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-D0WGmzLX.js");
		runtime.log("");
	...
	if (probeSummary) {
		const [{ getTerminalTableWidth, renderTable }, { describeProbeSummary, formatProbeLatency, sortProbeResults }] = await Promise.all([import("./table-CoGJVKUP.js"), import("./list.probe-qaxy3GBw.js")]);
		runtime.log("");
