...
import { l as resolveAuthStorePath } from "./source-check-CaRahOH0.js";
...
import { i as parseIdentityMarkdown, t as identityHasValues } from "./identity-file-CcVrhYAj.js";
import { r as ensureWorkspaceAndSessions, s as moveToTrash } from "./onboard-helpers-DnqWC8bO.js";
import { i as parseBindingSpecs, n as buildChannelBindings, r as describeBinding$1, t as applyAgentBindings } from "./agents.bindings-BIKowARB.js";
import { n as requireValidConfigSnapshot, t as requireValidConfigFileSnapshot$1 } from "./config-validation-CRtxGi4h.js";
import { i as loadAgentIdentity, n as buildAgentSummaries, o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-CI5mT5Qy.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-DTU2NHzG.js";
import { n as applyAuthChoice, t as warnIfModelConfigLooksOff } from "./auth-choice-sz8W8kTR.js";
...
async function resolveParsedBindingsOrExit(params) {
	...
	const { parseBindingSpecs } = await import("./agents.bindings-CyRNU7gX.js");
...
async function agentsBindCommand(opts, runtime = defaultRuntime) {
	...
	if (!parsed) return;
	const { applyAgentBindings } = await import("./agents.bindings-CyRNU7gX.js");
...
async function agentsUnbindCommand(opts, runtime = defaultRuntime) {
	...
	if (!parsed) return;
	const { removeAgentBindings } = await import("./agents.bindings-CyRNU7gX.js");
