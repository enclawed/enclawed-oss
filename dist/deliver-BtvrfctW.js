...
import { i as resolveMirroredTranscriptText } from "./transcript-CvYC9_pK.js";
...
import { a as shouldSuppressReasoningPayload, i as isRenderablePayload, r as formatBtwTextForExternalDelivery } from "./reply-payloads-BkvOvD36.js";
...
async function loadTranscriptRuntime() {
	transcriptRuntimePromise ??= import("./transcript.runtime-DM_ZMjDB.js");
	return await transcriptRuntimePromise;
}
let channelBootstrapRuntimePromise;
async function loadChannelBootstrapRuntime() {
	channelBootstrapRuntimePromise ??= import("./channel-bootstrap.runtime-BIRgD8ZZ.js");
