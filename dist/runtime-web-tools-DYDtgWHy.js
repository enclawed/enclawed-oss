...
import { d as resolveSecretInputRef } from "./types.secrets-BpVPfGSB.js";
import { t as createGatewayCredentialPlan } from "./credential-planner-BQSKxqU1.js";
import { u as secretRefKey } from "./ref-contract-CXDupHS0.js";
import "./shared-B-Pgjspa.js";
import { o as resolveSecretRefValues } from "./resolve-C69fXEuE.js";
import { n as getBootstrapChannelSecrets } from "./bootstrap-registry-OoL59bzm.js";
import { S as resolveDefaultAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-n27Qvudk.js";
import { a as normalizePluginsConfig, c as resolveEnableState } from "./config-state-BmxTP58e.js";
import { o as collectPluginConfigContractMatches, s as resolvePluginConfigContractsById } from "./plugin-auto-enable-DpfzwZLV.js";
...
import { n as resolvePluginCapabilityProviders } from "./capability-provider-runtime-B0hDdPmK.js";
...
import { t as loadBundledChannelSecretContractApi } from "./channel-contract-api-BGiqFKtI.js";
import { c as pushInactiveSurfaceWarning, l as pushWarning, n as collectSecretInputAssignment } from "./runtime-shared-Db4frzlP.js";
import { t as collectTtsApiKeyAssignments } from "./runtime-config-collectors-tts-Dj6dy77T.js";
import { o as sortWebFetchProvidersForAutoDetect, r as sortWebSearchProvidersForAutoDetect } from "./web-search-providers.shared-DuPIJEbG.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts, r as resolveBundledExplicitWebFetchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-CgfO3JVb.js";
...
const loadResolveManifestContractOwnerPluginId = createLazyRuntimeNamedExport(() => import("./runtime-web-tools-manifest.runtime-BVaev9Ns.js"), "resolveManifestContractOwnerPluginId");
...
const loadRuntimeWebToolsFallbackProviders = createLazyRuntimeSurface(() => import("./runtime-web-tools-fallback.runtime-B1yJs7k5.js"), ({ runtimeWebToolsFallbackProviders }) => runtimeWebToolsFallbackProviders);
const loadRuntimeWebToolsPublicArtifacts = createLazyRuntimeSurface(() => import("./runtime-web-tools-public-artifacts.runtime-DcwLTiHw.js"), (mod) => mod);
const loadRuntimeWebToolsManifest = createLazyRuntimeSurface(() => import("./runtime-web-tools-manifest.runtime-BVaev9Ns.js"), (mod) => mod);
