...
import { d as resolveSecretInputRef, i as coerceSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-B-g1z55T.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-B_vjonjo.js";
import { n as info, o as success, t as danger } from "./globals-CYDryU7g.js";
import { a as resolveSecretRefValue } from "./resolve-jcnf_t2z.js";
import { w as SecretProviderSchema } from "./zod-schema.core-PXLVKQoM.js";
import { b as validateConfigObjectRaw, l as readConfigFileSnapshot, v as collectUnsupportedSecretRefPolicyIssues } from "./io-BPigC1a6.js";
import { t as isBlockedObjectKey } from "./prototype-keys-DHl-z4Wt.js";
import { r as replaceConfigFile } from "./config-BDd-c7HD.js";
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-B5juDRgp.js";
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-DnKUAQRm.js";
import { i as redactConfigObject, n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-8T0AL2vm.js";
import { n as setCommandJsonMode } from "./json-mode-DEw7oXuB.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.enclawed.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-HAb4SSG8.js");
