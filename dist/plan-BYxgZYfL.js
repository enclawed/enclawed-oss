import { n as MIGRATION_REASON_TARGET_EXISTS, o as createMigrationItem, v as summarizeMigrationItems } from "./migration-DOSnICX3.js";
import { r as exists, s as parseHermesConfig, u as readText } from "./helpers-CdKiqbVQ.js";
import { r as buildConfigItems } from "./config-DeQdkIon.js";
import { l as createHermesModelItem } from "./items-DY23BKq7.js";
import { n as resolveCurrentModelRef, r as resolveHermesModelRef } from "./model-BYBCcbWu.js";
import { n as buildSecretItems } from "./secrets-CtTXW6xE.js";
import { t as buildSkillItems } from "./skills-BLWDwwOT.js";
import { n as hasHermesSource, t as discoverHermesSource } from "./source-CqwcsV6x.js";
import { t as resolveTargets } from "./targets-B0vhOTd8.js";
...
async function buildHermesPlan(ctx) {
	...
	const warnings = [
		...
		...source.archivePaths.length > 0 ? ["Some Hermes files are archive-only. They will be copied into the migration report for manual review, not loaded into Enclawed."] : [],
