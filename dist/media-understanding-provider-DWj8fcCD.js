import { i as FALLBACK_CODEX_MODELS, r as CODEX_PROVIDER_ID } from "./provider-catalog-BInkH4kI.js";
import { i as resolveCodexAppServerRuntimeOptions } from "./config-4fguwYEf.js";
import { a as readCodexErrorNotification, c as readCodexTurnCompletedNotification, n as assertCodexThreadStartResponse, r as assertCodexTurnStartResponse } from "./protocol-validators-B0a1ygyl.js";
import { r as readModelListResult } from "./models-DSCW-tj3.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-DMWpq2B0.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
