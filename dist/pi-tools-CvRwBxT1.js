...
import { v as resolveAgentConfig } from "./agent-scope-Bv7XD6OT.js";
import { d as resolveGatewayMessageChannel } from "./message-channel-CP7lSRvA.js";
import { _ as PROCESS_TOOL_DISPLAY_SUMMARY, g as EXEC_TOOL_DISPLAY_SUMMARY, i as collectExplicitAllowlist, n as applyOwnerOnlyToolPolicy, o as mergeAlsoAllowPolicy, u as resolveToolProfilePolicy } from "./tool-policy-Bkov0fJO.js";
import { i as listChannelAgentTools, l as copyPluginToolMeta, t as copyChannelAgentToolMeta, u as getPluginToolMeta } from "./channel-tools-CQ0awn7Q.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-CoyKSbHr.js";
import { n as normalizeToolParameters } from "./pi-tools.schema-C4hH_xSU.js";
import { c as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-CscuAdNM.js";
import { t as bindAbortRelay } from "./fetch-timeout-CX15k_ki.js";
import { a as createEnclawedReadTool, c as createSandboxedEditTool, d as wrapToolMemoryFlushAppendOnlyWrite, f as wrapToolWorkspaceRootGuard, l as createSandboxedReadTool, o as createHostWorkspaceEditTool, p as wrapToolWorkspaceRootGuardWithOptions, s as createHostWorkspaceWriteTool, t as createEnclawedTools, u as createSandboxedWriteTool } from "./enclawed-tools-CecGzQ4d.js";
import { a as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-_verVbrn.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-Ckl9uf2z.js";
import { g as writeFileWithinRoot, o as mkdirPathWithinRoot, p as removePathWithinRoot } from "./fs-safe-DbL4T6oL.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-CWtn4o3G.js";
import { n as assertSandboxPath } from "./sandbox-paths-CLNWxZDE.js";
import { a as resolveGroupToolPolicy, d as toRelativeSandboxPath, l as resolveWorkspaceRoot, r as resolveEffectiveToolPolicy, s as resolveSubagentToolPolicyForSession, u as resolvePathFromInput } from "./read-capability-BBdqCvWu.js";
...
import { t as isToolAllowedByPolicies } from "./tool-policy-match-CK-rUT3T.js";
import { i as resolveToolFsConfig, t as createToolFsPolicy } from "./tool-fs-policy-DATECwiU.js";
...
function createLazyExecTool(defaults) {
	...
	const loadTool = async () => {
		if (!loadedTool) {
			const { createExecTool } = await import("./bash-tools-D3WEUL-V.js");
...
function createLazyProcessTool(defaults) {
	...
	const loadTool = async () => {
		if (!loadedTool) {
			const { createProcessTool } = await import("./bash-tools-D3WEUL-V.js");
...
function createEnclawedCodingTools(options) {
	...
	const base = createCodingTools(workspaceRoot).flatMap((tool) => {
		if (tool.name === "read") {
			...
			const wrapped = createEnclawedReadTool(createReadTool(workspaceRoot), {
				modelContextWindowTokens: options?.modelContextWindowTokens,
				imageSanitization
			});
...
//#endregion
export { resolveToolLoopDetectionConfig as n, createEnclawedCodingTools as t };
