...
import { t as logDebug } from "./logger-CKs2nJWp.js";
import { a as loadConfig, h as resolveConfigSnapshotHash, o as parseConfigJson5 } from "./io-BPigC1a6.js";
import { n as resolveManifestContractOwnerPluginId } from "./manifest-registry-BSUm5sVB.js";
import { r as normalizeProviderId } from "./provider-id-JqYiEozY.js";
import { c as parseThreadSessionSuffix, o as parseAgentSessionKey } from "./session-key-utils-Ce7cepnN.js";
import { n as normalizeAccountId } from "./account-id-BV5xNTUp.js";
import { c as normalizeAgentId, f as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-BOC5unB4.js";
import { o as normalizeChannelId } from "./registry-DA6N3sbz.js";
import { i as normalizeChannelId$1, r as listChannelPlugins, t as getChannelPlugin } from "./registry-BnDtOQsV.js";
import { t as applyMergePatch } from "./merge-patch-DiggvcXH.js";
import { t as getProviderEnvVars } from "./provider-env-vars-Clirdqjr.js";
import { n as resolveAgentModelPrimaryValue, t as resolveAgentModelFallbackValues } from "./model-input-BdUVhsjK.js";
import { m as resolveSessionAgentIds, p as resolveSessionAgentId, r as resolveAgentExecutionContract, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-Bv7XD6OT.js";
...
import { h as GATEWAY_CLIENT_MODES, m as GATEWAY_CLIENT_IDS, u as normalizeMessageChannel } from "./message-channel-CP7lSRvA.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-mjm4W8wY.js";
import "./plugins-aoBJbOTG.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-BcnUyz_Y.js";
import { t as ensureEnclawedModelsJson } from "./models-config-0R5Z7JxG.js";
import { f as modelKey, p as normalizeModelRef } from "./model-selection-cli-CfVfEtdt.js";
import { f as resolveDefaultModelForAgent, i as buildModelAliasIndex, m as resolveModelRefFromString, t as buildAllowedModelSet } from "./model-selection-CSCqfmCj.js";
...
import { a as discoverModels, i as discoverAuthStorage } from "./pi-model-discovery-DksWC-YF.js";
import { o as updateSessionStore } from "./store-BkF3pYvh.js";
import { t as extractDeliveryInfo } from "./sessions-D71lwKID.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-Lozvxyih.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-CIWKeEct.js";
import { t as loadSessionStore } from "./store-load-NgoHF_53.js";
import { n as resolveSessionConversationRef } from "./session-conversation-6IaF39PY.js";
import "./delivery-context-8cWU6POu.js";
import { d as resolveSessionModelIdentityRef } from "./session-utils-DY67z3Wl.js";
import { l as jsonUtf8Bytes, n as capArrayByJsonBytes } from "./session-utils.fs-D4KXI-63.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-DgKTURQ1.js";
import { i as imageMimeFromFormat, t as detectMime } from "./mime-CwPaZfyo.js";
import { C as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY, D as describeSessionsSendTool, E as describeSessionsListTool, O as describeSessionsSpawnTool, S as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, T as describeSessionsHistoryTool, b as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, h as CRON_TOOL_DISPLAY_SUMMARY, k as describeUpdatePlanTool, v as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, w as describeSessionStatusTool, x as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, y as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY } from "./tool-policy-Bkov0fJO.js";
import { a as listChannelSupportedActions, d as resolvePluginTools, r as listAllChannelSupportedActions } from "./channel-tools-CQ0awn7Q.js";
import { w as textToSpeech } from "./tts-runtime-wTc8Wa1J.js";
import "./tts-BstCFzHG.js";
import { a as getImageMetadata } from "./image-ops-DdCDfmES.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-CoyKSbHr.js";
import { a as resolveChannelMessageToolSchemaProperties, n as channelSupportsMessageCapabilityForChannel, t as channelSupportsMessageCapability } from "./message-action-discovery-DJhkseDv.js";
import { r as getApiKeyForModel } from "./model-auth-B85ng6CG.js";
import { t as SsrFBlockedError } from "./ssrf-DQDx1s1G.js";
import { u as parseReplyDirectives } from "./deliver-DYr7WjIl.js";
import { n as runWithImageModelFallback } from "./model-fallback-D9hl20Un.js";
import { t as extractTextFromChatContent } from "./chat-content-o12e3MYm.js";
import { c as stripReasoningTagsFromText } from "./assistant-visible-text-DorKrU1h.js";
import { t as extractAssistantText } from "./pi-embedded-utils-fu5_oXAZ.js";
import { r as callGateway } from "./call-DtxbZweG.js";
import { c as jsonResult, d as readNumberParam, h as readStringParam$1, o as imageResult, p as readStringArrayParam, r as ToolInputError, y as readSnakeCaseParamRaw } from "./common-BMEsSwt3.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-u_c4UwFM.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-DbL4T6oL.js";
import { t as isWindowsDrivePath } from "./archive-path-xknm3LhT.js";
import { o as trySafeFileURLToPath, r as hasEncodedFileUrlSeparator } from "./local-file-access-DcHUOMtl.js";
import { n as assertSandboxPath } from "./sandbox-paths-CLNWxZDE.js";
import { c as normalizeWorkspaceDir, f as toRelativeWorkspacePath, l as resolveWorkspaceRoot } from "./read-capability-BBdqCvWu.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata } from "./runtime-DyoaLmKZ.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-BsThNkgD.js";
import { a as createSessionVisibilityGuard, c as resolveDisplaySessionKey, d as resolveSessionReference, f as resolveVisibleSessionReference, i as createAgentToAgentPolicy, l as resolveInternalSessionKey, n as deriveChannel, o as resolveEffectiveSessionToolsVisibility, p as shouldResolveSessionIdInput, r as resolveSessionToolContext, s as resolveSandboxedSessionToolContext, t as classifySessionKind, u as resolveMainSessionAlias } from "./sessions-helpers-ENz16qOu.js";
import { r as stripToolMessages } from "./chat-history-text-BvO-6krC.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-SHehYBKH.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-G_8MwHNV.js";
import { i as stringEnum, n as channelTargetsSchema, r as optionalStringEnum, t as channelTargetSchema } from "./typebox-DTLhjzIz.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-DPEN7Eok.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-DUg2Fmkx.js";
...
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-Da6Y-5kj.js";
import { n as formatDoctorNonInteractiveHint, s as writeRestartSentinel } from "./restart-sentinel-CiwintAf.js";
import { o as scheduleGatewaySigusr1Restart } from "./restart-BjqW_Da8.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-BfLBtM6z.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-Ci1YFa0U.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-BAyiAUe3.js";
import { l as saveMediaBuffer } from "./store-DrQVGdgl.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-BjEYydW3.js";
import { r as getDefaultLocalRoots } from "./local-media-access-BGZjPdWr.js";
import { a as coerceImageModelConfig, c as resolveProviderVisionModelFromConfig, d as hasAuthForProvider, f as hasToolModelConfig, l as buildToolModelConfigFromCandidates, n as isMinimaxVlmProvider, o as decodeDataUrl, p as resolveDefaultModelRef, u as coerceToolModelConfig } from "./minimax-vlm-CFtyj7w9.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-B8cjiGT0.js";
import { C as getMediaUnderstandingProvider, E as resolveBundledDefaultMediaModel, T as resolveBundledAutoMediaKeyProviders, b as resolveAutoMediaKeyProviders, w as bundledProviderSupportsNativePdfDocument, x as resolveDefaultMediaModel } from "./resolve-BJ1XgB6C.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-Btc9P6hl.js";
import { t as buildProviderRegistry } from "./runner-3y5AItbb.js";
import "./media-understanding-BEWZG7O9.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-D-KtMj0i.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-CFMzEmB3.js";
import { a as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-BhK2K9pt.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-BhCzkZ8l.js";
import { t as sendMessage } from "./message-CuuOlwkP.js";
import { n as resolveMusicGenerationModeCapabilities, t as listSupportedMusicGenerationModes } from "./capabilities-Drsbhnhp.js";
import { r as parseMusicGenerationModelRef } from "./provider-registry-BC4BRPdJ.js";
import { n as listRuntimeMusicGenerationProviders, t as generateMusic } from "./runtime-B3PI1wQE.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-BdepUXHi.js";
...
import { a as createRunningTaskRun, c as recordTaskRunProgressByRunId, o as failTaskRunByRunId, r as completeTaskRunByRunId } from "./task-executor-DsolRNhT.js";
import "./task-registry-delivery-runtime-Dc-yGszC.js";
import { t as formatAgentInternalEventsForPrompt } from "./internal-events-DBE5KFmH.js";
import { _ as REPLY_SKIP_TOKEN, b as deliverSubagentAnnouncement, d as registerSubagentRun, g as ANNOUNCE_SKIP_TOKEN, h as runAgentStep, v as isAnnounceSkip, y as isReplySkip } from "./subagent-registry-DbjoxRAI.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-TjAeWRDo.js";
import { t as parseTimeoutMs } from "./parse-timeout-rS8x7MdD.js";
import { t as extractPdfContent } from "./pdf-extract-DJdRUYuO.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DsB-Idj6.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-yoFVoaJ9.js";
import { t as AGENT_LANE_NESTED } from "./lanes-e7slEYtV.js";
import { i as waitForAgentRunAndReadUpdatedAssistantReply, n as readLatestAssistantReplySnapshot, r as waitForAgentRun, t as readLatestAssistantReply } from "./run-wait-B_d2SdL8.js";
import { n as SUBAGENT_SPAWN_MODES, t as spawnSubagentDirect } from "./subagent-spawn-CizbJaRW.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-BMfiRW12.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-CM7XP72Y.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-BVIqqsxZ.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-NMAdWLtD.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-CRDoJpms.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-BG0h4WfB.js";
import { a as runWebSearch, i as resolveWebSearchDefinition, l as resolveWebProviderConfig } from "./runtime-C60Gg9GD.js";
import { r as resolveWebFetchDefinition } from "./runtime-D1_PoY8v.js";
import { i as markdownToText, n as extractReadableContent, o as truncateText$1, r as htmlToMarkdown, t as extractBasicHtmlContent } from "./web-fetch-utils-FwUlVm66.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds, u as fetchWithWebToolsNetworkGuard } from "./web-shared-BIzF2cfP.js";
import "./web-search-provider-common-NMKrio6_.js";
...
function loadCommandsStatusRuntime() {
	commandsStatusRuntimePromise ??= import("./session-status.runtime-DOOM6Kjk.js");
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-ta4R4V_n.js");
...
async function loadAcpSpawnModule() {
	acpSpawnModulePromise ??= import("./acp-spawn-CkFsjL6n.js");
