...
import { p as resolvePayloadMediaUrls, x as sendTextMediaPayload, y as sendPayloadMediaSequenceOrFallback } from "./reply-payload-ULobvdLo.js";
import { t as resolveOutboundSendDep } from "./send-deps-AMmmrjG-.js";
import { n as retryAsync, t as resolveRetryConfig } from "./retry-C9tlAwQL.js";
import "./text-runtime-DwWuUy-T.js";
import { t as createReplyToFanout } from "./outbound-runtime-D6Dcqfxk.js";
...
import { a as chunkDiscordTextWithMode, i as normalizeDiscordOutboundTarget } from "./normalize-CL-TAjzv.js";
...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-5S1-qlzF.js").then((module) => module.sendDiscordComponentMessage);
	return await (await discordComponentSendPromise)(...args);
}
function loadDiscordSharedInteractive() {
	discordSharedInteractivePromise ??= import("./shared-interactive-fGY8ZSDc.js");
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-Tp7K-yAr.js");
