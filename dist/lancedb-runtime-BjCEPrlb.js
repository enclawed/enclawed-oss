	...
	return { async load(logger) {
		if (!loadPromise) loadPromise = (async () => {
			try {
				...
				if (deps.env.ENCLAWED_NIX_MODE === "1") throw new Error(buildLoadFailureMessage("failed to load LanceDB and Nix mode disables auto-install", bundledError), { cause: bundledError });
