...
import { r as hasInterSessionUserProvenance } from "./input-provenance-DwdRnS02.js";
import { a as normalizeUsage, n as deriveSessionTotalTokens, r as hasNonzeroUsage } from "./usage-BAoTEYmL.js";
...
import { a as hasToolCall, i as extractToolCallNames, n as stripMessageIdHints, t as stripEnvelope } from "./chat-envelope-aSu34cLz.js";
import { n as stripInboundMetadata, t as extractInboundSenderLabel } from "./strip-inbound-meta-B-t4NsiU.js";
...
function attachEnclawedTranscriptMeta(message, meta) {
	if (!message || typeof message !== "object" || Array.isArray(message)) return message;
	const record = message;
	const existing = record.__enclawed && typeof record.__enclawed === "object" && !Array.isArray(record.__enclawed) ? record.__enclawed : {};
	return {
		...record,
		__enclawed: {
			...existing,
...
function readSessionMessages(sessionId, storePath, sessionFile) {
	...
	for (const line of lines) {
		...
		try {
			...
			if (parsed?.message) {
				messageSeq += 1;
				messages.push(attachEnclawedTranscriptMeta(parsed.message, {
...
//#endregion
export { readSessionPreviewItemsFromTranscript as a, stripEnvelopeFromMessages as c, readSessionMessages as i, jsonUtf8Bytes as l, capArrayByJsonBytes as n, readSessionTitleFieldsFromTranscript as o, readLatestSessionUsageFromTranscript as r, stripEnvelopeFromMessage as s, attachEnclawedTranscriptMeta as t };
