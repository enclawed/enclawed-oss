...
import { i as parseIdentityMarkdown, t as identityHasValues } from "./identity-file-sQ5pH7df.js";
import { r as ensureWorkspaceAndSessions, s as moveToTrash } from "./onboard-helpers-DQ5qqC_T.js";
import { i as parseBindingSpecs, n as buildChannelBindings, r as describeBinding$1, t as applyAgentBindings } from "./agents.bindings-CVSiqyY3.js";
import { n as requireValidConfigSnapshot, t as requireValidConfigFileSnapshot$1 } from "./config-validation-Dy7dJ56q.js";
import { i as loadAgentIdentity, n as buildAgentSummaries, o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-Bwb1Zjpj.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-CM9IpTNM.js";
import { n as applyAuthChoice, t as warnIfModelConfigLooksOff } from "./auth-choice-C5dlgjaT.js";
...
async function resolveParsedBindingsOrExit(params) {
	...
	const { parseBindingSpecs } = await import("./agents.bindings-CfSF2Cm1.js");
...
async function agentsBindCommand(opts, runtime = defaultRuntime) {
	...
	if (!parsed) return;
	const { applyAgentBindings } = await import("./agents.bindings-CfSF2Cm1.js");
...
async function agentsUnbindCommand(opts, runtime = defaultRuntime) {
	...
	if (!parsed) return;
	const { removeAgentBindings } = await import("./agents.bindings-CfSF2Cm1.js");
