...
import { c as resolveOpenDmAllowlistAccess } from "./dm-policy-shared-Cu5wU6lb.js";
import "./reply-history-C_8iJp54.js";
import { t as createReplyPrefixContext } from "./reply-prefix-DEjJBK1T.js";
...
import { t as buildAgentMediaPayload } from "./agent-media-payload-CLc2UmTV.js";
...
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-CVKkP8if.js";
...
import { n as createChannelPairingController } from "./channel-pairing-DIV-o5ud.js";
import { n as createPersistentDedupe } from "./persistent-dedupe-6WNQaIDF.js";
...
import { t as buildFeishuConversationId } from "./conversation-id-B-daS6Z5.js";
import { i as resolveReceiveIdType } from "./targets-DW42gJdA.js";
import { n as createFeishuThreadBindingManager } from "./thread-bindings-DYtKy2MO.js";
import { _ as buildFeishuCommentTarget, d as extractReplyText, g as readString$2, h as parseCommentContentElements, l as resolveFeishuRuntimeAccount, m as normalizeString, p as isRecord$2, u as encodeQuery, v as normalizeCommentFileType } from "./accounts-Bop3Pflv.js";
import { i as decodeFeishuCardAction, n as buildFeishuCardActionTextFallback, r as createFeishuCardInteractionEnvelope } from "./card-interaction-CZQ-4VDc.js";
import { i as resolveFeishuGroupConfig, n as isFeishuGroupAllowed, o as resolveFeishuReplyPolicy, r as resolveFeishuAllowlistMatch, t as hasExplicitFeishuGroupConfig } from "./policy-DZwSIMOY.js";
import { t as getFeishuRuntime } from "./runtime-CK2I9cCX.js";
import { a as createEventDispatcher, c as getFeishuUserAgent, o as createFeishuClient, s as createFeishuWSClient } from "./client-B55PKUcX.js";
import { c as getChatInfo, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-BgJwos4F.js";
import "./runtime-api-sU-DYP1o.js";
import { _ as normalizeFeishuExternalKey, a as sendCardFeishu, c as sendStructuredCardFeishu, d as extractMentionTargets, f as isFeishuBroadcastMention, g as sendMediaFeishu, h as downloadMessageResourceFeishu, i as resolveFeishuCardTemplate, l as parsePostContent, m as isFeishuGroupChatType, n as getMessageFeishu, p as isMentionForwardRequest, r as listFeishuThreadMessages, s as sendMessageFeishu, u as buildMentionedCardContent } from "./send-DgdW_0E-.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-BG34O5Nv.js";
import { a as feishuWebhookRateLimiter, c as wsClients, i as botOpenIds, l as fetchBotIdentityForMonitor, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as httpServers, r as botNames, s as recordWebhookStatus, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS } from "./monitor.state-CZ-r8tlj.js";
...
async function resolveFeishuAudioPreflightTranscript(params) {
	...
	try {
		const { transcribeFirstAudio } = await import("./audio-preflight.runtime-nmIrgYRy.js");
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-BiFpB0Gy.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-BiFpB0Gy.js");
