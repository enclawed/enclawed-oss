...
import { r as prefixSystemMessage, t as SYSTEM_MARK } from "./system-message-D5GeBw7h.js";
import { i as resolveModelDirectiveSelection } from "./model-selection-Db6GD3KP.js";
...
function formatElevatedUnavailableText(params) {
	...
	if (params.sessionKey) lines.push(`See: ${formatCliCommand(`enclawed sandbox explain --session ${params.sessionKey}`)}`);
	return lines.join("\n");
}
//#endregion
