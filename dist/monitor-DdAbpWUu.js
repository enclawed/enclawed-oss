...
import { n as formatAllowlistMatchMeta } from "./allowlist-match-_TU1EVqz.js";
import { t as resolveAckReaction } from "./identity-IAiNDSmy.js";
import { h as resolveSessionStoreEntry } from "./store-eo7yB1I1.js";
...
import { n as resolveControlCommandGate } from "./command-gating-DLPAMnWl.js";
...
import { a as waitUntilAbort } from "./channel-lifecycle.core-tcDREoOT.js";
import { r as mergeDmAllowFromSources } from "./allow-from-B9qoXme1.js";
...
import { a as warnMissingProviderGroupPolicyFallbackOnce, n as resolveAllowlistProviderRuntimeGroupPolicy, r as resolveDefaultGroupPolicy, t as GROUP_POLICY_BLOCKED_LABEL } from "./runtime-group-policy-BKsa-SoT.js";
import { l as resolvePinnedMainDmOwnerFromAllowlist } from "./dm-policy-shared-DX-_B8DN.js";
import { n as createReplyPrefixOptions } from "./reply-prefix-DSCcVhUg.js";
import { t as createTypingCallbacks } from "./typing-ClGnFLOu.js";
...
import { l as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel } from "./thread-bindings-policy-s3DnUDZm.js";
...
import { n as logInboundDrop, r as logTypingFailure } from "./logging-Dy0jyfcu.js";
...
import "./string-coerce-runtime-C86BPY1x.js";
import { a as resolveMatrixAccountConfig, i as resolveMatrixAccountAllowlistConfig } from "./account-config-DvbL3CQO.js";
import { t as isMatrixQualifiedUserId } from "./target-ids-DJrvnFnW.js";
import { n as matrixReplaceConfigFile, t as getMatrixRuntime } from "./runtime-C81KrYiI.js";
import { n as resolveConfiguredMatrixBotUserIds } from "./accounts-B_DszpRB.js";
import { n as normalizeMatrixUserId, r as resolveMatrixAllowListMatch, t as normalizeMatrixAllowList } from "./allowlist-jjZs5N28.js";
import { r as isMatrixNotFoundError, t as formatMatrixErrorMessage } from "./errors-DFW-R2p9.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-Cdc70irs.js";
import { i as resolveMatrixStateFilePath } from "./storage-D8RM0B1L.js";
import { a as sendMessageMatrix, g as isPollStartType, h as isPollEventType, p as formatPollAsText, t as chunkMatrixText, v as parsePollStartContent } from "./send-DxUaeahX.js";
import { o as MATRIX_ENCLAWED_FINALIZED_PREVIEW_KEY, r as promoteMatrixDirectRoomCandidate } from "./direct-management-Bxu8QlD-.js";
import { o as readJoinedMatrixMembers, r as isStrictDirectMembership, t as hasDirectMatrixMemberFlag } from "./direct-room-TI-X3Esa.js";
import { t as createMatrixThreadBindingManager } from "./thread-bindings-CrV5A22x.js";
import { t as createAsyncLock } from "./async-lock-D1nJcYZT.js";
import { n as LogService } from "./logger-CasR-M3r.js";
import { i as isMatrixMediaSizeLimitError, r as MatrixMediaSizeLimitError } from "./http-client-QnTv1utb.js";
import { i as throwIfMatrixStartupAborted, r as isMatrixStartupAbortError } from "./startup-abort-DyRxFOL9.js";
import { n as isMatrixReadySyncState, r as isMatrixTerminalSyncState, t as isMatrixDisconnectedSyncState } from "./sync-state-DpRwuD6C.js";
import { a as resolveMatrixMessageBody, i as resolveMatrixMessageAttachment, n as formatMatrixMediaUnavailableText, r as formatMatrixMessageText, s as fetchMatrixPollSnapshot, t as formatMatrixMediaTooLargeText } from "./media-text-BFz6YQqE.js";
import { n as setActiveMatrixClient } from "./active-client-BPpme1MS.js";
import { t as isBunRuntime } from "./runtime-Cg2SX5Qo.js";
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext, t as backfillMatrixAuthDeviceIdAfterStartup } from "./config-CFK8o2RH.js";
import { i as resolveSharedMatrixClient, n as releaseSharedClientInstance } from "./shared-D5ojEYTL.js";
import "./client-BFP7inOc.js";
import "./runtime-api-DnwD2I16.js";
import { t as resolveMatrixTargets } from "./resolve-targets-imNWp7al.js";
import { t as formatMatrixEncryptedEventDisabledWarning } from "./encryption-guidance-Be7EV_Ld.js";
import { a as EventType, i as resolveMatrixThreadRouting, n as resolveMatrixReplyToEventId, o as RelationType, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-F0RwlbLf.js";
...
async function loadMatrixDirectRoomDeps() {
	matrixDirectRoomDepsPromise ??= Promise.all([import("./direct-management-BKJv3xvd.js"), import("./direct-room-CcVqH3LB.js")]).then(([directManagementModule, directRoomModule]) => ({
...
function formatMatrixPostHealthySyncDecryptionHint(accountId) {
	return `matrix: repeated fresh encrypted messages are still failing to decrypt after Matrix resumed healthy sync. This device may still be missing new room keys. Check 'enclawed matrix verify status --verbose --account ${accountId}' and 'enclawed matrix devices list --account ${accountId}'.`;
}
...
function formatMatrixSelfDecryptionHint(accountId) {
	return `matrix: failed to decrypt a message from this same Matrix user. This usually means another Matrix device did not share the room key, or another Enclawed runtime is using the same account. Check 'enclawed matrix verify status --verbose --account ${accountId}' and 'enclawed matrix devices list --account ${accountId}'.`;
}
...
function loadMatrixSendModule() {
	matrixSendModulePromise ??= import("./send-DYGGlSTL.js");
...
function loadMatrixReactionEvents() {
	matrixReactionEventsPromise ??= import("./reaction-events-BXGh3zYM.js");
	return matrixReactionEventsPromise;
}
function loadMatrixDraftStream() {
	matrixDraftStreamPromise ??= import("./draft-stream-Cmi2H9LD.js");
	...
	return async (roomId, event) => {
		...
		try {
			...
			const continueIngress = async (params) => {
				...
				const liveCfg = core.config.current?.() ?? core.config.loadConfig();
...
async function loadMatrixStartupMaintenanceDeps() {
	matrixStartupMaintenanceDepsPromise ??= Promise.all([
		import("./config-update-FtKq3gD2.js"),
		import("./device-health-BzSMJZI9.js"),
		import("./profile-CSc-qxti.js"),
		import("./legacy-crypto-restore-DUgIopca.js"),
		import("./startup-verification-JOELo5Vx.js")
...
async function runMatrixStartupMaintenance(params, deps) {
	...
	try {
		...
		if (deviceHealth.staleEnclawedDevices.length > 0) params.logger.warn(`matrix: stale Enclawed devices detected for ${params.auth.userId}: ${deviceHealth.staleEnclawedDevices.map((device) => device.deviceId).join(", ")}. Run 'enclawed matrix devices prune-stale --account ${params.effectiveAccountId}' to keep encrypted-room trust healthy.`);
	} catch (err) {
		if (isMatrixStartupAbortError(err)) throw err;
	...
	try {
		...
		if (startupVerification.kind === "verified") params.logger.info("matrix: device is verified by its owner and ready for encrypted rooms");
			...
			params.logger.info("matrix: device not verified — run 'enclawed matrix verify device <key>' to enable E2EE");
...
async function monitorMatrixProvider(opts = {}) {
	...
	const core = getMatrixRuntime();
	let cfg = core.config.current?.() ?? core.config.loadConfig();
	...
	try {
		...
		await runMatrixStartupMaintenance({
			...
			logger,
			logVerboseMessage,
			getRuntimeConfig: () => core.config.current?.() ?? core.config.loadConfig(),
