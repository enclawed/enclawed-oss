...
import { c as mimeTypeFromFilePath, l as normalizeMimeType, m as maxBytesForKind, n as extensionForMime, r as getFileExtension, s as kindFromMime, t as detectMime } from "./mime-Bs8vyLeZ.js";
import { c as optimizeImageToPng, i as convertHeicToJpeg, l as resizeToJpeg, o as hasAlphaChannel } from "./image-ops-B58JkOb8.js";
import { d as readLocalFileSafely, s as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-C3irXap3.js";
...
const CANVAS_WS_PATH = "/__enclawed__/ws";
...
async function handleA2uiHttpRequest(req, res) {
	...
	const basePath = url.pathname === "/__enclawed__/a2ui" || url.pathname.startsWith(`/__enclawed__/a2ui/`) ? A2UI_PATH : void 0;
