...
import { d as legacyModelKey, f as modelKey } from "./model-selection-cli-DrzfE0gz.js";
import { i as buildModelAliasIndex, m as resolveModelRefFromString } from "./model-selection-3QcDboLc.js";
...
function resolveKnownAgentId(params) {
	...
	if (!listAgentIds(params.cfg).includes(agentId)) throw new Error(`Unknown agent id "${raw}". Use "${formatCliCommand("enclawed agents list")}" to see configured agents.`);
	return agentId;
}
