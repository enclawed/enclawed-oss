...
import { g as sendMediaWithLeadingCaption, h as resolveTextChunksWithFallback, m as resolveSendableOutboundReplyParts } from "./reply-payload-ULobvdLo.js";
...
import { c as resolveOpenDmAllowlistAccess } from "./dm-policy-shared-DX-_B8DN.js";
import "./reply-history-Dq3jEIjW.js";
import { t as createReplyPrefixContext } from "./reply-prefix-DSCcVhUg.js";
...
import { t as buildAgentMediaPayload } from "./agent-media-payload-gE9e9iGF.js";
...
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-CF48GUmH.js";
import "./conversation-runtime-zROIv0RL.js";
import "./security-runtime-B2-Yl3T5.js";
import "./command-primitives-runtime-QaQdq4Pd.js";
import { r as logTypingFailure } from "./logging-Dy0jyfcu.js";
import "./channel-feedback-BOMZTn-y.js";
import { n as createChannelPairingController } from "./channel-pairing-BXQZOLtw.js";
import { n as createPersistentDedupe } from "./persistent-dedupe-tm33CCqc.js";
import { c as readWebhookBodyOrReject, r as applyBasicWebhookRequestGuards } from "./webhook-request-guards-BoGT1AcX.js";
import "./webhook-ingress-Bua0eRIA.js";
import { t as buildFeishuConversationId } from "./conversation-id-C-6eO8b8.js";
import { i as resolveReceiveIdType } from "./targets-BkOuOMnC.js";
import { n as createFeishuThreadBindingManager } from "./thread-bindings-DI-AK8hV.js";
import { _ as buildFeishuCommentTarget, d as extractReplyText, g as readString$2, h as parseCommentContentElements, l as resolveFeishuRuntimeAccount, m as normalizeString, p as isRecord$2, u as encodeQuery, v as normalizeCommentFileType } from "./accounts-BD6ZGK7S.js";
import { i as decodeFeishuCardAction, n as buildFeishuCardActionTextFallback, r as createFeishuCardInteractionEnvelope } from "./card-interaction-qYF_RPhE.js";
import { i as resolveFeishuGroupConfig, n as isFeishuGroupAllowed, o as resolveFeishuReplyPolicy, r as resolveFeishuAllowlistMatch, t as hasExplicitFeishuGroupConfig } from "./policy-BoiE88FE.js";
import { t as getFeishuRuntime } from "./runtime-Cd4EFaqn.js";
import { a as createEventDispatcher, c as getFeishuUserAgent, o as createFeishuClient, s as createFeishuWSClient } from "./client-CQAQi7Ie.js";
import { c as getChatInfo, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-Cq5tGUIy.js";
import "./runtime-api-ClgoSIZP.js";
import { _ as normalizeFeishuExternalKey, a as sendCardFeishu, c as sendStructuredCardFeishu, d as extractMentionTargets, f as isFeishuBroadcastMention, g as sendMediaFeishu, h as downloadMessageResourceFeishu, i as resolveFeishuCardTemplate, l as parsePostContent, m as isFeishuGroupChatType, n as getMessageFeishu, p as isMentionForwardRequest, r as listFeishuThreadMessages, s as sendMessageFeishu, u as buildMentionedCardContent } from "./send-Buh6yNtf.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-CrrOkbZX.js";
import { a as feishuWebhookRateLimiter, c as wsClients, i as botOpenIds, l as fetchBotIdentityForMonitor, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as httpServers, r as botNames, s as recordWebhookStatus, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS } from "./monitor.state-Djod78Pi.js";
...
async function resolveFeishuAudioPreflightTranscript(params) {
	...
	try {
		const { transcribeFirstAudio } = await import("./audio-preflight.runtime-B7Czj91V.js");
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-DEbZwxOc.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-DEbZwxOc.js");
