...
import { f as INTERNAL_RUNTIME_CONTEXT_BEGIN, u as sanitizeUserFacingText } from "./sanitize-user-facing-text-DC3SMoyx.js";
...
function stripInlineLeakedInternalContext(value) {
	...
	if (beginIndex !== -1 && (value.includes("<<<END_ENCLAWED_INTERNAL_CONTEXT>>>") || value.includes("Enclawed runtime context (internal):") || value.includes("[Internal task completion event]"))) return value.slice(0, beginIndex);
