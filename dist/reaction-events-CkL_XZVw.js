...
import "./session-binding-runtime-DQqz7E7Y.js";
import { a as resolveMatrixAccountConfig } from "./account-config-D1al0QIu.js";
import { a as extractMatrixReactionAnnotation } from "./reaction-common-2fZ9zwIO.js";
...
import { i as resolveMatrixThreadRouting, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-CpkSvoWH.js";
...
function loadApprovalReactionAuth() {
	approvalReactionAuthPromise ??= import("./approval-reaction-auth-CP0COQ4i.js");
	return approvalReactionAuthPromise;
}
function loadExecApprovalResolver() {
	execApprovalResolverPromise ??= import("./exec-approval-resolver-DpmeEHZB.js");
