...
import { v as resolveAgentConfig } from "./agent-scope-5o1jve-2.js";
import { d as resolveGatewayMessageChannel } from "./message-channel-BZ78qqgM.js";
import { _ as PROCESS_TOOL_DISPLAY_SUMMARY, g as EXEC_TOOL_DISPLAY_SUMMARY, i as collectExplicitAllowlist, n as applyOwnerOnlyToolPolicy, o as mergeAlsoAllowPolicy, u as resolveToolProfilePolicy } from "./tool-policy-D994AhXf.js";
import { i as listChannelAgentTools, l as copyPluginToolMeta, t as copyChannelAgentToolMeta, u as getPluginToolMeta } from "./channel-tools-DJBTw8u5.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-BfMc3nWK.js";
import { n as normalizeToolParameters } from "./pi-tools.schema-DERW_M3Q.js";
import { c as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-BNlzd9MI.js";
import { t as bindAbortRelay } from "./fetch-timeout-6EAEfsz8.js";
import { a as createEnclawedReadTool, c as createSandboxedEditTool, d as wrapToolMemoryFlushAppendOnlyWrite, f as wrapToolWorkspaceRootGuard, l as createSandboxedReadTool, o as createHostWorkspaceEditTool, p as wrapToolWorkspaceRootGuardWithOptions, s as createHostWorkspaceWriteTool, t as createEnclawedTools, u as createSandboxedWriteTool } from "./enclawed-tools-BOX1dGI0.js";
import { s as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-C52866db.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-CwYbONan.js";
import { g as writeFileWithinRoot, o as mkdirPathWithinRoot, p as removePathWithinRoot } from "./fs-safe-C3irXap3.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-CJHRhKhJ.js";
import { n as assertSandboxPath } from "./sandbox-paths-AfYJvOXd.js";
import { a as resolveGroupToolPolicy, d as toRelativeSandboxPath, l as resolveWorkspaceRoot, r as resolveEffectiveToolPolicy, s as resolveSubagentToolPolicyForSession, u as resolvePathFromInput } from "./read-capability-P7UkKFgm.js";
...
import { t as isToolAllowedByPolicies } from "./tool-policy-match-BLA48GX4.js";
import { i as resolveToolFsConfig, t as createToolFsPolicy } from "./tool-fs-policy-DADdFRh7.js";
...
function createLazyExecTool(defaults) {
	...
	const loadTool = async () => {
		if (!loadedTool) {
			const { createExecTool } = await import("./bash-tools-DlYw7pLc.js");
...
function createLazyProcessTool(defaults) {
	...
	const loadTool = async () => {
		if (!loadedTool) {
			const { createProcessTool } = await import("./bash-tools-DlYw7pLc.js");
