...
import { _ as safeParseJson } from "./utils-CrVQlOZJ.js";
import { i as getRuntimeConfig } from "./io-gK4mTn0s.js";
import { nn as ErrorCodes, rn as errorShape } from "./protocol-CAcA9P3Z.js";
import { c as jsonResult, h as readStringParam, s as imageResultFromFile } from "./common-BLKrO58o.js";
import { t as callGatewayTool } from "./gateway-MCF4vbZ5.js";
import { a as selectDefaultNodeFromList, i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-rgUSu_AO.js";
import { i as wrapExternalContent } from "./external-content-BG0h4WfB.js";
import "./text-runtime-Co0Dyh7P.js";
import { t as startLazyPluginServiceModule } from "./lazy-service-module-CwqYzolq.js";
import { n as respondUnavailableOnNodeInvokeError } from "./nodes.helpers-C2FK6MRe.js";
import { i as resolveNodeCommandAllowlist, n as isNodeCommandAllowed } from "./node-command-policy-BKwNXAY_.js";
import { t as BrowserToolSchema } from "./browser-tool.schema-C9ZbZLkT.js";
import { t as withTimeout } from "./sdk-node-runtime-DKQHLw0l.js";
import "./sdk-security-runtime-BkkG6lzP.js";
import { D as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./cdp.helpers-DZMnXnxy.js";
import "./control-auth-CNgUvKUj.js";
import { c as resolveExistingPathsWithinRoot, i as resolveProfile, n as resolveBrowserConfig, s as DEFAULT_UPLOAD_DIR } from "./config-DyQGXjQ7.js";
import "./sdk-setup-tools-jKpBoJXs.js";
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-B1T86TGX.js";
import { c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as isPersistentBrowserProfileMutation, l as browserAct, n as persistBrowserProxyFiles, o as resolveRequestedBrowserProfile, p as browserScreenshotAction, s as browserConsoleMessages, t as applyBrowserProxyPaths, u as browserArmDialog } from "./browser-runtime-xUMmaQwO.js";
import { r as getBrowserProfileCapabilities } from "./target-id-DCq4gnFS.js";
import { r as createBrowserRouteDispatcher, t as startBrowserControlServiceFromConfig } from "./control-service-B2hE1eoi.js";
import { n as createBrowserControlContext } from "./plugin-enabled-Bk0OerCI.js";
import "./core-api-BSC8Lw9h.js";
...
function resolveBrowserBaseUrl(params) {
	...
	if (!resolved.enabled) throw new Error("Browser control is disabled. Set browser.enabled=true in ~/.enclawed/enclawed.json.");
}
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-ad29YOEZ.js"),
