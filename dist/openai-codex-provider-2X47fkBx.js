...
import { r as ensureAuthProfileStoreForLocalUpdate } from "./store-J7Io5AUg.js";
import { i as normalizeModelCompat } from "./provider-model-compat-BTKr4bsR.js";
import { n as listProfilesForProvider } from "./profiles-FX5Xo3iA.js";
import { d as cloneFirstTemplateModel, f as matchesExactOrPrefix } from "./provider-model-shared-CbMZtQ7U.js";
import "./error-runtime-BGM6tzrQ.js";
import { t as buildOauthProviderAuthResult } from "./provider-auth-result-CwnFjqLo.js";
import "./provider-auth-DUo6yqBv.js";
import "./text-runtime-DwWuUy-T.js";
import { n as loginOpenAICodexOAuth } from "./provider-auth-login-lTV8Kkfq.js";
import { s as findCatalogTemplate } from "./provider-catalog-shared-D6TyqH8i.js";
import { i as fetchCodexUsage } from "./provider-usage-BtFYfTal.js";
import { i as isOpenAICodexBaseUrl, r as isOpenAIApiBaseUrl, t as OPENAI_CODEX_RESPONSES_BASE_URL } from "./base-url-DUMlcIPp.js";
import { t as OPENAI_CODEX_DEFAULT_MODEL } from "./default-models-DAaVMhHf.js";
import { n as buildOpenAISyntheticCatalogEntry, t as buildOpenAIResponsesProviderHooks } from "./shared-BpPK_eq1.js";
import { a as OPENAI_CODEX_LOGIN_HINT, i as OPENAI_CODEX_DEVICE_PAIRING_LABEL, o as OPENAI_CODEX_LOGIN_LABEL, r as OPENAI_CODEX_DEVICE_PAIRING_HINT, s as OPENAI_CODEX_WIZARD_GROUP } from "./auth-choice-copy-CFd7ll4o.js";
import { n as resolveCodexAuthIdentity } from "./openai-codex-auth-identity-Cgd2ZXuI.js";
import { t as buildOpenAICodexProvider } from "./openai-codex-catalog-DW51ESzW.js";
import { t as loginOpenAICodexDeviceCode } from "./openai-codex-device-code-CobVrl4b.js";
import { t as resolveOpenAICodexThinkingProfile } from "./thinking-policy-CdunPkIZ.js";
...
async function runOpenAICodexDeviceCode(ctx) {
	...
	try {
		...
		await ctx.prompter.note("Trouble with device code login? See https://docs.enclawed.ai/start/faq", "OAuth help");
		throw error;
	}
}
