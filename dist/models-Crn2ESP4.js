...
import { y as shortenHomePath } from "./utils-BcQ7uNrT.js";
import { r as writeRuntimeJson } from "./runtime-DVd7lkz0.js";
import { n as isRich$1, r as theme, t as colorize } from "./theme-BVnTyzuE.js";
...
import { i as getRuntimeConfig, p as readSourceConfigSnapshotForWrite, r as createConfigIO } from "./io-Dzvn-wpi.js";
...
import { o as shouldEnableShellEnvFallback, t as getShellEnvAppliedKeys } from "./shell-env-Bb4wWnVF.js";
import { f as setRuntimeConfigSnapshot } from "./runtime-snapshot-CZqO77WE.js";
import { n as resolveAgentModelPrimaryValue, r as toAgentModelListLike, t as resolveAgentModelFallbackValues } from "./model-input-fnfl6j7e.js";
import { _ as resolveDefaultAgentWorkspaceDir } from "./workspace-dcdTJd2I.js";
import { S as resolveDefaultAgentId, b as resolveAgentDir, i as resolveAgentExplicitModelPrimary, s as resolveAgentModelFallbacksOverride, x as resolveAgentWorkspaceDir } from "./agent-scope-5o1jve-2.js";
import { t as parseDurationMs } from "./parse-duration-HsxmkmJ-.js";
import "./config-DOKACpaG.js";
import { c as resolveAuthStatePathForDisplay, u as resolveAuthStorePathForDisplay } from "./source-check-WHC0RF1m.js";
import { a as loadAuthProfileStoreForRuntime, n as ensureAuthProfileStore } from "./store-J7Io5AUg.js";
...
import { _ as resolveProviderEnvApiKeyCandidates, u as isNonSecretApiKeyMarker } from "./model-auth-markers-CZACM95M.js";
import { f as modelKey, m as parseModelRef, t as isCliProvider } from "./model-selection-cli-DrzfE0gz.js";
import { t as modelKey$1 } from "./model-ref-shared-BF3XvjlY.js";
import { d as resolveConfiguredModelRef, f as resolveDefaultModelForAgent, i as buildModelAliasIndex, m as resolveModelRefFromString } from "./model-selection-3QcDboLc.js";
import { t as resolveEnvApiKey } from "./model-auth-env-Pl4G28Oj.js";
import { n as resolveAwsSdkEnvVarName } from "./model-auth-runtime-shared-BteMUm-N.js";
...
import { t as resolveAuthProfileDisplayLabel } from "./auth-profiles-CWIWzE4_.js";
import { a as setAuthProfileOrder, n as listProfilesForProvider, o as upsertAuthProfile } from "./profiles-FX5Xo3iA.js";
import { d as resolveProfileUnusableUntilForDisplay, i as clearAuthProfileCooldown } from "./order-B81rwr6N.js";
import { i as getCustomProviderApiKey, l as resolveUsableCustomProviderApiKey, o as hasUsableCustomProviderApiKey, s as resolveApiKeyForProvider } from "./model-auth-CEwjo3Cm.js";
import "./command-secret-gateway-DhBMjDV3.js";
import { r as getModelsCommandSecretTargetIds } from "./command-secret-targets-D-Xq2bfy.js";
import { n as shouldSuppressBuiltInModel } from "./model-suppression-C64bNxSc.js";
import { r as resolveModelWithRegistry } from "./model-CuUEmEan.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-BrK8Zwld.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-BvfOtjb_.js";
import { r as withProgressTotals } from "./progress-DZ7JU7SC.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-CPWYQlir.js";
import { t as createClackPrompter } from "./clack-prompter-TewPG3xu.js";
import { n as logConfigUpdated } from "./logging-YqCQnNxV.js";
import { t as normalizeAlias } from "./alias-name-B9f1GgP3.js";
import { a as loadValidConfigOrThrow, c as resolveModelKeysFromEntries, d as upsertCanonicalModelConfigEntry, f as isLocalBaseUrl, i as formatTokenK, l as resolveModelTarget, n as ensureFlagCompatibility, o as mergePrimaryFallbackConfig, r as formatMs, s as resolveKnownAgentId, t as applyDefaultModelPrimaryUpdate, u as updateConfig } from "./shared-B1-_wHzJ.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-DkCz9DT0.js";
import { t as maskApiKey } from "./mask-api-key-DT31oCWk.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-D26pXIXY.js";
import { t as isRemoteEnvironment } from "./remote-env-DP3iI2Yg.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-Cu-YTWt3.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-Cdde0T4X.js";
import "./list.runtime-DgwO3zKO.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-D61rF9cP.js";
...
function resolveRequestedProviderOrThrow(providers, rawProvider) {
	...
	throw new Error(`Unknown provider "${requested}". Loaded providers: ${availableText}. Verify plugins via \`${formatCliCommand("enclawed plugins list --json")}\`.`);
}
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-C6uRY72v.js");
				await openUrl(url);
			},
...
async function modelsAuthSetupTokenCommand(opts, runtime) {
	...
	if (tokenProviders.length === 0) throw new Error(`No provider token-auth plugins found. Install one via \`${formatCliCommand("enclawed plugins install")}\`.`);
...
function maybeLogOpenAICodexNativeSearchTip(runtime, providerId) {
	...
	runtime.log("Tip: Codex-capable models can use native Codex web search. Enable it with enclawed configure --section web (recommended mode: cached). Docs: https://docs.enclawed.ai/tools/web");
}
async function modelsAuthLoginCommand(opts, runtime) {
	...
	if (authProviders.length === 0) throw new Error(`No provider plugins found. Install one via \`${formatCliCommand("enclawed plugins install")}\`.`);
...
function toModelRow$1(params) {
	...
	const modelIsAvailable = availableKeys?.has(modelKey$1(model.provider, model.id)) ?? false;
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore, ensureEnclawedModelsJson } = await import("./list.runtime-B-sfukRm.js");
...
function loadProviderUsageRuntime() {
	providerUsageRuntimePromise ??= import("./provider-usage-BJHnZGRL.js");
...
async function modelsStatusCommand(opts, runtime) {
	...
	let probeSummary;
	if (opts.probe) {
		const [{ withProgressTotals }, { runAuthProbes }] = await Promise.all([import("./progress-Bd29CXaE.js"), import("./list.probe-BQbb0k1i.js")]);
	...
	if (missingProvidersInUse.length > 0) {
		const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-NFKUaWBM.js");
		runtime.log("");
	...
	if (probeSummary) {
		const [{ getTerminalTableWidth, renderTable }, { describeProbeSummary, formatProbeLatency, sortProbeResults }] = await Promise.all([import("./table-8kI648bB.js"), import("./list.probe-BQbb0k1i.js")]);
		runtime.log("");
...
const BASE_IMAGE_PNG = "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNwcAAAAMMAgUx79QEAAAAASUVORK5CYII=";
const TOOL_PING = {
	name: "ping",
