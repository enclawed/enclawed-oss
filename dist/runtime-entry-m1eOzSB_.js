...
import { C as resolveRealtimeVoiceAgentConsultTools, f as consultRealtimeVoiceAgent, m as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, t as convertPcmToMulaw8k, w as resolveRealtimeVoiceAgentConsultToolsAllow, x as parseRealtimeVoiceAgentConsultArgs } from "./realtime-voice-FXb7Rae_.js";
import { t as resolveConfiguredCapabilityProvider } from "./provider-selection-runtime-B0ys7F6d.js";
import { n as getActiveMemorySearchManager } from "./memory-host-search-CA1D58lk.js";
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-DNwhOQWV.js";
import "./webhook-ingress-B3JS-8GF.js";
import { t as zod_exports } from "./zod-BjTCjsWs.js";
import "./api-B64cynRD.js";
import { a as validateProviderConfig, i as resolveVoiceCallConfig, n as normalizeVoiceCallConfig, o as deepMergeDefined, r as resolveTwilioAuthToken } from "./config-Dy74H6Z3.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-CZ-gcT5x.js";
import { t as resolveVoiceResponseModel } from "./response-model-DocghPXT.js";
import { t as isProviderStatusTerminal } from "./call-status-Dr9cvoJs.js";
import { t as getHeader } from "./http-headers-DuNmZR7i.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-7Wwtx9iu.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-CbJhyzVZ.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-DhoYnhbs.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-DKwRqx1-.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-Ccx9VlvD.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-CBTLrm-E.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-BxpZdpMF.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-DCfZvonk.js");
