...
import { i as loadAuthProfileStore } from "./store-D3mjjSwW.js";
import "./plugins-aoBJbOTG.js";
import "./logging-0C4iM3er.js";
import { c as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-DJhkseDv.js";
import "./auth-profiles-CyL93P03.js";
import { r as callGateway } from "./call-DtxbZweG.js";
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-BhK2K9pt.js";
...
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-4QaeDWq0.js";
import { n as withProgress } from "./progress-CDY9v3hd.js";
import { t as createClackPrompter } from "./clack-prompter-7FBHiOy4.js";
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-BY0sxg0K.js";
import { n as formatUsageReportLines, t as loadProviderUsageSummary } from "./provider-usage-CwSudbOe.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-D73gihNw.js";
import { n as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-Ds95BV5S.js";
import { t as parseLogLine } from "./parse-log-line-z5aX-fy5.js";
import { r as describeBinding, t as applyAgentBindings } from "./agents.bindings-BIKowARB.js";
import { n as requireValidConfigSnapshot, t as requireValidConfigFileSnapshot } from "./config-validation-CRtxGi4h.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-C0Yz10Az.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-CNTpHLTS.js";
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	const { listChannelPluginCatalogEntries } = await import("./catalog-B4gyy7v4.js");
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-DJvCyVAU.js"), import("./onboard-channels-u5unK06-.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-BzFrgo2Z.js");
	...
	if (!channel && catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-Clb_AGy-.js");
		if (!isCatalogChannelInstalled({
			cfg: nextConfig,
			entry: catalogEntry,
			workspaceDir
		})) {
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-BzFrgo2Z.js");
			const prompter = createClackPrompter();
	...
	if (afterAccountConfigWritten) {
		const { runCollectedChannelOnboardingPostWriteHooks } = await import("./onboard-channels-u5unK06-.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = !useWizard && rawChannel && (!channel || !getChannelPlugin(channel)) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-BpraXd5Q.js");
