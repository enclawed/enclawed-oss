...
import { f as resolveRunModelFallbacksOverride, p as resolveSessionAgentId, t as hasConfiguredModelFallbacks } from "./agent-scope-D-lQQ64_.js";
...
import { t as isCliProvider } from "./model-selection-cli-CsqB1sDP.js";
...
import { S as resolveGroupSessionKey, o as updateSessionStore, s as updateSessionStoreEntry } from "./store-BojxuYyw.js";
...
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-BzIB3P-3.js";
...
import { M as readPostCompactionContext, k as estimateMessagesTokens } from "./model-context-tokens-Cb0F5AZ3.js";
import { n as isDiagnosticsEnabled, t as emitDiagnosticEvent } from "./diagnostic-events-DPcyBAFM.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-AW6crC7V.js";
...
import { a as isLikelyExecutionAckPrompt, t as runEmbeddedPiAgent } from "./pi-embedded-runner-D0f2iyPl.js";
...
import { n as resolveSandboxConfigForAgent } from "./config-DW2vjdts.js";
...
import { g as isTransientHttpError, l as isCompactionFailureError, p as isLikelyContextOverflowError, u as isContextOverflowError } from "./errors-C0XxPilZ.js";
import "./pi-embedded-helpers-Ba-zbzdj.js";
import { c as resolveModelAuthMode } from "./model-auth-m8tj01Sr.js";
...
import { i as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-BK-XDhue.js";
import { a as generateSecureUuid } from "./secure-random-CoURpmDF.js";
import { i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-DLCmY7SY.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-DpSyw8e8.js";
import { n as filterMessagingToolMediaDuplicates, r as shouldSuppressMessagingToolReplies, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-BkQWKhOL.js";
import { i as enqueueSystemEvent } from "./system-events-AQjBSiiK.js";
import { o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession } from "./queue-B9HfGcW9.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-DrEoYBRS.js";
import { h as replyRunRegistry, m as createReplyOperation, p as ReplyRunAlreadyActiveError, s as queueEmbeddedPiMessage } from "./runs-BK6SAvHE.js";
import "./sandbox-B3AYL5AZ.js";
import "./pi-embedded-D4WhD7CB.js";
import { n as resolveCronStorePath, t as loadCronStore } from "./store-BvC3LWa7.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-6V_zmbY8.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-B8XTJi_L.js";
import { r as resolveActiveRunQueueAction, t as createTypingSignaler } from "./typing-mode-CGEKVczQ.js";
import { t as runCliAgent } from "./cli-runner-Dta7QPXY.js";
import { n as getCliSessionBinding, o as setCliSessionBinding, s as setCliSessionId } from "./cli-session-HDa_Noxh.js";
import { t as formatProviderModelRef } from "./model-runtime-BMO-63-U.js";
import { a as resolveModelFallbackOptions, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyExecutionConfig, r as formatBunFetchSocketError, s as resolveQueuedReplyRuntimeConfig, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-CX-fk1vK.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-1vzMUExw.js";
import { t as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-DrRSTWEq.js";
...
async function compactEmbeddedPiSessionDefault(...args) {
	const { compactEmbeddedPiSession } = await import("./pi-embedded-CoQynI-g.js");
	return await compactEmbeddedPiSession(...args);
}
async function runEmbeddedPiAgentDefault(...args) {
	const { runEmbeddedPiAgent } = await import("./pi-embedded-CoQynI-g.js");
...
function loadReplyPayloadsDedupeRuntime() {
	replyPayloadsDedupeRuntimePromise ??= import("./reply-payloads-dedupe.runtime-BohgvgJo.js");
