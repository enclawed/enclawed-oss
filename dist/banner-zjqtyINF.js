import { M as hasRootVersionAlias } from "./logger-wuQoU2z2.js";
import { i as visibleWidth } from "./ansi-haTfqSzd.js";
...
function pickTagline(options = {}) {
	...
	const override = (options.env ?? process.env)?.ENCLAWED_TAGLINE_INDEX;
	if (override !== void 0) {
