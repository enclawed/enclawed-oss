...
import { o as createRealtimeVoiceBridgeSession, v as buildRealtimeVoiceAgentConsultWorkingResponse } from "./realtime-voice-DiVEA8Jz.js";
...
<Response>
  <Connect>
	...
	async executeToolCall(bridge, callId, bridgeCallId, name, args) {
		...
		if (handler && name === "enclawed_agent_consult" && bridge.bridge.supportsToolResultContinuation && !this.config.fastContext.enabled) bridge.submitToolResult(bridgeCallId, buildRealtimeVoiceAgentConsultWorkingResponse("caller"), { willContinue: true });
