...
import { p as resolveSessionAgentId } from "./agent-scope-5o1jve-2.js";
import { _ as hasGatewayClientCap, g as GATEWAY_CLIENT_NAMES, h as GATEWAY_CLIENT_MODES, n as isGatewayCliClient, o as isWebchatClient, p as GATEWAY_CLIENT_CAPS, u as normalizeMessageChannel } from "./message-channel-BZ78qqgM.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-DiqXDzpD.js";
import { _ as validateChatSendParams, g as validateChatInjectParams, h as validateChatHistoryParams, m as validateChatAbortParams, nn as ErrorCodes, rn as errorShape, t as formatValidationErrors } from "./protocol-G22L7yBL.js";
import { a as normalizeInputProvenance } from "./input-provenance-BiaaGm3T.js";
import { o as ADMIN_SCOPE } from "./method-scopes-BYgvEi9d.js";
import { x as resolveThinkingDefault } from "./model-selection-3QcDboLc.js";
import "./sessions-Dq3XJ_x5.js";
import { i as resolveSessionFilePath } from "./paths-CADYkZ1j.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-lxMn1Y_m.js";
import { a as loadSessionEntry, f as resolveSessionModelRef, l as resolveGatewayModelSupportsImages } from "./session-utils-BHb7olSM.js";
import { c as stripEnvelopeFromMessages, i as readSessionMessages, l as jsonUtf8Bytes, n as capArrayByJsonBytes, s as stripEnvelopeFromMessage, t as attachEnclawedTranscriptMeta } from "./session-utils.fs-Bz4LmaEr.js";
import { o as parseAssistantTextSignature, s as resolveAssistantMessagePhase } from "./chat-message-content-CcFUU_mI.js";
import { i as stripInlineDirectiveTagsFromMessageForDisplay, r as stripInlineDirectiveTagsForDisplay } from "./directive-tags-B8g3zt37.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-QEVVv3to.js";
import { a as isSilentReplyText, n as SILENT_REPLY_TOKEN } from "./tokens-pnu38gX0.js";
...
import { a as safeFileURLToPath, t as assertNoWindowsNetworkPath } from "./local-file-access-BqYOmV4w.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-HJUX4WNh.js";
import { l as saveMediaBuffer } from "./store-C1zvYuUA.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-Cp7X1OvG.js";
import { t as resolveAgentTimeoutMs } from "./timeout-CZTBoioj.js";
import { t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-BLt_Z1Fd.js";
...
import { i as createReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-D2lB3lT5.js";
import { n as formatZonedTimestamp } from "./format-datetime-DA1RyRtL.js";
...
import { t as formatForLog } from "./ws-log-CbpCZ_44.js";
...
function parseClaudeCliHistoryEntry(entry, cliSessionId, toolNameRegistry) {
	...
	if (type === "user") return attachEnclawedTranscriptMeta({
		role: "user",
		content,
...
function resolveImportedExternalId(message) {
	if (!message || typeof message !== "object") return;
	return normalizeOptionalString(("__enclawed" in message && message.__enclawed && typeof message.__enclawed === "object" ? message.__enclawed ?? {} : void 0)?.externalId);
}
...
function appendInjectedAssistantMessageToTranscript(params) {
	...
	const messageBody = {
		...
		...params.abortMeta ? { enclawedAbort: {
			aborted: true,
