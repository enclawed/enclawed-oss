...
import { i as isUsageCountedSessionTranscriptFileName } from "./artifacts-CxM5l-NG.js";
...
import "./query-expansion-CM44xUgG.js";
import { o as hashText } from "./internal-eXimu566.js";
...
function isDreamingNarrativeBootstrapRecord(record) {
	...
	if (candidate.type !== "custom" || candidate.customType !== "enclawed:bootstrap-context:full" || !candidate.data || typeof candidate.data !== "object" || Array.isArray(candidate.data)) return false;
