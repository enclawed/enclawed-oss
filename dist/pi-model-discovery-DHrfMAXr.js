...
import { r as getPluginRegistryState } from "./runtime-state-DyaFyteI.js";
import { n as ensureAuthProfileStore } from "./store-J7Io5AUg.js";
import { P as resolveProviderSyntheticAuthWithPlugin, _ as normalizeProviderResolvedModelWithPlugin, a as applyProviderResolvedTransportWithPlugin, i as applyProviderResolvedModelCompatWithPlugins } from "./provider-runtime-DB4wLsLH.js";
import { _ as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-CZACM95M.js";
...
function createEnclawedModelRegistry(authStorage, modelsJsonPath, agentDir) {
...
function scrubLegacyStaticAuthJsonEntriesForDiscovery(pathname) {
	if (process.env.ENCLAWED_AUTH_STORE_READONLY === "1") return;
