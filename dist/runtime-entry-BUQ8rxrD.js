...
import { c as isBlockedHostnameOrIp } from "./ssrf-DQDx1s1G.js";
...
import { C as resolveRealtimeVoiceAgentConsultTools, f as consultRealtimeVoiceAgent, m as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, t as convertPcmToMulaw8k, w as resolveRealtimeVoiceAgentConsultToolsAllow, x as parseRealtimeVoiceAgentConsultArgs } from "./realtime-voice-BQu7Xl4_.js";
import { t as resolveConfiguredCapabilityProvider } from "./provider-selection-runtime-BlanjEm8.js";
import { n as getActiveMemorySearchManager } from "./memory-host-search-CfHTNI6t.js";
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-BYfyt29F.js";
import "./webhook-ingress-BF2faJ_O.js";
import { t as zod_exports } from "./zod-D31fSMXP.js";
import "./api-CNKUeQPG.js";
import { a as validateProviderConfig, i as resolveVoiceCallConfig, n as normalizeVoiceCallConfig, o as deepMergeDefined, r as resolveTwilioAuthToken } from "./config-DNrZZT-Q.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-BzVUKXPg.js";
import { t as resolveVoiceResponseModel } from "./response-model-DsbWd3R3.js";
import { t as isProviderStatusTerminal } from "./call-status-0I2aPFVv.js";
import { t as getHeader } from "./http-headers-CplfzlUJ.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-WEQbo5Ha.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-C2zQ4GTK.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-Dg16u8B6.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-oG71IFQN.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-DBy9HS6H.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-C_epTdZZ.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-CnvfDrgG.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-CGnpfsx2.js");
