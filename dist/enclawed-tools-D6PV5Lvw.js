...
import { S as truncateUtf16Safe, g as resolveUserPath, l as isRecord } from "./utils-CrVQlOZJ.js";
...
import { t as logDebug } from "./logger-D4q1iOk_.js";
import { a as loadConfig, h as resolveConfigSnapshotHash, o as parseConfigJson5 } from "./io-CXz21W7w.js";
import { n as resolveManifestContractOwnerPluginId } from "./manifest-registry-DwVSF2gb.js";
...
import { o as normalizeChannelId } from "./registry-DWJO7iQk.js";
import { i as normalizeChannelId$1, r as listChannelPlugins, t as getChannelPlugin } from "./registry-DMBHPRsB.js";
...
import { m as resolveSessionAgentIds, p as resolveSessionAgentId, r as resolveAgentExecutionContract, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-n27Qvudk.js";
...
import { h as GATEWAY_CLIENT_MODES, m as GATEWAY_CLIENT_IDS, u as normalizeMessageChannel } from "./message-channel-eZXacO7t.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-BmmOta3N.js";
import "./plugins-iuTgQA7g.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-BdkzPi5k.js";
import { t as ensureEnclawedModelsJson } from "./models-config-BhHAPY79.js";
import { f as modelKey, p as normalizeModelRef } from "./model-selection-cli-BC0OF3q6.js";
import { f as resolveDefaultModelForAgent, i as buildModelAliasIndex, m as resolveModelRefFromString, t as buildAllowedModelSet } from "./model-selection-CRPDotcW.js";
...
import { a as discoverModels, i as discoverAuthStorage } from "./pi-model-discovery-DcwVT9sq.js";
import { o as updateSessionStore } from "./store-CJURmbu1.js";
import { t as extractDeliveryInfo } from "./sessions-DczeBbOf.js";
...
import { n as resolveSessionConversationRef } from "./session-conversation-BkJIgAqh.js";
import "./delivery-context-BmkIGEsr.js";
import { d as resolveSessionModelIdentityRef } from "./session-utils-DWioyTyn.js";
import { l as jsonUtf8Bytes, n as capArrayByJsonBytes } from "./session-utils.fs-D4KXI-63.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-DEyoRqN5.js";
...
import { a as listChannelSupportedActions, d as resolvePluginTools, r as listAllChannelSupportedActions } from "./channel-tools-Bwrv83Qx.js";
import { w as textToSpeech } from "./tts-runtime-CVM3Iyzy.js";
import "./tts-TFBdqpqk.js";
import { a as getImageMetadata } from "./image-ops-BnZlPl2P.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-in97HBKp.js";
import { a as resolveChannelMessageToolSchemaProperties, n as channelSupportsMessageCapabilityForChannel, t as channelSupportsMessageCapability } from "./message-action-discovery-CRt1rORA.js";
import { r as getApiKeyForModel } from "./model-auth-C20TpuWJ.js";
import { t as SsrFBlockedError } from "./ssrf-DQDx1s1G.js";
import { u as parseReplyDirectives } from "./deliver-BtvrfctW.js";
import { n as runWithImageModelFallback } from "./model-fallback-DOn2mqGh.js";
...
import { t as extractAssistantText } from "./pi-embedded-utils-C_4onw9i.js";
import { r as callGateway } from "./call-CmVOwPMM.js";
import { c as jsonResult, d as readNumberParam, h as readStringParam$1, o as imageResult, p as readStringArrayParam, r as ToolInputError, y as readSnakeCaseParamRaw } from "./common-BLKrO58o.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-D2dPhCzX.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-D-Jjh4zb.js";
...
import { c as normalizeWorkspaceDir, f as toRelativeWorkspacePath, l as resolveWorkspaceRoot } from "./read-capability-D9UGKfXa.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata } from "./runtime-D715rRBR.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-BsThNkgD.js";
import { a as createSessionVisibilityGuard, c as resolveDisplaySessionKey, d as resolveSessionReference, f as resolveVisibleSessionReference, i as createAgentToAgentPolicy, l as resolveInternalSessionKey, n as deriveChannel, o as resolveEffectiveSessionToolsVisibility, p as shouldResolveSessionIdInput, r as resolveSessionToolContext, s as resolveSandboxedSessionToolContext, t as classifySessionKind, u as resolveMainSessionAlias } from "./sessions-helpers-DkIYIPx5.js";
import { r as stripToolMessages } from "./chat-history-text-BvO-6krC.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-CgAAsrWC.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-FJC2cHKk.js";
import { i as stringEnum, n as channelTargetsSchema, r as optionalStringEnum, t as channelTargetSchema } from "./typebox-CyALQwwQ.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-DlHKFuh7.js";
...
import { o as scheduleGatewaySigusr1Restart } from "./restart-DRkudGg0.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-mRClLwgy.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-RaIZUzQm.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-BwigKRwb.js";
import { l as saveMediaBuffer } from "./store-B5Pdc0kP.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-BRE-xKBd.js";
import { r as getDefaultLocalRoots } from "./local-media-access-uM06F7T5.js";
import { a as coerceImageModelConfig, c as resolveProviderVisionModelFromConfig, d as hasAuthForProvider, f as hasToolModelConfig, l as buildToolModelConfigFromCandidates, n as isMinimaxVlmProvider, o as decodeDataUrl, p as resolveDefaultModelRef, u as coerceToolModelConfig } from "./minimax-vlm-Bjk_HRrG.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-B8cjiGT0.js";
import { C as getMediaUnderstandingProvider, E as resolveBundledDefaultMediaModel, T as resolveBundledAutoMediaKeyProviders, b as resolveAutoMediaKeyProviders, w as bundledProviderSupportsNativePdfDocument, x as resolveDefaultMediaModel } from "./resolve-BGscZYCi.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-CKItejnh.js";
import { t as buildProviderRegistry } from "./runner-DS8XZbnp.js";
import "./media-understanding-Dr1BAcG5.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-BTnxwhYC.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-Bc23JeZV.js";
import { a as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-AiCLh2A8.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-DFmgzcYB.js";
import { t as sendMessage } from "./message-CSOaSOwJ.js";
import { n as resolveMusicGenerationModeCapabilities, t as listSupportedMusicGenerationModes } from "./capabilities-Drsbhnhp.js";
import { r as parseMusicGenerationModelRef } from "./provider-registry-BYq73ydj.js";
import { n as listRuntimeMusicGenerationProviders, t as generateMusic } from "./runtime-CTFP-ocs.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-DDEjuaaN.js";
...
import { a as createRunningTaskRun, c as recordTaskRunProgressByRunId, o as failTaskRunByRunId, r as completeTaskRunByRunId } from "./task-executor-gcTUn1m7.js";
import "./task-registry-delivery-runtime-C6-8zvtf.js";
import { t as formatAgentInternalEventsForPrompt } from "./internal-events-DBE5KFmH.js";
import { _ as REPLY_SKIP_TOKEN, b as deliverSubagentAnnouncement, d as registerSubagentRun, g as ANNOUNCE_SKIP_TOKEN, h as runAgentStep, v as isAnnounceSkip, y as isReplySkip } from "./subagent-registry-DOmyesbV.js";
...
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-DYMwUqD0.js";
import { t as AGENT_LANE_NESTED } from "./lanes-e7slEYtV.js";
import { i as waitForAgentRunAndReadUpdatedAssistantReply, n as readLatestAssistantReplySnapshot, r as waitForAgentRun, t as readLatestAssistantReply } from "./run-wait-D9ooJ6XB.js";
import { n as SUBAGENT_SPAWN_MODES, t as spawnSubagentDirect } from "./subagent-spawn-BhEH2Oeg.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-CqT0nMsd.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-DzNAjOrj.js";
...
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-rB5ax6BL.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-BG0h4WfB.js";
import { a as runWebSearch, i as resolveWebSearchDefinition, l as resolveWebProviderConfig } from "./runtime-bOZgZCgd.js";
import { r as resolveWebFetchDefinition } from "./runtime-CQ2Bvfe_.js";
...
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds, u as fetchWithWebToolsNetworkGuard } from "./web-shared-BtcCsXIK.js";
import "./web-search-provider-common-BdQJOJl3.js";
...
function loadCommandsStatusRuntime() {
	commandsStatusRuntimePromise ??= import("./session-status.runtime-VKDkRB4d.js");
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-B30l_Ota.js");
...
async function loadAcpSpawnModule() {
	acpSpawnModulePromise ??= import("./acp-spawn-B5AVVFCE.js");
