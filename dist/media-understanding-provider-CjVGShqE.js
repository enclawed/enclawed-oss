...
import { r as readModelListResult } from "./models-9yv4jJnM.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-CNf9qig8.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
