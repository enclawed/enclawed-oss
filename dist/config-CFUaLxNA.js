...
import { d as ssrfPolicyFromDangerouslyAllowPrivateNetwork, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-ZujUx1uT.js";
import "./ssrf-runtime-DqMve8F8.js";
import "./retry-runtime-BUIxmcPL.js";
import "./secret-input-runtime-DkJGN4LC.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-BKqZoheG.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-DhD-Fc2c.js";
...
import { t as resolveMatrixConfigFieldPath } from "./config-paths-BIZiSGkg.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-BWedr5IE.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-CJYaFWXR.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-BFdGoUw1.js"), import("./logging-q1E45-_c.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-C4mQ_8Jr.js").then((credentialsReadModule) => ({
...
async function loadMatrixCredentialsWriteRuntime() {
	matrixCredentialsWriteRuntimePromise ??= import("./credentials-write.runtime-H8Z8Xp9P.js");
	return await matrixCredentialsWriteRuntimePromise;
}
async function loadMatrixSecretInputDeps() {
	matrixSecretInputDepsPromise ??= import("./config-secret-input.runtime-GDI7NWJt.js").then((runtime) => ({ resolveConfiguredSecretInputString: runtime.resolveConfiguredSecretInputString }));
