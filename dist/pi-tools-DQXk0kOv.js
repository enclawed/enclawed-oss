...
import { v as resolveAgentConfig } from "./agent-scope-n27Qvudk.js";
import { d as resolveGatewayMessageChannel } from "./message-channel-eZXacO7t.js";
...
import { i as listChannelAgentTools, l as copyPluginToolMeta, t as copyChannelAgentToolMeta, u as getPluginToolMeta } from "./channel-tools-CUMxi4EB.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-in97HBKp.js";
import { n as normalizeToolParameters } from "./pi-tools.schema-Caeg_pkt.js";
import { c as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-DzcGXGbw.js";
import { t as bindAbortRelay } from "./fetch-timeout-CX15k_ki.js";
import { a as createEnclawedReadTool, c as createSandboxedEditTool, d as wrapToolMemoryFlushAppendOnlyWrite, f as wrapToolWorkspaceRootGuard, l as createSandboxedReadTool, o as createHostWorkspaceEditTool, p as wrapToolWorkspaceRootGuardWithOptions, s as createHostWorkspaceWriteTool, t as createEnclawedTools, u as createSandboxedWriteTool } from "./enclawed-tools-CjwQbk40.js";
import { a as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-sv5v0r0O.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-Ckl9uf2z.js";
import { g as writeFileWithinRoot, o as mkdirPathWithinRoot, p as removePathWithinRoot } from "./fs-safe-D-Jjh4zb.js";
...
import { a as resolveGroupToolPolicy, d as toRelativeSandboxPath, l as resolveWorkspaceRoot, r as resolveEffectiveToolPolicy, s as resolveSubagentToolPolicyForSession, u as resolvePathFromInput } from "./read-capability-BtBBWxnh.js";
...
import { i as resolveToolFsConfig, t as createToolFsPolicy } from "./tool-fs-policy-BB7ZAUAy.js";
...
function createLazyExecTool(defaults) {
	...
	const loadTool = async () => {
		if (!loadedTool) {
			const { createExecTool } = await import("./bash-tools-CDFSw_QM.js");
...
function createLazyProcessTool(defaults) {
	...
	const loadTool = async () => {
		if (!loadedTool) {
			const { createProcessTool } = await import("./bash-tools-CDFSw_QM.js");
