...
import { n as normalizeBundledPluginArtifactSubpath, t as PUBLIC_SURFACE_SOURCE_EXTENSIONS } from "./public-surface-runtime-DLFcJy5P.js";
...
import { a as normalizePluginsConfig, n as createPluginActivationSource, s as resolveEffectivePluginActivationState } from "./config-state-DPvzxDpF.js";
import { n as configMayNeedPluginAutoEnable, t as applyPluginAutoEnable } from "./plugin-auto-enable-DfzfHwyb.js";
...
function readBundledPluginManifestRecordFromDir(params) {
	const manifestPath = path.join(params.pluginsRoot, params.resolvedDirName, "enclawed.plugin.json");
