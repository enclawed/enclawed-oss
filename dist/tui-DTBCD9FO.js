...
import { i as visibleWidth, r as stripAnsi$1 } from "./ansi-haTfqSzd.js";
import { n as VERSION } from "./version-CeugVlbG.js";
import { t as assertExplicitGatewayAuthModeWhenBothConfigured } from "./auth-mode-policy-AUB01Xjb.js";
...
import { S as resolveDefaultAgentId, a as resolveAgentIdByWorkspacePath } from "./agent-scope-Bv7XD6OT.js";
import "./config-BDd-c7HD.js";
import { t as GatewayClient } from "./client-3iHbFEDf.js";
import { g as GATEWAY_CLIENT_NAMES, h as GATEWAY_CLIENT_MODES, p as GATEWAY_CLIENT_CAPS } from "./message-channel-CP7lSRvA.js";
import "./protocol-COkGKyb_.js";
import { f as resolveResponseUsageMode, u as normalizeUsageDisplay } from "./thinking.shared-DCWjwvfv.js";
import { r as formatTokenCount } from "./usage-format-DEmHsOwP.js";
import { r as extractAssistantVisibleText } from "./chat-message-content-C5zS33r4.js";
import { r as stripLeadingInboundMetadata } from "./strip-inbound-meta-B-t4NsiU.js";
import { n as formatRawAssistantErrorForUi } from "./assistant-error-format-CC5yyFEh.js";
import { n as listThinkingLevelLabels, t as formatThinkingLevels } from "./thinking-DyqDTQLE.js";
import { r as resolveToolDisplay, t as formatToolDetail } from "./tool-display-CGXI-iwe.js";
import { l as resolveExplicitGatewayAuth, n as buildGatewayConnectionDetails, s as ensureExplicitGatewayAuth } from "./call-DtxbZweG.js";
import { r as resolveSessionInfoModelSelection } from "./model-selection-display-CVF7k4OQ.js";
import { n as listChatCommands, r as listChatCommandsForConfig } from "./commands-registry-list-CirS-ylU.js";
import "./commands-registry-a349Kg0i.js";
import { n as formatTimeAgo, t as formatRelativeTimestamp } from "./format-relative-Bre6NxLl.js";
import { t as normalizeGroupActivation } from "./group-activation-CbofnQzN.js";
import { t as resolveGatewayInteractiveSurfaceAuth } from "./auth-surface-resolution-DMfyQSoP.js";
...
function resolveGatewayDisconnectState(reason) {
	...
	if (/pairing required/i.test(reasonLabel)) return {
		...
		pairingHint: "Pairing required. Run `enclawed devices list`, approve your request ID, then reconnect."
	};
	return {
		connectionStatus: `gateway disconnected: ${reasonLabel}`,
		activityStatus: "idle"
...
async function runTui(opts) {
	...
	const updateHeader = () => {
		...
		header.setText(theme.header(`enclawed tui - ${client.connection.url} - agent ${agentLabel} - session ${sessionLabel}`));
	};
