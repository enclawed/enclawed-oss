...
import { n as matrixReplaceConfigFile, r as readMatrixRuntimeConfig, t as getMatrixRuntime } from "./runtime-BVJsSV4n.js";
import { i as resolveMatrixAccount } from "./accounts-DtzyuWNQ.js";
import { t as formatMatrixErrorMessage } from "./errors-DTkJb8Y0.js";
import { n as resolveMatrixConfigPath } from "./config-paths-BIZiSGkg.js";
import { t as updateMatrixAccountConfig } from "./config-update-Dw0i9N0I.js";
import { n as matrixSetupAdapter } from "./setup-core-Cne0kbdi.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-L_Fn8LAC.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-CmI93FbW.js";
import { t as withResolvedActionClient } from "./client-BjFTIcY6.js";
import { r as resolveMatrixAuthContext } from "./config-CFUaLxNA.js";
import "./client-Dm3VJhrR.js";
import "./runtime-api-Cginkyp5.js";
import { n as summarizeMatrixDeviceHealth, t as isEnclawedManagedMatrixDevice } from "./device-health-Ccn47AY0.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-D7otNMll.js";
import { a as confirmMatrixVerificationSas, c as getMatrixRoomKeyBackupStatus, d as listMatrixVerifications, f as mismatchMatrixVerificationSas, g as runMatrixSelfVerification, h as restoreMatrixRoomKeyBackup, l as getMatrixVerificationSas, m as resetMatrixRoomKeyBackup, n as bootstrapMatrixVerification, p as requestMatrixVerification, r as cancelMatrixVerification, t as acceptMatrixVerification, u as getMatrixVerificationStatus, v as startMatrixVerification, y as verifyMatrixRecoveryKey } from "./verification-BKE0t9SO.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-D3tg2-PH.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-93jNZR5j.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-Ca9Y24mC.js");
