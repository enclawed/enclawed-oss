...
import { n as resolvePluginRegistryScopeForCommandPath, t as ensureCliPluginRegistryLoaded } from "./plugin-registry-loader-C_5oQh29.js";
//#region src/cli/command-bootstrap.ts
let configGuardModulePromise;
function loadConfigGuardModule() {
	configGuardModulePromise ??= import("./config-guard-ClNBeYjc.js");
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-DIp0GrmQ.js");
	if (params.argv) {
