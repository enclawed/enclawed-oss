...
import { a as loadConfig, u as readConfigFileSnapshotForWrite } from "./io-CXz21W7w.js";
...
import { i as LiveSessionModelSwitchError, r as runWithModelFallback } from "./model-fallback-DOn2mqGh.js";
...
import { r as resolveSession } from "./live-model-switch-pEh2yxeN.js";
import { n as resolveSendPolicy } from "./send-policy-N5H3BAXx.js";
import { t as clearSessionAuthProfileOverride } from "./session-override-CPTMDX_f.js";
import { n as applyVerboseOverride } from "./level-overrides-D73dgr0I.js";
import { n as prependInternalEventContext, t as persistSessionEntry$1 } from "./attempt-execution.shared-C6pwV4d8.js";
...
async function resolveAgentRuntimeConfig(runtime, params) {
	...
	}) ? (await (await import("./command-config-resolution.runtime-Wf0ZfrMd.js")).resolveCommandConfigWithSecrets({
		config: loadedRaw,
		commandName: "agent",
...
function loadAttemptExecutionRuntime() {
	attemptExecutionRuntimePromise ??= import("./attempt-execution.runtime-C9rjcoHO.js");
	return attemptExecutionRuntimePromise;
}
function loadAcpManagerRuntime() {
	acpManagerRuntimePromise ??= import("./manager-CsuNBXmm.js");
	return acpManagerRuntimePromise;
}
function loadAcpPolicyRuntime() {
	acpPolicyRuntimePromise ??= import("./policy-Ov0K5Llm.js");
	return acpPolicyRuntimePromise;
}
function loadAcpRuntimeErrorsRuntime() {
	acpRuntimeErrorsRuntimePromise ??= import("./errors-BUZaN44B.js");
	return acpRuntimeErrorsRuntimePromise;
}
function loadAcpSessionIdentifiersRuntime() {
	acpSessionIdentifiersRuntimePromise ??= import("./session-identifiers-9fI44Fbh.js");
	return acpSessionIdentifiersRuntimePromise;
}
function loadDeliveryRuntime() {
	deliveryRuntimePromise ??= import("./delivery.runtime-CNq2XFtx.js");
	return deliveryRuntimePromise;
}
function loadSessionStoreRuntime() {
	sessionStoreRuntimePromise ??= import("./session-store.runtime-cVgAKHqI.js");
	return sessionStoreRuntimePromise;
}
function loadTranscriptResolveRuntime() {
	transcriptResolveRuntimePromise ??= import("./transcript-resolve.runtime-CicvTK0j.js");
	return transcriptResolveRuntimePromise;
}
function loadCliDepsRuntime() {
	cliDepsRuntimePromise ??= import("./deps-BUKLAoU_.js");
	return cliDepsRuntimePromise;
}
function loadExecDefaultsRuntime() {
	execDefaultsRuntimePromise ??= import("./exec-defaults-5h067Sht.js");
