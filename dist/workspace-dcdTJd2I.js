...
function resolveDefaultAgentWorkspaceDir(env = process.env, homedir = os.homedir) {
	...
	if (profile && normalizeOptionalLowercaseString(profile) !== "default") return path.join(home, ".enclawed", `workspace-${profile}`);
...
//#endregion
export { resolveDefaultAgentWorkspaceDir as _, DEFAULT_IDENTITY_FILENAME as a, DEFAULT_SOUL_FILENAME as c, ensureAgentWorkspace as d, filterBootstrapFilesForSession as f, loadWorkspaceBootstrapFiles as g, loadExtraBootstrapFilesWithDiagnostics as h, DEFAULT_HEARTBEAT_FILENAME as i, DEFAULT_TOOLS_FILENAME as l, isWorkspaceSetupCompleted as m, DEFAULT_AGENT_WORKSPACE_DIR as n, DEFAULT_MEMORY_ALT_FILENAME as o, isWorkspaceBootstrapPending as p, DEFAULT_BOOTSTRAP_FILENAME as r, DEFAULT_MEMORY_FILENAME as s, DEFAULT_AGENTS_FILENAME as t, DEFAULT_USER_FILENAME as u, resolveWorkspaceBootstrapStatus as v, resolveWorkspaceTemplateDir as y };
