...
import { t as createGatewayCredentialPlan } from "./credential-planner-Cre55rWL.js";
import { u as secretRefKey } from "./ref-contract-UQhW34sh.js";
import "./shared-S-P3eT9D.js";
import { o as resolveSecretRefValues } from "./resolve-DVl7buUu.js";
import { n as getBootstrapChannelSecrets } from "./bootstrap-registry-Ba7OKrIO.js";
import { S as resolveDefaultAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-5o1jve-2.js";
import { a as normalizePluginsConfig, c as resolveEnableState } from "./config-state-DbwRF0HU.js";
import { o as collectPluginConfigContractMatches, s as resolvePluginConfigContractsById } from "./plugin-auto-enable-BE3SC6M5.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-USTwUAvA.js";
import { a as createLazyRuntimeSurface, i as createLazyRuntimeNamedExport } from "./lazy-runtime-CTKnZsG3.js";
import { n as resolvePluginCapabilityProviders } from "./capability-provider-runtime-CbBpFrnf.js";
import { n as resolveEffectiveMediaEntryCapabilities, r as normalizeMediaProviderId, t as resolveConfiguredMediaEntryCapabilities } from "./entry-capabilities-Ds57jqx7.js";
import { t as loadBundledChannelSecretContractApi } from "./channel-contract-api-BaDYXhAb.js";
import { c as pushInactiveSurfaceWarning, l as pushWarning, n as collectSecretInputAssignment } from "./runtime-shared-3E_O2lTV.js";
import { t as collectTtsApiKeyAssignments } from "./runtime-config-collectors-tts-CTKdRvDU.js";
import { o as sortWebFetchProvidersForAutoDetect, r as sortWebSearchProvidersForAutoDetect } from "./web-search-providers.shared-D6yoO1Ki.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts, r as resolveBundledExplicitWebFetchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-DiogHzjU.js";
...
const loadResolveManifestContractOwnerPluginId = createLazyRuntimeNamedExport(() => import("./runtime-web-tools-manifest.runtime-BrAdaWfi.js"), "resolveManifestContractOwnerPluginId");
...
const loadRuntimeWebToolsFallbackProviders = createLazyRuntimeSurface(() => import("./runtime-web-tools-fallback.runtime-D6TJb4cT.js"), ({ runtimeWebToolsFallbackProviders }) => runtimeWebToolsFallbackProviders);
const loadRuntimeWebToolsPublicArtifacts = createLazyRuntimeSurface(() => import("./runtime-web-tools-public-artifacts.runtime-Rf82R3Yw.js"), (mod) => mod);
const loadRuntimeWebToolsManifest = createLazyRuntimeSurface(() => import("./runtime-web-tools-manifest.runtime-BrAdaWfi.js"), (mod) => mod);
