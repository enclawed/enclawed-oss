...
import { s as sanitizeHostExecEnvWithDiagnostics } from "./host-env-security-CSPdLugP.js";
import { a as logWarn, r as logInfo } from "./logger-CKs2nJWp.js";
import { a as isSubagentSessionKey, i as isCronSessionKey, o as parseAgentSessionKey } from "./session-key-utils-Ce7cepnN.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-BOC5unB4.js";
import { i as resolveShellEnvFallbackTimeoutMs, n as getShellPathFromLoginShell } from "./shell-env-B4_eUMEy.js";
import { d as resolveApprovalAuditCandidatePath } from "./exec-safe-bin-trust-D84Sn_gf.js";
import { t as killProcessTree } from "./kill-tree-CVXDk07v.js";
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-CP7lSRvA.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-CIWKeEct.js";
import "./delivery-context-8cWU6POu.js";
import { _ as PROCESS_TOOL_DISPLAY_SUMMARY, g as EXEC_TOOL_DISPLAY_SUMMARY } from "./tool-policy-Bkov0fJO.js";
import { _ as isExecDeniedResultText, g as formatExecDeniedUserMessage, u as sanitizeUserFacingText, v as parseExecApprovalResultText } from "./sanitize-user-facing-text-DC3SMoyx.js";
import { _ as textResult, a as failedTextResult } from "./common-BMEsSwt3.js";
import { t as callGatewayTool } from "./gateway-u_c4UwFM.js";
import { t as splitShellArgs } from "./shell-argv-_wczschr.js";
import { c as describeInterpreterInlineEval, f as analyzeShellCommand, l as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, p as buildEnforcedShellCommand } from "./exec-approvals-allowlist-DnhLAGDd.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-Ckl9uf2z.js";
import { t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-DbL4T6oL.js";
...
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-CBpq7Et7.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-CkLqp1-r.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-DPEN7Eok.js";
...
import { A as listFinishedSessions, C as resolveWorkdir, D as drainSession, E as deleteSession, F as tail, I as applyPathPrepend, L as normalizePathPrepend, M as markBackgrounded, N as markExited, O as getFinishedSession, P as setJobTtlMs, S as resolveSandboxWorkdir, T as truncateMiddle, _ as clampWithDefault, a as DEFAULT_PENDING_MAX_OUTPUT, b as pad, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, g as buildSandboxEnv, i as DEFAULT_PATH, j as listRunningSessions, k as getSession, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput, v as coerceEnv, w as sliceLogLines, x as readEnvInt, y as deriveSessionName } from "./bash-tools.exec-runtime-5o7yzRPH.js";
import { t as getProcessSupervisor } from "./supervisor-CwAjgxu_.js";
import { f as resolveExecApprovalInitiatingSurfaceState, s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-CENdgjHe.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-Bml5oq59.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-CpoQuaBS.js";
