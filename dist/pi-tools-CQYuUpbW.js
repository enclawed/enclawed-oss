...
import { i as listChannelAgentTools, l as copyPluginToolMeta, t as copyChannelAgentToolMeta, u as getPluginToolMeta } from "./channel-tools-Bwrv83Qx.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-in97HBKp.js";
import { n as normalizeToolParameters } from "./pi-tools.schema-BxwgKTlP.js";
import { c as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-BEaASACt.js";
import { t as bindAbortRelay } from "./fetch-timeout-CX15k_ki.js";
import { a as createEnclawedReadTool, c as createSandboxedEditTool, d as wrapToolMemoryFlushAppendOnlyWrite, f as wrapToolWorkspaceRootGuard, l as createSandboxedReadTool, o as createHostWorkspaceEditTool, p as wrapToolWorkspaceRootGuardWithOptions, s as createHostWorkspaceWriteTool, t as createEnclawedTools, u as createSandboxedWriteTool } from "./enclawed-tools-D6PV5Lvw.js";
import { a as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-D5dNRogZ.js";
...
import { a as resolveGroupToolPolicy, d as toRelativeSandboxPath, l as resolveWorkspaceRoot, r as resolveEffectiveToolPolicy, s as resolveSubagentToolPolicyForSession, u as resolvePathFromInput } from "./read-capability-D9UGKfXa.js";
...
function createLazyExecTool(defaults) {
	...
	const loadTool = async () => {
		if (!loadedTool) {
			const { createExecTool } = await import("./bash-tools-DSetqZAk.js");
...
function createLazyProcessTool(defaults) {
	...
	const loadTool = async () => {
		if (!loadedTool) {
			const { createProcessTool } = await import("./bash-tools-DSetqZAk.js");
