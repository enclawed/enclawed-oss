...
import { a as resolveHookEntries, i as resolveHookEnableState, r as resolveHookConfig, t as isConfigPathTruthy } from "./config-CKRCE6Kt.js";
...
function normalizeInstallOptions(entry) {
	...
	return install.map((spec, index) => {
		...
		if (!label) if (spec.kind === "bundled") label = "Bundled with Enclawed";
