import { h as resolveHomeDir } from "./utils-BcQ7uNrT.js";
...
import { _ as resolveStateDir, h as resolveOAuthDir, i as isNixMode, o as resolveConfigPath, u as resolveGatewayPort } from "./paths-CDjhyzOH.js";
...
import { a as removeStateAndLinkedPaths, i as removePath, o as removeWorkspaceDirs, r as listAgentSessionDirs, t as buildCleanupPlan } from "./cleanup-utils-DKaVc4jp.js";
...
import { i as formatControlUiSshHint } from "./onboard-helpers-DnqWC8bO.js";
...
async function dashboardCommand(runtime = defaultRuntime, options = {}) {
	...
	if (resolvedToken.unresolvedRefReason) {
		...
		runtime.log("Set ENCLAWED_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `enclawed dashboard`.");
	}
	...
	if (opened) runtime.log("Opened in your browser. Keep that tab to control Enclawed.");
