...
import { i as createActionGate } from "./common-DthjNV6P.js";
...
import { T as projectConfigAccountIdWarningCollector, h as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-CdRqk-3-.js";
...
import { i as createChatChannelPlugin, l as stripChannelTargetPrefix, t as buildChannelOutboundSessionRoute } from "./core-DBv8LeUb.js";
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-DDpEhh55.js";
...
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-BuPxN_a9.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-B_1CRaRd.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, n as inspectFeishuCredentials, p as isRecord, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-DWjsn3FI.js";
import "./card-interaction-BbISmqq8.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-DYNVckgA.js";
import { t as messageActionTargetAliases } from "./security-audit-zFEpWpo9.js";
import { a as resolveFeishuGroupToolPolicy } from "./policy-DUstCGjv.js";
...
import { t as resolveFeishuSessionConversation } from "./session-conversation-sfkpZqG1.js";
...
async function runScanToCreate(prompter) {
	const { beginAppRegistration, initAppRegistration, pollAppRegistration, printQrCode } = await import("./app-registration-R00UtKjK.js");
	try {
...
async function runNewAppFlow(params) {
	...
	if (scanResult) {
		...
		if (appId && appSecretProbeValue) {
			const { getAppOwnerOpenId } = await import("./app-registration-R00UtKjK.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-BHk2eUyl.js"), "feishuChannelRuntime");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-C46FO0LA.js");
