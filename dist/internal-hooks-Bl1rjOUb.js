...
const handlers = resolveGlobalSingleton(Symbol.for("enclawed.internalHookHandlers"), () => /* @__PURE__ */ new Map());
const internalHooksEnabledState = resolveGlobalSingleton(Symbol.for("enclawed.internalHooksEnabled"), () => ({ enabled: true }));
