...
import { i as resolvePluginSourceRoots } from "./discovery-Yk6Slu1A.js";
...
import { i as uninstallPlugin, n as resolveUninstallChannelConfigKeys, r as resolveUninstallDirectoryTarget } from "./uninstall-sUMqZzW5.js";
import { n as setPluginEnabledInConfig, t as enablePluginInConfig } from "./enable-ChkuLfdb.js";
import { m as parseClawHubPluginSpec } from "./clawhub-DNe3XZ3z.js";
import { a as buildPluginInspectReport, i as buildPluginDiagnosticsReport, n as buildPluginCompatibilityNotices, o as buildPluginSnapshotReport, s as formatPluginCompatibilityNotice, t as buildAllPluginInspectReports } from "./status-CcPrdmqQ.js";
import { i as createPluginInstallLogger, l as logSlotWarnings, t as applySlotSelectionForPlugin } from "./plugins-command-helpers-DOaSggVM.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-Dg2KD-rV.js";
import { n as runPluginInstallCommand, t as runPluginUpdateCommand } from "./plugins-update-command-Bi6tRMBK.js";
import { i as listMarketplacePlugins } from "./update-DVutEihZ.js";
...
function registerPluginsCli(program) {
	const plugins = program.command("plugins").description("Manage Enclawed plugins and extensions").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/plugins", "docs.enclawed.ai/cli/plugins")}\n`);
	...
	plugins.command("doctor").description("Report plugin load issues").option("--json", "Print machine-readable JSON instead of styled lines").action((opts = {}) => {
