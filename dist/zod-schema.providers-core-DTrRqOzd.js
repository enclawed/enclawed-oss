...
import { C as SecretInputSchema, F as requireAllowlistAllowFrom, I as requireOpenAllowFrom, S as RetryConfigSchema, T as SecretRefSchema, a as DmConfigSchema, h as MarkdownConfigSchema, i as ContextVisibilityModeSchema, j as TtsConfigSchema, l as GroupPolicySchema, m as MSTeamsReplyStyleSchema, n as BlockStreamingCoalesceSchema, o as DmPolicySchema, s as ExecutableTokenSchema, t as BlockStreamingChunkSchema, u as HexColorSchema, v as ProviderCommandsSchema, x as ReplyToModeSchema } from "./zod-schema.core-Dg8HKj-q.js";
import { t as sensitive } from "./zod-schema.sensitive-MFr0aGHM.js";
import { c as ToolPolicySchema } from "./zod-schema.agent-runtime-CTza-mNi.js";
import { t as isSafeScpRemoteHost } from "./scp-host-C6b6bFna.js";
import { n as isValidInboundPathRootPattern } from "./inbound-path-policy-CeCCJ-QD.js";
import { a as resolveTelegramCustomCommands, i as normalizeTelegramCommandName, r as normalizeTelegramCommandDescription } from "./telegram-command-config-WkwOBfYh.js";
import { z } from "zod";
...
const TelegramAccountSchemaBase = z.object({
	...
	pollingStallThresholdMs: z.number().optional().describe("Long-polling stall watchdog threshold in ms. When no successful update fetch occurs within this window, Enclawed restarts the poll loop."),
...
const DiscordAccountSchema = z.object({
	...
	thread: z.object({ inheritParent: z.boolean().optional() }).strict().optional(),
	proxy: z.string().optional(),
