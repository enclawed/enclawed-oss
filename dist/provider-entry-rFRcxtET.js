...
import { t as definePluginEntry } from "./plugin-entry-BJj-1CHz.js";
import { o as buildSingleProviderApiKeyCatalog } from "./provider-catalog-shared-CVSPzI69.js";
		...
		register(api) {
			...
			if (provider) {
				...
				if ("run" in provider.catalog) {
					...
					if (buildStaticProvider) staticCatalog = {
						order: "simple",
