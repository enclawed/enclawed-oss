...
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute } from "./core-Cp6Nf0m-.js";
...
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-DkhpVqWx.js";
...
import { n as createChannelNativeOriginTargetResolver, t as createChannelApproverDmTargetResolver } from "./approval-native-helpers-DrW6NECE.js";
import "./approval-native-runtime-O3EEIifi.js";
import { o as resolveConfiguredFromRequiredCredentialStatuses, r as projectCredentialSnapshotFields } from "./account-snapshot-fields-gSVoZfus.js";
...
import "./param-readers-Bvgo3yuJ.js";
import { d as createDefaultChannelRuntimeState, u as createComputedAccountStatusAdapter } from "./status-helpers-BjB94cGc.js";
import { h as stringifyRouteThreadId, o as channelRouteTargetsMatchExact } from "./channel-route-DDGQjdxk.js";
import { a as resolveSlackAccount, i as resolveDefaultSlackAccountId, l as resolveSlackReplyToMode, n as listSlackAccountIds, o as resolveSlackAccountAllowFrom } from "./accounts-DhxAd-WQ.js";
...
import { a as normalizeSlackApproverId, c as shouldSuppressLocalSlackExecApprovalPrompt, i as isSlackExecApprovalClientEnabled, o as resolveSlackExecApprovalTarget, r as isSlackExecApprovalAuthorizedSender, s as shouldHandleSlackExecApprovalRequest, t as getSlackExecApprovalApprovers } from "./exec-approvals-Duj6rKHE.js";
import { n as buildSlackPresentationBlocks, r as resolveSlackInteractiveBlockOffsets, t as buildSlackInteractiveBlocks } from "./blocks-render-B_5CGqL6.js";
import { t as SLACK_TEXT_LIMIT } from "./limits-BoDX0g2L.js";
import { n as extractSlackToolSend, t as describeSlackMessageTool } from "./message-tool-api-D_c90X72.js";
import { n as isSlackInteractiveRepliesEnabled, t as compileSlackInteractiveReplies } from "./interactive-replies-C5Yb4Vbw.js";
import "./channel-api-BQA8OgK_.js";
import { r as createSlackWebClient } from "./client-S5mQH64B.js";
import { r as normalizeAllowListLower } from "./allow-list-B1jt8IJI.js";
import { n as resolveSlackGroupToolPolicy, t as resolveSlackGroupRequireMention } from "./group-policy-yqowTE3e.js";
import { t as resolveSlackReplyBlocks } from "./reply-blocks-CaDCJEFH.js";
import { t as getOptionalSlackRuntime } from "./runtime-C4Afjosr.js";
import { i as slackSecurityAdapter, n as isSlackPluginAccountConfigured, r as slackConfigAdapter, t as createSlackPluginBase } from "./shared-Bfdyldz4.js";
import { i as SLACK_CHANNEL, n as createSlackSetupWizardProxy, r as slackSetupAdapter } from "./setup-core-D8RckO4X.js";
import { n as resolveSlackThreadTsValue, t as normalizeSlackThreadTsCandidate } from "./thread-ts-Bk6_Vrxj.js";
...
const slackApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-DVCJEESY.js")).slackApprovalNativeRuntime
	})
});
...
async function loadSlackActionRuntime$1() {
	slackActionRuntimePromise$1 ??= import("./action-runtime.runtime-B-pIm2Uy.js");
...
const loadSlackSetupSurfaceModule = createLazyRuntimeModule(() => import("./setup-surface-DwzTm5bu.js"));
const loadSlackScopesModule = createLazyRuntimeModule(() => import("./scopes-RULbNHoi.js"));
const loadSlackOutboundAdapterModule = createLazyRuntimeModule(() => import("./outbound-adapter-CJv10arl.js"));
...
const loadSlackDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-BeHXi4Sh.js"));
const loadSlackResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-DXSmtjV1.js"));
const loadSlackResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-BvbofFYK.js"));
async function loadSlackActionRuntime() {
	slackActionRuntimePromise ??= import("./action-runtime.runtime-B-pIm2Uy.js");
	return await slackActionRuntimePromise;
}
async function loadSlackSendRuntime() {
	slackSendRuntimePromise ??= import("./send.runtime-Dbz5o6vh.js");
	return await slackSendRuntimePromise;
}
async function loadSlackProbeModule() {
	slackProbeModulePromise ??= import("./probe-l3cshnJE.js");
	return await slackProbeModulePromise;
}
async function loadSlackMonitorModule() {
	slackMonitorModulePromise ??= import("./monitor-Cd92Akzs.js");
	return await slackMonitorModulePromise;
}
async function loadSlackDirectoryLiveModule() {
	slackDirectoryLiveModulePromise ??= import("./directory-live-DNs2CXD8.js");
