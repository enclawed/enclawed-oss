...
import { C as resolveRealtimeVoiceAgentConsultTools, f as consultRealtimeVoiceAgent, m as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, t as convertPcmToMulaw8k, w as resolveRealtimeVoiceAgentConsultToolsAllow, x as parseRealtimeVoiceAgentConsultArgs } from "./realtime-voice-DiVEA8Jz.js";
import { t as resolveConfiguredCapabilityProvider } from "./provider-selection-runtime-B0ys7F6d.js";
import { n as getActiveMemorySearchManager } from "./memory-host-search-BFWki0Td.js";
...
import { a as validateProviderConfig, i as resolveVoiceCallConfig, n as normalizeVoiceCallConfig, o as deepMergeDefined, r as resolveTwilioAuthToken } from "./config-zoIzYwVj.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-BuzJcmx3.js";
import { t as resolveVoiceResponseModel } from "./response-model-DocghPXT.js";
import { t as isProviderStatusTerminal } from "./call-status-DC3nLp2_.js";
import { t as getHeader } from "./http-headers-DLklzExV.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-CtwVLuau.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-Ck3LDh3Q.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-DI4dKkvu.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-IbyqZmQV.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-91W_wUog.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-DPgCA-jz.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-LRDaSvEp.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-BBctXUI5.js");
