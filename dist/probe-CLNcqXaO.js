import { i as normalizeLowercaseStringOrEmpty$1, o as normalizeOptionalLowercaseString } from "./string-coerce-BUSzWgUA.js";
import { b as sleep } from "./utils-BcQ7uNrT.js";
import { s as normalizeStringEntries } from "./string-normalization-BWhNVcLY.js";
import { i as withFileLock$1 } from "./file-lock-BUY2i0LK.js";
import { a as isSilentReplyText } from "./tokens-pnu38gX0.js";
import { n as extensionForMime, r as getFileExtension, t as detectMime } from "./mime-Bs8vyLeZ.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-ULobvdLo.js";
import { o as extractOriginalFilename } from "./store-C1zvYuUA.js";
...
function extractMSTeamsPollVote(activity) {
	...
	const pollId = readNestedString(value, ["enclawedPollId"]) ?? readNestedString(value, ["pollId"]) ?? readNestedString(value, ["enclawed", "pollId"]) ?? readNestedString(value, [
		"enclawed",
		"poll",
		"id"
	]) ?? readNestedString(value, ["data", "enclawedPollId"]) ?? readNestedString(value, ["data", "pollId"]) ?? readNestedString(value, [
		"data",
		"enclawed",
		"pollId"
	]);
...
async function uploadToOneDrive(params) {
	...
	const res = await fetchFn(`${GRAPH_ROOT}/me/drive/root:${`/EnclawedShared/${encodeURIComponent(params.filename)}`}:/content`, {
		method: "PUT",
		headers: {
			"User-Agent": buildUserAgent(),
