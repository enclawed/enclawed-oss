...
import { n as isGatewayConfigBypassCommandPath } from "./explicit-connection-policy-CW8mCKYC.js";
import { n as resolvePluginRegistryScopeForCommandPath, t as ensureCliPluginRegistryLoaded } from "./plugin-registry-loader-DcMohBZ3.js";
//#region src/cli/command-bootstrap.ts
let configGuardModulePromise;
function loadConfigGuardModule() {
	configGuardModulePromise ??= import("./config-guard-Di-cZted.js");
...
function shouldHideCliBannerForCommandPath(commandPath, env = process.env) {
	return isTruthyEnvValue(env.ENCLAWED_HIDE_BANNER) || resolveCliCommandPathPolicy(commandPath).hideBanner;
}
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-DYrxVdCX.js");
	if (params.argv) {
