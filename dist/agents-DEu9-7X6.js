...
import { i as parseIdentityMarkdown, t as identityHasValues } from "./identity-file-CuEqDYls.js";
import { r as ensureWorkspaceAndSessions, s as moveToTrash } from "./onboard-helpers-DL_wxoBY.js";
import { i as parseBindingSpecs, n as buildChannelBindings, r as describeBinding$1, t as applyAgentBindings } from "./agents.bindings-Dbc2zEgz.js";
import { n as requireValidConfigSnapshot, t as requireValidConfigFileSnapshot$1 } from "./config-validation-M8txYvao.js";
import { i as loadAgentIdentity, n as buildAgentSummaries, o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-CNbdBeMd.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-BicQRB1z.js";
import { n as applyAuthChoice, t as warnIfModelConfigLooksOff } from "./auth-choice-cpif6d4b.js";
...
async function resolveParsedBindingsOrExit(params) {
	...
	const { parseBindingSpecs } = await import("./agents.bindings-xuaQWhxs.js");
...
async function agentsBindCommand(opts, runtime = defaultRuntime) {
	...
	if (!parsed) return;
	const { applyAgentBindings } = await import("./agents.bindings-xuaQWhxs.js");
...
async function agentsUnbindCommand(opts, runtime = defaultRuntime) {
	...
	if (!parsed) return;
	const { removeAgentBindings } = await import("./agents.bindings-xuaQWhxs.js");
