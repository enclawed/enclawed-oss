...
import { t as isVerbose } from "./global-state-CfiqbeEm.js";
import { t as createNonExitingRuntime } from "./runtime-DVd7lkz0.js";
import { t as createSubsystemLogger } from "./subsystem-WGqvYWrS.js";
import { _ as resolveStateDir } from "./paths-Z7drr_SN.js";
import { a as shouldLogVerbose, r as logVerbose, s as warn, t as danger } from "./globals-D8R_YQwt.js";
import { n as logError, t as logDebug } from "./logger-B8mPHfvt.js";
import { s as normalizeStringEntries } from "./string-normalization-BWhNVcLY.js";
...
import { i as withFileLock } from "./file-lock-BUY2i0LK.js";
...
import { i as resolveHumanDelayConfig } from "./identity-IAiNDSmy.js";
import { n as readSessionUpdatedAt, o as updateSessionStore } from "./store-eo7yB1I1.js";
import { u as resolveStorePath } from "./paths-CADYkZ1j.js";
import { t as loadSessionStore } from "./store-load-C5fhLNaT.js";
import { a as clearExpiredCooldowns, f as resolveProfilesUnavailableReason, s as isProfileInCooldown } from "./order-B81rwr6N.js";
import { d as resolveDebugProxySettings, f as resolveEffectiveDebugProxyUrl, n as captureWsEvent, t as captureHttpExchange } from "./runtime-B0vRcVVh.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-CgHO6oDe.js";
import { h as resolveTextChunksWithFallback, m as resolveSendableOutboundReplyParts } from "./reply-payload-ULobvdLo.js";
...
import { i as resolveChannelStreamingBlockEnabled } from "./channel-streaming-DVpBWz6e.js";
import { c as resolveTextChunkLimit, s as resolveChunkMode } from "./chunk-_i16mZcD.js";
import { i as resolveAgentRoute } from "./resolve-route-BDbWw8vc.js";
import { i as enqueueSystemEvent } from "./system-events-BDxISYT2.js";
import { n as writeJsonFileAtomically, t as readJsonFileWithFallback } from "./json-store-omP8GdLt.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DAldxFPt.js";
import { i as formatDurationSeconds } from "./format-duration-BKnM5WuD.js";
...
import { n as listChatCommands } from "./commands-registry-list-2keVg1rG.js";
import { c as listNativeCommandSpecsForConfig, d as resolveCommandArgMenu, f as serializeCommandArgs, i as formatCommandArgMenuTitle, l as parseCommandArgs, n as buildCommandTextFromArgs, r as findCommandByNativeName, u as resolveCommandArgChoices } from "./commands-registry-kc2RkbyN.js";
import { a as resolveEnvelopeFormatOptions, r as formatInboundEnvelope } from "./envelope-DTSFWzJ1.js";
import { t as finalizeInboundContext } from "./inbound-context-BtJAUPkD.js";
import { n as dispatchReplyWithDispatcher } from "./provider-dispatcher-CMHCJV5M.js";
import { t as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-DLPAMnWl.js";
import { t as resolveMarkdownTableMode } from "./markdown-tables-CxdhDl6o.js";
import { t as buildPairingReply } from "./pairing-messages-CElL4HJk.js";
import { d as upsertChannelPairingRequest } from "./pairing-store-f0EMbN2m.js";
import { t as summarizeStringEntries } from "./string-sample-CJmQAJDa.js";
import { a as patchAllowlistUsersInConfigEntries, n as buildAllowlistResolutionSummary, o as summarizeMapping, r as canonicalizeAllowlistWithResolvedIds, t as addAllowlistUserEntriesFromConfigEntry } from "./resolve-utils-DV6verqt.js";
import { a as warnMissingProviderGroupPolicyFallbackOnce, i as resolveOpenProviderRuntimeGroupPolicy, r as resolveDefaultGroupPolicy, t as GROUP_POLICY_BLOCKED_LABEL } from "./runtime-group-policy-BKsa-SoT.js";
import { n as isDangerousNameMatchingEnabled } from "./dangerous-name-matching-B7pmnOd3.js";
import { l as resolvePinnedMainDmOwnerFromAllowlist, n as readStoreAllowFromForDmPolicy, o as resolveDmGroupAccessWithLists } from "./dm-policy-shared-DX-_B8DN.js";
import { t as createChannelReplyPipeline } from "./channel-reply-pipeline-B2m58agi.js";
import { n as chunkItems } from "./text-runtime-DwWuUy-T.js";
import { t as withTimeout } from "./with-timeout-DoRibKy-.js";
import "./routing-_SeFXPvp.js";
import "./runtime-env-I1Ganeuv.js";
import "./proxy-capture-Bd5eY185.js";
...
import { r as registerChannelRuntimeContext } from "./channel-runtime-context-DVijF7Px.js";
import { n as resolveNativeCommandsEnabled, r as resolveNativeSkillsEnabled, t as isNativeCommandsExplicitlyDisabled } from "./commands-DpeYsnof.js";
import { t as resolveStoredModelOverride } from "./stored-model-override-B1cGekJY.js";
import "./reply-dispatch-runtime-7RvofKW6.js";
import "./reply-chunking-CGhb1HK5.js";
import { a as runInboundReplyTurn } from "./inbound-reply-dispatch-CaDhebRh.js";
import "./web-media-B5my5Dmd.js";
import "./system-event-runtime-DP3cgHob.js";
import { n as wrapFetchWithAbortSignal } from "./fetch-BRcphnv7.js";
import "./runtime-config-snapshot-DpwiPgJG.js";
import "./model-session-runtime-BfqkiSQt.js";
import "./ssrf-runtime-DcbzcBnU.js";
import "./media-runtime-C7OYyRri.js";
import { n as resolveConfiguredBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-CF48GUmH.js";
import "./conversation-binding-runtime-D2_59Ye4.js";
import "./conversation-runtime-zROIv0RL.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-D3tKsGWi.js";
import "./agent-runtime-DBrJR7qH.js";
import { n as createInteractiveConversationBindingHelpers, t as dispatchPluginInteractiveHandler } from "./plugin-runtime-3Sb6ANw2.js";
import "./security-runtime-B2-Yl3T5.js";
import { n as createConnectedChannelStatusPatch, r as createTransportActivityStatusPatch } from "./gateway-runtime-RTkarc5S.js";
import "./markdown-table-runtime-kkOyy7R8.js";
import { s as resolveNativeCommandSessionTargets } from "./command-auth--hijQ671.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-DvQK3A5B.js";
import "./command-auth-native-CDVz1MqF.js";
import { t as resolveDirectStatusReplyForSession } from "./command-status-runtime-BkfcmegS.js";
import "./channel-inbound-BMrCQUzu.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-BXQZOLtw.js";
import "./fetch-runtime-DOwYOjlZ.js";
import "./session-store-runtime-cT4Gqcbg.js";
import { t as resolveRequestUrl } from "./request-url-CbIyHMU-.js";
import "./native-command-config-runtime-DDSxjUK0.js";
import "./native-command-registry-B7ho_MdX.js";
import "./state-paths-DdDaGCxI.js";
import { E as Integer, H as _Object_, g as String$1, v as Number$1 } from "./build-C8OtfxIR.js";
import { B as Row, C as Guild, H as Separator, It as overwriteApplicationCommands, M as Button, P as Container, S as CommandWithSubcommands, T as User, U as StringSelectMenu, W as TextDisplay, a as MessageReactionRemoveListener, b as Check, d as Client, f as Plugin, h as RateLimitError, i as MessageReactionAddListener, k as Modal, l as ThreadUpdateListener, n as InteractionCreateListener, o as PresenceUpdateListener, q as BaseMessageInteractiveComponent, r as MessageCreateListener, s as ReadyListener, t as discord_exports, w as Message, x as Command, y as Errors } from "./discord-BOcNbEM2.js";
import { t as normalizeDiscordToken } from "./token-JDq1RRjA.js";
import { c as resolveDiscordAccountAllowFrom, d as resolveDiscordAccountDmPolicy, f as resolveDiscordMaxLinesPerMessage, s as resolveDiscordAccount } from "./accounts-CgccMlcy.js";
import { a as chunkDiscordTextWithMode } from "./normalize-CL-TAjzv.js";
import { a as resolveDiscordModalEntryWithPersistence, i as resolveDiscordComponentEntryWithPersistence, t as editDiscordComponentMessage } from "./send.components-C-1jX3Mh.js";
import { c as setPresence, i as unregisterGateway, r as registerGateway } from "./gateway-registry-CxE2CyON.js";
import { B as withValidatedDiscordProxy, I as DISCORD_REST_TIMEOUT_MS, L as createDiscordRequestClient, M as createDiscordRestClient, R as resolveDiscordProxyFetchForAccount, z as validateDiscordProxyUrl } from "./send.shared-euVHoeJy.js";
import { i as summarizeDiscordResponseBody, r as isDiscordRateLimitResponseBody } from "./api-CTNzUprt.js";
import { n as formatDiscordUserTag, t as formatDiscordReactionEmoji } from "./format-BCgdhuZR.js";
import { _ as shouldEmitDiscordReactionNotification, a as resolveDiscordAllowListMatch, c as resolveDiscordChannelPolicyCommandAuthorizer, d as resolveDiscordMemberAccessState, g as resolveGroupDmAllow, i as normalizeDiscordSlug, n as isDiscordGroupAllowedByPolicy, p as resolveDiscordOwnerAccess, r as normalizeDiscordAllowList, s as resolveDiscordChannelConfigWithFallback, u as resolveDiscordGuildEntry } from "./allow-list-DmqO05Pg.js";
import { t as formatMention } from "./mentions-DAglbl8I.js";
import { g as parseDiscordModalCustomIdForInteraction, h as parseDiscordModalCustomId, m as parseDiscordComponentCustomIdForInteraction, p as parseDiscordComponentCustomId } from "./components-3nZNHDxk.js";
import { i as isDiscordExecApprovalClientEnabled, n as getDiscordExecApprovalApprovers } from "./approval-shared-Bwy_zTMs.js";
import "./approval-native-Dl5mO3MG.js";
import { t as resolveDiscordConversationIdentity } from "./conversation-identity-LZsZ2Fsz.js";
import { t as resolveDiscordChannelAllowlist } from "./resolve-channels-CN0GIjs6.js";
import { t as resolveDiscordUserAllowlist } from "./resolve-users-DCM3eeWy.js";
import { a as isThreadArchived } from "./thread-bindings.discord-api-BvOG7UuJ.js";
import { r as parseApplicationIdFromToken, t as fetchDiscordApplicationId } from "./probe-CQSqR9mu.js";
import { o as raceWithTimeout, s as withAbortTimeout } from "./timeouts-DcHfnVVZ.js";
import { c as resolveDiscordChannelInfo, d as resolveDiscordChannelInfoSafe, f as resolveDiscordChannelNameSafe, h as resolveDiscordChannelTopicSafe, p as resolveDiscordChannelParentIdSafe, u as resolveDiscordChannelIdSafe } from "./message-utils-Vo4YCRg1.js";
import { s as resolveDiscordThreadParentInfo } from "./threading-BS8Vlr1r.js";
import { i as resolveDiscordEffectiveRoute, n as resolveDiscordBoundConversationRoute, o as handleDiscordDmCommandDecision, s as resolveDiscordDmCommandAccess } from "./route-resolution-B1fyfjJT.js";
import { t as resolveDiscordSenderIdentity } from "./sender-identity-X4wUo8-9.js";
import { n as buildDiscordInboundAccessContext, t as buildDiscordGroupSystemPrompt } from "./inbound-context-7uF-nSz7.js";
import { n as resolveDiscordVoiceEnabled, t as authorizeDiscordVoiceIngress } from "./access-BrxHFcQn.js";
import { n as buildDirectLabel, r as buildGuildLabel, t as deliverDiscordReply } from "./reply-delivery-ueJrtvYD.js";
import "./approval-handler.runtime-DNYJlClQ.js";
...
function getDiscordModelPickerModelPage(params) {
	...
	return {
		...paginateItems({
			items: [...modelSet].toSorted((a, b) => a < b ? -1 : a > b ? 1 : 0),
			page: normalizeModelPickerPage(params.page),
			pageSize
		}),
		provider
...
function listDiscordModelPickerProviderModels(data, provider) {
	...
	if (!modelSet) return [];
	return [...modelSet].toSorted((a, b) => a < b ? -1 : a > b ? 1 : 0);
}
...
const DISCORD_GATEWAY_TRANSPORT_ACTIVITY_EVENT = "enclawed:discord-gateway-transport-activity";
//#endregion
...
const discordGatewayBotInfoSchema = _Object_({
	url: String$1({ minLength: 1 }),
	shards: Integer({ minimum: 1 }),
	session_start_limit: _Object_({
		total: Integer({ minimum: 0 }),
		remaining: Integer({ minimum: 0 }),
		reset_after: Number$1({ minimum: 0 }),
		max_concurrency: Integer({ minimum: 1 })
	})
});
...
function createGatewayPlugin(params) {
	class EnclawedGatewayPlugin extends GatewayPlugin {
		constructor() {
...
async function deployDiscordCommands(params) {
	...
	try {
		for (let attempt = 1; attempt <= maxAttempts; attempt += 1) try {
			...
			if (!rateLimitDetails || attempt >= maxAttempts) throw err;
			const retryAfterMs = Math.max(0, Math.ceil(rateLimitDetails.retryAfterMs ?? 0));
			if (retryAfterMs > maxRetryDelayMs) {
				params.runtime.log?.(warn(`discord: native slash command deploy skipped for ${accountId}; retry after ${formatDurationSeconds(retryAfterMs, { decimals: 1 })} exceeds startup budget. Existing slash commands stay active. Message send/receive is unaffected.`));
				return;
			}
			if (params.shouldLogVerbose()) params.runtime.log?.(`discord startup [${accountId}] deploy-retry ${Math.max(0, Date.now() - startupStartedAt)}ms attempt=${attempt}/${maxAttempts - 1} retryAfterMs=${retryAfterMs} scope=${rateLimitDetails.scope ?? "unknown"} code=${rateLimitDetails.discordCode ?? "unknown"}`);
			await sleep(retryAfterMs);
		}
	} catch (err) {
		const rateLimitWarning = formatDiscordDeployRateLimitWarning(err, accountId);
		params.runtime.log?.(warn(rateLimitWarning ?? `discord: native slash command deploy warning (not message send): ${formatDiscordDeployErrorMessage(err)}${formatDiscordDeployErrorDetails(err)}`));
	} finally {
...
async function loadConversationRuntime$1() {
	conversationRuntimePromise$1 ??= import("./agent-components.runtime-CzTPqu82.js");
...
async function loadTypingRuntime() {
	typingRuntimePromise ??= import("./typing-DeTHb79_.js");
...
async function loadConversationRuntime() {
	conversationRuntimePromise ??= import("./agent-components.runtime-CzTPqu82.js");
...
async function loadComponentsRuntime() {
	componentsRuntimePromise ??= import("./components-YAfcTzbT.js");
...
var DiscordComponentModal = class extends Modal {
	constructor(ctx) {
		super();
		this.title = "Enclawed form";
		this.customId = "__enclawed_discord_component_modal_wildcard__";
		this.components = [];
...
var DiscordComponentButton = class extends Button {
	constructor(ctx, handlers) {
		...
		this.customId = "__enclawed_discord_component_button_wildcard__";
		this.style = ButtonStyle.Primary;
		this.customIdParser = parseDiscordComponentCustomIdForInteraction;
	}
	async run(interaction, data) {
...
async function loadDiscordVoiceRuntime() {
	const promise = discordVoiceRuntimePromise ?? import("./manager.runtime-DfBzzsoz.js");
...
async function loadDiscordProviderSessionRuntime() {
	const promise = discordProviderSessionRuntimePromise ?? import("./provider-session.runtime-CN_5_Yjm.js");
