...
import { d as setConsoleTimestampPrefix, t as createSubsystemLogger, u as setConsoleSubsystemFilter } from "./subsystem-DTyALtnK.js";
...
import { a as loadConfig, g as writeConfigFile, l as readConfigFileSnapshot, r as createConfigIO } from "./io-b4s6ivfp.js";
import { _ as resolveDefaultAgentWorkspaceDir, y as resolveWorkspaceTemplateDir } from "./workspace-Dg5fnKWT.js";
import { t as cleanStaleGatewayProcessesSync } from "./restart-stale-pids-Cupz8fFw.js";
...
import { a as getActiveTaskCount, c as markGatewayDraining, d as waitForActiveTasks, l as resetAllLanes } from "./command-queue-AW6crC7V.js";
import { r as callGateway } from "./call-BbWFdSoI.js";
import { a as markGatewaySigusr1RestartHandled, i as isGatewaySigusr1RestartExternallyAllowed, l as triggerEnclawedRestart, o as scheduleGatewaySigusr1Restart, t as consumeGatewaySigusr1RestartAuthorization } from "./restart-BunH6e-H.js";
import { d as waitForActiveEmbeddedRuns, r as getActiveEmbeddedRunCount, t as abortEmbeddedPiRun } from "./runs-BK6SAvHE.js";
...
import { n as buildGatewayDiscoveryTarget } from "./gateway-discovery-targets-ThWtRNds.js";
import { o as resolveControlUiRootSync } from "./control-ui-assets-D7-z8MI6.js";
import { n as acquireGatewayLock, t as GatewayLockError } from "./gateway-lock-CC7KDi-R.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-BwP-wGkj.js";
import { o as handleReset } from "./onboard-helpers-DL_wxoBY.js";
...
async function runGatewayCommand$1(opts) {
	...
	const { startGatewayServer } = await withProgress({
		...
		indeterminate: true
	}, async () => import("./server-D0Mp1a8G.js"));
...
function loadConfigModule() {
	configModulePromise ??= import("./read-best-effort-config.runtime-D_OX6H2f.js");
	return configModulePromise;
}
function loadGatewayStatusModule() {
	gatewayStatusModulePromise ??= import("./gateway-status-WMvorbss.js");
	return gatewayStatusModulePromise;
}
function loadGatewayHealthModule() {
	gatewayHealthModulePromise ??= import("./health-C407i02B.js");
	return gatewayHealthModulePromise;
}
function loadBonjourDiscoveryModule() {
	bonjourDiscoveryModulePromise ??= import("./bonjour-discovery-Dp0ARuUc.js");
...
function loadUsageFormatModule() {
	usageFormatModulePromise ??= import("./usage-format-C-TnYp2o.js");
