...
import { s as hasOutboundReplyContent } from "./reply-payload-ULobvdLo.js";
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-DE5dx1yB.js";
...
import { t as resolveConfiguredTtsMode } from "./tts-config-mbusBNuE.js";
import { r as prefixSystemMessage } from "./system-message-D5GeBw7h.js";
import { i as toAcpRuntimeError } from "./errors-CCznxKEz.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-BJnfKrM1.js";
import { r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-CqMWTPPe.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-D7llANpS.js";
import { a as resolveAcpDispatchPolicyError, i as resolveAcpAgentPolicyError } from "./policy-BJcD2nvG.js";
import { a as resolveAcpThreadSessionDetailLines } from "./session-identifiers-qSSSoR0s.js";
import { r as createBlockReplyPipeline } from "./block-reply-pipeline-B_DJ7Xaz.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-Brr818Nf.js";
...
function loadDispatchAcpMediaRuntime() {
	dispatchAcpMediaRuntimePromise ??= import("./dispatch-acp-media.runtime-CAaRgiuD.js");
...
function loadDispatchAcpTtsRuntime$1() {
	dispatchAcpTtsRuntimePromise$1 ??= import("./dispatch-acp-tts.runtime-ZL-GVwve.js");
	return dispatchAcpTtsRuntimePromise$1;
}
function loadChannelPluginRuntime() {
	channelPluginRuntimePromise ??= import("./plugins-D0v238xT.js");
	return channelPluginRuntimePromise;
}
function loadMessageActionRuntime() {
	messageActionRuntimePromise ??= import("./message-action-runner-CxSuTXBL.js");
...
function loadDispatchAcpManagerRuntime() {
	dispatchAcpManagerRuntimePromise ??= import("./dispatch-acp-manager.runtime-ClH_4d8F.js");
	return dispatchAcpManagerRuntimePromise;
}
function loadDispatchAcpSessionRuntime() {
	dispatchAcpSessionRuntimePromise ??= import("./dispatch-acp-session.runtime-olLPV7Pv.js");
	return dispatchAcpSessionRuntimePromise;
}
function loadDispatchAcpTtsRuntime() {
	dispatchAcpTtsRuntimePromise ??= import("./dispatch-acp-tts.runtime-ZL-GVwve.js");
