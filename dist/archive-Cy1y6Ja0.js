...
import { i as copyFileWithinRoot, l as openWritableFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-B5oXcRDC.js";
import { i as validateArchiveEntryPath, n as resolveArchiveOutputPath, r as stripArchivePath } from "./archive-path-xknm3LhT.js";
...
async function withStagedArchiveDestination(params) {
	const stagingDir = await fs$1.mkdtemp(path.join(params.destinationRealDir, ".enclawed-archive-"));
	try {
