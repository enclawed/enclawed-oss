...
import { t as logDebug } from "./logger-BEIxhllB.js";
import { a as loadConfig, h as resolveConfigSnapshotHash, o as parseConfigJson5 } from "./io-b4s6ivfp.js";
...
import { i as normalizeChannelId$1, r as listChannelPlugins, t as getChannelPlugin } from "./registry-CI36HBCI.js";
...
import { m as resolveSessionAgentIds, p as resolveSessionAgentId, r as resolveAgentExecutionContract, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-D-lQQ64_.js";
...
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-Bf8EdmFA.js";
import { t as ensureEnclawedModelsJson } from "./models-config-d50MyEqR.js";
import { f as modelKey, p as normalizeModelRef } from "./model-selection-cli-CsqB1sDP.js";
import { f as resolveDefaultModelForAgent, i as buildModelAliasIndex, m as resolveModelRefFromString, t as buildAllowedModelSet } from "./model-selection-DYKhuAoE.js";
...
import { a as discoverModels, i as discoverAuthStorage } from "./pi-model-discovery-aA35LDXf.js";
import { o as updateSessionStore } from "./store-BojxuYyw.js";
import { t as extractDeliveryInfo } from "./sessions-BhMvlzjx.js";
...
import { n as resolveSessionConversationRef } from "./session-conversation-SOzvCpzt.js";
import "./delivery-context-B53wctMG.js";
import { d as resolveSessionModelIdentityRef } from "./session-utils-BDNgtlyJ.js";
...
import { a as listChannelSupportedActions, d as resolvePluginTools, r as listAllChannelSupportedActions } from "./channel-tools-BECJD9-T.js";
import { w as textToSpeech } from "./tts-runtime-C0wxbtbl.js";
import "./tts-Bi-lPqla.js";
import { a as getImageMetadata } from "./image-ops-C48nAQih.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-Aykyg1nc.js";
import { a as resolveChannelMessageToolSchemaProperties, n as channelSupportsMessageCapabilityForChannel, t as channelSupportsMessageCapability } from "./message-action-discovery-xACgYzpm.js";
import { r as getApiKeyForModel } from "./model-auth-m8tj01Sr.js";
import { t as SsrFBlockedError } from "./ssrf-DQDx1s1G.js";
import { u as parseReplyDirectives } from "./deliver-Cm9sSV1G.js";
import { n as runWithImageModelFallback } from "./model-fallback-BK-XDhue.js";
...
import { c as jsonResult, d as readNumberParam, h as readStringParam$1, o as imageResult, p as readStringArrayParam, r as ToolInputError, y as readSnakeCaseParamRaw } from "./common-DthjNV6P.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-DxzpW_Fw.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-B5oXcRDC.js";
...
import { c as normalizeWorkspaceDir, f as toRelativeWorkspacePath, l as resolveWorkspaceRoot } from "./read-capability-CS7Tj3iD.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata } from "./runtime-0Lz14ds2.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-BsThNkgD.js";
import { a as createSessionVisibilityGuard, c as resolveDisplaySessionKey, d as resolveSessionReference, f as resolveVisibleSessionReference, i as createAgentToAgentPolicy, l as resolveInternalSessionKey, n as deriveChannel, o as resolveEffectiveSessionToolsVisibility, p as shouldResolveSessionIdInput, r as resolveSessionToolContext, s as resolveSandboxedSessionToolContext, t as classifySessionKind, u as resolveMainSessionAlias } from "./sessions-helpers-BCz0drG7.js";
import { r as stripToolMessages } from "./chat-history-text-BvO-6krC.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-IbppjNhm.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-BLbskw3Q.js";
import { i as stringEnum, n as channelTargetsSchema, r as optionalStringEnum, t as channelTargetSchema } from "./typebox-DiOC0WMo.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-BQDNDJzx.js";
...
import { o as scheduleGatewaySigusr1Restart } from "./restart-BunH6e-H.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-Cext79ge.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-yIIyWwXh.js";
...
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-D4u9FG5U.js";
import { r as getDefaultLocalRoots } from "./local-media-access-DgwZrHM7.js";
import { a as coerceImageModelConfig, c as resolveProviderVisionModelFromConfig, d as hasAuthForProvider, f as hasToolModelConfig, l as buildToolModelConfigFromCandidates, n as isMinimaxVlmProvider, o as decodeDataUrl, p as resolveDefaultModelRef, u as coerceToolModelConfig } from "./minimax-vlm-DDuNtJP9.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-B8cjiGT0.js";
import { C as getMediaUnderstandingProvider, E as resolveBundledDefaultMediaModel, T as resolveBundledAutoMediaKeyProviders, b as resolveAutoMediaKeyProviders, w as bundledProviderSupportsNativePdfDocument, x as resolveDefaultMediaModel } from "./resolve-C7HA0dVK.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-Vegx5Msw.js";
import { t as buildProviderRegistry } from "./runner-Cbs4XT_a.js";
...
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-Uhx1WDw0.js";
import { a as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-AiCLh2A8.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-DSFpV06e.js";
import { t as sendMessage } from "./message-DWEt_wI2.js";
import { n as resolveMusicGenerationModeCapabilities, t as listSupportedMusicGenerationModes } from "./capabilities-Drsbhnhp.js";
import { r as parseMusicGenerationModelRef } from "./provider-registry-OUXH_flS.js";
...
import { a as createRunningTaskRun, c as recordTaskRunProgressByRunId, o as failTaskRunByRunId, r as completeTaskRunByRunId } from "./task-executor-B0lKdY6M.js";
import "./task-registry-delivery-runtime-GAcxZ3IT.js";
import { t as formatAgentInternalEventsForPrompt } from "./internal-events-DBE5KFmH.js";
import { _ as REPLY_SKIP_TOKEN, b as deliverSubagentAnnouncement, d as registerSubagentRun, g as ANNOUNCE_SKIP_TOKEN, h as runAgentStep, v as isAnnounceSkip, y as isReplySkip } from "./subagent-registry-C6dLFkZE.js";
...
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-fMDjTpbj.js";
import { t as AGENT_LANE_NESTED } from "./lanes-e7slEYtV.js";
import { i as waitForAgentRunAndReadUpdatedAssistantReply, n as readLatestAssistantReplySnapshot, r as waitForAgentRun, t as readLatestAssistantReply } from "./run-wait-Bz3urKMw.js";
import { n as SUBAGENT_SPAWN_MODES, t as spawnSubagentDirect } from "./subagent-spawn-CP6OoF30.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-Bqf7MTr9.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-BQ1MuOGI.js";
...
import { a as runWebSearch, i as resolveWebSearchDefinition, l as resolveWebProviderConfig } from "./runtime-CKHBHaOQ.js";
import { r as resolveWebFetchDefinition } from "./runtime-CnpfR0av.js";
...
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds, u as fetchWithWebToolsNetworkGuard } from "./web-shared-DNag826S.js";
import "./web-search-provider-common-B0Epj1Dl.js";
...
function loadCommandsStatusRuntime() {
	commandsStatusRuntimePromise ??= import("./session-status.runtime-CDn4siMU.js");
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-BNSvQCs0.js");
...
async function loadAcpSpawnModule() {
	acpSpawnModulePromise ??= import("./acp-spawn-BSC5K9_k.js");
