...
import { i as normalizeChannelId$1, t as getChannelPlugin } from "./registry-DMBHPRsB.js";
...
import { n as resolveChannelApprovalCapability } from "./plugins-iuTgQA7g.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-Dm-6ahPb.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-BdkzPi5k.js";
...
import { i as formatUsd, r as formatTokenCount } from "./usage-format-CjTo2Fpa.js";
...
import { i as unsetConfiguredMcpServer, r as setConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-iaf93EAR.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-CQDlqDha.js";
import { r as callGateway } from "./call-CmVOwPMM.js";
import { l as triggerEnclawedRestart, o as scheduleGatewaySigusr1Restart } from "./restart-DRkudGg0.js";
...
import { h as replyRunRegistry, i as getActiveEmbeddedRunSnapshot } from "./runs-CQqd9Wbt.js";
import "./diagnostic-CNBXKu9s.js";
import { t as formatDurationCompact } from "./format-duration-DtQBjCYd.js";
import { O as getFinishedSession, k as getSession } from "./bash-tools.exec-runtime-Cbax6svY.js";
...
import { n as estimateTokensFromChars } from "./cjk-chars-YcSygSrD.js";
import { r as resolveModelWithRegistry } from "./model-C7zvosT-.js";
...
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-6rz3ruWW.js";
import "./commands-registry-Fu-L616i.js";
import { n as formatTimeAgo } from "./format-relative-DP06EFN7.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-DwJPPFkz.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-DpGJMp89.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-06vkVxSR.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-CmSaci9p.js";
import { l as resolveArchiveKind } from "./archive-Bx4mRIBv.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-X8kI_IvG.js";
import { n as parseActivationCommand } from "./group-activation-iBBwSTJB.js";
...
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-BHlK_Hhe.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-DscXt4kk.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-CIMiGj_E.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-CmliR0nh.js";
import { t as extractBtwQuestion } from "./btw-command-CK4onjmj.js";
...
import { a as requireGatewayClientScopeForInternalChannel, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-BCr5R7qD.js";
import { t as handleAcpCommand } from "./commands-acp-BqdhtBzh.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-BaTZ9yrb.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-DKDh37V4.js";
import { r as handleModelsCommand } from "./commands-models-BtGJihAQ.js";
import { n as setPluginEnabledInConfig } from "./enable--x_8awhI.js";
import { n as createExecTool } from "./bash-tools-CWj0VIG_.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./status-text-8-Dn3y2h.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-BtUeZTAd.js";
import { f as resolveSubagentsAction, h as resolveCommandSurfaceChannel, l as resolveHandledPrefix, m as resolveChannelAccountId, p as stopWithText, u as resolveRequesterSessionKey } from "./shared-DBdjqFo_.js";
import { n as buildToolsMessage } from "./status-FdzhyUOg.js";
import { t as parseConfigValue } from "./config-value-CRn4eDNL.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-Cwc278TX.js";
import { t as buildStatusReply } from "./commands-status-BBzZN3JL.js";
import { i as buildNpmInstallRecordFields, n as persistPluginInstall } from "./plugins-install-persist-BGKyNjpS.js";
import { m as parseClawHubPluginSpec } from "./clawhub-CHEjoiE_.js";
import { r as installPluginFromClawHub } from "./clawhub-BLcBOLYD.js";
import { a as buildPluginInspectReport, i as buildPluginDiagnosticsReport, o as buildPluginSnapshotReport, s as formatPluginCompatibilityNotice, t as buildAllPluginInspectReports } from "./status-BSwGNVSk.js";
import { a as decidePreferredClawHubFallback, i as createPluginInstallLogger, n as buildPreferredClawHubSpec, u as resolveFileNpmSpecToLocalPath } from "./plugins-command-helpers-wQjP9rFc.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-CU4MlHP3.js";
...
const handleCompactCommand = async (params) => {
	...
	const runtime = await import("./commands-compact.runtime-LyjIWagB.js");
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-XV30Djnr.js");
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-gPXvqvFn.js");
...
function loadAgentsAction() {
	actionAgentsPromise ??= import("./action-agents-DdNQCHdI.js");
	return actionAgentsPromise;
}
function loadFocusAction() {
	actionFocusPromise ??= import("./action-focus-DT4QXh9P.js");
	return actionFocusPromise;
}
function loadHelpAction() {
	actionHelpPromise ??= import("./action-help-Cxywy3GP.js");
	return actionHelpPromise;
}
function loadInfoAction() {
	actionInfoPromise ??= import("./action-info-BCFuLKKf.js");
	return actionInfoPromise;
}
function loadKillAction() {
	actionKillPromise ??= import("./action-kill-DXdgQWxT.js");
	return actionKillPromise;
}
function loadListAction() {
	actionListPromise ??= import("./action-list-BW4mLJiU.js");
	return actionListPromise;
}
function loadLogAction() {
	actionLogPromise ??= import("./action-log-BUsLC19_.js");
	return actionLogPromise;
}
function loadSendAction() {
	actionSendPromise ??= import("./action-send-cLssX5D5.js");
	return actionSendPromise;
}
function loadSpawnAction() {
	actionSpawnPromise ??= import("./action-spawn-BzOrztLx.js");
	return actionSpawnPromise;
}
function loadUnfocusAction() {
	actionUnfocusPromise ??= import("./action-unfocus-Domps6dh.js");
	return actionUnfocusPromise;
}
function loadControlRuntime() {
	controlRuntimePromise ??= import("./commands-subagents-control.runtime-09dajzEI.js");
