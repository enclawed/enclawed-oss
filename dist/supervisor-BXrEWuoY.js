...
import { o as resolveWindowsCommandShim, s as spawnWithFallback } from "./exec-LGLh3vyF.js";
import { t as killProcessTree } from "./kill-tree-DSz_msxx.js";
import { n as getShellConfig } from "./shell-utils-Cn5GYmJh.js";
...
function createProcessSupervisor() {
	...
	const spawn = async (input) => {
		...
		try {
			...
			const { warnProcessSupervisorSpawnFailure } = await import("./supervisor-log.runtime-BnKQedUX.js");
