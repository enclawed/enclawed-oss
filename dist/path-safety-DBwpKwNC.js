...
import { s as isPathInside$1 } from "./boundary-path-DV1omZV7.js";
import { i as openBoundaryFileSync, n as matchBoundaryFileOpenFailure } from "./boundary-file-read-g48ivAAk.js";
import { t as DEFAULT_PLUGIN_ENTRY_CANDIDATES } from "./manifest-Cdg6fKQA.js";
...
function detectBundleManifestFormat(rootDir) {
	...
	if (fs.existsSync(path.join(rootDir, "enclawed.plugin.json"))) return null;
