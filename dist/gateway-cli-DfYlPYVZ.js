...
import { a as loadConfig, g as writeConfigFile, l as readConfigFileSnapshot, r as createConfigIO } from "./io-CXz21W7w.js";
...
import { a as markGatewaySigusr1RestartHandled, i as isGatewaySigusr1RestartExternallyAllowed, l as triggerEnclawedRestart, o as scheduleGatewaySigusr1Restart, t as consumeGatewaySigusr1RestartAuthorization } from "./restart-DRkudGg0.js";
import { d as waitForActiveEmbeddedRuns, r as getActiveEmbeddedRunCount, t as abortEmbeddedPiRun } from "./runs-CQqd9Wbt.js";
import { n as parseTimeoutMsWithFallback } from "./parse-timeout-rS8x7MdD.js";
import { n as withProgress } from "./progress-Bnz7HAqX.js";
import { n as setGatewayWsLogStyle } from "./ws-logging-BG2snUC0.js";
import { t as formatHelpExamples } from "./help-format-DGXiWSnV.js";
import { n as runCommandWithRuntime } from "./cli-utils-BoeHfEkc.js";
import { t as readSecretFromFile } from "./secret-file-CvKw6L7g.js";
import { n as buildGatewayDiscoveryTarget } from "./gateway-discovery-targets-BYZTM1jV.js";
import { o as resolveControlUiRootSync } from "./control-ui-assets-DQSwUaZR.js";
import { n as acquireGatewayLock, t as GatewayLockError } from "./gateway-lock-Gs9LPTHO.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-BwP-wGkj.js";
import { o as handleReset } from "./onboard-helpers-DQ5qqC_T.js";
...
async function runGatewayCommand$1(opts) {
	...
	const { startGatewayServer } = await withProgress({
		...
		indeterminate: true
	}, async () => import("./server-CfLXseOT.js"));
...
function loadConfigModule() {
	configModulePromise ??= import("./read-best-effort-config.runtime-r_3JvzRi.js");
	return configModulePromise;
}
function loadGatewayStatusModule() {
	gatewayStatusModulePromise ??= import("./gateway-status-Bd3_UsXA.js");
	return gatewayStatusModulePromise;
}
function loadGatewayHealthModule() {
	gatewayHealthModulePromise ??= import("./health-CDKDSjkR.js");
	return gatewayHealthModulePromise;
}
function loadBonjourDiscoveryModule() {
	bonjourDiscoveryModulePromise ??= import("./bonjour-discovery-BvSrNP7X.js");
	return bonjourDiscoveryModulePromise;
}
function loadWideAreaDnsModule() {
	wideAreaDnsModulePromise ??= import("./widearea-dns-CjECo7As.js");
	return wideAreaDnsModulePromise;
}
function loadHealthStyleModule() {
	healthStyleModulePromise ??= import("./health-style-1VRxRyyT.js");
	return healthStyleModulePromise;
}
function loadUsageFormatModule() {
	usageFormatModulePromise ??= import("./usage-format-Co90NzKf.js");
