...
import { n as formatPluginInstallPathIssue, t as detectPluginInstallPathIssue } from "./plugin-install-path-warnings-DBVUnsJ0.js";
import { t as removePluginFromConfig } from "./uninstall-rTnUFxk8.js";
import "./runtime-doctor-DL-xXSzi.js";
import "./record-shared-CbW6h8t9.js";
import "./doctor-contract-BKj5mBiW.js";
...
async function applyMatrixDoctorRepair(params) {
	...
	if (migrationStatus.actionable) try {
		...
		warnings.push("- Skipping Matrix migration changes for now. Resolve the snapshot failure, then rerun \"enclawed doctor --fix\".");
	}
