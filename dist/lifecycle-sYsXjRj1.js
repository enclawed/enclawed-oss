...
import { c as readBestEffortConfig } from "./io-CXz21W7w.js";
import { i as launchAgentPlistExists, s as repairLaunchAgentBootstrap } from "./launchd-CMgPPglp.js";
import { d as formatGatewayPidList, f as signalVerifiedGatewayPidSync, u as findVerifiedGatewayListenerPidsOnPortSync } from "./schtasks-D5mTj0MO.js";
import { r as resolveGatewayService } from "./service-CHvWS1mb.js";
import { l as renderGatewayServiceStartHints, s as parsePortFromArgs } from "./shared-DQ7rBjOA.js";
import { n as isRestartEnabled } from "./commands.flags-DeLhNXm8.js";
import "./config-D3uukyZR.js";
import { i as probeGateway } from "./probe-BOBjHFaY.js";
import { i as runServiceUninstall, n as runServiceStart, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-C9GeGZLx.js";
import { a as renderGatewayPortHealthDiagnostics, c as waitForGatewayHealthyListener, l as waitForGatewayHealthyRestart, o as renderRestartDiagnostics, s as terminateStaleGatewayPids, t as DEFAULT_RESTART_HEALTH_ATTEMPTS } from "./restart-health-D7QTp-R7.js";
...
async function restartGatewayWithoutServiceManager(port) {
	...
	const pids = resolveVerifiedGatewayListenerPids(port);
	if (pids.length === 0) return null;
	if (pids.length > 1) throw new Error(`multiple gateway processes are listening on port ${port}: ${formatGatewayPidList(pids)}; use "enclawed gateway status --deep" before retrying restart`);
	...
	return await runServiceRestart({
		...
		postRestartCheck: async ({ warnings, fail, stdout }) => {
			if (restartedWithoutServiceManager) {
				...
				fail(`Gateway restart timed out after ${restartWaitSeconds}s waiting for health checks.`, [formatCliCommand("enclawed gateway status --deep"), formatCliCommand("enclawed doctor")]);
			...
			fail(failure.failMessage, [formatCliCommand("enclawed gateway status --deep"), formatCliCommand("enclawed doctor")]);
