...
import { c as moveSingleAccountChannelSectionToDefaultAccount, l as patchScopedAccountConfig } from "./setup-helpers-Dsxp4-4J.js";
//#region src/channels/plugins/setup-wizard-helpers.ts
let providerAuthInputPromise;
function loadProviderAuthInput() {
	providerAuthInputPromise ??= import("./provider-auth-ref-Bw1cC98a.js");
...
async function promptSingleChannelSecretInput(params) {
	...
	const resolved = await promptSecretRefForSetup({
		...
		copy: {
			...
			envVarFormatError: "Use an env var name like \"ENCLAWED_SECRET\" (uppercase letters, numbers, underscores).",
