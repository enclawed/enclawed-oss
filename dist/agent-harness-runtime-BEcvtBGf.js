...
import { n as resolveProviderIdForAuth } from "./provider-auth-aliases-DuuqG2A5.js";
import "./agent-scope-Bv7XD6OT.js";
import "./registry-HWND2Ug6.js";
import { s as joinPresentTextSegments, t as getGlobalHookRunner } from "./hook-runner-global-BVz2OJuP.js";
import { r as PluginApprovalResolutions } from "./types-VxFFQ_Ma.js";
import { r as getActivePluginRegistry } from "./runtime-v-gfCtZv.js";
import { F as resolveProviderSystemPromptContribution } from "./provider-runtime-BcnUyz_Y.js";
import "./agent-paths-BXAogyu3.js";
import "./session-write-lock-B7HIVMq0.js";
import { f as normalizeEmbeddedAgentRuntime } from "./attempt.tool-run-context-C3dWN2Fa.js";
import { r as isSilentReplyPayloadText } from "./tokens-DgKTURQ1.js";
import { l as normalizeToolName } from "./tool-policy-Bkov0fJO.js";
import "./model-auth-B85ng6CG.js";
import { o as logProviderToolSchemaDiagnostics, s as normalizeProviderToolSchemas } from "./attempt.thread-helpers-DvFXzSKc.js";
...
import { d as runContextEngineMaintenance, n as buildAfterTurnRuntimeContextFromUsage, t as buildAfterTurnRuntimeContext } from "./attempt.prompt-helpers-BAbz1GVF.js";
import { t as callGatewayTool } from "./gateway-u_c4UwFM.js";
import { i as runBeforeToolCallHook, n as consumeAdjustedParamsForToolCall } from "./pi-tools.before-tool-call-_verVbrn.js";
import "./nodes-utils-DPEN7Eok.js";
import "./runs-cE9sGCqK.js";
import "./sandbox-C9-diPyu.js";
import { h as isGpt5ModelId } from "./provider-model-shared-Cw7Df4po.js";
import { r as resolveTranscriptPolicy } from "./compaction-runtime-context-CnLMYsZY.js";
import { i as resolvePreparedExtraParams } from "./extra-params-QWMPNneg.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolveHandlers = async () => {
		...
		resolvedHandlersPromise ??= import("./agent-tool-result-middleware-loader-BBGVvZQL.js").then(({ loadAgentToolResultMiddlewaresForRuntime }) => loadAgentToolResultMiddlewaresForRuntime({ runtime: ctx.runtime }));
