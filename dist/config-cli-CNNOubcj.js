...
import { d as resolveSecretInputRef, i as coerceSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-BpVPfGSB.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-CXDupHS0.js";
import { n as info, o as success, t as danger } from "./globals-CYDryU7g.js";
import { a as resolveSecretRefValue } from "./resolve-DJj4APwl.js";
import { w as SecretProviderSchema } from "./zod-schema.core-Dg8HKj-q.js";
import { b as validateConfigObjectRaw, l as readConfigFileSnapshot, v as collectUnsupportedSecretRefPolicyIssues } from "./io-b4s6ivfp.js";
...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-BudCYa5V.js";
import { i as redactConfigObject, n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-BnNml52t.js";
import { n as setCommandJsonMode } from "./json-mode-CuFnBvuQ.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.enclawed.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-ByXxE05R.js");
