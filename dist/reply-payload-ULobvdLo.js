...
function _trimLeadingMarkdownQuoteMarkers(text) {
...
function isReasoningReplyPayload(payload) {
	...
	return normalizeLowercaseStringOrEmpty(_trimLeadingMarkdownQuoteMarkers(text)).startsWith(REASONING_PREFIX);
}
//#endregion
