...
import { i as normalizeChannelId, n as getLoadedChannelPlugin, r as listChannelPlugins, t as getChannelPlugin } from "./registry-DMBHPRsB.js";
...
import { r as parseByteSize } from "./zod-schema-CFl1x2SW.js";
...
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-DpfzwZLV.js";
import { l as disposeRegisteredAgentHarnesses } from "./registry-CfvjI940.js";
...
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-iuTgQA7g.js";
...
import { r as createPluginRuntimeLoaderLogger } from "./load-context--3-QIWz1.js";
...
import { o as updateSessionStore, s as updateSessionStoreEntry, t as archiveRemovedSessionTranscripts } from "./store-CJURmbu1.js";
...
import { n as resolveMainSessionKeyFromConfig, t as extractDeliveryInfo } from "./sessions-DczeBbOf.js";
...
import { t as parseSessionThreadInfo } from "./thread-info-DkEfE7h6.js";
...
import { n as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-D-XiHX5r.js";
import { o as startGatewayModelPricingRefresh } from "./usage-format-CjTo2Fpa.js";
...
import { ct as getSessionCompactionCheckpoint, lt as listSessionCompactionCheckpoints } from "./model-context-tokens-DJOPw5KY.js";
...
import { m as resolveEmbeddedAgentRuntime } from "./attempt.tool-run-context-rTzTxjAc.js";
...
import { d as resolvePluginTools, u as getPluginToolMeta } from "./channel-tools-Bwrv83Qx.js";
import { C as synthesizeSpeech, S as setTtsProvider, b as setTtsEnabled, c as isTtsEnabled, f as resolveExplicitTtsOverrides, g as resolveTtsProviderOrder, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, p as resolveTtsAutoMode, w as textToSpeech } from "./tts-runtime-CVM3Iyzy.js";
import "./tts-TFBdqpqk.js";
import { n as compactEmbeddedPiSession, r as selectAgentHarness } from "./pi-embedded-runner-ErLaGPEf.js";
...
import { n as createOutboundPayloadPlan, s as projectOutboundPayloadPlanForMirror, t as deliverOutboundPayloads } from "./deliver-BtvrfctW.js";
...
import { i as normalizeCronJobPatch, n as normalizeCronJobCreate, r as normalizeCronJobInput } from "./enclawed-tools-D6PV5Lvw.js";
...
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-D715rRBR.js";
...
import { c as setPreRestartDeferralCheck, n as deferGatewayRestartUntilIdle, o as scheduleGatewaySigusr1Restart, r as emitGatewayRestart, s as setGatewaySigusr1RestartPolicy } from "./restart-DRkudGg0.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-mRClLwgy.js";
...
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-secret-gateway-Bc23JeZV.js";
import { i as evaluateGatewayAuthSurfaceStates, r as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-web-tools-DYDtgWHy.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-DFmgzcYB.js";
import { n as normalizePollInput } from "./polls-DUmN6raC.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-BMPs_KVP.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-vvWHdxek.js";
import { r as resetDirectoryCache } from "./target-resolver-BIleszjd.js";
...
import { r as resolveOutboundTarget } from "./targets-DqvZ6X4h.js";
...
import { a as createRunningTaskRun, o as failTaskRunByRunId, r as completeTaskRunByRunId } from "./task-executor-gcTUn1m7.js";
import { m as cleanupBrowserSessionsForLifecycleEnd, o as initSubagentRegistry, p as scheduleSubagentOrphanRecovery } from "./subagent-registry-DOmyesbV.js";
import { a as clearSessionQueues } from "./queue-CMMblsxY.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-SYF3lXGF.js";
import { a as isEmbeddedPiRunActive, f as waitForEmbeddedPiRunEnd, r as getActiveEmbeddedRunCount, t as abortEmbeddedPiRun } from "./runs-CQqd9Wbt.js";
import { h as stopDiagnosticHeartbeat, m as startDiagnosticHeartbeat } from "./diagnostic-CNBXKu9s.js";
...
import { n as resolveCronStyleNow } from "./current-time-CC6PBbPg.js";
import { n as getActiveMemorySearchManager, r as resolveActiveMemoryBackendConfig } from "./memory-runtime-BPxigYpU.js";
import { t as resolveMemorySearchConfig } from "./memory-search-CJapkYrX.js";
import { t as resolveModel } from "./model-C7zvosT-.js";
import { o as resolvePreferredSessionKeyForSessionIdMatches } from "./live-model-switch-pEh2yxeN.js";
import "./pi-embedded-BwOVaa14.js";
import { r as listPluginCommands } from "./commands-DwWDqOAU.js";
import { n as createPluginRuntime, r as setGatewaySubagentRuntime } from "./runtime-DtniYh5r.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-CORLuMZO.js";
import "./commands-registry-Fu-L616i.js";
import { o as getTotalPendingReplies } from "./dispatch-CL8UC1U7.js";
import { n as resolveSendPolicy, t as normalizeSendPolicy } from "./send-policy-N5H3BAXx.js";
import { n as sanitizeInboundSystemTags } from "./inbound-text-Ce_yYk_9.js";
import { t as getChannelActivity } from "./channel-activity-4gM0wfKz.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-Db-VEnkz.js";
import { n as getAcpSessionManager } from "./manager-L9y9bOJq.js";
import { t as primeConfiguredBindingRegistry } from "./binding-registry-x-yuXD3E.js";
import { t as WizardCancelledError } from "./prompts-DC9uBmdr.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-Br4VlGfT.js";
import { c as formatExecApprovalExpiresIn, f as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-reply-CrNco8sW.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "./approval-handler-adapter-runtime-Dv0QkH7k.js";
import { n as sanitizeExecApprovalDisplayText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-CBWGn3Jk.js";
import { n as createChannelApprovalHandlerFromCapability } from "./approval-handler-runtime-jssi70eQ.js";
import { i as watchChannelRuntimeContexts, n as getChannelRuntimeContext, t as createTaskScopedChannelRuntime } from "./channel-runtime-context-CT9Flrm7.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-B47YfY7A.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-BvC3LWa7.js";
import { t as normalizeGroupActivation } from "./group-activation-iBBwSTJB.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-C1BOLUCT.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-DscXt4kk.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-C7j5vgat.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-CuIaVPy4.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-sQ5pH7df.js";
import { n as resolveAgentOutboundIdentity } from "./identity-C9j1QO7f.js";
import { i as parseVerboseOverride, n as applyVerboseOverride, r as parseTraceOverride, t as applyTraceOverride } from "./level-overrides-D73dgr0I.js";
import { r as agentCommandFromIngress } from "./agent-command-C_FUg2ED.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-NJnMiuoo.js";
import { a as ensureGatewayStartupAuth, i as safeParseJson, n as respondUnavailableOnNodeInvokeError, o as mergeGatewayAuthConfig, r as respondUnavailableOnThrow, s as mergeGatewayTailscaleConfig, t as respondInvalidParams } from "./nodes.helpers-DnOL-sHD.js";
import { i as resolveNodeCommandAllowlist, n as isNodeCommandAllowed, r as normalizeDeclaredNodeCommands } from "./node-command-policy-CZnYCqwa.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs, t as formatForLog } from "./ws-log-DB1aH8zU.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-DKDh37V4.js";
import { r as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-BR13tIgj.js";
import { _ as verifyDeviceToken, a as getPairedDevice, c as listDevicePairing, d as removePairedDevice, f as requestDevicePairing, g as updatePairedDeviceMetadata, h as summarizeDeviceTokens, i as formatDevicePairingForbiddenMessage, l as listEffectivePairedDeviceRoles, m as rotateDeviceToken, n as approveDevicePairing, o as hasEffectivePairedDeviceRole, p as revokeDeviceToken, r as ensureDeviceToken, s as listApprovedPairedDeviceRoles, t as approveBootstrapDevicePairing, u as rejectDevicePairing } from "./device-pairing-CRgsdnrG.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-D_7xMVJv.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-D_h1ZpYQ.js";
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-D_uZNZI6.js";
import "./agent-Becr2-pz.js";
import { n as shouldIncludeHook } from "./config-CKRCE6Kt.js";
import "./session-identifiers-BTcRHbkC.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, i as buildSystemRunApprovalEnvBinding, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-DD7WZ13n.js";
import { n as resolveSystemRunApprovalRequestContext, r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-defJaRZy.js";
import { t as closeMcpLoopbackServer } from "./mcp-http-D3txZkN7.js";
import { A as isSessionKeyAllowedByPrefix, B as resolveHookTargetAgentId, D as getHookChannelError, E as getHookAgentPolicyError, F as readJsonBody, H as applyHookMappings, I as resolveHookChannel, L as resolveHookDeliver, M as normalizeHookDispatchSessionKey, N as normalizeHookHeaders, O as getHookSessionKeyPrefixError, P as normalizeWakePayload, R as resolveHookIdempotencyKey, T as extractHookToken, U as resolveFunctionModuleExport, V as resolveHooksConfig, _ as sendGatewayAuthFailure, a as getHeader, h as loadGatewayModelCatalog, i as getBearerToken, j as normalizeAgentPayload, k as isHookAgentAllowed, l as resolveHttpBrowserOriginPolicy, m as __resetModelCatalogCacheForTest, p as resolveTrustedHttpOperatorScopes, r as authorizeGatewayHttpRequestOrReply, x as setDefaultSecurityHeaders, z as resolveHookSessionKey } from "./http-utils-BY-3hXGb.js";
import { t as createOutboundSendDeps$1 } from "./outbound-send-deps-BFEKPA1w.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-w7iV9R92.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-Cppvc1ov.js";
import { t as loadProviderUsageSummary } from "./provider-usage-D0RWqPjJ.js";
import "./refresh-vh3qs0bA.js";
import { o as fetchClawHubSkillDetail } from "./clawhub-CHEjoiE_.js";
import { a as loadSessionUsageTimeSeries, n as loadCostUsageSummary, o as resolveExistingUsageSessionFile, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-CU4MlHP3.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-C5MV7yLo.js";
import { a as performGatewaySessionReset } from "./session-reset-service-B4scRuxc.js";
import { t as buildChannelUiCatalog } from "./catalog-D27zaPio.js";
import { t as ensureEnclawedCliOnPath } from "./path-env-Dwp9YykY.js";
import { a as removeBackfillDiaryEntries, c as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeGroundedShortTermCandidates, r as previewGroundedRemMarkdown, s as repairDreamingArtifacts } from "./memory-core-bundled-runtime-DoHgQzPl.js";
import { a as resolveGatewayStartupPluginIds, r as resolveConfiguredDeferredChannelPluginIds } from "./channel-plugin-ids-CF1VGml8.js";
import { a as redactConfigSnapshot, i as redactConfigObject, o as restoreRedactedValues, r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-B82LEMgG.js";
import { a as writeWideAreaGatewayZone, i as resolveWideAreaDiscoveryDomain } from "./widearea-dns-CgOhJJq2.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DQSwUaZR.js";
import { t as GatewayLockError } from "./gateway-lock-Gs9LPTHO.js";
import { t as loadWorkspaceHookEntries } from "./workspace-Dba4fF6-.js";
import { t as readConfiguredLogTail } from "./log-tail-Cnua5uzR.js";
import { o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-Bwb1Zjpj.js";
import { t as getHealthSnapshot } from "./health-C5BzPd1P.js";
import { t as installSkill } from "./skills-install-Cqd8UClw.js";
import { n as normalizeCronJobIdentityFields, r as runGatewayUpdate, t as runChannelPluginStartupMaintenance } from "./lifecycle-startup-DTgix0QK.js";
import { m as normalizeUpdateChannel, n as compareSemverStrings, o as resolveNpmChannelTag, t as checkUpdateStatus } from "./update-check-CBD-B9DA.js";
import { i as migrateOrphanedSessionKeys } from "./state-migrations-BTPl8UDM.js";
import { t as runSetupWizard } from "./setup-XKj4GzvT.js";
import "./status-NrOr4lso.js";
import { t as getStatusSummary } from "./status.summary-kvlM5rD3.js";
import { d as startTaskRegistryMaintenance, f as stopTaskRegistryMaintenance, g as markCronJobActive, h as clearCronJobActive, n as getInspectableTaskRegistrySummary } from "./task-registry.maintenance-CLVB30wT.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-nHbcUByZ.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeLogArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-BMoDZBky.js";
import { t as buildChannelAccountSnapshot } from "./status-BPy_gPC_.js";
import { _ as resolveDeliveryTarget, a as computeJobPreviousRunAtMs, c as findJobOrThrow, d as isJobEnabled, f as nextWakeAtMs, g as resolveJobPayloadTextForMain, h as recordScheduleComputeError, i as computeJobNextRunAtMs, l as hasScheduledNextRunAtMs, m as recomputeNextRunsForMaintenance, n as applyJobPatch, o as createJob, p as recomputeNextRuns, r as assertSupportedJobSpec, s as errorBackoffMs, t as DEFAULT_ERROR_BACKOFF_SCHEDULE_MS, u as isJobDue } from "./jobs-BaoENvD8.js";
import { a as resolveHeartbeatAckMaxChars$1, i as resolveCronPayloadOutcome, t as isHeartbeatOnlyResponse } from "./helpers-CWyIwpV2.js";
import { n as markCronSessionPreRun, r as persistCronSkillsSnapshotIfChanged, t as createPersistCronSessionEntry } from "./run-session-state-Dx6qkqdk.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-Dqwvw5kp.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-D1TlgCny.js";
import { n as MediaOffloadError, r as parseMessageWithAttachments, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-D8P6_lMV.js";
import { a as resolveCronSession, n as runHeartbeatOnce, r as startHeartbeatRunner } from "./heartbeat-runner-ygAMID_C.js";
import { _ as injectTimestamp, a as DEDUPE_TTL_MS, c as MAX_PAYLOAD_BYTES, d as isSuppressedControlReplyLeadFragment, f as isSuppressedControlReplyText, g as waitForTerminalGatewayDedupe, h as setGatewayDedupeEntry, i as DEDUPE_MAX, l as MAX_PREAUTH_PAYLOAD_BYTES, m as readTerminalSnapshotFromGatewayDedupe, n as chatHandlers, o as HEALTH_REFRESH_INTERVAL_MS, p as abortChatRunById, s as MAX_BUFFERED_BYTES, u as TICK_INTERVAL_MS, v as timestampOptsFromConfig } from "./chat-DtFgANhr.js";
...
function loadExecApprovalForwarderRuntime() {
	execApprovalForwarderRuntimePromise ??= import("./exec-approval-forwarder.runtime-CCApEvdx.js");
...
async function loadSkillsSnapshotRuntime() {
	skillsSnapshotRuntimePromise ??= import("./skills-snapshot.runtime-CdnUHij-.js");
...
async function loadCliRunnerRuntime() {
	return await import("./cli-runner.runtime-CStd5ZFm.js");
}
async function loadUsageFormatRuntime() {
	return await import("./usage-format-Co90NzKf.js");
}
...
async function loadSessionSubagentReactivationRuntime() {
	return import("./session-subagent-reactivation.runtime-CBJ-AmPK.js");
}
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-vVsPSOg6.js");
...
const sessionsHandlers = {
	...
	"sessions.reset": async ({ params, respond, context }) => {
		...
		const { performGatewaySessionReset } = await import("./sessions.runtime-tmyLjJy8.js");
		const result = await performGatewaySessionReset({
			key,
			reason,
	...
	"sessions.delete": async ({ params, respond, client, isWebchatConnect, context }) => {
		...
		const { archiveSessionTranscriptsForSessionDetailed, cleanupSessionBeforeMutation, emitGatewaySessionEndPluginHook, emitSessionUnboundLifecycleEvent } = await import("./sessions.runtime-tmyLjJy8.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-C6EJDd6L.js");
...
function recoverPendingOutboundDeliveries(params) {
	(async () => {
		...
		const { deliverOutboundPayloads } = await import("./deliver-BlesI0Ty.js");
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-C-s1WQ4J.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-C4eaOcD7.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-ChutSU-_.js");
	return embeddingsHttpModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-DCAfnUT6.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-CUKngtrd.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-Berj016Z.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-BENj8rkH.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-fd7yNJI_.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-BOSaNQLK.js");
