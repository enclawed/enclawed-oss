...
import { _ as resolveRequestClientIp } from "./net-SK24IRt9.js";
import "./error-runtime-8fPZWhDX.js";
import "./security-runtime-CbsrjaQi.js";
import "./string-coerce-runtime-DHP37Oa1.js";
import { a as createFixedWindowRateLimiter, r as WEBHOOK_RATE_LIMIT_DEFAULTS } from "./webhook-memory-guards-Bmz7jDfm.js";
import { a as createWebhookInFlightLimiter, c as readWebhookBodyOrReject } from "./webhook-request-guards-BYfyt29F.js";
import { t as normalizeWebhookPath } from "./webhook-path-DsAEnn4E.js";
import { l as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute, s as resolveWebhookTargetWithAuthOrRejectSync } from "./webhook-targets-DsABjk4P.js";
import "./webhook-ingress-BF2faJ_O.js";
import { F as resolveBlueBubblesEffectiveAllowPrivateNetwork, _ as normalizeWebhookReaction, g as normalizeWebhookMessage, o as probeBlueBubbles, t as fetchBlueBubblesServerInfo, u as asRecord } from "./probe-UKy6e0SE.js";
import { t as getBlueBubblesRuntime } from "./runtime-DdSclW7c.js";
import { n as resolveWebhookPathFromConfig } from "./webhook-shared-BB-DA1P4.js";
import { a as resolveBlueBubblesMessageId, b as sendMessageBlueBubbles } from "./reactions-_Zh6TCyz.js";
import { i as sendBlueBubblesMedia, n as processMessage, r as processReaction, t as logVerbose } from "./monitor-processing-CPs4PAHG.js";
...
async function monitorBlueBubblesProvider(options) {
	...
	return await new Promise((resolve) => {
		...
		import("./catchup-B6olImhG.js").then(({ runBlueBubblesCatchup }) => runBlueBubblesCatchup(target)).catch((err) => {
