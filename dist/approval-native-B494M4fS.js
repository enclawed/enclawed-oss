...
import { n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-B0J8p_YE.js";
...
import { r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-CXTFhYLQ.js";
import { i as isDiscordExecApprovalClientEnabled, n as getDiscordExecApprovalApprovers, r as isDiscordExecApprovalApprover, t as shouldHandleDiscordApprovalRequest } from "./approval-shared-m9ArkXt3.js";
...
function createDiscordApprovalCapability(configOverride) {
	return createApproverRestrictedNativeApprovalCapability({
		...
		nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
			...
			load: async () => (await import("./approval-handler.runtime-ThkABoXo.js")).discordApprovalNativeRuntime
		})
	});
}
