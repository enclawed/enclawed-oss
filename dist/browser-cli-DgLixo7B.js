...
import { t as addGatewayClientOptions } from "./gateway-rpc-_PRZo_2A.js";
import { t as formatHelpExamples } from "./help-format-02fn-Ugc.js";
import { i as registerCommandGroups } from "./register-command-groups-CrNSl_Wb.js";
import { t as shouldEagerRegisterSubcommands } from "./command-registration-policy-ojQYruw_.js";
...
const browserCommandGroupDefinitions = [
	{
		...
		register: async (args) => {
			(await import("./browser-cli-manage-BuUHOr2f.js")).registerBrowserManageCommands(args.browser, args.parentOpts);
		}
	},
	{
		...
		register: async (args) => {
			(await import("./browser-cli-inspect-BElp9NXl.js")).registerBrowserInspectCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-input-D5Yvw4CA.js")).registerBrowserActionInputCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-observe-WqGBcRW9.js")).registerBrowserActionObserveCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-debug-OENCVPRQ.js")).registerBrowserDebugCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-state-kOsI4keu.js")).registerBrowserStateCommands(args.browser, args.parentOpts);
		}
	}
];
