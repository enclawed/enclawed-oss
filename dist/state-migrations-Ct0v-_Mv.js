...
import { t as expandHomePrefix } from "./home-dir-yzjXRaUx.js";
import "./subsystem-WGqvYWrS.js";
import { _ as resolveStateDir, h as resolveOAuthDir, m as resolveNewStateDir, p as resolveLegacyStateDirs } from "./paths-CDjhyzOH.js";
import { o as listBundledChannelLegacySessionSurfaces, s as listBundledChannelLegacyStateMigrationDetectors } from "./bundled-rQ9JGl7f.js";
import { o as parseAgentSessionKey } from "./session-key-utils-Ce7cepnN.js";
import { c as normalizeAgentId, l as normalizeMainKey, n as DEFAULT_MAIN_KEY, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID } from "./session-key-BOC5unB4.js";
...
async function autoMigrateLegacyStateDir(params) {
	...
	if ((params.env ?? process.env).ENCLAWED_STATE_DIR?.trim()) return {
		migrated: false,
		skipped: true,
		changes: [],
		warnings: []
	...
	try {
		...
		try {
			...
			try {
				...
				warnings.push(`Rollback failed; set ENCLAWED_STATE_DIR=${targetDir} to avoid split state: ${String(rollbackErr)}`);
