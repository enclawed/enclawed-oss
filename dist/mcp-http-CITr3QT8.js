...
import { i as isLoopbackAddress } from "./net-SK24IRt9.js";
import { s as checkBrowserOrigin } from "./auth-B8XaTaMr.js";
...
import { a as getHeader } from "./http-utils-B9m02weK.js";
...
const MCP_LOOPBACK_SERVER_NAME = "enclawed";
...
function resolveMcpRequestContext(req, cfg) {
	const senderIsOwnerRaw = normalizeOptionalLowercaseString(getHeader(req, "x-enclawed-sender-is-owner"));
	return {
		sessionKey: resolveScopedSessionKey(cfg, getHeader(req, "x-session-key")),
		messageProvider: normalizeMessageChannel(getHeader(req, "x-enclawed-message-channel")) ?? void 0,
