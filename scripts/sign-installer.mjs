...
// Canonical install URLs the bootstrap scripts are bound to.
const BUNDLES = [
  {
    label: "bash",
    scriptPath: join(repoRoot, "enclawed-apps", "install.sh"),
    installUrl:
      "https://raw.githubusercontent.com/enclawed/enclawed-oss/main/enclawed-apps/install.sh",
  ...
  },
  {
    ...
    installUrl:
      "https://raw.githubusercontent.com/enclawed/enclawed-oss/main/enclawed-apps/install.ps1",
