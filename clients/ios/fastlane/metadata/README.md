...
The `ios metadata` lane uses App Store Connect API key auth from `clients/ios/fastlane/.env`:
...
- `release_notes.txt` is generated from `clients/ios/CHANGELOG.md`; after changelog updates, run `pnpm ios:version:sync`.
