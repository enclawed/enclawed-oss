...
- Open the folder `clients/android`.
...
`bun run android:bundle:release` auto-bumps Android `versionName`/`versionCode` in `clients/android/app/build.gradle.kts`, then builds two signed release bundles:

- Play build: `clients/android/build/release-bundles/enclawed-<version>-play-release.aab`
- Third-party build: `clients/android/build/release-bundles/enclawed-<version>-third-party-release.aab`
...
- `clients/android/benchmark/build/reports/androidTests/connected/`
...
- Writes timestamped snapshot JSON to `clients/android/benchmark/results/`.
