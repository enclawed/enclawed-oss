...
- _Skills as Verifiable Artifacts: A Trust Schema and a Capability
  Containment Property_. Defines the manifest schema, capability
  vocabulary, signing convention, and the four-level verification lattice.
- _Methods for Formal Verification of Agent Skills: Three Layers Toward a
  Mechanically Checkable Capability-Containment Proof_. Defines the
