// In OSS the EnclawedKit Swift package lives under `clients/`; the prior path
// resolved against an internal `apps/` mirror that does not ship here.
import SHARED_TOOL_DISPLAY_JSON from "../../../clients/shared/EnclawedKit/Sources/EnclawedKit/Resources/tool-display.json" with { type: "json" };
import {
  defaultTitle,
