...
export const LEGACY_CLEARANCE_ORDER: Record<string, number> = impl.LEGACY_CLEARANCE_ORDER;
export const CLEARANCE_ORDER: Record<string, number> = impl.CLEARANCE_ORDER;
