...
import { createEgressGuard, installEgressGuard, EgressDeniedError } from "../src/egress-guard.mjs";
...
test("guard blocks unallowed host", async () => {
  ...
  await assert.rejects(() => guard("https://evil.example.com/"), EgressDeniedError);
});
