...
describe("parseTaskFile", () => {
  it("extracts system + user sections", () => {
    ...
    expect(out.systemPrompt).toContain("You are an executive assistant.");
...
describe("registerRunCommand", () => {
  ...
  it("dispatches the parsed task message through agentCliCommand", async () => {
    ...
    await runCli(["run", file, "--var", "name=alice", "--agent", "executive-assistant"]);
    ...
    expect(opts.agent).toBe("executive-assistant");
