...
export function registerLazyCommandGroup(
  ...
  registerLazyCommand({
    ...
    // The placeholder's declared options were dropped here, so flags a group
    // documents (browser doctor --deep, for one) appeared nowhere in help
    // until the group's module had already been loaded.
