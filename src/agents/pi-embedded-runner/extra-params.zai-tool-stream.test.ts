import type { Model, SimpleStreamOptions } from "@mariozechner/pi-ai/compat";
...
vi.mock("@mariozechner/pi-ai/compat", async () =>
  createPiAiStreamSimpleMock(() =>
    vi.importActual<typeof import("@mariozechner/pi-ai/compat")>("@mariozechner/pi-ai/compat"),
  ),
);
