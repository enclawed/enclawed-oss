...
// Imported fresh in beforeEach rather than statically. Test files here run
// without module isolation, so a static import binds to whatever copy of the
// subject is already in the shared registry -- and if another file loaded it
// before these vi.mock factories were installed, the real manifest registry is
// used and every lookup below resolves to undefined.
