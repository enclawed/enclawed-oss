...
// Not re-exported from the root barrel: image-generation already has its own
// `@enclawed/plugin-sdk/image-generation` subpath, and star-exporting it here
// added seventeen names to a root runtime surface the contract test keeps
// deliberately small. Nothing imported them from the root.
