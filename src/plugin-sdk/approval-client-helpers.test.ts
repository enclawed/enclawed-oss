...
describe("createChannelExecApprovalProfile", () => {
  ...
  it("requires explicit enablement, and treats false as disabled", () => {
    // Unset is a refusal, not an implicit "auto". Approvers being configured
    // describes who could approve, not that the approval client may run.
    expect(
      isChannelExecApprovalClientEnabledFromConfig({
        approverCount: 1,
      }),
