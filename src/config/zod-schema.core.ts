  ...
  .object({
    ...
    thinkingFormat: z
      .union([
        ...
        // pi-ai 0.x added these to OpenAICompletionsCompat["thinkingFormat"].
        // The local ModelCompatConfig already widens to include them; keep the
        // schema in sync so config -> runtime assignability still type-checks.
        z.literal("deepseek"),
        z.literal("together"),
        // Added in pi-ai 0.78.x.
        z.literal("string-thinking"),
        z.literal("ant-ling"),
        // Added in pi-ai 0.80.x.
