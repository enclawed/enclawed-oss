...
// apps/ directory -- so there is no Swift side to conform to. Skipped
// explicitly rather than throwing on a missing file.
const macosClientPresent = existsSync(path.join(process.cwd(), MACOS_APP_SOURCES_DIR));
