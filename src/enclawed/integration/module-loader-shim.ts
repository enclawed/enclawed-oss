...
import { type ClearanceLevel, parseManifest, type ModuleManifest } from "../module-manifest.js";
import { getRuntime } from "../runtime.js";

const MANIFEST_FILENAME = "enclawed.module.json";

export async function loadModuleManifest(moduleDir: string): Promise<ModuleManifest | null> {
  try {
