...
// (echo-mismatch) detection for any recurring event the secretary
...
import { canonicalEventSha256 } from "../../enclawed-apps/secretary/src/tools/canonical-event-sha.ts";
