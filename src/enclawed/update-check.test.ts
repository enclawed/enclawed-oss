// Smoke + contract test for the executive assistant's self-update check. We
...
// same way the running executive assistant would, against the same binary the
// executive assistant will call in production.
...
import {
  checkForUpdates,
  resolveRepoRoot,
} from "../../enclawed-apps/executive-assistant/src/scheduler/update-check.ts";
