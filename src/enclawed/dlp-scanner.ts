...
const PATTERNS: Pattern[] = [
  ...
  // hijacking the secretary's downstream prompt. The patterns are
  ...
  // secretary has no legitimate reason to process such requests, and the
  ...
  // secretary has no legitimate need to produce thermite recipes,
