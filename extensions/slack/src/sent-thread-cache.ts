...
function getPersistentThreadParticipationStore(): SlackThreadParticipationStore | undefined {
  ...
  // `state` is optional too, not just the method on it: reading through it
  // unguarded throws a TypeError for any host exposing no state capability,
  // instead of quietly disabling persistence the way an absent capability
  // should.
