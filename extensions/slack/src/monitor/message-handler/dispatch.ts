...
export async function dispatchPreparedSlackMessage(prepared: PreparedSlackMessage) {
  ...
  if (statusReactionsEnabled) {
    if (dispatchError) {
      ...
      // The error reaction stays unless something was actually delivered.
      // Restoring the initial ack painted over the failure, leaving a message
      // that looked merely acknowledged when the turn had thrown.
      if (ctx.removeAckAfterReply && anyReplyDelivered) {
        void (async () => {
