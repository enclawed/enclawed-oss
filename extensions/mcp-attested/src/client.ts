...
import type { ClearanceLevel } from "@enclawed/module-trust/module-manifest.js";
import { getRuntime } from "@enclawed/module-trust/runtime.js";
...
export type McpToolResult = { ok: true; output: unknown } | { ok: false; reason: string };
