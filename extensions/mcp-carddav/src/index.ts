...
// password. The Contacts half of the executive assistant's three-MCP surface
// after the migration off Google OAuth.

import { registerServer, type RegisteredServer } from "@enclawed/mcp-attested";
...
export const CARDDAV_TOOLS = Object.freeze(["search_contacts", "list_contacts", "add_contact"]);
