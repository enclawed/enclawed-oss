...
import { getMatrixRuntime, matrixReplaceConfigFile, readMatrixRuntimeConfig } from "./runtime.js";
...
async function setupMatrixEncryption(params: {
  ...
  // Throws "Matrix runtime not initialized" if the host never set it, so the
  // call is the guard even though nothing here needs the value.
  getMatrixRuntime();
