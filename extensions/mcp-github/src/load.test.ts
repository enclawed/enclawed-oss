...
import { _resetServerRegistryForTest, getServerById } from "../../mcp-attested/src/index.js";
import { DEFAULT_GITHUB_MCP_ENDPOINT, GITHUB_MCP_TOOLS, loadGithubBridge } from "./index.js";
...
describe("mcp-github bridge load", () => {
  ...
  it("respects a trimmed allowedTools override", () => {
    ...
    expect(result.registered.allowedTools).toEqual(["github.pulls.get", "github.pulls.list_files"]);
  });
});
